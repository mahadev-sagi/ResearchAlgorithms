; ModuleID = 'BFS/bfs_15_pointer.cpp'
...
; <label>:8                                       ; preds = %32, %7
  %9 = call zeroext i1 @_ZNKSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::queue"* %q)
  %10 = xor i1 %9, true
  br i1 %10, label %11, label %33

; <label>:11                                      ; preds = %8
  %12 = call %struct.Node** @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE5frontEv(%"class.std::queue"* %q)
  %13 = load %struct.Node** %12
  store %struct.Node* %13, %struct.Node** %u, align 8
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::queue"* %q)
  %14 = load %"class.std::vector"** %2, align 8
  %15 = load %struct.Node** %u, align 8
...
; <label>:21                                      ; preds = %11
  ...
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::queue"* %q, %struct.Node** %23)
  br label %24
...
; <label>:29                                      ; preds = %24
  ...
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::queue"* %q, %struct.Node** %31)
  br label %32
...
; <label>:37                                      ; preds = %21
  ...
  call void @_Z11bfs_pointerP4NodeRSt6vectorIiSaIiEE(%struct.Node* %38, %"class.std::vector"* %result)
