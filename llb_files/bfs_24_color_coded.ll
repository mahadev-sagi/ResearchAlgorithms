; ModuleID = 'BFS/bfs_24_color_coded.cpp'
...
define void @_Z9bfs_colorP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  %color = alloca %"class.std::map", align 8
...
; <label>:9                                       ; preds = %0
  call void @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEEC2Ev(%"class.std::map"* %color) #0
  ...
  %10 = call i32* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEEixERS6_(%"class.std::map"* %color, %struct.Node** %1)
  store i32 1, i32* %10
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::queue"* %q, %struct.Node** %1)
  br label %11

; <label>:11                                      ; preds = %55, %9
  %12 = call zeroext i1 @_ZNKSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::queue"* %q)
  %13 = xor i1 %12, true
  br i1 %13, label %14, label %57

; <label>:14                                      ; preds = %11
  %15 = call %struct.Node** @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE5frontEv(%"class.std::queue"* %q)
  %16 = load %struct.Node** %15
  store %struct.Node* %16, %struct.Node** %u, align 8
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::queue"* %q)
  %17 = load %"class.std::vector"** %2, align 8
  %18 = load %struct.Node** %u, align 8
  %19 = getelementptr inbounds %struct.Node* %18, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %17, i32* %19)
  %20 = getelementptr inbounds [2 x %struct.Node*]* %neighbors, i64 0, i64 0
  %21 = load %struct.Node** %u, align 8
  %22 = getelementptr inbounds %struct.Node* %21, i32 0, i32 1
  %23 = load %struct.Node** %22, align 8
  store %struct.Node* %23, %struct.Node** %20
  %24 = getelementptr inbounds %struct.Node** %20, i64 1
  %25 = load %struct.Node** %u, align 8
  %26 = getelementptr inbounds %struct.Node* %25, i32 0, i32 2
  %27 = load %struct.Node** %26, align 8
  store %struct.Node* %27, %struct.Node** %24
...
; <label>:31                                      ; preds = %28
  ...
  %34 = getelementptr inbounds [2 x %struct.Node*]* %neighbors, i32 0, i64 %33
  %35 = load %struct.Node** %34, align 8
  store %struct.Node* %35, %struct.Node** %v, align 8
  %36 = load %struct.Node** %v, align 8
  %37 = icmp ne %struct.Node* %36, null
  br i1 %37, label %38, label %51

; <label>:38                                      ; preds = %31
  %39 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE4findERS6_(%"class.std::map"* %color, %struct.Node** %v)
  ...
  %41 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE3endEv(%"class.std::map"* %color) #0
  %42 = getelementptr %"struct.std::_Rb_tree_iterator"* %5, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %41, %"struct.std::_Rb_tree_node_base"** %42
  %43 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEeqERKS6_(%"struct.std::_Rb_tree_iterator"* %4, %"struct.std::_Rb_tree_iterator"* %5) #0
  br i1 %43, label %48, label %44

; <label>:44                                      ; preds = %38
  %45 = call i32* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEEixERS6_(%"class.std::map"* %color, %struct.Node** %v)
  %46 = load i32* %45
  %47 = icmp eq i32 %46, 0
  br i1 %47, label %48, label %50

; <label>:48                                      ; preds = %44, %38
  %49 = call i32* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEEixERS6_(%"class.std::map"* %color, %struct.Node** %v)
  store i32 1, i32* %49
...
; <label>:55                                      ; preds = %28
  %56 = call i32* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEEixERS6_(%"class.std::map"* %color, %struct.Node** %u)
  store i32 2, i32* %56
  br label %11

; <label>:57                                      ; preds = %11
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::queue"* %q) #0
  call void @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEED2Ev(%"class.std::map"* %color) #0
  br label %58
...
define linkonce_odr void @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEEC2Ev(%"class.std::map"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EEC2Ev(%"class.std::_Rb_tree"* %3)
  ret void
}
...
define linkonce_odr i32* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEEixERS6_(%"class.std::map"* %this, %struct.Node** %__k) #3 align 2 {
  ...
  %11 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE11lower_boundERS6_(%"class.std::map"* %9, %struct.Node** %10)
  ...
  %13 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE3endEv(%"class.std::map"* %9) #0
  ...
  %15 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEeqERKS6_(%"struct.std::_Rb_tree_iterator"* %__i, %"struct.std::_Rb_tree_iterator"* %3) #0
  br i1 %15, label %21, label %16

; <label>:16                                      ; preds = %0
  call void @_ZNKSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE8key_compEv(%"class.std::map"* %9)
  %17 = load %struct.Node*** %2, align 8
  %18 = call %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEdeEv(%"struct.std::_Rb_tree_iterator"* %__i) #0
...
; <label>:21                                      ; preds = %16, %0
  ...
  call void @_ZNSt23_Rb_tree_const_iteratorISt4pairIKP4Node5ColorEEC2ERKSt17_Rb_tree_iteratorIS5_E(%"struct.std::_Rb_tree_const_iterator"* %6, %"struct.std::_Rb_tree_iterator"* %__i) #0
...
; <label>:30                                      ; preds = %21, %16
  %31 = call %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEdeEv(%"struct.std::_Rb_tree_iterator"* %__i) #0
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE4findERS6_(%"class.std::map"* %this, %struct.Node** %__x) #3 align 2 {
  ...
  %7 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE4findERS3_(%"class.std::_Rb_tree"* %5, %struct.Node** %6)
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE3endEv(%"class.std::map"* %this) #3 align 2 {
  ...
  %5 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE3endEv(%"class.std::_Rb_tree"* %4) #0
...
define linkonce_odr void @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEED2Ev(%"class.std::map"* %this) unnamed_addr #4 align 2 {
  ...
  %2 = load %"class.std::map"** %1
  %3 = getelementptr inbounds %"class.std::map"* %2, i32 0, i32 0
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EED2Ev(%"class.std::_Rb_tree"* %3) #0
  ret void
}
...
; <label>:37                                      ; preds = %21
  ...
  call void @_Z9bfs_colorP4NodeRSt6vectorIiSaIiEE(%struct.Node* %38, %"class.std::vector"* %result)
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE3endEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  %5 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %4, i32 0, i32 1
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %5) #0
  %6 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE4findERS3_(%"class.std::_Rb_tree"* %this, %struct.Node** %__k) #3 align 2 {
  ...
  %6 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_M_beginEv(%"class.std::_Rb_tree"* %5) #0
  %7 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_M_endEv(%"class.std::_Rb_tree"* %5) #0
  %8 = load %struct.Node*** %3, align 8
  %9 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS5_ESE_RS3_(%"class.std::_Rb_tree"* %5, %"struct.std::_Rb_tree_node"* %6, %"struct.std::_Rb_tree_node"* %7, %struct.Node** %8)
  ...
  %11 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE3endEv(%"class.std::_Rb_tree"* %5) #0
  %12 = getelementptr %"struct.std::_Rb_tree_iterator"* %4, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %11, %"struct.std::_Rb_tree_node_base"** %12
  %13 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEeqERKS6_(%"struct.std::_Rb_tree_iterator"* %__j, %"struct.std::_Rb_tree_iterator"* %4) #0
  br i1 %13, label %22, label %14

; <label>:14                                      ; preds = %0
  %15 = getelementptr inbounds %"class.std::_Rb_tree"* %5, i32 0, i32 0
  %16 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %15, i32 0, i32 0
  ...
  %20 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %19)
  %21 = call zeroext i1 @_ZNKSt4lessIP4NodeEclERKS1_S4_(%"struct.std::less"* %16, %struct.Node** %17, %struct.Node** %20)
  br i1 %21, label %22, label %25

; <label>:22                                      ; preds = %14, %0
  %23 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE3endEv(%"class.std::_Rb_tree"* %5) #0
...
; <label>:10                                      ; preds = %7
  ...
  %12 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %11, i32 0, i32 0
  %13 = load %"struct.std::_Rb_tree_node"** %3, align 8
  %14 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt13_Rb_tree_nodeIS5_E(%"struct.std::_Rb_tree_node"* %13)
...
; <label>:17                                      ; preds = %10
  ...
  %21 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %20) #0
...
; <label>:22                                      ; preds = %10
  ...
  %25 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %24) #0
...
; <label>:27                                      ; preds = %7
  ...
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %29) #0
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_M_beginEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %3, i32 0, i32 1
...
define linkonce_odr %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #3 align 2 {
  ...
  %4 = call %"struct.std::pair"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_valueEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %3)
  %5 = call %struct.Node** @_ZNKSt10_Select1stISt4pairIKP4Node5ColorEEclERKS5_(%"struct.std::_Select1st"* %2, %"struct.std::pair"* %4)
  ret %struct.Node** %5
}
...
define linkonce_odr %"struct.std::pair"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_valueEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #3 align 2 {
  ...
  %4 = call %"struct.std::pair"* @_ZNKSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %3)
...
define linkonce_odr %"struct.std::pair"* @_ZNKSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %this) #3 align 2 {
  ...
  %4 = call %"struct.std::pair"* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKP4Node5ColorEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %3) #0
  ret %"struct.std::pair"* %4
}
...
define linkonce_odr %"struct.std::pair"* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKP4Node5ColorEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %this) #3 align 2 {
  ...
  %3 = call i8* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKP4Node5ColorEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* %2) #0
...
define linkonce_odr %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt13_Rb_tree_nodeIS5_E(%"struct.std::_Rb_tree_node"* %__x) #3 align 2 {
  ...
  %4 = call %"struct.std::pair"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_valueEPKSt13_Rb_tree_nodeIS5_E(%"struct.std::_Rb_tree_node"* %3)
  %5 = call %struct.Node** @_ZNKSt10_Select1stISt4pairIKP4Node5ColorEEclERKS5_(%"struct.std::_Select1st"* %2, %"struct.std::pair"* %4)
  ret %struct.Node** %5
}
...
define linkonce_odr %"struct.std::pair"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_valueEPKSt13_Rb_tree_nodeIS5_E(%"struct.std::_Rb_tree_node"* %__x) #3 align 2 {
  ...
  %3 = call %"struct.std::pair"* @_ZNKSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %2)
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE11lower_boundERS6_(%"class.std::map"* %this, %struct.Node** %__x) #3 align 2 {
  ...
  %5 = getelementptr inbounds %"class.std::map"* %4, i32 0, i32 0
  %6 = load %struct.Node*** %3, align 8
  %7 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11lower_boundERS3_(%"class.std::_Rb_tree"* %5, %struct.Node** %6)
  %8 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %7, %"struct.std::_Rb_tree_node_base"** %8
  %9 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
  %10 = load %"struct.std::_Rb_tree_node_base"** %9
...
define linkonce_odr void @_ZNKSt3mapIP4Node5ColorSt4lessIS1_ESaISt4pairIKS1_S2_EEE8key_compEv(%"class.std::map"* %this) #3 align 2 {
  ...
  %4 = load %"class.std::map"** %2
  %5 = getelementptr inbounds %"class.std::map"* %4, i32 0, i32 0
  call void @_ZNKSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8key_compEv(%"class.std::_Rb_tree"* %5)
  ret void
}
...
define linkonce_odr %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEdeEv(%"struct.std::_Rb_tree_iterator"* %this) #3 align 2 {
  ...
  %4 = load %"struct.std::_Rb_tree_node_base"** %3, align 8
  %5 = bitcast %"struct.std::_Rb_tree_node_base"* %4 to %"struct.std::_Rb_tree_node"*
  %6 = call %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %5)
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE22_M_emplace_hint_uniqueIJRKSt21piecewise_construct_tSt5tupleIJRS3_EESG_IJEEEEESt17_Rb_tree_iteratorIS5_ESt23_Rb_tree_const_iteratorIS5_EDpOT_(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node_base"* %__pos.coerce, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.13"* %__args2) #3 align 2 {
  ...
  %19 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt13_Rb_tree_nodeIS5_E(%"struct.std::_Rb_tree_node"* %18)
  %20 = getelementptr %"struct.std::_Rb_tree_const_iterator"* %6, i32 0, i32 0
  %21 = load %"struct.std::_Rb_tree_node_base"** %20
  %22 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE29_M_get_insert_hint_unique_posESt23_Rb_tree_const_iteratorIS5_ERS3_(%"class.std::_Rb_tree"* %8, %"struct.std::_Rb_tree_node_base"* %21, %struct.Node** %19)
...
; <label>:31                                      ; preds = %0
  ...
  %37 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE14_M_insert_nodeEPSt18_Rb_tree_node_baseSD_PSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %8, %"struct.std::_Rb_tree_node_base"* %33, %"struct.std::_Rb_tree_node_base"* %35, %"struct.std::_Rb_tree_node"* %36)
...
; <label>:39                                      ; preds = %0
  ...
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %8, %"struct.std::_Rb_tree_node"* %40) #0
  ...
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %44) #0
  br label %45
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE14_M_create_nodeIJRKSt21piecewise_construct_tSt5tupleIJRS3_EESG_IJEEEEEPSt13_Rb_tree_nodeIS5_EDpOT_(%"class.std::_Rb_tree"* %this, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.13"* %__args2) #3 align 2 {
  ...
  %6 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11_M_get_nodeEv(%"class.std::_Rb_tree"* %5)
...
define linkonce_odr { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE29_M_get_insert_hint_unique_posESt23_Rb_tree_const_iteratorIS5_ERS3_(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node_base"* %__position.coerce, %struct.Node** %__k) #3 align 2 {
  ...
  %11 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIKP4Node5ColorEE13_M_const_castEv(%"struct.std::_Rb_tree_const_iterator"* %__position) #0
  ...
  %15 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_M_endEv(%"class.std::_Rb_tree"* %10) #0
...
; <label>:18                                      ; preds = %0
  %19 = call i64 @_ZNKSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE4sizeEv(%"class.std::_Rb_tree"* %10) #0
  %20 = icmp ugt i64 %19, 0
  br i1 %20, label %21, label %31

; <label>:21                                      ; preds = %18
  %22 = getelementptr inbounds %"class.std::_Rb_tree"* %10, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %22, i32 0, i32 0
  %24 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %10) #0
  %25 = load %"struct.std::_Rb_tree_node_base"** %24
  %26 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %25)
...
; <label>:29                                      ; preds = %21
  ...
  %30 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %10) #0
...
; <label>:31                                      ; preds = %21, %18
  ...
  %33 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE24_M_get_insert_unique_posERS3_(%"class.std::_Rb_tree"* %10, %struct.Node** %32)
...
; <label>:39                                      ; preds = %0
  ...
  %41 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %40, i32 0, i32 0
  ...
  %45 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %44)
...
; <label>:47                                      ; preds = %39
  ...
  %52 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11_M_leftmostEv(%"class.std::_Rb_tree"* %10) #0
  %53 = load %"struct.std::_Rb_tree_node_base"** %52
  %54 = icmp eq %"struct.std::_Rb_tree_node_base"* %51, %53
  br i1 %54, label %55, label %58

; <label>:55                                      ; preds = %47
  %56 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11_M_leftmostEv(%"class.std::_Rb_tree"* %10) #0
  %57 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11_M_leftmostEv(%"class.std::_Rb_tree"* %10) #0
...
; <label>:58                                      ; preds = %47
  ...
  %60 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %59, i32 0, i32 0
  %61 = call %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEmmEv(%"struct.std::_Rb_tree_iterator"* %__before) #0
  %62 = getelementptr inbounds %"struct.std::_Rb_tree_iterator"* %61, i32 0, i32 0
  %63 = load %"struct.std::_Rb_tree_node_base"** %62, align 8
  %64 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %63)
...
; <label>:67                                      ; preds = %58
  ...
  %70 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %69) #0
...
; <label>:77                                      ; preds = %58
  ...
  %79 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE24_M_get_insert_unique_posERS3_(%"class.std::_Rb_tree"* %10, %struct.Node** %78)
...
; <label>:85                                      ; preds = %39
  ...
  %87 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %86, i32 0, i32 0
  %88 = getelementptr inbounds %"struct.std::_Rb_tree_iterator"* %__pos, i32 0, i32 0
  %89 = load %"struct.std::_Rb_tree_node_base"** %88, align 8
  %90 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %89)
...
; <label>:93                                      ; preds = %85
  ...
  %98 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %10) #0
...
; <label>:101                                     ; preds = %93
  ...
  %102 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %10) #0
...
; <label>:103                                     ; preds = %93
  ...
  %105 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %104, i32 0, i32 0
  %106 = load %struct.Node*** %3, align 8
  %107 = call %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEppEv(%"struct.std::_Rb_tree_iterator"* %__after) #0
  ...
  %110 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %109)
...
; <label>:112                                     ; preds = %103
  ...
  %115 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %114) #0
...
; <label>:122                                     ; preds = %103
  ...
  %124 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE24_M_get_insert_unique_posERS3_(%"class.std::_Rb_tree"* %10, %struct.Node** %123)
...
; <label>:9                                       ; preds = %0
  ...
  %11 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_M_endEv(%"class.std::_Rb_tree"* %6) #0
...
; <label>:14                                      ; preds = %9
  ...
  %18 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt13_Rb_tree_nodeIS5_E(%"struct.std::_Rb_tree_node"* %17)
...
; <label>:22                                      ; preds = %14, %9, %0
  ...
  %31 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %30, i32 0, i32 1
  ...
  %33 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %32, i32 0, i32 2
  %34 = load i64* %33, align 8
  %35 = add i64 %34, 1
  store i64 %35, i64* %33, align 8
  %36 = load %"struct.std::_Rb_tree_node"** %5, align 8
  %37 = bitcast %"struct.std::_Rb_tree_node"* %36 to %"struct.std::_Rb_tree_node_base"*
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %37) #0
  %38 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__p) #3 align 2 {
  ...
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %3, %"struct.std::_Rb_tree_node"* %4) #0
  %5 = load %"struct.std::_Rb_tree_node"** %2, align 8
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %3, %"struct.std::_Rb_tree_node"* %5) #0
  ret void
}
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__p) #3 align 2 {
  ...
  store %"struct.std::_Rb_tree_node"* %__p, %"struct.std::_Rb_tree_node"** %2, align 8
  %3 = load %"class.std::_Rb_tree"** %1
  %4 = call %"class.std::allocator.0"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %3) #0
  %5 = load %"struct.std::_Rb_tree_node"** %2, align 8
  %6 = call %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %5)
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEE7destroyIS6_EEvRS8_PT_(%"class.std::allocator.0"* %4, %"struct.std::pair"* %6)
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__p) #3 align 2 {
  ...
  %4 = call %"class.std::allocator.0"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %3) #0
  %5 = load %"struct.std::_Rb_tree_node"** %2, align 8
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEE10deallocateERS8_PS7_m(%"class.std::allocator.0"* %4, %"struct.std::_Rb_tree_node"* %5, i64 1)
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEE10deallocateERS8_PS7_m(%"class.std::allocator.0"* %__a, %"struct.std::_Rb_tree_node"* %__p, i64 %__n) #3 align 2 {
  ...
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEE10deallocateEPS8_m(%"class.__gnu_cxx::new_allocator.1"* %5, %"struct.std::_Rb_tree_node"* %6, i64 %7)
  ret void
}
...
define linkonce_odr %"class.std::allocator.0"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  %4 = bitcast %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %3 to %"class.std::allocator.0"*
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEE7destroyIS6_EEvRS8_PT_(%"class.std::allocator.0"* %__a, %"struct.std::pair"* %__p) #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEE7destroyIS7_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %4, %"struct.std::pair"* %5)
  ret void
}
...
define linkonce_odr %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %this) #3 align 2 {
  ...
  %2 = load %"struct.std::_Rb_tree_node"** %1
  %3 = getelementptr inbounds %"struct.std::_Rb_tree_node"* %2, i32 0, i32 1
  %4 = call %"struct.std::pair"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKP4Node5ColorEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %3) #0
  ret %"struct.std::pair"* %4
}
...
define linkonce_odr %"struct.std::pair"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKP4Node5ColorEE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %this) #3 align 2 {
  ...
  store %"struct.__gnu_cxx::__aligned_membuf"* %this, %"struct.__gnu_cxx::__aligned_membuf"** %1, align 8
  %2 = load %"struct.__gnu_cxx::__aligned_membuf"** %1
  %3 = call i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKP4Node5ColorEE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* %2) #0
  %4 = bitcast i8* %3 to %"struct.std::pair"*
  ret %"struct.std::pair"* %4
}
...
define linkonce_odr i64 @_ZNKSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE4sizeEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %3, i32 0, i32 2
  %5 = load i64* %4, align 8
  ret i64 %5
}
...
define linkonce_odr { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE24_M_get_insert_unique_posERS3_(%"class.std::_Rb_tree"* %this, %struct.Node** %__k) #3 align 2 {
  ...
  store %struct.Node** %__k, %struct.Node*** %3, align 8
  %6 = load %"class.std::_Rb_tree"** %2
  %7 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_M_beginEv(%"class.std::_Rb_tree"* %6) #0
  store %"struct.std::_Rb_tree_node"* %7, %"struct.std::_Rb_tree_node"** %__x, align 8
  %8 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_M_endEv(%"class.std::_Rb_tree"* %6) #0
...
; <label>:12                                      ; preds = %9
  ...
  %15 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %14, i32 0, i32 0
...
; <label>:23                                      ; preds = %12
  ...
  %26 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %25) #0
  br label %31

; <label>:27                                      ; preds = %12
  %28 = load %"struct.std::_Rb_tree_node"** %__x, align 8
  %29 = bitcast %"struct.std::_Rb_tree_node"* %28 to %"struct.std::_Rb_tree_node_base"*
  %30 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %29) #0
  br label %31
...
; <label>:33                                      ; preds = %9
  ...
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %__j, %"struct.std::_Rb_tree_node_base"* %35) #0
  %36 = load i8* %__comp, align 1
  %37 = trunc i8 %36 to i1
  br i1 %37, label %38, label %46

; <label>:38                                      ; preds = %33
  %39 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE5beginEv(%"class.std::_Rb_tree"* %6) #0
  %40 = getelementptr %"struct.std::_Rb_tree_iterator"* %4, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %39, %"struct.std::_Rb_tree_node_base"** %40
  %41 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEeqERKS6_(%"struct.std::_Rb_tree_iterator"* %__j, %"struct.std::_Rb_tree_iterator"* %4) #0
  br i1 %41, label %42, label %43

; <label>:42                                      ; preds = %38
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKP4Node5ColorEESC_vEEOT_OT0_(%"struct.std::pair.14"* %1, %"struct.std::_Rb_tree_node"** %__x, %"struct.std::_Rb_tree_node"** %__y)
  br label %57

; <label>:43                                      ; preds = %38
  %44 = call %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEmmEv(%"struct.std::_Rb_tree_iterator"* %__j) #0
  br label %45
...
; <label>:46                                      ; preds = %45, %33
  ...
  %48 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %47, i32 0, i32 0
  %49 = getelementptr inbounds %"struct.std::_Rb_tree_iterator"* %__j, i32 0, i32 0
  %50 = load %"struct.std::_Rb_tree_node_base"** %49, align 8
  %51 = call %struct.Node** @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %50)
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE5beginEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  %7 = load %"struct.std::_Rb_tree_node_base"** %6, align 8
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP4Node5ColorEEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %7) #0
  %8 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
...
define linkonce_odr void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKP4Node5ColorEESC_vEEOT_OT0_(%"struct.std::pair.14"* %this, %"struct.std::_Rb_tree_node"** %__x, %"struct.std::_Rb_tree_node"** %__y) unnamed_addr #3 align 2 {
  ...
  %5 = getelementptr inbounds %"struct.std::pair.14"* %4, i32 0, i32 0
  %6 = load %"struct.std::_Rb_tree_node"*** %2, align 8
  %7 = call %"struct.std::_Rb_tree_node"** @_ZSt7forwardIRPSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEOT_RNSt16remove_referenceISA_E4typeE(%"struct.std::_Rb_tree_node"** %6) #0
  ...
  %12 = call %"struct.std::_Rb_tree_node"** @_ZSt7forwardIRPSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEOT_RNSt16remove_referenceISA_E4typeE(%"struct.std::_Rb_tree_node"** %11) #0
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11_M_get_nodeEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = call %"class.std::allocator.0"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %2) #0
  %4 = call %"struct.std::_Rb_tree_node"* @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEE8allocateERS8_m(%"class.std::allocator.0"* %3, i64 1)
...
; <label>:12                                      ; preds = %10, %0
  ...
  %14 = call %"class.std::allocator.0"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %6) #0
  %15 = load %"struct.std::_Rb_tree_node"** %2, align 8
  %16 = call %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKP4Node5ColorEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %15)
  ...
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEE9constructIS6_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESE_IJEEEEEvRS8_PT_DpOT0_(%"class.std::allocator.0"* %14, %"struct.std::pair"* %16, %"struct.std::piecewise_construct_t"* %18, %"class.std::tuple"* %20, %"class.std::tuple.13"* %22)
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEE9constructIS6_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESE_IJEEEEEvRS8_PT_DpOT0_(%"class.std::allocator.0"* %__a, %"struct.std::pair"* %__p, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.13"* %__args2) #3 align 2 {
  ...
  %13 = load %"class.std::tuple.13"** %5, align 8
  %14 = call %"class.std::tuple.13"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.13"* %13) #0
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEE9constructIS7_JRKSt21piecewise_construct_tSt5tupleIJRS5_EESE_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %7, %"struct.std::pair"* %8, %"struct.std::piecewise_construct_t"* %10, %"class.std::tuple"* %12, %"class.std::tuple.13"* %14)
  ret void
}
...
; <label>:13                                      ; preds = %0
  ...
  call void @_ZNSt4pairIKP4Node5ColorEC2IJRS2_EJEEESt21piecewise_construct_tSt5tupleIJDpT_EES8_IJDpT0_EE(%"struct.std::pair"* %14, %struct.Node** %24)
  br label %25
...
define linkonce_odr void @_ZNSt4pairIKP4Node5ColorEC2IJRS2_EJEEESt21piecewise_construct_tSt5tupleIJDpT_EES8_IJDpT0_EE(%"struct.std::pair"* %this, %struct.Node** %__first.coerce) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt4pairIKP4Node5ColorEC2IJRS2_EJLm0EEJEJEEERSt5tupleIJDpT_EERS7_IJDpT1_EESt12_Index_tupleIJXspT0_EEESG_IJXspT2_EEE(%"struct.std::pair"* %8, %"class.std::tuple"* %__first, %"class.std::tuple.13"* %__second)
  ret void
}
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEE8allocateERS8_m(%"class.std::allocator.0"* %__a, i64 %__n) #3 align 2 {
  ...
  %4 = bitcast %"class.std::allocator.0"* %3 to %"class.__gnu_cxx::new_allocator.1"*
  %5 = load i64* %2, align 8
  %6 = call %"struct.std::_Rb_tree_node"* @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %4, i64 %5, i8* null)
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.1"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
define linkonce_odr void @_ZNKSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8key_compEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  %3 = load %"class.std::_Rb_tree"** %2
  %4 = getelementptr inbounds %"class.std::_Rb_tree"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %4, i32 0, i32 0
  ret void
}
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE11lower_boundERS3_(%"class.std::_Rb_tree"* %this, %struct.Node** %__k) #3 align 2 {
  ...
  %5 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_M_beginEv(%"class.std::_Rb_tree"* %4) #0
  %6 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE6_M_endEv(%"class.std::_Rb_tree"* %4) #0
  %7 = load %struct.Node*** %3, align 8
  %8 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS5_ESE_RS3_(%"class.std::_Rb_tree"* %4, %"struct.std::_Rb_tree_node"* %5, %"struct.std::_Rb_tree_node"* %6, %struct.Node** %7)
  %9 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EEC2Ev(%"class.std::_Rb_tree"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE13_Rb_tree_implIS9_Lb1EEC2Ev(%"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %3)
  ret void
}
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE13_Rb_tree_implIS9_Lb1EEC2Ev(%"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"*, align 8
  ...
  %2 = load %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"** %1
  %3 = bitcast %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2 to %"class.std::allocator.0"*
  call void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEC2Ev(%"class.std::allocator.0"* %3) #0
  %4 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  %6 = bitcast %"struct.std::_Rb_tree_node_base"* %5 to i8*
  call void @llvm.memset.p0i8.i64(i8* %6, i8 0, i64 32, i32 8, i1 false)
  %7 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2, i32 0, i32 2
  store i64 0, i64* %7, align 8
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE13_Rb_tree_implIS9_Lb1EE13_M_initializeEv(%"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2)
  ret void
}
...
define linkonce_odr void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEC2Ev(%"class.std::allocator.0"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEEC2Ev(%"class.__gnu_cxx::new_allocator.1"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE13_Rb_tree_implIS9_Lb1EE13_M_initializeEv(%"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %this) #3 align 2 {
  ...
  store %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %this, %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"** %1, align 8
  %2 = load %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"** %1
  %3 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  ...
  %7 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  %8 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  ...
  %10 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  %11 = getelementptr inbounds %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2, i32 0, i32 1
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EED2Ev(%"class.std::_Rb_tree"* %this) unnamed_addr #3 align 2 {
  ...
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_M_beginEv(%"class.std::_Rb_tree"* %2) #0
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_M_eraseEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %2, %"struct.std::_Rb_tree_node"* %3)
  %4 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE13_Rb_tree_implIS9_Lb1EED2Ev(%"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %4) #0
  ret void
}
...
; <label>:7                                       ; preds = %4
  ...
  %9 = bitcast %"struct.std::_Rb_tree_node"* %8 to %"struct.std::_Rb_tree_node_base"*
  %10 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %9) #0
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE8_M_eraseEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %3, %"struct.std::_Rb_tree_node"* %10)
  %11 = load %"struct.std::_Rb_tree_node"** %2, align 8
  %12 = bitcast %"struct.std::_Rb_tree_node"* %11 to %"struct.std::_Rb_tree_node_base"*
  %13 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %12) #0
  store %"struct.std::_Rb_tree_node"* %13, %"struct.std::_Rb_tree_node"** %__y, align 8
  %14 = load %"struct.std::_Rb_tree_node"** %2, align 8
  call void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS5_E(%"class.std::_Rb_tree"* %3, %"struct.std::_Rb_tree_node"* %14) #0
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_5ColorESt10_Select1stIS5_ESt4lessIS1_ESaIS5_EE13_Rb_tree_implIS9_Lb1EED2Ev(%"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %this) unnamed_addr #4 align 2 {
  ...
  %2 = load %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"** %1
  %3 = bitcast %"struct.std::_Rb_tree<Node *, std::pair<Node *const, Color>, std::_Select1st<std::pair<Node *const, Color> >, std::less<Node *>, std::allocator<std::pair<Node *const, Color> > >::_Rb_tree_impl"* %2 to %"class.std::allocator.0"*
  call void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEED2Ev(%"class.std::allocator.0"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEED2Ev(%"class.std::allocator.0"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::allocator.0"** %1
  %3 = bitcast %"class.std::allocator.0"* %2 to %"class.__gnu_cxx::new_allocator.1"*
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4Node5ColorEEED2Ev(%"class.__gnu_cxx::new_allocator.1"* %3) #0
  ret void
}
