...
define void @_Z3dlsP4NodeiRSt6vectorIiSaIiEE(%struct.Node* %u, i32 %limit, %"class.std::vector"* %result) #3 {
  ...
  store %struct.Node* %u, %struct.Node** %1, align 8
...
; <label>:10                                      ; preds = %7
  %11 = load %"class.std::vector"** %3, align 8
...
; <label>:14                                      ; preds = %7
  ...
  %19 = sub nsw i32 %18, 1
  %20 = load %"class.std::vector"** %3, align 8
  call void @_Z3dlsP4NodeiRSt6vectorIiSaIiEE(%struct.Node* %17, i32 %19, %"class.std::vector"* %20)
  ...
  call void @_Z3dlsP4NodeiRSt6vectorIiSaIiEE(%struct.Node* %23, i32 %25, %"class.std::vector"* %26)
  br label %27
...
define void @_Z15iddfs_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  %size_before = alloca i64, align 8
...
; <label>:7                                       ; preds = %6, %18
  ...
  store i64 %9, i64* %size_before, align 8
  %10 = load %struct.Node** %1, align 8
  %11 = load i32* %depth, align 4
  %12 = load %"class.std::vector"** %2, align 8
  call void @_Z3dlsP4NodeiRSt6vectorIiSaIiEE(%struct.Node* %10, i32 %11, %"class.std::vector"* %12)
  %13 = load %"class.std::vector"** %2, align 8
  %14 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %13) #0
  %15 = load i64* %size_before, align 8
...
; <label>:18                                      ; preds = %7
  %19 = load i32* %depth, align 4
  %20 = add nsw i32 %19, 1
  store i32 %20, i32* %depth, align 4
  br label %7
...
; <label>:37                                      ; preds = %21
  ...
  call void @_Z15iddfs_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %38, %"class.std::vector"* %result)
