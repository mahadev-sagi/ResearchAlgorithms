; ModuleID = 'BFS/bfs_12_ll_queue.cpp'
...
define void @_Z14bfs_list_queueP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  %q = alloca %"class.std::__cxx11::list", align 8
...
; <label>:8                                       ; preds = %0
  call void @_ZNSt7__cxx114listIP4NodeSaIS2_EEC2Ev(%"class.std::__cxx11::list"* %q) #0
  call void @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEEC2Ev(%"class.std::map"* %visited) #0
  %9 = call i8* @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEEixERS5_(%"class.std::map"* %visited, %struct.Node** %1)
  store i8 1, i8* %9
  call void @_ZNSt7__cxx114listIP4NodeSaIS2_EE9push_backERKS2_(%"class.std::__cxx11::list"* %q, %struct.Node** %1)
  br label %10

; <label>:10                                      ; preds = %49, %8
  %11 = call zeroext i1 @_ZNKSt7__cxx114listIP4NodeSaIS2_EE5emptyEv(%"class.std::__cxx11::list"* %q) #0
  %12 = xor i1 %11, true
  br i1 %12, label %13, label %50

; <label>:13                                      ; preds = %10
  %14 = call %struct.Node** @_ZNSt7__cxx114listIP4NodeSaIS2_EE5frontEv(%"class.std::__cxx11::list"* %q) #0
  %15 = load %struct.Node** %14
  store %struct.Node* %15, %struct.Node** %u, align 8
  call void @_ZNSt7__cxx114listIP4NodeSaIS2_EE9pop_frontEv(%"class.std::__cxx11::list"* %q) #0
  %16 = load %"class.std::vector"** %2, align 8
  %17 = load %struct.Node** %u, align 8
  %18 = getelementptr inbounds %struct.Node* %17, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %16, i32* %18)
  %19 = getelementptr inbounds [2 x %struct.Node*]* %neighbors, i64 0, i64 0
  %20 = load %struct.Node** %u, align 8
  %21 = getelementptr inbounds %struct.Node* %20, i32 0, i32 1
  %22 = load %struct.Node** %21, align 8
  store %struct.Node* %22, %struct.Node** %19
  %23 = getelementptr inbounds %struct.Node** %19, i64 1
...
; <label>:30                                      ; preds = %27
  ...
  %33 = getelementptr inbounds [2 x %struct.Node*]* %neighbors, i32 0, i64 %32
  %34 = load %struct.Node** %33, align 8
  store %struct.Node* %34, %struct.Node** %v, align 8
  %35 = load %struct.Node** %v, align 8
  %36 = icmp ne %struct.Node* %35, null
  br i1 %36, label %37, label %45

; <label>:37                                      ; preds = %30
  %38 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEE4findERS5_(%"class.std::map"* %visited, %struct.Node** %v)
  %39 = getelementptr %"struct.std::_Rb_tree_iterator"* %3, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %38, %"struct.std::_Rb_tree_node_base"** %39
  %40 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEE3endEv(%"class.std::map"* %visited) #0
  ...
  %42 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4NodebEEeqERKS5_(%"struct.std::_Rb_tree_iterator"* %3, %"struct.std::_Rb_tree_iterator"* %4) #0
  br i1 %42, label %43, label %45

; <label>:43                                      ; preds = %37
  %44 = call i8* @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEEixERS5_(%"class.std::map"* %visited, %struct.Node** %v)
  store i8 1, i8* %44
  call void @_ZNSt7__cxx114listIP4NodeSaIS2_EE9push_backERKS2_(%"class.std::__cxx11::list"* %q, %struct.Node** %v)
  br label %45
...
; <label>:50                                      ; preds = %10
  ...
  call void @_ZNSt7__cxx114listIP4NodeSaIS2_EED2Ev(%"class.std::__cxx11::list"* %q) #0
  br label %51
...
define linkonce_odr void @_ZNSt7__cxx114listIP4NodeSaIS2_EEC2Ev(%"class.std::__cxx11::list"* %this) unnamed_addr #3 align 2 {
  ...
  store %"class.std::__cxx11::list"* %this, %"class.std::__cxx11::list"** %1, align 8
  %2 = load %"class.std::__cxx11::list"** %1
  %3 = bitcast %"class.std::__cxx11::list"* %2 to %"class.std::__cxx11::_List_base"*
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EEC2Ev(%"class.std::__cxx11::_List_base"* %3)
  ret void
}
...
define linkonce_odr void @_ZNSt7__cxx114listIP4NodeSaIS2_EE9push_backERKS2_(%"class.std::__cxx11::list"* %this, %struct.Node** %__x) #3 align 2 {
  ...
  %4 = load %"class.std::__cxx11::list"** %1
  %5 = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIP4NodeSaIS2_EE3endEv(%"class.std::__cxx11::list"* %4) #0
  ...
  call void @_ZNSt7__cxx114listIP4NodeSaIS2_EE9_M_insertIJRKS2_EEEvSt14_List_iteratorIS2_EDpOT_(%"class.std::__cxx11::list"* %4, %"struct.std::__detail::_List_node_base"* %9, %struct.Node** %7)
  ret void
}
...
define linkonce_odr zeroext i1 @_ZNKSt7__cxx114listIP4NodeSaIS2_EE5emptyEv(%"class.std::__cxx11::list"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::__cxx11::list"** %1
  %3 = bitcast %"class.std::__cxx11::list"* %2 to %"class.std::__cxx11::_List_base"*
  %4 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %4, i32 0, i32 0
  ...
  %9 = bitcast %"class.std::__cxx11::list"* %2 to %"class.std::__cxx11::_List_base"*
  %10 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %10, i32 0, i32 0
  %12 = bitcast %"struct.std::_List_node"* %11 to %"struct.std::__detail::_List_node_base"*
  %13 = icmp eq %"struct.std::__detail::_List_node_base"* %8, %12
  ret i1 %13
}
...
define linkonce_odr %struct.Node** @_ZNSt7__cxx114listIP4NodeSaIS2_EE5frontEv(%"class.std::__cxx11::list"* %this) #3 align 2 {
  ...
  store %"class.std::__cxx11::list"* %this, %"class.std::__cxx11::list"** %1, align 8
  %3 = load %"class.std::__cxx11::list"** %1
  %4 = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIP4NodeSaIS2_EE5beginEv(%"class.std::__cxx11::list"* %3) #0
  ...
  %6 = call %struct.Node** @_ZNKSt14_List_iteratorIP4NodeEdeEv(%"struct.std::_List_iterator"* %2) #0
  ret %struct.Node** %6
}
...
define linkonce_odr void @_ZNSt7__cxx114listIP4NodeSaIS2_EE9pop_frontEv(%"class.std::__cxx11::list"* %this) #3 align 2 {
  ...
  call void @_ZNSt7__cxx114listIP4NodeSaIS2_EE8_M_eraseESt14_List_iteratorIS2_E(%"class.std::__cxx11::list"* %3, %"struct.std::__detail::_List_node_base"* %7) #0
  ret void
}
...
define linkonce_odr void @_ZNSt7__cxx114listIP4NodeSaIS2_EED2Ev(%"class.std::__cxx11::list"* %this) unnamed_addr #4 align 2 {
  ...
  %2 = load %"class.std::__cxx11::list"** %1
  %3 = bitcast %"class.std::__cxx11::list"* %2 to %"class.std::__cxx11::_List_base"*
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EED2Ev(%"class.std::__cxx11::_List_base"* %3) #0
  ret void
}
...
; <label>:37                                      ; preds = %21
  ...
  call void @_Z14bfs_list_queueP4NodeRSt6vectorIiSaIiEE(%struct.Node* %38, %"class.std::vector"* %result)
...
define linkonce_odr void @_ZNSt7__cxx114listIP4NodeSaIS2_EE8_M_eraseESt14_List_iteratorIS2_E(%"class.std::__cxx11::list"* %this, %"struct.std::__detail::_List_node_base"* %__position.coerce) #3 align 2 {
  ...
  %__n = alloca %"struct.std::_List_node.10"*, align 8
  store %"class.std::__cxx11::list"* %this, %"class.std::__cxx11::list"** %1, align 8
  %2 = getelementptr %"struct.std::_List_iterator"* %__position, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %__position.coerce, %"struct.std::__detail::_List_node_base"** %2
  %3 = load %"class.std::__cxx11::list"** %1
  %4 = bitcast %"class.std::__cxx11::list"* %3 to %"class.std::__cxx11::_List_base"*
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_dec_sizeEm(%"class.std::__cxx11::_List_base"* %4, i64 1)
  %5 = getelementptr inbounds %"struct.std::_List_iterator"* %__position, i32 0, i32 0
  %6 = load %"struct.std::__detail::_List_node_base"** %5, align 8
  call void @_ZNSt8__detail15_List_node_base9_M_unhookEv(%"struct.std::__detail::_List_node_base"* %6) #0
  %7 = getelementptr inbounds %"struct.std::_List_iterator"* %__position, i32 0, i32 0
  %8 = load %"struct.std::__detail::_List_node_base"** %7, align 8
  %9 = bitcast %"struct.std::__detail::_List_node_base"* %8 to %"struct.std::_List_node.10"*
  store %"struct.std::_List_node.10"* %9, %"struct.std::_List_node.10"** %__n, align 8
  %10 = bitcast %"class.std::__cxx11::list"* %3 to %"class.std::__cxx11::_List_base"*
  %11 = call %"class.std::allocator.0"* @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE21_M_get_Node_allocatorEv(%"class.std::__cxx11::_List_base"* %10) #0
  %12 = bitcast %"class.std::allocator.0"* %11 to %"class.__gnu_cxx::new_allocator.1"*
  %13 = load %"struct.std::_List_node.10"** %__n, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE7destroyIS4_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %12, %"struct.std::_List_node.10"* %13)
  %14 = bitcast %"class.std::__cxx11::list"* %3 to %"class.std::__cxx11::_List_base"*
  %15 = load %"struct.std::_List_node.10"** %__n, align 8
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_put_nodeEPSt10_List_nodeIS2_E(%"class.std::__cxx11::_List_base"* %14, %"struct.std::_List_node.10"* %15) #0
  ret void
}
...
define linkonce_odr %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIP4NodeSaIS2_EE5beginEv(%"class.std::__cxx11::list"* %this) #3 align 2 {
  ...
  store %"class.std::__cxx11::list"* %this, %"class.std::__cxx11::list"** %2, align 8
  %3 = load %"class.std::__cxx11::list"** %2
  %4 = bitcast %"class.std::__cxx11::list"* %3 to %"class.std::__cxx11::_List_base"*
  %5 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %4, i32 0, i32 0
  %6 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %5, i32 0, i32 0
  ...
  call void @_ZNSt14_List_iteratorIP4NodeEC2EPNSt8__detail15_List_node_baseE(%"struct.std::_List_iterator"* %1, %"struct.std::__detail::_List_node_base"* %9) #0
  %10 = getelementptr %"struct.std::_List_iterator"* %1, i32 0, i32 0
  %11 = load %"struct.std::__detail::_List_node_base"** %10
...
define linkonce_odr void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_dec_sizeEm(%"class.std::__cxx11::_List_base"* %this, i64 %__n) #3 align 2 {
  %1 = alloca %"class.std::__cxx11::_List_base"*, align 8
  %2 = alloca i64, align 8
  store %"class.std::__cxx11::_List_base"* %this, %"class.std::__cxx11::_List_base"** %1, align 8
  store i64 %__n, i64* %2, align 8
  %3 = load %"class.std::__cxx11::_List_base"** %1
  %4 = load i64* %2, align 8
  %5 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %3, i32 0, i32 0
  %6 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %5, i32 0, i32 0
  %7 = getelementptr inbounds %"struct.std::_List_node"* %6, i32 0, i32 1
...
define linkonce_odr %"class.std::allocator.0"* @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE21_M_get_Node_allocatorEv(%"class.std::__cxx11::_List_base"* %this) #3 align 2 {
  %1 = alloca %"class.std::__cxx11::_List_base"*, align 8
  store %"class.std::__cxx11::_List_base"* %this, %"class.std::__cxx11::_List_base"** %1, align 8
  %2 = load %"class.std::__cxx11::_List_base"** %1
  %3 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %2, i32 0, i32 0
  %4 = bitcast %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %3 to %"class.std::allocator.0"*
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE7destroyIS4_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %this, %"struct.std::_List_node.10"* %__p) #3 align 2 {
  ...
  %2 = alloca %"struct.std::_List_node.10"*, align 8
  store %"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"** %1, align 8
  store %"struct.std::_List_node.10"* %__p, %"struct.std::_List_node.10"** %2, align 8
  %3 = load %"class.__gnu_cxx::new_allocator.1"** %1
  %4 = load %"struct.std::_List_node.10"** %2, align 8
  ret void
}
...
define linkonce_odr void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_put_nodeEPSt10_List_nodeIS2_E(%"class.std::__cxx11::_List_base"* %this, %"struct.std::_List_node.10"* %__p) #3 align 2 {
  ...
  %3 = load %"class.std::__cxx11::_List_base"** %1
  %4 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %3, i32 0, i32 0
  %5 = bitcast %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %4 to %"class.std::allocator.0"*
  %6 = bitcast %"class.std::allocator.0"* %5 to %"class.__gnu_cxx::new_allocator.1"*
  %7 = load %"struct.std::_List_node.10"** %2, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE10deallocateEPS4_m(%"class.__gnu_cxx::new_allocator.1"* %6, %"struct.std::_List_node.10"* %7, i64 1)
  ret void
}
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE10deallocateEPS4_m(%"class.__gnu_cxx::new_allocator.1"* %this, %"struct.std::_List_node.10"* %__p, i64) #3 align 2 {
  ...
  store %"struct.std::_List_node.10"* %__p, %"struct.std::_List_node.10"** %3, align 8
  store i64 %0, i64* %4, align 8
  %5 = load %"class.__gnu_cxx::new_allocator.1"** %2
  %6 = load %"struct.std::_List_node.10"** %3, align 8
  %7 = bitcast %"struct.std::_List_node.10"* %6 to i8*
  call void @_ZdlPv(i8* %7) #0
  ret void
}
...
define linkonce_odr %struct.Node** @_ZNKSt14_List_iteratorIP4NodeEdeEv(%"struct.std::_List_iterator"* %this) #3 align 2 {
  ...
  %5 = bitcast %"struct.std::__detail::_List_node_base"* %4 to %"struct.std::_List_node.10"*
  %6 = getelementptr inbounds %"struct.std::_List_node.10"* %5, i32 0, i32 1
  ret %struct.Node** %6
}
...
define linkonce_odr void @_ZNSt7__cxx114listIP4NodeSaIS2_EE9_M_insertIJRKS2_EEEvSt14_List_iteratorIS2_EDpOT_(%"class.std::__cxx11::list"* %this, %"struct.std::__detail::_List_node_base"* %__position.coerce, %struct.Node** %__args) #3 align 2 {
  ...
  %__position = alloca %"struct.std::_List_iterator", align 8
  %2 = alloca %struct.Node**, align 8
  %__tmp = alloca %"struct.std::_List_node.10"*, align 8
  store %"class.std::__cxx11::list"* %this, %"class.std::__cxx11::list"** %1, align 8
  ...
  %4 = load %"class.std::__cxx11::list"** %1
  %5 = load %struct.Node*** %2, align 8
  %6 = call %struct.Node** @_ZSt7forwardIRKP4NodeEOT_RNSt16remove_referenceIS4_E4typeE(%struct.Node** %5) #0
  %7 = call %"struct.std::_List_node.10"* @_ZNSt7__cxx114listIP4NodeSaIS2_EE14_M_create_nodeIJRKS2_EEEPSt10_List_nodeIS2_EDpOT_(%"class.std::__cxx11::list"* %4, %struct.Node** %6)
  store %"struct.std::_List_node.10"* %7, %"struct.std::_List_node.10"** %__tmp, align 8
  %8 = load %"struct.std::_List_node.10"** %__tmp, align 8
  %9 = bitcast %"struct.std::_List_node.10"* %8 to %"struct.std::__detail::_List_node_base"*
  %10 = getelementptr inbounds %"struct.std::_List_iterator"* %__position, i32 0, i32 0
  %11 = load %"struct.std::__detail::_List_node_base"** %10, align 8
  call void @_ZNSt8__detail15_List_node_base7_M_hookEPS0_(%"struct.std::__detail::_List_node_base"* %9, %"struct.std::__detail::_List_node_base"* %11) #0
  %12 = bitcast %"class.std::__cxx11::list"* %4 to %"class.std::__cxx11::_List_base"*
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_inc_sizeEm(%"class.std::__cxx11::_List_base"* %12, i64 1)
  ret void
}
...
define linkonce_odr %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIP4NodeSaIS2_EE3endEv(%"class.std::__cxx11::list"* %this) #3 align 2 {
  ...
  %6 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %5, i32 0, i32 0
  %7 = bitcast %"struct.std::_List_node"* %6 to %"struct.std::__detail::_List_node_base"*
  call void @_ZNSt14_List_iteratorIP4NodeEC2EPNSt8__detail15_List_node_baseE(%"struct.std::_List_iterator"* %1, %"struct.std::__detail::_List_node_base"* %7) #0
  %8 = getelementptr %"struct.std::_List_iterator"* %1, i32 0, i32 0
  %9 = load %"struct.std::__detail::_List_node_base"** %8
  ret %"struct.std::__detail::_List_node_base"* %9
}
...
define linkonce_odr %"struct.std::_List_node.10"* @_ZNSt7__cxx114listIP4NodeSaIS2_EE14_M_create_nodeIJRKS2_EEEPSt10_List_nodeIS2_EDpOT_(%"class.std::__cxx11::list"* %this, %struct.Node** %__args) #3 align 2 {
  %1 = alloca %"class.std::__cxx11::list"*, align 8
  %2 = alloca %struct.Node**, align 8
  %__p = alloca %"struct.std::_List_node.10"*, align 8
  store %"class.std::__cxx11::list"* %this, %"class.std::__cxx11::list"** %1, align 8
  store %struct.Node** %__args, %struct.Node*** %2, align 8
  %3 = load %"class.std::__cxx11::list"** %1
  %4 = bitcast %"class.std::__cxx11::list"* %3 to %"class.std::__cxx11::_List_base"*
  %5 = call %"struct.std::_List_node.10"* @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_get_nodeEv(%"class.std::__cxx11::_List_base"* %4)
  store %"struct.std::_List_node.10"* %5, %"struct.std::_List_node.10"** %__p, align 8
  %6 = bitcast %"class.std::__cxx11::list"* %3 to %"class.std::__cxx11::_List_base"*
  %7 = call %"class.std::allocator.0"* @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE21_M_get_Node_allocatorEv(%"class.std::__cxx11::_List_base"* %6) #0
  %8 = bitcast %"class.std::allocator.0"* %7 to %"class.__gnu_cxx::new_allocator.1"*
  %9 = load %"struct.std::_List_node.10"** %__p, align 8
  %10 = load %struct.Node*** %2, align 8
  %11 = call %struct.Node** @_ZSt7forwardIRKP4NodeEOT_RNSt16remove_referenceIS4_E4typeE(%struct.Node** %10) #0
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE9constructIS4_JRKS3_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %8, %"struct.std::_List_node.10"* %9, %struct.Node** %11)
  %12 = load %"struct.std::_List_node.10"** %__p, align 8
  ret %"struct.std::_List_node.10"* %12
}
...
define linkonce_odr %"struct.std::_List_node.10"* @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_get_nodeEv(%"class.std::__cxx11::_List_base"* %this) #3 align 2 {
  ...
  %6 = call %"struct.std::_List_node.10"* @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %5, i64 1, i8* null)
  ret %"struct.std::_List_node.10"* %6
}
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE9constructIS4_JRKS3_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %this, %"struct.std::_List_node.10"* %__p, %struct.Node** %__args) #3 align 2 {
  ...
  %5 = load %"struct.std::_List_node.10"** %2, align 8
  %6 = bitcast %"struct.std::_List_node.10"* %5 to i8*
  %7 = icmp eq i8* %6, null
  br i1 %7, label %12, label %8

; <label>:8                                       ; preds = %0
  %9 = bitcast i8* %6 to %"struct.std::_List_node.10"*
  %10 = load %struct.Node*** %3, align 8
  %11 = call %struct.Node** @_ZSt7forwardIRKP4NodeEOT_RNSt16remove_referenceIS4_E4typeE(%struct.Node** %10) #0
  call void @_ZNSt10_List_nodeIP4NodeEC2IJRKS1_EEEDpOT_(%"struct.std::_List_node.10"* %9, %struct.Node** %11)
  br label %12

; <label>:12                                      ; preds = %8, %0
  %13 = phi %"struct.std::_List_node.10"* [ %9, %8 ], [ null, %0 ]
  ret void
}
...
define linkonce_odr void @_ZNSt10_List_nodeIP4NodeEC2IJRKS1_EEEDpOT_(%"struct.std::_List_node.10"* %this, %struct.Node** %__args) unnamed_addr #3 align 2 {
  %1 = alloca %"struct.std::_List_node.10"*, align 8
  %2 = alloca %struct.Node**, align 8
  store %"struct.std::_List_node.10"* %this, %"struct.std::_List_node.10"** %1, align 8
  store %struct.Node** %__args, %struct.Node*** %2, align 8
  %3 = load %"struct.std::_List_node.10"** %1
  %4 = bitcast %"struct.std::_List_node.10"* %3 to %"struct.std::__detail::_List_node_base"*
  %5 = bitcast %"struct.std::__detail::_List_node_base"* %4 to i8*
  call void @llvm.memset.p0i8.i64(i8* %5, i8 0, i64 16, i32 8, i1 false)
  %6 = getelementptr inbounds %"struct.std::_List_node.10"* %3, i32 0, i32 1
  %7 = load %struct.Node*** %2, align 8
...
define linkonce_odr %"struct.std::_List_node.10"* @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.1"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; <label>:10                                      ; preds = %1
  ...
  %12 = mul i64 %11, 24
  %13 = call noalias i8* @_Znwm(i64 %12)
  %14 = bitcast i8* %13 to %"struct.std::_List_node.10"*
  ret %"struct.std::_List_node.10"* %14
}
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__p) #3 align 2 {
  ...
  store %"struct.std::_Rb_tree_node"* %__p, %"struct.std::_Rb_tree_node"** %2, align 8
  %3 = load %"class.std::_Rb_tree"** %1
  %4 = call %"class.std::allocator.3"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %3) #0
  %5 = load %"struct.std::_Rb_tree_node"** %2, align 8
  %6 = call %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKP4NodebEE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %5)
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE7destroyIS5_EEvRS7_PT_(%"class.std::allocator.3"* %4, %"struct.std::pair"* %6)
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__p) #3 align 2 {
  ...
  %4 = call %"class.std::allocator.3"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %3) #0
  %5 = load %"struct.std::_Rb_tree_node"** %2, align 8
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE10deallocateERS7_PS6_m(%"class.std::allocator.3"* %4, %"struct.std::_Rb_tree_node"* %5, i64 1)
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE10deallocateERS7_PS6_m(%"class.std::allocator.3"* %__a, %"struct.std::_Rb_tree_node"* %__p, i64 %__n) #3 align 2 {
  ...
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEE10deallocateEPS7_m(%"class.__gnu_cxx::new_allocator.4"* %5, %"struct.std::_Rb_tree_node"* %6, i64 %7)
  ret void
}
...
define linkonce_odr %"class.std::allocator.3"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  %4 = bitcast %"struct.std::_Rb_tree<Node *, std::pair<Node *const, bool>, std::_Select1st<std::pair<Node *const, bool> >, std::less<Node *>, std::allocator<std::pair<Node *const, bool> > >::_Rb_tree_impl"* %3 to %"class.std::allocator.3"*
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE7destroyIS5_EEvRS7_PT_(%"class.std::allocator.3"* %__a, %"struct.std::pair"* %__p) #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEE7destroyIS6_EEvPT_(%"class.__gnu_cxx::new_allocator.4"* %4, %"struct.std::pair"* %5)
  ret void
}
...
; <label>:42                                      ; preds = %38
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKP4NodebEESB_vEEOT_OT0_(%"struct.std::pair.12"* %1, %"struct.std::_Rb_tree_node"** %__x, %"struct.std::_Rb_tree_node"** %__y)
  br label %57
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_get_nodeEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = call %"class.std::allocator.3"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %2) #0
  %4 = call %"struct.std::_Rb_tree_node"* @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE8allocateERS7_m(%"class.std::allocator.3"* %3, i64 1)
...
; <label>:12                                      ; preds = %10, %0
  ...
  %14 = call %"class.std::allocator.3"* @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %6) #0
  ...
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESD_IJEEEEEvRS7_PT_DpOT0_(%"class.std::allocator.3"* %14, %"struct.std::pair"* %16, %"struct.std::piecewise_construct_t"* %18, %"class.std::tuple"* %20, %"class.std::tuple.11"* %22)
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESD_IJEEEEEvRS7_PT_DpOT0_(%"class.std::allocator.3"* %__a, %"struct.std::pair"* %__p, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.11"* %__args2) #3 align 2 {
  ...
  store %"class.std::tuple"* %__args1, %"class.std::tuple"** %4, align 8
  store %"class.std::tuple.11"* %__args2, %"class.std::tuple.11"** %5, align 8
  %6 = load %"class.std::allocator.3"** %1, align 8
  %7 = bitcast %"class.std::allocator.3"* %6 to %"class.__gnu_cxx::new_allocator.4"*
  ...
  %13 = load %"class.std::tuple.11"** %5, align 8
  %14 = call %"class.std::tuple.11"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.11"* %13) #0
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEE9constructIS6_JRKSt21piecewise_construct_tSt5tupleIJRS5_EESD_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.4"* %7, %"struct.std::pair"* %8, %"struct.std::piecewise_construct_t"* %10, %"class.std::tuple"* %12, %"class.std::tuple.11"* %14)
  ret void
}
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEE9constructIS6_JRKSt21piecewise_construct_tSt5tupleIJRS5_EESD_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.4"* %this, %"struct.std::pair"* %__p, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.11"* %__args2) #3 align 2 {
  ...
  store %"class.std::tuple"* %__args1, %"class.std::tuple"** %4, align 8
  store %"class.std::tuple.11"* %__args2, %"class.std::tuple.11"** %5, align 8
  %9 = load %"class.__gnu_cxx::new_allocator.4"** %1
...
define linkonce_odr void @_ZNSt4pairIKP4NodebEC2IJRS2_EJEEESt21piecewise_construct_tSt5tupleIJDpT_EES7_IJDpT0_EE(%"struct.std::pair"* %this, %struct.Node** %__first.coerce) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt4pairIKP4NodebEC2IJRS2_EJLm0EEJEJEEERSt5tupleIJDpT_EERS6_IJDpT1_EESt12_Index_tupleIJXspT0_EEESF_IJXspT2_EEE(%"struct.std::pair"* %8, %"class.std::tuple"* %__first, %"class.std::tuple.11"* %__second)
  ret void
}
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE8allocateERS7_m(%"class.std::allocator.3"* %__a, i64 %__n) #3 align 2 {
  ...
  %4 = bitcast %"class.std::allocator.3"* %3 to %"class.__gnu_cxx::new_allocator.4"*
  %5 = load i64* %2, align 8
  %6 = call %"struct.std::_Rb_tree_node"* @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.4"* %4, i64 %5, i8* null)
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.4"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.4"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.4"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EEC2Ev(%"struct.std::_Rb_tree<Node *, std::pair<Node *const, bool>, std::_Select1st<std::pair<Node *const, bool> >, std::less<Node *>, std::allocator<std::pair<Node *const, bool> > >::_Rb_tree_impl"* %this) unnamed_addr #3 align 2 {
  ...
  %3 = bitcast %"struct.std::_Rb_tree<Node *, std::pair<Node *const, bool>, std::_Select1st<std::pair<Node *const, bool> >, std::less<Node *>, std::allocator<std::pair<Node *const, bool> > >::_Rb_tree_impl"* %2 to %"class.std::allocator.3"*
  call void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEC2Ev(%"class.std::allocator.3"* %3) #0
...
define linkonce_odr void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEC2Ev(%"class.std::allocator.3"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEEC2Ev(%"class.__gnu_cxx::new_allocator.4"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EEC2Ev(%"class.std::__cxx11::_List_base"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::__cxx11::_List_base"** %1
  %3 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %2, i32 0, i32 0
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE10_List_implC2Ev(%"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %3)
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE7_M_initEv(%"class.std::__cxx11::_List_base"* %2) #0
  ret void
}
...
define linkonce_odr void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE10_List_implC2Ev(%"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"*, align 8
  store %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %this, %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"** %1, align 8
  %2 = load %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"** %1
  %3 = bitcast %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %2 to %"class.std::allocator.0"*
  call void @_ZNSaISt10_List_nodeIP4NodeEEC2Ev(%"class.std::allocator.0"* %3) #0
  %4 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %2, i32 0, i32 0
  call void @_ZNSt10_List_nodeImEC2IJEEEDpOT_(%"struct.std::_List_node"* %4)
  ret void
}
...
define linkonce_odr void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE7_M_initEv(%"class.std::__cxx11::_List_base"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::__cxx11::_List_base"** %1
  %3 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %3, i32 0, i32 0
  %5 = bitcast %"struct.std::_List_node"* %4 to %"struct.std::__detail::_List_node_base"*
  %6 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %2, i32 0, i32 0
  %7 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %6, i32 0, i32 0
  %8 = bitcast %"struct.std::_List_node"* %7 to %"struct.std::__detail::_List_node_base"*
  %9 = getelementptr inbounds %"struct.std::__detail::_List_node_base"* %8, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %5, %"struct.std::__detail::_List_node_base"** %9, align 8
  %10 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %2, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %10, i32 0, i32 0
  %12 = bitcast %"struct.std::_List_node"* %11 to %"struct.std::__detail::_List_node_base"*
  %13 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %2, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %13, i32 0, i32 0
  %15 = bitcast %"struct.std::_List_node"* %14 to %"struct.std::__detail::_List_node_base"*
  %16 = getelementptr inbounds %"struct.std::__detail::_List_node_base"* %15, i32 0, i32 1
  store %"struct.std::__detail::_List_node_base"* %12, %"struct.std::__detail::_List_node_base"** %16, align 8
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_set_sizeEm(%"class.std::__cxx11::_List_base"* %2, i64 0)
  ret void
}
...
define linkonce_odr void @_ZNSaISt10_List_nodeIP4NodeEEC2Ev(%"class.std::allocator.0"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEEC2Ev(%"class.__gnu_cxx::new_allocator.1"* %3) #0
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt10_List_nodeImEC2IJEEEDpOT_(%"struct.std::_List_node"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"struct.std::_List_node"*, align 8
  store %"struct.std::_List_node"* %this, %"struct.std::_List_node"** %1, align 8
  %2 = load %"struct.std::_List_node"** %1
  %3 = bitcast %"struct.std::_List_node"* %2 to %"struct.std::__detail::_List_node_base"*
  %4 = bitcast %"struct.std::__detail::_List_node_base"* %3 to i8*
  call void @llvm.memset.p0i8.i64(i8* %4, i8 0, i64 16, i32 8, i1 false)
  %5 = getelementptr inbounds %"struct.std::_List_node"* %2, i32 0, i32 1
...
define linkonce_odr void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EED2Ev(%"class.std::__cxx11::_List_base"* %this) unnamed_addr #3 align 2 {
  ...
  store %"class.std::__cxx11::_List_base"* %this, %"class.std::__cxx11::_List_base"** %1, align 8
  %2 = load %"class.std::__cxx11::_List_base"** %1
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE8_M_clearEv(%"class.std::__cxx11::_List_base"* %2) #0
  %3 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %2, i32 0, i32 0
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE10_List_implD2Ev(%"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE8_M_clearEv(%"class.std::__cxx11::_List_base"* %this) #3 align 2 {
  ...
  store %"struct.std::__detail::_List_node_base"* %7, %"struct.std::__detail::_List_node_base"** %__cur, align 8
  br label %8

; <label>:8                                       ; preds = %14, %0
  %9 = load %"struct.std::__detail::_List_node_base"** %__cur, align 8
  %10 = getelementptr inbounds %"class.std::__cxx11::_List_base"* %2, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %10, i32 0, i32 0
  %12 = bitcast %"struct.std::_List_node"* %11 to %"struct.std::__detail::_List_node_base"*
  %13 = icmp ne %"struct.std::__detail::_List_node_base"* %9, %12
  br i1 %13, label %14, label %25

; <label>:14                                      ; preds = %8
  %15 = load %"struct.std::__detail::_List_node_base"** %__cur, align 8
  %16 = bitcast %"struct.std::__detail::_List_node_base"* %15 to %"struct.std::_List_node.10"*
  store %"struct.std::_List_node.10"* %16, %"struct.std::_List_node.10"** %__tmp, align 8
  %17 = load %"struct.std::_List_node.10"** %__tmp, align 8
  %18 = bitcast %"struct.std::_List_node.10"* %17 to %"struct.std::__detail::_List_node_base"*
  %19 = getelementptr inbounds %"struct.std::__detail::_List_node_base"* %18, i32 0, i32 0
  %20 = load %"struct.std::__detail::_List_node_base"** %19, align 8
  store %"struct.std::__detail::_List_node_base"* %20, %"struct.std::__detail::_List_node_base"** %__cur, align 8
  %21 = call %"class.std::allocator.0"* @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE21_M_get_Node_allocatorEv(%"class.std::__cxx11::_List_base"* %2) #0
  %22 = bitcast %"class.std::allocator.0"* %21 to %"class.__gnu_cxx::new_allocator.1"*
  %23 = load %"struct.std::_List_node.10"** %__tmp, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEE7destroyIS4_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %22, %"struct.std::_List_node.10"* %23)
  %24 = load %"struct.std::_List_node.10"** %__tmp, align 8
  call void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE11_M_put_nodeEPSt10_List_nodeIS2_E(%"class.std::__cxx11::_List_base"* %2, %"struct.std::_List_node.10"* %24) #0
  br label %8
...
define linkonce_odr void @_ZNSt7__cxx1110_List_baseIP4NodeSaIS2_EE10_List_implD2Ev(%"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %this) unnamed_addr #4 align 2 {
  ...
  %2 = load %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"** %1
  %3 = bitcast %"struct.std::__cxx11::_List_base<Node *, std::allocator<Node *> >::_List_impl"* %2 to %"class.std::allocator.0"*
  call void @_ZNSaISt10_List_nodeIP4NodeEED2Ev(%"class.std::allocator.0"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaISt10_List_nodeIP4NodeEED2Ev(%"class.std::allocator.0"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::allocator.0"** %1
  %3 = bitcast %"class.std::allocator.0"* %2 to %"class.__gnu_cxx::new_allocator.1"*
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIP4NodeEED2Ev(%"class.__gnu_cxx::new_allocator.1"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt8_Rb_treeIP4NodeSt4pairIKS1_bESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EED2Ev(%"struct.std::_Rb_tree<Node *, std::pair<Node *const, bool>, std::_Select1st<std::pair<Node *const, bool> >, std::less<Node *>, std::allocator<std::pair<Node *const, bool> > >::_Rb_tree_impl"* %this) unnamed_addr #4 align 2 {
  ...
  %2 = load %"struct.std::_Rb_tree<Node *, std::pair<Node *const, bool>, std::_Select1st<std::pair<Node *const, bool> >, std::less<Node *>, std::allocator<std::pair<Node *const, bool> > >::_Rb_tree_impl"** %1
  %3 = bitcast %"struct.std::_Rb_tree<Node *, std::pair<Node *const, bool>, std::_Select1st<std::pair<Node *const, bool> >, std::less<Node *>, std::allocator<std::pair<Node *const, bool> > >::_Rb_tree_impl"* %2 to %"class.std::allocator.3"*
  call void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP4NodebEEED2Ev(%"class.std::allocator.3"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP4NodebEEED2Ev(%"class.std::allocator.3"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::allocator.3"** %1
  %3 = bitcast %"class.std::allocator.3"* %2 to %"class.__gnu_cxx::new_allocator.4"*
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEED2Ev(%"class.__gnu_cxx::new_allocator.4"* %3) #0
  ret void
}
