; ModuleID = 'BFS/bfs_11_stlqueue.cpp'
...
; <label>:9                                       ; preds = %0
  ...
  %10 = call i8* @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEEixERS5_(%"class.std::map"* %visited, %struct.Node** %1)
  store i8 1, i8* %10
...
; <label>:38                                      ; preds = %31
  %39 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEE4findERS5_(%"class.std::map"* %visited, %struct.Node** %v)
  ...
  %41 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEE3endEv(%"class.std::map"* %visited) #0
  ...
  %43 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4NodebEEeqERKS5_(%"struct.std::_Rb_tree_iterator"* %4, %"struct.std::_Rb_tree_iterator"* %5) #0
  br i1 %43, label %44, label %46

; <label>:44                                      ; preds = %38
  %45 = call i8* @_ZNSt3mapIP4NodebSt4lessIS1_ESaISt4pairIKS1_bEEEixERS5_(%"class.std::map"* %visited, %struct.Node** %v)
  store i8 1, i8* %45
...
; <label>:37                                      ; preds = %21
  ...
  call void @_Z12bfs_baselineP4NodeRSt6vectorIiSaIiEE(%struct.Node* %38, %"class.std::vector"* %result)
...
; <label>:15                                      ; preds = %0
  ...
  %23 = load %struct.Node*** %22, align 8
  call void @_ZNSt16allocator_traitsISaIP4NodeEE7destroyIS1_EEvRS2_PT_(%"class.std::allocator.0"* %18, %struct.Node** %23)
...
define linkonce_odr void @_ZNSt5dequeIP4NodeSaIS1_EE16_M_pop_front_auxEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = call %"class.std::allocator.0"* @_ZNSt11_Deque_baseIP4NodeSaIS1_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %3) #0
  ...
  call void @_ZNSt16allocator_traitsISaIP4NodeEE7destroyIS1_EEvRS2_PT_(%"class.std::allocator.0"* %4, %struct.Node** %9)
...
define linkonce_odr void @_ZNKSt11_Deque_baseIP4NodeSaIS1_EE20_M_get_map_allocatorEv(%"class.std::allocator.10"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  call void @_ZNSaIPP4NodeEC2IS0_EERKSaIT_E(%"class.std::allocator.10"* %agg.result, %"class.std::allocator.0"* %3) #0
  ret void
}
...
; <label>:42                                      ; preds = %38
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKP4NodebEESB_vEEOT_OT0_(%"struct.std::pair.14"* %1, %"struct.std::_Rb_tree_node"** %__x, %"struct.std::_Rb_tree_node"** %__y)
  br label %57
...
; <label>:12                                      ; preds = %10, %0
  ...
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESD_IJEEEEEvRS7_PT_DpOT0_(%"class.std::allocator.3"* %14, %"struct.std::pair"* %16, %"struct.std::piecewise_construct_t"* %18, %"class.std::tuple"* %20, %"class.std::tuple.13"* %22)
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodebEEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESD_IJEEEEEvRS7_PT_DpOT0_(%"class.std::allocator.3"* %__a, %"struct.std::pair"* %__p, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.13"* %__args2) #3 align 2 {
  ...
  %13 = load %"class.std::tuple.13"** %5, align 8
  %14 = call %"class.std::tuple.13"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.13"* %13) #0
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodebEEE9constructIS6_JRKSt21piecewise_construct_tSt5tupleIJRS5_EESD_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.4"* %7, %"struct.std::pair"* %8, %"struct.std::piecewise_construct_t"* %10, %"class.std::tuple"* %12, %"class.std::tuple.13"* %14)
  ret void
}
...
define linkonce_odr void @_ZNSt4pairIKP4NodebEC2IJRS2_EJEEESt21piecewise_construct_tSt5tupleIJDpT_EES7_IJDpT0_EE(%"struct.std::pair"* %this, %struct.Node** %__first.coerce) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt4pairIKP4NodebEC2IJRS2_EJLm0EEJEJEEERSt5tupleIJDpT_EERS6_IJDpT1_EESt12_Index_tupleIJXspT0_EEESF_IJXspT2_EEE(%"struct.std::pair"* %8, %"class.std::tuple"* %__first, %"class.std::tuple.13"* %__second)
  ret void
}
