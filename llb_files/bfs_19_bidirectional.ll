; ModuleID = 'BFS/bfs_19_bidirectional.cpp'
...
define void @_Z17bfs_bidirectionalP4NodeS0_RSt6vectorIiSaIiEE(%struct.Node* %start, %struct.Node* %target, %"class.std::vector"* %result) #3 {
  ...
  %dist_s = alloca %"class.std::map", align 8
  %dist_t = alloca %"class.std::map", align 8
  %q_s = alloca %"class.std::queue", align 8
  %4 = alloca %"class.std::deque", align 8
  %q_t = alloca %"class.std::queue", align 8
  %5 = alloca %"class.std::deque", align 8
  %u = alloca %struct.Node*, align 8
  %neighbors_s = alloca [2 x %struct.Node*], align 16
  ...
  %10 = alloca i32
  %u2 = alloca %struct.Node*, align 8
  %neighbors_t = alloca %"class.std::vector.6", align 8
  %__range1 = alloca %"class.std::vector.6"*, align 8
  %__begin2 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %__end3 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %v4 = alloca %struct.Node*, align 8
  %11 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %12 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %13 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %14 = alloca %"struct.std::_Rb_tree_iterator", align 8
  store %struct.Node* %start, %struct.Node** %1, align 8
  store %struct.Node* %target, %struct.Node** %2, align 8
...
; <label>:25                                      ; preds = %21
  %26 = load %"class.std::vector"** %3, align 8
...
; <label>:29                                      ; preds = %21
  call void @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEC2Ev(%"class.std::map"* %dist_s) #0
  call void @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEC2Ev(%"class.std::map"* %dist_t) #0
  call void @_ZNSt5dequeIP4NodeSaIS1_EEC2Ev(%"class.std::deque"* %4)
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::queue"* %q_s, %"class.std::deque"* %4)
  call void @_ZNSt5dequeIP4NodeSaIS1_EED2Ev(%"class.std::deque"* %4) #0
  call void @_ZNSt5dequeIP4NodeSaIS1_EEC2Ev(%"class.std::deque"* %5)
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::queue"* %q_t, %"class.std::deque"* %5)
  call void @_ZNSt5dequeIP4NodeSaIS1_EED2Ev(%"class.std::deque"* %5) #0
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::queue"* %q_s, %struct.Node** %1)
  %30 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist_s, %struct.Node** %1)
  store i32 0, i32* %30
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::queue"* %q_t, %struct.Node** %2)
  %31 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist_t, %struct.Node** %2)
  store i32 0, i32* %31
  br label %32

; <label>:32                                      ; preds = %155, %29
  %33 = call zeroext i1 @_ZNKSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::queue"* %q_s)
  br i1 %33, label %37, label %34

; <label>:34                                      ; preds = %32
  %35 = call zeroext i1 @_ZNKSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::queue"* %q_t)
  %36 = xor i1 %35, true
  br label %37
...
; <label>:39                                      ; preds = %37
  %40 = call %struct.Node** @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE5frontEv(%"class.std::queue"* %q_s)
  %41 = load %struct.Node** %40
  store %struct.Node* %41, %struct.Node** %u, align 8
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::queue"* %q_s)
  %42 = load %"class.std::vector"** %3, align 8
  %43 = load %struct.Node** %u, align 8
  %44 = getelementptr inbounds %struct.Node* %43, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %42, i32* %44)
  %45 = getelementptr inbounds [2 x %struct.Node*]* %neighbors_s, i64 0, i64 0
  %46 = load %struct.Node** %u, align 8
  %47 = getelementptr inbounds %struct.Node* %46, i32 0, i32 1
  %48 = load %struct.Node** %47, align 8
  store %struct.Node* %48, %struct.Node** %45
  %49 = getelementptr inbounds %struct.Node** %45, i64 1
  %50 = load %struct.Node** %u, align 8
  %51 = getelementptr inbounds %struct.Node* %50, i32 0, i32 2
  %52 = load %struct.Node** %51, align 8
  store %struct.Node* %52, %struct.Node** %49
  store [2 x %struct.Node*]* %neighbors_s, [2 x %struct.Node*]** %__range, align 8
  %53 = load [2 x %struct.Node*]** %__range, align 8
  %54 = getelementptr inbounds [2 x %struct.Node*]* %53, i32 0, i32 0
  store %struct.Node** %54, %struct.Node*** %__begin, align 8
  %55 = load [2 x %struct.Node*]** %__range, align 8
  %56 = getelementptr inbounds [2 x %struct.Node*]* %55, i32 0, i32 0
  %57 = getelementptr inbounds %struct.Node** %56, i64 2
  store %struct.Node** %57, %struct.Node*** %__end, align 8
  br label %58

; <label>:58                                      ; preds = %86, %39
  %59 = load %struct.Node*** %__begin, align 8
  %60 = load %struct.Node*** %__end, align 8
  %61 = icmp ne %struct.Node** %59, %60
  br i1 %61, label %62, label %89

; <label>:62                                      ; preds = %58
  %63 = load %struct.Node*** %__begin, align 8
  %64 = load %struct.Node** %63, align 8
  store %struct.Node* %64, %struct.Node** %v, align 8
  %65 = load %struct.Node** %v, align 8
  %66 = icmp ne %struct.Node* %65, null
  br i1 %66, label %67, label %85

; <label>:67                                      ; preds = %62
  %68 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEE4findERS5_(%"class.std::map"* %dist_s, %struct.Node** %v)
  %69 = getelementptr %"struct.std::_Rb_tree_iterator"* %6, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %68, %"struct.std::_Rb_tree_node_base"** %69
  %70 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEE3endEv(%"class.std::map"* %dist_s) #0
  %71 = getelementptr %"struct.std::_Rb_tree_iterator"* %7, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %70, %"struct.std::_Rb_tree_node_base"** %71
  %72 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4NodeiEEeqERKS5_(%"struct.std::_Rb_tree_iterator"* %6, %"struct.std::_Rb_tree_iterator"* %7) #0
  br i1 %72, label %73, label %85

; <label>:73                                      ; preds = %67
  %74 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist_s, %struct.Node** %u)
  %75 = load i32* %74
  %76 = add nsw i32 %75, 1
  %77 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist_s, %struct.Node** %v)
  store i32 %76, i32* %77
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::queue"* %q_s, %struct.Node** %v)
  %78 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEE4findERS5_(%"class.std::map"* %dist_t, %struct.Node** %v)
  %79 = getelementptr %"struct.std::_Rb_tree_iterator"* %8, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %78, %"struct.std::_Rb_tree_node_base"** %79
  %80 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEE3endEv(%"class.std::map"* %dist_t) #0
  %81 = getelementptr %"struct.std::_Rb_tree_iterator"* %9, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %80, %"struct.std::_Rb_tree_node_base"** %81
  %82 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4NodeiEEneERKS5_(%"struct.std::_Rb_tree_iterator"* %8, %"struct.std::_Rb_tree_iterator"* %9) #0
...
; <label>:86                                      ; preds = %85
  %87 = load %struct.Node*** %__begin, align 8
  %88 = getelementptr inbounds %struct.Node** %87, i32 1
  store %struct.Node** %88, %struct.Node*** %__begin, align 8
  br label %58

; <label>:89                                      ; preds = %58
  %90 = call %struct.Node** @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE5frontEv(%"class.std::queue"* %q_t)
  %91 = load %struct.Node** %90
  store %struct.Node* %91, %struct.Node** %u2, align 8
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::queue"* %q_t)
  %92 = load %"class.std::vector"** %3, align 8
  %93 = load %struct.Node** %u2, align 8
  %94 = getelementptr inbounds %struct.Node* %93, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %92, i32* %94)
  call void @_ZNSt6vectorIP4NodeSaIS1_EEC2Ev(%"class.std::vector.6"* %neighbors_t) #0
  %95 = load %struct.Node** %u2, align 8
  %96 = getelementptr inbounds %struct.Node* %95, i32 0, i32 3
  %97 = load %struct.Node** %96, align 8
  %98 = icmp ne %struct.Node* %97, null
  br i1 %98, label %99, label %102

; <label>:99                                      ; preds = %89
  %100 = load %struct.Node** %u2, align 8
  %101 = getelementptr inbounds %struct.Node* %100, i32 0, i32 3
  call void @_ZNSt6vectorIP4NodeSaIS1_EE9push_backERKS1_(%"class.std::vector.6"* %neighbors_t, %struct.Node** %101)
  br label %102

; <label>:102                                     ; preds = %99, %89
  %103 = load %struct.Node** %u2, align 8
  %104 = getelementptr inbounds %struct.Node* %103, i32 0, i32 1
  %105 = load %struct.Node** %104, align 8
  %106 = icmp ne %struct.Node* %105, null
  br i1 %106, label %107, label %110

; <label>:107                                     ; preds = %102
  %108 = load %struct.Node** %u2, align 8
  %109 = getelementptr inbounds %struct.Node* %108, i32 0, i32 1
  call void @_ZNSt6vectorIP4NodeSaIS1_EE9push_backERKS1_(%"class.std::vector.6"* %neighbors_t, %struct.Node** %109)
  br label %110

; <label>:110                                     ; preds = %107, %102
  %111 = load %struct.Node** %u2, align 8
  %112 = getelementptr inbounds %struct.Node* %111, i32 0, i32 2
  %113 = load %struct.Node** %112, align 8
  %114 = icmp ne %struct.Node* %113, null
  br i1 %114, label %115, label %118

; <label>:115                                     ; preds = %110
  %116 = load %struct.Node** %u2, align 8
  %117 = getelementptr inbounds %struct.Node* %116, i32 0, i32 2
  call void @_ZNSt6vectorIP4NodeSaIS1_EE9push_backERKS1_(%"class.std::vector.6"* %neighbors_t, %struct.Node** %117)
  br label %118

; <label>:118                                     ; preds = %115, %110
  store %"class.std::vector.6"* %neighbors_t, %"class.std::vector.6"** %__range1, align 8
  %119 = load %"class.std::vector.6"** %__range1, align 8
  %120 = call %struct.Node** @_ZNSt6vectorIP4NodeSaIS1_EE5beginEv(%"class.std::vector.6"* %119) #0
  %121 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__begin2, i32 0, i32 0
  store %struct.Node** %120, %struct.Node*** %121
  %122 = load %"class.std::vector.6"** %__range1, align 8
  %123 = call %struct.Node** @_ZNSt6vectorIP4NodeSaIS1_EE3endEv(%"class.std::vector.6"* %122) #0
  %124 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__end3, i32 0, i32 0
  store %struct.Node** %123, %struct.Node*** %124
  br label %125

; <label>:125                                     ; preds = %151, %118
  %126 = call zeroext i1 @_ZN9__gnu_cxxneIPP4NodeSt6vectorIS2_SaIS2_EEEEbRKNS_17__normal_iteratorIT_T0_EESC_(%"class.__gnu_cxx::__normal_iterator"* %__begin2, %"class.__gnu_cxx::__normal_iterator"* %__end3) #0
  br i1 %126, label %127, label %153

; <label>:127                                     ; preds = %125
  %128 = call %struct.Node** @_ZNK9__gnu_cxx17__normal_iteratorIPP4NodeSt6vectorIS2_SaIS2_EEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %__begin2) #0
  %129 = load %struct.Node** %128
  store %struct.Node* %129, %struct.Node** %v4, align 8
  %130 = load %struct.Node** %v4, align 8
  %131 = icmp ne %struct.Node* %130, null
  br i1 %131, label %132, label %150

; <label>:132                                     ; preds = %127
  %133 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEE4findERS5_(%"class.std::map"* %dist_t, %struct.Node** %v4)
  %134 = getelementptr %"struct.std::_Rb_tree_iterator"* %11, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %133, %"struct.std::_Rb_tree_node_base"** %134
  %135 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEE3endEv(%"class.std::map"* %dist_t) #0
  %136 = getelementptr %"struct.std::_Rb_tree_iterator"* %12, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %135, %"struct.std::_Rb_tree_node_base"** %136
  %137 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4NodeiEEeqERKS5_(%"struct.std::_Rb_tree_iterator"* %11, %"struct.std::_Rb_tree_iterator"* %12) #0
  br i1 %137, label %138, label %150

; <label>:138                                     ; preds = %132
  %139 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist_t, %struct.Node** %u2)
  %140 = load i32* %139
  %141 = add nsw i32 %140, 1
  %142 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist_t, %struct.Node** %v4)
  store i32 %141, i32* %142
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::queue"* %q_t, %struct.Node** %v4)
  %143 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEE4findERS5_(%"class.std::map"* %dist_s, %struct.Node** %v4)
  %144 = getelementptr %"struct.std::_Rb_tree_iterator"* %13, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %143, %"struct.std::_Rb_tree_node_base"** %144
  %145 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEE3endEv(%"class.std::map"* %dist_s) #0
  %146 = getelementptr %"struct.std::_Rb_tree_iterator"* %14, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %145, %"struct.std::_Rb_tree_node_base"** %146
  %147 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP4NodeiEEneERKS5_(%"struct.std::_Rb_tree_iterator"* %13, %"struct.std::_Rb_tree_iterator"* %14) #0
...
; <label>:151                                     ; preds = %150
  %152 = call %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPP4NodeSt6vectorIS2_SaIS2_EEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin2) #0
  br label %125
...
; <label>:154                                     ; preds = %153, %148
  call void @_ZNSt6vectorIP4NodeSaIS1_EED2Ev(%"class.std::vector.6"* %neighbors_t) #0
  %cleanup.dest = load i32* %10
...
; <label>:157                                     ; preds = %156, %154, %83
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::queue"* %q_t) #0
  call void @_ZNSt5queueIP4NodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::queue"* %q_s) #0
  call void @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEED2Ev(%"class.std::map"* %dist_t) #0
  call void @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEED2Ev(%"class.std::map"* %dist_s) #0
  %cleanup.dest5 = load i32* %10
  switch i32 %cleanup.dest5, label %159 [
    i32 0, label %158
    i32 1, label %158
  ]

; <label>:158                                     ; preds = %20, %25, %157, %157
  ret void
...
define linkonce_odr void @_ZNSt6vectorIP4NodeSaIS1_EEC2Ev(%"class.std::vector.6"* %this) unnamed_addr #3 align 2 {
  ...
  store %"class.std::vector.6"* %this, %"class.std::vector.6"** %1, align 8
  %2 = load %"class.std::vector.6"** %1
  %3 = bitcast %"class.std::vector.6"* %2 to %"struct.std::_Vector_base.7"*
  call void @_ZNSt12_Vector_baseIP4NodeSaIS1_EEC2Ev(%"struct.std::_Vector_base.7"* %3)
  ret void
}
...
define linkonce_odr void @_ZNSt6vectorIP4NodeSaIS1_EE9push_backERKS1_(%"class.std::vector.6"* %this, %struct.Node** %__x) #3 align 2 {
  ...
  store %"class.std::vector.6"* %this, %"class.std::vector.6"** %1, align 8
  store %struct.Node** %__x, %struct.Node*** %2, align 8
  %3 = load %"class.std::vector.6"** %1
  %4 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %5 = getelementptr inbounds %"struct.std::_Vector_base.7"* %4, i32 0, i32 0
  ...
  %9 = getelementptr inbounds %"struct.std::_Vector_base.7"* %8, i32 0, i32 0
...
; <label>:13                                      ; preds = %0
  %14 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %15 = getelementptr inbounds %"struct.std::_Vector_base.7"* %14, i32 0, i32 0
  %16 = bitcast %"struct.std::_Vector_base<Node *, std::allocator<Node *> >::_Vector_impl"* %15 to %"class.std::allocator.3"*
  %17 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %18 = getelementptr inbounds %"struct.std::_Vector_base.7"* %17, i32 0, i32 0
  ...
  call void @_ZNSt16allocator_traitsISaIP4NodeEE9constructIS1_JRKS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.3"* %16, %struct.Node** %20, %struct.Node** %21)
  %22 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %23 = getelementptr inbounds %"struct.std::_Vector_base.7"* %22, i32 0, i32 0
...
; <label>:27                                      ; preds = %0
  ...
  call void @_ZNSt6vectorIP4NodeSaIS1_EE19_M_emplace_back_auxIJRKS1_EEEvDpOT_(%"class.std::vector.6"* %3, %struct.Node** %28)
  br label %29
...
define linkonce_odr %struct.Node** @_ZNSt6vectorIP4NodeSaIS1_EE5beginEv(%"class.std::vector.6"* %this) #3 align 2 {
  ...
  store %"class.std::vector.6"* %this, %"class.std::vector.6"** %2, align 8
  %3 = load %"class.std::vector.6"** %2
  %4 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %5 = getelementptr inbounds %"struct.std::_Vector_base.7"* %4, i32 0, i32 0
...
define linkonce_odr void @_ZNSt6vectorIP4NodeSaIS1_EED2Ev(%"class.std::vector.6"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::vector.6"** %1
  %3 = bitcast %"class.std::vector.6"* %2 to %"struct.std::_Vector_base.7"*
  %4 = getelementptr inbounds %"struct.std::_Vector_base.7"* %3, i32 0, i32 0
  ...
  %7 = bitcast %"class.std::vector.6"* %2 to %"struct.std::_Vector_base.7"*
  %8 = getelementptr inbounds %"struct.std::_Vector_base.7"* %7, i32 0, i32 0
  ...
  %11 = bitcast %"class.std::vector.6"* %2 to %"struct.std::_Vector_base.7"*
  %12 = call %"class.std::allocator.3"* @_ZNSt12_Vector_baseIP4NodeSaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.7"* %11) #0
  call void @_ZSt8_DestroyIPP4NodeS1_EvT_S3_RSaIT0_E(%struct.Node** %6, %struct.Node** %10, %"class.std::allocator.3"* %12)
  %13 = bitcast %"class.std::vector.6"* %2 to %"struct.std::_Vector_base.7"*
  call void @_ZNSt12_Vector_baseIP4NodeSaIS1_EED2Ev(%"struct.std::_Vector_base.7"* %13) #0
  ret void
}
...
define %struct.Node* @_Z9find_nodeP4Nodei(%struct.Node* %r, i32 %v) #3 {
  ...
  %2 = alloca %struct.Node*, align 8
  %3 = alloca i32, align 4
  store %struct.Node* %r, %struct.Node** %2, align 8
...
; <label>:20                                      ; preds = %14
  ...
  %25 = call %struct.Node* @_Z9find_nodeP4Nodei(%struct.Node* %23, i32 %24)
  store %struct.Node* %25, %struct.Node** %1
  br label %32
...
; <label>:26                                      ; preds = %14
  ...
  %31 = call %struct.Node* @_Z9find_nodeP4Nodei(%struct.Node* %29, i32 %30)
  store %struct.Node* %31, %struct.Node** %1
  br label %32

; <label>:32                                      ; preds = %26, %20, %12
  %33 = load %struct.Node** %1
  ret %struct.Node* %33
}
...
define i32 @main(i32 %argc, i8** %argv) #3 {
  ...
  %target_node = alloca %struct.Node*, align 8
...
; <label>:20                                      ; preds = %13
  ...
  store i32 -1, i32* %last_num, align 4
  br label %21
...
; <label>:33                                      ; preds = %21
  ...
  store i32 %37, i32* %last_num, align 4
  br label %21
...
; <label>:38                                      ; preds = %21
  ...
  %40 = load i32* %last_num, align 4
  %41 = call %struct.Node* @_Z9find_nodeP4Nodei(%struct.Node* %39, i32 %40)
  store %struct.Node* %41, %struct.Node** %target_node, align 8
...
; <label>:44                                      ; preds = %38
  %45 = load %struct.Node** %target_node, align 8
  %46 = icmp ne %struct.Node* %45, null
  br i1 %46, label %47, label %50

; <label>:47                                      ; preds = %44
  %48 = load %struct.Node** %root, align 8
  %49 = load %struct.Node** %target_node, align 8
  call void @_Z17bfs_bidirectionalP4NodeS0_RSt6vectorIiSaIiEE(%struct.Node* %48, %struct.Node* %49, %"class.std::vector"* %result)
  br label %50
...
; <label>:51                                      ; preds = %61, %50
  ...
  %53 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %result) #0
  %54 = icmp ult i64 %52, %53
  br i1 %54, label %55, label %64

; <label>:55                                      ; preds = %51
  %56 = load i64* %i, align 8
  %57 = call i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %result, i64 %56) #0
  %58 = load i32* %57
  %59 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %58)
  %60 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %59, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0))
  br label %61
...
; <label>:64                                      ; preds = %51
  %65 = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* @_ZSt4cout, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  store i32 0, i32* %1
  store i32 1, i32* %5
...
define linkonce_odr void @_ZNSt6vectorIP4NodeSaIS1_EE19_M_emplace_back_auxIJRKS1_EEEvDpOT_(%"class.std::vector.6"* %this, %struct.Node** %__args) #3 align 2 {
  ...
  %3 = load %"class.std::vector.6"** %1
  %4 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE12_M_check_lenEmPKc(%"class.std::vector.6"* %3, i64 1, i8* getelementptr inbounds ([28 x i8]* @.str3, i32 0, i32 0))
  store i64 %4, i64* %__len, align 8
  %5 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %6 = load i64* %__len, align 8
  %7 = call %struct.Node** @_ZNSt12_Vector_baseIP4NodeSaIS1_EE11_M_allocateEm(%"struct.std::_Vector_base.7"* %5, i64 %6)
  ...
  %10 = getelementptr inbounds %"struct.std::_Vector_base.7"* %9, i32 0, i32 0
  ...
  %13 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE4sizeEv(%"class.std::vector.6"* %3) #0
  ...
  call void @_ZNSt16allocator_traitsISaIP4NodeEE9constructIS1_JRKS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.3"* %11, %struct.Node** %14, %struct.Node** %16)
  ...
  %20 = load %struct.Node*** %19, align 8
  %21 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %22 = getelementptr inbounds %"struct.std::_Vector_base.7"* %21, i32 0, i32 0
  ...
  %26 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %27 = call %"class.std::allocator.3"* @_ZNSt12_Vector_baseIP4NodeSaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.7"* %26) #0
  %28 = call %struct.Node** @_ZSt34__uninitialized_move_if_noexcept_aIPP4NodeS2_SaIS1_EET0_T_S5_S4_RT1_(%struct.Node** %20, %struct.Node** %24, %struct.Node** %25, %"class.std::allocator.3"* %27)
  ...
  %31 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %32 = getelementptr inbounds %"struct.std::_Vector_base.7"* %31, i32 0, i32 0
  ...
  %35 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %36 = getelementptr inbounds %"struct.std::_Vector_base.7"* %35, i32 0, i32 0
  ...
  %39 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %40 = call %"class.std::allocator.3"* @_ZNSt12_Vector_baseIP4NodeSaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.7"* %39) #0
  call void @_ZSt8_DestroyIPP4NodeS1_EvT_S3_RSaIT0_E(%struct.Node** %34, %struct.Node** %38, %"class.std::allocator.3"* %40)
  %41 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %42 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %43 = getelementptr inbounds %"struct.std::_Vector_base.7"* %42, i32 0, i32 0
  ...
  %46 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %47 = getelementptr inbounds %"struct.std::_Vector_base.7"* %46, i32 0, i32 0
  ...
  %50 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %51 = getelementptr inbounds %"struct.std::_Vector_base.7"* %50, i32 0, i32 0
  ...
  call void @_ZNSt12_Vector_baseIP4NodeSaIS1_EE13_M_deallocateEPS1_m(%"struct.std::_Vector_base.7"* %41, %struct.Node** %45, i64 %57)
  %58 = load %struct.Node*** %__new_start, align 8
  %59 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %60 = getelementptr inbounds %"struct.std::_Vector_base.7"* %59, i32 0, i32 0
  ...
  %63 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %64 = getelementptr inbounds %"struct.std::_Vector_base.7"* %63, i32 0, i32 0
  ...
  %69 = bitcast %"class.std::vector.6"* %3 to %"struct.std::_Vector_base.7"*
  %70 = getelementptr inbounds %"struct.std::_Vector_base.7"* %69, i32 0, i32 0
...
define linkonce_odr i64 @_ZNKSt6vectorIP4NodeSaIS1_EE12_M_check_lenEmPKc(%"class.std::vector.6"* %this, i64 %__n, i8* %__s) #3 align 2 {
  ...
  %5 = load %"class.std::vector.6"** %1
  %6 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE8max_sizeEv(%"class.std::vector.6"* %5) #0
  %7 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE4sizeEv(%"class.std::vector.6"* %5) #0
  %8 = sub i64 %6, %7
...
; <label>:13                                      ; preds = %0
  %14 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE4sizeEv(%"class.std::vector.6"* %5) #0
  %15 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE4sizeEv(%"class.std::vector.6"* %5) #0
  store i64 %15, i64* %4
  ...
  %20 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE4sizeEv(%"class.std::vector.6"* %5) #0
  %21 = icmp ult i64 %19, %20
  br i1 %21, label %26, label %22

; <label>:22                                      ; preds = %13
  %23 = load i64* %__len, align 8
  %24 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE8max_sizeEv(%"class.std::vector.6"* %5) #0
  %25 = icmp ugt i64 %23, %24
  br i1 %25, label %26, label %28

; <label>:26                                      ; preds = %22, %13
  %27 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE8max_sizeEv(%"class.std::vector.6"* %5) #0
  br label %30
...
define linkonce_odr %struct.Node** @_ZNSt12_Vector_baseIP4NodeSaIS1_EE11_M_allocateEm(%"struct.std::_Vector_base.7"* %this, i64 %__n) #3 align 2 {
  %1 = alloca %"struct.std::_Vector_base.7"*, align 8
  %2 = alloca i64, align 8
  store %"struct.std::_Vector_base.7"* %this, %"struct.std::_Vector_base.7"** %1, align 8
  store i64 %__n, i64* %2, align 8
  %3 = load %"struct.std::_Vector_base.7"** %1
  %4 = load i64* %2, align 8
  %5 = icmp ne i64 %4, 0
  br i1 %5, label %6, label %11

; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds %"struct.std::_Vector_base.7"* %3, i32 0, i32 0
  %8 = bitcast %"struct.std::_Vector_base<Node *, std::allocator<Node *> >::_Vector_impl"* %7 to %"class.std::allocator.3"*
  %9 = load i64* %2, align 8
  %10 = call %struct.Node** @_ZNSt16allocator_traitsISaIP4NodeEE8allocateERS2_m(%"class.std::allocator.3"* %8, i64 %9)
  br label %12
...
define linkonce_odr %struct.Node** @_ZSt34__uninitialized_move_if_noexcept_aIPP4NodeS2_SaIS1_EET0_T_S5_S4_RT1_(%struct.Node** %__first, %struct.Node** %__last, %struct.Node** %__result, %"class.std::allocator.3"* %__alloc) #4 {
  ...
  store %"class.std::allocator.3"* %__alloc, %"class.std::allocator.3"** %4, align 8
  ...
  %14 = load %"class.std::allocator.3"** %4, align 8
  ...
  %19 = call %struct.Node** @_ZSt22__uninitialized_copy_aISt13move_iteratorIPP4NodeES3_S2_ET0_T_S6_S5_RSaIT1_E(%struct.Node** %16, %struct.Node** %18, %struct.Node** %13, %"class.std::allocator.3"* %14)
  ret %struct.Node** %19
}
...
define linkonce_odr %"class.std::allocator.3"* @_ZNSt12_Vector_baseIP4NodeSaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.7"* %this) #3 align 2 {
  %1 = alloca %"struct.std::_Vector_base.7"*, align 8
  store %"struct.std::_Vector_base.7"* %this, %"struct.std::_Vector_base.7"** %1, align 8
  %2 = load %"struct.std::_Vector_base.7"** %1
  %3 = getelementptr inbounds %"struct.std::_Vector_base.7"* %2, i32 0, i32 0
...
define linkonce_odr void @_ZNSt12_Vector_baseIP4NodeSaIS1_EE13_M_deallocateEPS1_m(%"struct.std::_Vector_base.7"* %this, %struct.Node** %__p, i64 %__n) #3 align 2 {
  ...
  store %struct.Node** %__p, %struct.Node*** %2, align 8
  store i64 %__n, i64* %3, align 8
  %4 = load %"struct.std::_Vector_base.7"** %1
  %5 = load %struct.Node*** %2, align 8
  %6 = icmp ne %struct.Node** %5, null
  br i1 %6, label %7, label %12

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %"struct.std::_Vector_base.7"* %4, i32 0, i32 0
  %9 = bitcast %"struct.std::_Vector_base<Node *, std::allocator<Node *> >::_Vector_impl"* %8 to %"class.std::allocator.3"*
  %10 = load %struct.Node*** %2, align 8
  %11 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIP4NodeEE10deallocateERS2_PS1_m(%"class.std::allocator.3"* %9, %struct.Node** %10, i64 %11)
  br label %12
...
define linkonce_odr i64 @_ZNKSt6vectorIP4NodeSaIS1_EE8max_sizeEv(%"class.std::vector.6"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::vector.6"** %1
  %3 = bitcast %"class.std::vector.6"* %2 to %"struct.std::_Vector_base.7"*
  %4 = call %"class.std::allocator.3"* @_ZNKSt12_Vector_baseIP4NodeSaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.7"* %3) #0
  %5 = call i64 @_ZNSt16allocator_traitsISaIP4NodeEE8max_sizeERKS2_(%"class.std::allocator.3"* %4) #0
  ret i64 %5
}
...
define linkonce_odr i64 @_ZNSt16allocator_traitsISaIP4NodeEE8max_sizeERKS2_(%"class.std::allocator.3"* %__a) #3 align 2 {
  ...
  %4 = call i64 @_ZNK9__gnu_cxx13new_allocatorIP4NodeE8max_sizeEv(%"class.__gnu_cxx::new_allocator.4"* %3) #0
  ret i64 %4
}
...
define linkonce_odr void @_ZNSt12_Vector_baseIP4NodeSaIS1_EED2Ev(%"struct.std::_Vector_base.7"* %this) unnamed_addr #3 align 2 {
  ...
  %6 = getelementptr inbounds %"struct.std::_Vector_base.7"* %2, i32 0, i32 0
  ...
  %9 = getelementptr inbounds %"struct.std::_Vector_base.7"* %2, i32 0, i32 0
  ...
  call void @_ZNSt12_Vector_baseIP4NodeSaIS1_EE13_M_deallocateEPS1_m(%"struct.std::_Vector_base.7"* %2, %struct.Node** %5, i64 %15)
  %16 = getelementptr inbounds %"struct.std::_Vector_base.7"* %2, i32 0, i32 0
...
define linkonce_odr void @_ZNSt12_Vector_baseIP4NodeSaIS1_EE12_Vector_implD2Ev(%"struct.std::_Vector_base<Node *, std::allocator<Node *> >::_Vector_impl"* %this) unnamed_addr #4 align 2 {
  ...
  %3 = bitcast %"struct.std::_Vector_base<Node *, std::allocator<Node *> >::_Vector_impl"* %2 to %"class.std::allocator.3"*
...
; <label>:12                                      ; preds = %10, %0
  ...
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodeiEEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESD_IJEEEEEvRS7_PT_DpOT0_(%"class.std::allocator.0"* %14, %"struct.std::pair"* %16, %"struct.std::piecewise_construct_t"* %18, %"class.std::tuple"* %20, %"class.std::tuple.12"* %22)
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP4NodeiEEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESD_IJEEEEEvRS7_PT_DpOT0_(%"class.std::allocator.0"* %__a, %"struct.std::pair"* %__p, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.12"* %__args2) #3 align 2 {
  ...
  %13 = load %"class.std::tuple.12"** %5, align 8
  %14 = call %"class.std::tuple.12"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.12"* %13) #0
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP4NodeiEEE9constructIS6_JRKSt21piecewise_construct_tSt5tupleIJRS5_EESD_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %7, %"struct.std::pair"* %8, %"struct.std::piecewise_construct_t"* %10, %"class.std::tuple"* %12, %"class.std::tuple.12"* %14)
  ret void
}
...
define linkonce_odr %struct.Node*** @_ZNSt11_Deque_baseIP4NodeSaIS1_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  ...
  call void @_ZNKSt11_Deque_baseIP4NodeSaIS1_EE20_M_get_map_allocatorEv(%"class.std::allocator.15"* sret %__map_alloc, %"class.std::_Deque_base"* %4) #0
  %5 = load i64* %2, align 8
  %6 = call %struct.Node*** @_ZNSt16allocator_traitsISaIPP4NodeEE8allocateERS3_m(%"class.std::allocator.15"* %__map_alloc, i64 %5)
  store i32 1, i32* %3
  call void @_ZNSaIPP4NodeED2Ev(%"class.std::allocator.15"* %__map_alloc) #0
  ret %struct.Node*** %6
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIP4NodeSaIS1_EE17_M_deallocate_mapEPPS1_m(%"class.std::_Deque_base"* %this, %struct.Node*** %__p, i64 %__n) #3 align 2 {
  ...
  %5 = load %struct.Node**** %2, align 8
  %6 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIPP4NodeEE10deallocateERS3_PS2_m(%"class.std::allocator.15"* %__map_alloc, %struct.Node*** %5, i64 %6)
  call void @_ZNSaIPP4NodeED2Ev(%"class.std::allocator.15"* %__map_alloc) #0
  ret void
}
...
define linkonce_odr void @_ZNKSt11_Deque_baseIP4NodeSaIS1_EE20_M_get_map_allocatorEv(%"class.std::allocator.15"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  call void @_ZNSaIPP4NodeEC2IS0_EERKSaIT_E(%"class.std::allocator.15"* %agg.result, %"class.std::allocator.3"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaIPP4NodeED2Ev(%"class.std::allocator.15"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIPP4NodeED2Ev(%"class.__gnu_cxx::new_allocator.16"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaIPP4NodeEC2IS0_EERKSaIT_E(%"class.std::allocator.15"* %this, %"class.std::allocator.3"*) unnamed_addr #3 align 2 {
  ...
  %5 = bitcast %"class.std::allocator.15"* %4 to %"class.__gnu_cxx::new_allocator.16"*
  call void @_ZN9__gnu_cxx13new_allocatorIPP4NodeEC2Ev(%"class.__gnu_cxx::new_allocator.16"* %5) #0
  ret void
}
...
define linkonce_odr %struct.Node*** @_ZN9__gnu_cxx13new_allocatorIPP4NodeE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.16"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.16"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIPP4NodeE8max_sizeEv(%"class.__gnu_cxx::new_allocator.16"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
