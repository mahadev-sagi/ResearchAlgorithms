; ModuleID = 'BFS/bfs_02_custom_queue.cpp'
...
define void @_Z16bfs_custom_queueP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  %q = alloca %struct.CustomQueue, align 8
...
; <label>:6                                       ; preds = %0
  call void @_ZN11CustomQueueC2Ei(%struct.CustomQueue* %q, i32 10001)
  %7 = load %struct.Node** %1, align 8
  call void @_ZN11CustomQueue4pushEP4Node(%struct.CustomQueue* %q, %struct.Node* %7)
  br label %8

; <label>:8                                       ; preds = %33, %6
  %9 = call zeroext i1 @_ZN11CustomQueue5emptyEv(%struct.CustomQueue* %q)
  %10 = xor i1 %9, true
  br i1 %10, label %11, label %34

; <label>:11                                      ; preds = %8
  %12 = call %struct.Node* @_ZN11CustomQueue3topEv(%struct.CustomQueue* %q)
  store %struct.Node* %12, %struct.Node** %u, align 8
  call void @_ZN11CustomQueue3popEv(%struct.CustomQueue* %q)
...
; <label>:20                                      ; preds = %11
  ...
  call void @_ZN11CustomQueue4pushEP4Node(%struct.CustomQueue* %q, %struct.Node* %23)
  br label %24
...
; <label>:29                                      ; preds = %24
  ...
  call void @_ZN11CustomQueue4pushEP4Node(%struct.CustomQueue* %q, %struct.Node* %32)
  br label %33
...
; <label>:34                                      ; preds = %8
  call void @_ZN11CustomQueueD2Ev(%struct.CustomQueue* %q) #0
  br label %35
...
define linkonce_odr void @_ZN11CustomQueueC2Ei(%struct.CustomQueue* %this, i32 %c) unnamed_addr #3 align 2 {
  %1 = alloca %struct.CustomQueue*, align 8
  %2 = alloca i32, align 4
  store %struct.CustomQueue* %this, %struct.CustomQueue** %1, align 8
  store i32 %c, i32* %2, align 4
  %3 = load %struct.CustomQueue** %1
  %4 = load i32* %2, align 4
  %5 = getelementptr inbounds %struct.CustomQueue* %3, i32 0, i32 3
  ...
  %14 = getelementptr inbounds %struct.CustomQueue* %3, i32 0, i32 0
  store %struct.Node** %13, %struct.Node*** %14, align 8
  %15 = getelementptr inbounds %struct.CustomQueue* %3, i32 0, i32 1
  store i32 0, i32* %15, align 4
  %16 = getelementptr inbounds %struct.CustomQueue* %3, i32 0, i32 2
...
define linkonce_odr void @_ZN11CustomQueue4pushEP4Node(%struct.CustomQueue* %this, %struct.Node* %x) #3 align 2 {
  ...
  %5 = getelementptr inbounds %struct.CustomQueue* %3, i32 0, i32 2
  %6 = load i32* %5, align 4
  %7 = add nsw i32 %6, 1
  store i32 %7, i32* %5, align 4
  %8 = sext i32 %6 to i64
  %9 = getelementptr inbounds %struct.CustomQueue* %3, i32 0, i32 0
  %10 = load %struct.Node*** %9, align 8
  %11 = getelementptr inbounds %struct.Node** %10, i64 %8
...
define linkonce_odr zeroext i1 @_ZN11CustomQueue5emptyEv(%struct.CustomQueue* %this) #3 align 2 {
  %1 = alloca %struct.CustomQueue*, align 8
  store %struct.CustomQueue* %this, %struct.CustomQueue** %1, align 8
  %2 = load %struct.CustomQueue** %1
  %3 = getelementptr inbounds %struct.CustomQueue* %2, i32 0, i32 1
  %4 = load i32* %3, align 4
  %5 = getelementptr inbounds %struct.CustomQueue* %2, i32 0, i32 2
  %6 = load i32* %5, align 4
  %7 = icmp eq i32 %4, %6
  ret i1 %7
}
...
define linkonce_odr %struct.Node* @_ZN11CustomQueue3topEv(%struct.CustomQueue* %this) #3 align 2 {
  ...
  %4 = load i32* %3, align 4
  %5 = sext i32 %4 to i64
  %6 = getelementptr inbounds %struct.CustomQueue* %2, i32 0, i32 0
...
define linkonce_odr void @_ZN11CustomQueueD2Ev(%struct.CustomQueue* %this) unnamed_addr #3 align 2 {
  ...
  store %struct.CustomQueue* %this, %struct.CustomQueue** %1, align 8
  %2 = load %struct.CustomQueue** %1
  %3 = getelementptr inbounds %struct.CustomQueue* %2, i32 0, i32 0
...
; <label>:37                                      ; preds = %21
  ...
  call void @_Z16bfs_custom_queueP4NodeRSt6vectorIiSaIiEE(%struct.Node* %38, %"class.std::vector"* %result)
