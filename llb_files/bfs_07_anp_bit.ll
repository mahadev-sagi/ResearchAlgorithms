; ModuleID = 'BFS/bfs_07_anp_bit.cpp'
...
define void @_Z7bfs_anpP4NodeRKSt6vectorIS0_SaIS0_EERSt3mapIS0_iSt4lessIS0_ESaISt4pairIKS0_iEEERS1_IiSaIiEE(%struct.Node* %root, %"class.std::vector"* %all_nodes, %"class.std::map"* %node_to_idx, %"class.std::vector.3"* %result) #3 {
...
; <label>:68                                      ; preds = %58
  %69 = load i64* %mask, align 8
  %70 = load %"class.std::map"** %3, align 8
  %71 = load %struct.Node** %u, align 8
  %72 = getelementptr inbounds %struct.Node* %71, i32 0, i32 1
  %73 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %70, %struct.Node** %72)
  %74 = load i32* %73
  %75 = sext i32 %74 to i64
  %76 = call i64* @_ZNSt6vectorImSaImEEixEm(%"class.std::vector.8"* %next_frontier, i64 %75) #0
  %77 = load i64* %76
  %78 = or i64 %77, %69
  store i64 %78, i64* %76
  br label %79
...
; <label>:79                                      ; preds = %68, %58
  %80 = load %struct.Node** %u, align 8
  %81 = getelementptr inbounds %struct.Node* %80, i32 0, i32 2
  %82 = load %struct.Node** %81, align 8
  %83 = icmp ne %struct.Node* %82, null
  br i1 %83, label %84, label %95

; <label>:84                                      ; preds = %79
  %85 = load i64* %mask, align 8
  %86 = load %"class.std::map"** %3, align 8
  %87 = load %struct.Node** %u, align 8
  %88 = getelementptr inbounds %struct.Node* %87, i32 0, i32 2
  %89 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %86, %struct.Node** %88)
  %90 = load i32* %89
  %91 = sext i32 %90 to i64
  %92 = call i64* @_ZNSt6vectorImSaImEEixEm(%"class.std::vector.8"* %next_frontier, i64 %91) #0
  %93 = load i64* %92
  %94 = or i64 %93, %85
  store i64 %94, i64* %92
  br label %95
...
; <label>:97                                      ; preds = %96
  %98 = load i32* %u_idx, align 4
  %99 = add nsw i32 %98, 1
  store i32 %99, i32* %u_idx, align 4
  br label %46

; <label>:100                                     ; preds = %46
  store i32 0, i32* %u_idx1, align 4
  br label %101

; <label>:101                                     ; preds = %140, %100
  %102 = load i32* %u_idx1, align 4
  %103 = load i32* %n, align 4
  %104 = icmp slt i32 %102, %103
  br i1 %104, label %105, label %143

; <label>:105                                     ; preds = %101
  %106 = load i32* %u_idx1, align 4
  %107 = sext i32 %106 to i64
  %108 = call i64* @_ZNSt6vectorImSaImEEixEm(%"class.std::vector.8"* %next_frontier, i64 %107) #0
  %109 = load i64* %108
  %110 = load i64* %mask, align 8
  %111 = and i64 %109, %110
  %112 = icmp ne i64 %111, 0
  br i1 %112, label %113, label %135

; <label>:113                                     ; preds = %105
  %114 = load i32* %u_idx1, align 4
  %115 = sext i32 %114 to i64
  %116 = call i64* @_ZNSt6vectorImSaImEEixEm(%"class.std::vector.8"* %visited, i64 %115) #0
  %117 = load i64* %116
  %118 = load i64* %mask, align 8
  %119 = and i64 %117, %118
...
; <label>:121                                     ; preds = %113
  ...
  %123 = load i32* %u_idx1, align 4
  %124 = sext i32 %123 to i64
  %125 = call i64* @_ZNSt6vectorImSaImEEixEm(%"class.std::vector.8"* %visited, i64 %124) #0
  %126 = load i64* %125
  %127 = or i64 %126, %122
  store i64 %127, i64* %125
  %128 = load %"class.std::vector.3"** %4, align 8
  %129 = load %"class.std::vector"** %2, align 8
  %130 = load i32* %u_idx1, align 4
  %131 = sext i32 %130 to i64
  %132 = call %struct.Node** @_ZNKSt6vectorIP4NodeSaIS1_EEixEm(%"class.std::vector"* %129, i64 %131) #0
  %133 = load %struct.Node** %132
  %134 = getelementptr inbounds %struct.Node* %133, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.3"* %128, i32* %134)
  store i8 1, i8* %active, align 1
  br label %139

; <label>:135                                     ; preds = %113, %105
  %136 = load i32* %u_idx1, align 4
  %137 = sext i32 %136 to i64
  %138 = call i64* @_ZNSt6vectorImSaImEEixEm(%"class.std::vector.8"* %next_frontier, i64 %137) #0
  store i64 0, i64* %138
  br label %139
...
; <label>:140                                     ; preds = %139
  %141 = load i32* %u_idx1, align 4
  %142 = add nsw i32 %141, 1
  store i32 %142, i32* %u_idx1, align 4
  br label %101

; <label>:143                                     ; preds = %101
  %144 = call %"class.std::vector.8"* @_ZNSt6vectorImSaImEEaSERKS1_(%"class.std::vector.8"* %frontier, %"class.std::vector.8"* %next_frontier)
  %145 = call i64* @_ZNSt6vectorImSaImEE5beginEv(%"class.std::vector.8"* %next_frontier) #0
  %146 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %11, i32 0, i32 0
  store i64* %145, i64** %146
  %147 = call i64* @_ZNSt6vectorImSaImEE3endEv(%"class.std::vector.8"* %next_frontier) #0
  %148 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %12, i32 0, i32 0
  store i64* %147, i64** %148
  store i32 0, i32* %13
  %149 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %11, i32 0, i32 0
  %150 = load i64** %149
  %151 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %12, i32 0, i32 0
  %152 = load i64** %151
  call void @_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPmSt6vectorImSaImEEEEiEvT_S7_RKT0_(i64* %150, i64* %152, i32* %13)
  br label %42
...
; <label>:40                                      ; preds = %37
  ...
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.3"* %result, i32* %42)
  br label %43

; <label>:43                                      ; preds = %40, %37
  %44 = load %struct.Node** %root, align 8
  call void @_Z7bfs_anpP4NodeRKSt6vectorIS0_SaIS0_EERSt3mapIS0_iSt4lessIS0_ESaISt4pairIKS0_iEEERS1_IiSaIiEE(%struct.Node* %44, %"class.std::vector"* %all_nodes, %"class.std::map"* %node_to_idx, %"class.std::vector.3"* %result)
  store i64 0, i64* %i, align 8
  br label %45

; <label>:45                                      ; preds = %60, %43
  %46 = load i64* %i, align 8
  %47 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.3"* %result) #0
  %48 = icmp ult i64 %46, %47
  br i1 %48, label %49, label %63

; <label>:49                                      ; preds = %45
  %50 = load i64* %i, align 8
  %51 = call i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.3"* %result, i64 %50) #0
  %52 = load i32* %51
  %53 = call %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %52)
  %54 = load i64* %i, align 8
  %55 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.3"* %result) #0
  %56 = sub i64 %55, 1
  %57 = icmp eq i64 %54, %56
  %58 = select i1 %57, i8* getelementptr inbounds ([1 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @.str3, i32 0, i32 0)
  %59 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %53, i8* %58)
  br label %60
...
; <label>:63                                      ; preds = %45
  %64 = call %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* @_ZSt4cout, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  store i32 0, i32* %1
  store i32 1, i32* %5
