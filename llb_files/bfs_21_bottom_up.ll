; ModuleID = 'BFS/bfs_21_bottom_up.cpp'
...
define void @_Z13bfs_bottom_upP4NodeRKSt6vectorIS0_SaIS0_EERS1_IiSaIiEE(%struct.Node* %root, %"class.std::vector"* %all_nodes, %"class.std::vector.0"* %result) #3 {
  ...
  %parent_found = alloca i8, align 1
...
; <label>:7                                       ; preds = %0
  ...
  store %"class.std::vector"* %8, %"class.std::vector"** %__range, align 8
  %9 = load %"class.std::vector"** %__range, align 8
  %10 = call %struct.Node** @_ZNKSt6vectorIP4NodeSaIS1_EE5beginEv(%"class.std::vector"* %9) #0
  %11 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__begin, i32 0, i32 0
  store %struct.Node** %10, %struct.Node*** %11
  %12 = load %"class.std::vector"** %__range, align 8
  %13 = call %struct.Node** @_ZNKSt6vectorIP4NodeSaIS1_EE3endEv(%"class.std::vector"* %12) #0
  %14 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__end, i32 0, i32 0
  store %struct.Node** %13, %struct.Node*** %14
  br label %15

; <label>:15                                      ; preds = %21, %7
  %16 = call zeroext i1 @_ZN9__gnu_cxxneIPKP4NodeSt6vectorIS2_SaIS2_EEEEbRKNS_17__normal_iteratorIT_T0_EESD_(%"class.__gnu_cxx::__normal_iterator"* %__begin, %"class.__gnu_cxx::__normal_iterator"* %__end) #0
  br i1 %16, label %17, label %23

; <label>:17                                      ; preds = %15
  %18 = call %struct.Node** @_ZNK9__gnu_cxx17__normal_iteratorIPKP4NodeSt6vectorIS2_SaIS2_EEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %__begin) #0
  %19 = load %struct.Node** %18
  store %struct.Node* %19, %struct.Node** %n, align 8
  %20 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist, %struct.Node** %n)
  store i32 -1, i32* %20
  br label %21

; <label>:21                                      ; preds = %17
  %22 = call %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPKP4NodeSt6vectorIS2_SaIS2_EEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin) #0
  br label %15
...
; <label>:23                                      ; preds = %15
  ...
  %24 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist, %struct.Node** %1)
  store i32 0, i32* %24
  call void @_ZNSt6vectorIP4NodeSaIS1_EE9push_backERKS1_(%"class.std::vector"* %frontier, %struct.Node** %1)
  %25 = load %"class.std::vector.0"** %3, align 8
  %26 = load %struct.Node** %1, align 8
  %27 = getelementptr inbounds %struct.Node* %26, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.0"* %25, i32* %27)
  store i32 0, i32* %level, align 4
  br label %28

; <label>:28                                      ; preds = %117, %23
  %29 = call zeroext i1 @_ZNKSt6vectorIP4NodeSaIS1_EE5emptyEv(%"class.std::vector"* %frontier) #0
  %30 = xor i1 %29, true
...
; <label>:31                                      ; preds = %28
  ...
  %33 = add nsw i32 %32, 1
  store i32 %33, i32* %level, align 4
  call void @_ZNSt6vectorIP4NodeSaIS1_EE5clearEv(%"class.std::vector"* %next_frontier) #0
  %34 = load %"class.std::vector"** %2, align 8
  store %"class.std::vector"* %34, %"class.std::vector"** %__range1, align 8
  %35 = load %"class.std::vector"** %__range1, align 8
  %36 = call %struct.Node** @_ZNKSt6vectorIP4NodeSaIS1_EE5beginEv(%"class.std::vector"* %35) #0
  %37 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__begin2, i32 0, i32 0
  store %struct.Node** %36, %struct.Node*** %37
  %38 = load %"class.std::vector"** %__range1, align 8
  %39 = call %struct.Node** @_ZNKSt6vectorIP4NodeSaIS1_EE3endEv(%"class.std::vector"* %38) #0
  %40 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__end3, i32 0, i32 0
  store %struct.Node** %39, %struct.Node*** %40
  br label %41

; <label>:41                                      ; preds = %115, %31
  %42 = call zeroext i1 @_ZN9__gnu_cxxneIPKP4NodeSt6vectorIS2_SaIS2_EEEEbRKNS_17__normal_iteratorIT_T0_EESD_(%"class.__gnu_cxx::__normal_iterator"* %__begin2, %"class.__gnu_cxx::__normal_iterator"* %__end3) #0
  br i1 %42, label %43, label %117

; <label>:43                                      ; preds = %41
  %44 = call %struct.Node** @_ZNK9__gnu_cxx17__normal_iteratorIPKP4NodeSt6vectorIS2_SaIS2_EEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %__begin2) #0
  %45 = load %struct.Node** %44
  store %struct.Node* %45, %struct.Node** %v, align 8
  %46 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist, %struct.Node** %v)
  %47 = load i32* %46
  %48 = icmp eq i32 %47, -1
  br i1 %48, label %49, label %114

; <label>:49                                      ; preds = %43
  %50 = getelementptr inbounds [3 x %struct.Node*]* %neighbors, i64 0, i64 0
  %51 = load %struct.Node** %v, align 8
  %52 = getelementptr inbounds %struct.Node* %51, i32 0, i32 3
  %53 = load %struct.Node** %52, align 8
  store %struct.Node* %53, %struct.Node** %50
  %54 = getelementptr inbounds %struct.Node** %50, i64 1
  %55 = load %struct.Node** %v, align 8
  %56 = getelementptr inbounds %struct.Node* %55, i32 0, i32 1
  %57 = load %struct.Node** %56, align 8
  store %struct.Node* %57, %struct.Node** %54
  %58 = getelementptr inbounds %struct.Node** %54, i64 1
  %59 = load %struct.Node** %v, align 8
  %60 = getelementptr inbounds %struct.Node* %59, i32 0, i32 2
  %61 = load %struct.Node** %60, align 8
  store %struct.Node* %61, %struct.Node** %58
  store i8 0, i8* %parent_found, align 1
  store [3 x %struct.Node*]* %neighbors, [3 x %struct.Node*]** %__range4, align 8
  %62 = load [3 x %struct.Node*]** %__range4, align 8
  %63 = getelementptr inbounds [3 x %struct.Node*]* %62, i32 0, i32 0
  store %struct.Node** %63, %struct.Node*** %__begin5, align 8
  %64 = load [3 x %struct.Node*]** %__range4, align 8
  %65 = getelementptr inbounds [3 x %struct.Node*]* %64, i32 0, i32 0
  %66 = getelementptr inbounds %struct.Node** %65, i64 3
  store %struct.Node** %66, %struct.Node*** %__end6, align 8
  br label %67

; <label>:67                                      ; preds = %101, %49
  %68 = load %struct.Node*** %__begin5, align 8
  %69 = load %struct.Node*** %__end6, align 8
  %70 = icmp ne %struct.Node** %68, %69
  br i1 %70, label %71, label %104

; <label>:71                                      ; preds = %67
  %72 = load %struct.Node*** %__begin5, align 8
  %73 = load %struct.Node** %72, align 8
  store %struct.Node* %73, %struct.Node** %u, align 8
  %74 = load %struct.Node** %u, align 8
...
; <label>:77                                      ; preds = %71
  ...
  %78 = load %"class.std::vector"** %__range7, align 8
  %79 = call %struct.Node** @_ZNSt6vectorIP4NodeSaIS1_EE5beginEv(%"class.std::vector"* %78) #0
  %80 = getelementptr %"class.__gnu_cxx::__normal_iterator.8"* %__begin8, i32 0, i32 0
  store %struct.Node** %79, %struct.Node*** %80
  %81 = load %"class.std::vector"** %__range7, align 8
  %82 = call %struct.Node** @_ZNSt6vectorIP4NodeSaIS1_EE3endEv(%"class.std::vector"* %81) #0
  %83 = getelementptr %"class.__gnu_cxx::__normal_iterator.8"* %__end9, i32 0, i32 0
  store %struct.Node** %82, %struct.Node*** %83
  br label %84

; <label>:84                                      ; preds = %94, %77
  %85 = call zeroext i1 @_ZN9__gnu_cxxneIPP4NodeSt6vectorIS2_SaIS2_EEEEbRKNS_17__normal_iteratorIT_T0_EESC_(%"class.__gnu_cxx::__normal_iterator.8"* %__begin8, %"class.__gnu_cxx::__normal_iterator.8"* %__end9) #0
  br i1 %85, label %86, label %96

; <label>:86                                      ; preds = %84
  %87 = call %struct.Node** @_ZNK9__gnu_cxx17__normal_iteratorIPP4NodeSt6vectorIS2_SaIS2_EEEdeEv(%"class.__gnu_cxx::__normal_iterator.8"* %__begin8) #0
  %88 = load %struct.Node** %87
  store %struct.Node* %88, %struct.Node** %f, align 8
  %89 = load %struct.Node** %f, align 8
  %90 = load %struct.Node** %u, align 8
  %91 = icmp eq %struct.Node* %89, %90
  br i1 %91, label %92, label %93

; <label>:92                                      ; preds = %86
  store i8 1, i8* %parent_found, align 1
  br label %96
...
; <label>:94                                      ; preds = %93
  %95 = call %"class.__gnu_cxx::__normal_iterator.8"* @_ZN9__gnu_cxx17__normal_iteratorIPP4NodeSt6vectorIS2_SaIS2_EEEppEv(%"class.__gnu_cxx::__normal_iterator.8"* %__begin8) #0
  br label %84

; <label>:96                                      ; preds = %92, %84
  %97 = load i8* %parent_found, align 1
...
; <label>:101                                     ; preds = %100, %76
  %102 = load %struct.Node*** %__begin5, align 8
  %103 = getelementptr inbounds %struct.Node** %102, i32 1
  store %struct.Node** %103, %struct.Node*** %__begin5, align 8
  br label %67

; <label>:104                                     ; preds = %99, %67
  %105 = load i8* %parent_found, align 1
  %106 = trunc i8 %105 to i1
  br i1 %106, label %107, label %113

; <label>:107                                     ; preds = %104
  %108 = load i32* %level, align 4
  %109 = call i32* @_ZNSt3mapIP4NodeiSt4lessIS1_ESaISt4pairIKS1_iEEEixERS5_(%"class.std::map"* %dist, %struct.Node** %v)
  store i32 %108, i32* %109
  call void @_ZNSt6vectorIP4NodeSaIS1_EE9push_backERKS1_(%"class.std::vector"* %next_frontier, %struct.Node** %v)
  %110 = load %"class.std::vector.0"** %3, align 8
  %111 = load %struct.Node** %v, align 8
  %112 = getelementptr inbounds %struct.Node* %111, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector.0"* %110, i32* %112)
  br label %113
...
; <label>:115                                     ; preds = %114
  %116 = call %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPKP4NodeSt6vectorIS2_SaIS2_EEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin2) #0
  br label %41

; <label>:117                                     ; preds = %41
  %118 = call %"class.std::vector"* @_ZNSt6vectorIP4NodeSaIS1_EEaSERKS3_(%"class.std::vector"* %frontier, %"class.std::vector"* %next_frontier)
  br label %28
...
define linkonce_odr void @_ZNSt6vectorIP4NodeSaIS1_EE5clearEv(%"class.std::vector"* %this) #3 align 2 {
  ...
  call void @_ZNSt6vectorIP4NodeSaIS1_EE15_M_erase_at_endEPS1_(%"class.std::vector"* %2, %struct.Node** %6) #0
  ret void
}
...
define i32 @main(i32 %argc, i8** %argv) #3 {
  ...
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %filename, i8* getelementptr inbounds ([18 x i8]* @.str, i32 0, i32 0), %"class.std::allocator.9"* %4)
...
; <label>:37                                      ; preds = %21
  ...
  call void @_Z13bfs_bottom_upP4NodeRKSt6vectorIS0_SaIS0_EERS1_IiSaIiEE(%struct.Node* %38, %"class.std::vector"* %all_nodes, %"class.std::vector.0"* %result)
...
; <label>:43                                      ; preds = %39
  ...
  %48 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %47, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0))
  br label %49
...
define linkonce_odr void @_ZNSt6vectorIP4NodeSaIS1_EE15_M_erase_at_endEPS1_(%"class.std::vector"* %this, %struct.Node** %__pos) #3 align 2 {
  ...
  %10 = call %"class.std::allocator"* @_ZNSt12_Vector_baseIP4NodeSaIS1_EE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %9) #0
  call void @_ZSt8_DestroyIPP4NodeS1_EvT_S3_RSaIT0_E(%struct.Node** %4, %struct.Node** %8, %"class.std::allocator"* %10)
...
define linkonce_odr void @_ZNSt6vectorIP4NodeSaIS1_EE19_M_emplace_back_auxIJRKS1_EEEvDpOT_(%"class.std::vector"* %this, %struct.Node** %__args) #3 align 2 {
  ...
  %3 = load %"class.std::vector"** %1
  %4 = call i64 @_ZNKSt6vectorIP4NodeSaIS1_EE12_M_check_lenEmPKc(%"class.std::vector"* %3, i64 1, i8* getelementptr inbounds ([28 x i8]* @.str3, i32 0, i32 0))
  store i64 %4, i64* %__len, align 8
  %5 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*
  %6 = load i64* %__len, align 8
