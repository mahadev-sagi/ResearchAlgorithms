...
; <label>:6                                       ; preds = %0
  call void @_ZNSt5dequeIP4NodeSaIS1_EEC2Ev(%"class.std::deque"* %dq)
  call void @_ZNSt5dequeIP4NodeSaIS1_EE10push_frontERKS1_(%"class.std::deque"* %dq, %struct.Node** %1)
  br label %7

; <label>:7                                       ; preds = %31, %6
  %8 = call zeroext i1 @_ZNKSt5dequeIP4NodeSaIS1_EE5emptyEv(%"class.std::deque"* %dq) #0
  %9 = xor i1 %8, true
  br i1 %9, label %10, label %32

; <label>:10                                      ; preds = %7
  %11 = call %struct.Node** @_ZNSt5dequeIP4NodeSaIS1_EE5frontEv(%"class.std::deque"* %dq) #0
  %12 = load %struct.Node** %11
  store %struct.Node* %12, %struct.Node** %u, align 8
  call void @_ZNSt5dequeIP4NodeSaIS1_EE9pop_frontEv(%"class.std::deque"* %dq) #0
  %13 = load %"class.std::vector"** %2, align 8
  %14 = load %struct.Node** %u, align 8
...
; <label>:20                                      ; preds = %10
  ...
  call void @_ZNSt5dequeIP4NodeSaIS1_EE9push_backERKS1_(%"class.std::deque"* %dq, %struct.Node** %22)
  br label %23
...
; <label>:28                                      ; preds = %23
  ...
  call void @_ZNSt5dequeIP4NodeSaIS1_EE9push_backERKS1_(%"class.std::deque"* %dq, %struct.Node** %30)
  br label %31
...
; <label>:32                                      ; preds = %7
  call void @_ZNSt5dequeIP4NodeSaIS1_EED2Ev(%"class.std::deque"* %dq) #0
  br label %33
...
define linkonce_odr void @_ZNSt5dequeIP4NodeSaIS1_EE10push_frontERKS1_(%"class.std::deque"* %this, %struct.Node** %__x) #3 align 2 {
  ...
  %11 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %10, i32 0, i32 2
...
; <label>:15                                      ; preds = %0
  ...
  call void @_ZNSt16allocator_traitsISaIP4NodeEE9constructIS1_JRKS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.0"* %18, %struct.Node** %24, %struct.Node** %25)
  %26 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %27 = getelementptr inbounds %"class.std::_Deque_base"* %26, i32 0, i32 0
  %28 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %27, i32 0, i32 2
...
; <label>:32                                      ; preds = %0
  ...
  call void @_ZNSt5dequeIP4NodeSaIS1_EE17_M_push_front_auxIJRKS1_EEEvDpOT_(%"class.std::deque"* %3, %struct.Node** %33)
  br label %34
...
; <label>:37                                      ; preds = %21
  ...
  call void @_Z9bfs_dequeP4NodeRSt6vectorIiSaIiEE(%struct.Node* %38, %"class.std::vector"* %result)
...
define linkonce_odr void @_ZNSt5dequeIP4NodeSaIS1_EE17_M_push_front_auxIJRKS1_EEEvDpOT_(%"class.std::deque"* %this, %struct.Node** %__args) #3 align 2 {
  ...
  store %struct.Node** %__args, %struct.Node*** %2, align 8
  %3 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeIP4NodeSaIS1_EE23_M_reserve_map_at_frontEm(%"class.std::deque"* %3, i64 1)
  %4 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %5 = call %struct.Node** @_ZNSt11_Deque_baseIP4NodeSaIS1_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  ...
  %12 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %13, i32 0, i32 2
  %15 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %16, i32 0, i32 2
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator"* %17, i32 0, i32 3
  %19 = load %struct.Node**** %18, align 8
  %20 = getelementptr inbounds %struct.Node*** %19, i64 -1
  call void @_ZNSt15_Deque_iteratorIP4NodeRS1_PS1_E11_M_set_nodeEPS3_(%"struct.std::_Deque_iterator"* %14, %struct.Node*** %20) #0
  %21 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %22 = getelementptr inbounds %"class.std::_Deque_base"* %21, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %22, i32 0, i32 2
  %24 = getelementptr inbounds %"struct.std::_Deque_iterator"* %23, i32 0, i32 2
  %25 = load %struct.Node*** %24, align 8
  %26 = getelementptr inbounds %struct.Node** %25, i64 -1
  %27 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %28 = getelementptr inbounds %"class.std::_Deque_base"* %27, i32 0, i32 0
  %29 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %28, i32 0, i32 2
  ...
  %36 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %35, i32 0, i32 2
  %37 = getelementptr inbounds %"struct.std::_Deque_iterator"* %36, i32 0, i32 0
  %38 = load %struct.Node*** %37, align 8
  %39 = load %struct.Node*** %2, align 8
  %40 = call %struct.Node** @_ZSt7forwardIRKP4NodeEOT_RNSt16remove_referenceIS4_E4typeE(%struct.Node** %39) #0
  call void @_ZNSt16allocator_traitsISaIP4NodeEE9constructIS1_JRKS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.0"* %33, %struct.Node** %38, %struct.Node** %40)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIP4NodeSaIS1_EE23_M_reserve_map_at_frontEm(%"class.std::deque"* %this, i64 %__nodes_to_add) #3 align 2 {
  ...
  %13 = load %struct.Node**** %12, align 8
  %14 = ptrtoint %struct.Node*** %9 to i64
...
; <label>:19                                      ; preds = %0
  ...
  call void @_ZNSt5dequeIP4NodeSaIS1_EE17_M_reallocate_mapEmb(%"class.std::deque"* %3, i64 %20, i1 zeroext true)
  br label %21
