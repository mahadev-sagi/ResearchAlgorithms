...
define internal void @__cxx_global_var_init1() #0 section ".text.startup" {
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* @_ZL13global_buffer) #0
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::vector"*)* @_ZNSt6vectorIiSaIiEED2Ev to void (i8*)*), i8* bitcast (%"class.std::vector"* @_ZL13global_buffer to i8*), i8* @__dso_handle) #0
  ret void
}
...
; <label>:37                                      ; preds = %33
  ...
  %42 = call %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* %41, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0))
  br label %43
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  call void @_ZNSt6vectorIiSaIiEE5clearEv(%"class.std::vector"* @_ZL13global_buffer) #0
  %4 = load %struct.TreeNode** %2, align 8
