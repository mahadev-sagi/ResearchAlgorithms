; ModuleID = 'InorderTraversals/in_27_unrolled.cpp'
...
; <label>:8                                       ; preds = %5
  %9 = call zeroext i1 @_ZNKSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s)
  %10 = xor i1 %9, true
  br label %11
...
; <label>:17                                      ; preds = %14
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.Node** %curr)
  %18 = load %struct.Node** %curr, align 8
  %19 = getelementptr inbounds %struct.Node* %18, i32 0, i32 1
  %20 = load %struct.Node** %19, align 8
  store %struct.Node* %20, %struct.Node** %curr, align 8
  br label %14

; <label>:21                                      ; preds = %14
  %22 = call %struct.Node** @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s)
...
; <label>:10                                      ; preds = %7
  ...
  call void @_Z14iterative_partP4NodeRSt6vectorIiSaIiEE(%struct.Node* %11, %"class.std::vector"* %12)
  br label %32
...
; <label>:16                                      ; preds = %13
  ...
  %22 = add nsw i32 %21, 1
  call void @_Z14recursive_partP4NodeRSt6vectorIiSaIiEEi(%struct.Node* %19, %"class.std::vector"* %20, i32 %22)
  %23 = load %"class.std::vector"** %2, align 8
  %24 = load %struct.Node** %1, align 8
  %25 = getelementptr inbounds %struct.Node* %24, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %23, i32* %25)
  %26 = load %struct.Node** %1, align 8
  %27 = getelementptr inbounds %struct.Node* %26, i32 0, i32 2
  %28 = load %struct.Node** %27, align 8
  %29 = load %"class.std::vector"** %2, align 8
  %30 = load i32* %3, align 4
  %31 = add nsw i32 %30, 1
  call void @_Z14recursive_partP4NodeRSt6vectorIiSaIiEEi(%struct.Node* %28, %"class.std::vector"* %29, i32 %31)
  br label %32

; <label>:32                                      ; preds = %6, %10, %16, %13
  ret void
}
...
define void @_Z18in_order_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  call void @_Z14recursive_partP4NodeRSt6vectorIiSaIiEEi(%struct.Node* %3, %"class.std::vector"* %4, i32 0)
  ret void
}
