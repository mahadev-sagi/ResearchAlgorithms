...
; <label>:9                                       ; preds = %0
  ...
  %10 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %2)
  store %struct.TreeNode* null, %struct.TreeNode** %10
...
; <label>:15                                      ; preds = %12
  %16 = load %struct.TreeNode** %prev, align 8
  %17 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %curr)
  %18 = load %struct.TreeNode** %17
  %19 = icmp eq %struct.TreeNode* %16, %18
  br i1 %19, label %20, label %56

; <label>:20                                      ; preds = %15
  %21 = load %struct.TreeNode** %curr, align 8
...
; <label>:25                                      ; preds = %20
  ...
  %27 = load %struct.TreeNode** %curr, align 8
  %28 = getelementptr inbounds %struct.TreeNode* %27, i32 0, i32 1
  %29 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %28)
  store %struct.TreeNode* %26, %struct.TreeNode** %29
  %30 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %30, %struct.TreeNode** %prev, align 8
  ...
  store %struct.TreeNode* %33, %struct.TreeNode** %curr, align 8
  br label %55

; <label>:34                                      ; preds = %20
  %35 = load %struct.TreeNode** %curr, align 8
  %36 = getelementptr inbounds %struct.TreeNode* %35, i32 0, i32 2
  %37 = load %struct.TreeNode** %36, align 8
  %38 = icmp ne %struct.TreeNode* %37, null
  br i1 %38, label %39, label %48

; <label>:39                                      ; preds = %34
  %40 = load %struct.TreeNode** %curr, align 8
  %41 = load %struct.TreeNode** %curr, align 8
  %42 = getelementptr inbounds %struct.TreeNode* %41, i32 0, i32 2
  %43 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %42)
  store %struct.TreeNode* %40, %struct.TreeNode** %43
  %44 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %44, %struct.TreeNode** %prev, align 8
  ...
  store %struct.TreeNode* %47, %struct.TreeNode** %curr, align 8
  br label %54

; <label>:48                                      ; preds = %34
  %49 = load %struct.TreeNode** %curr, align 8
  %50 = getelementptr inbounds %struct.TreeNode* %49, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %50)
  %51 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %51, %struct.TreeNode** %prev, align 8
  %52 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %curr)
  %53 = load %struct.TreeNode** %52
...
; <label>:56                                      ; preds = %15
  ...
  %58 = getelementptr inbounds %struct.TreeNode* %57, i32 0, i32 1
  %59 = load %struct.TreeNode** %58, align 8
  %60 = load %struct.TreeNode** %prev, align 8
  %61 = icmp eq %struct.TreeNode* %59, %60
...
; <label>:62                                      ; preds = %56
  ...
  %66 = icmp ne %struct.TreeNode* %65, null
  br i1 %66, label %67, label %76

; <label>:67                                      ; preds = %62
  %68 = load %struct.TreeNode** %curr, align 8
  %69 = load %struct.TreeNode** %curr, align 8
  %70 = getelementptr inbounds %struct.TreeNode* %69, i32 0, i32 2
  %71 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %70)
  store %struct.TreeNode* %68, %struct.TreeNode** %71
  %72 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %72, %struct.TreeNode** %prev, align 8
  %73 = load %struct.TreeNode** %curr, align 8
  %74 = getelementptr inbounds %struct.TreeNode* %73, i32 0, i32 2
  %75 = load %struct.TreeNode** %74, align 8
  store %struct.TreeNode* %75, %struct.TreeNode** %curr, align 8
  br label %82

; <label>:76                                      ; preds = %62
  %77 = load %struct.TreeNode** %curr, align 8
  %78 = getelementptr inbounds %struct.TreeNode* %77, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %78)
  %79 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %79, %struct.TreeNode** %prev, align 8
  %80 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %curr)
  %81 = load %struct.TreeNode** %80
  store %struct.TreeNode* %81, %struct.TreeNode** %curr, align 8
  br label %82
...
; <label>:83                                      ; preds = %56
  %84 = load %struct.TreeNode** %curr, align 8
  %85 = getelementptr inbounds %struct.TreeNode* %84, i32 0, i32 2
  %86 = load %struct.TreeNode** %85, align 8
  %87 = load %struct.TreeNode** %prev, align 8
  %88 = icmp eq %struct.TreeNode* %86, %87
  br i1 %88, label %89, label %95

; <label>:89                                      ; preds = %83
  %90 = load %struct.TreeNode** %curr, align 8
  %91 = getelementptr inbounds %struct.TreeNode* %90, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %91)
  %92 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %92, %struct.TreeNode** %prev, align 8
  %93 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %curr)
  %94 = load %struct.TreeNode** %93
  store %struct.TreeNode* %94, %struct.TreeNode** %curr, align 8
  br label %95
