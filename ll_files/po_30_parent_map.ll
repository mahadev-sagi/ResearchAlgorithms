; ModuleID = 'PostorderTraversals/po_30_parent_map.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %3 = alloca i1
  %4 = alloca i32
  %parentMap = alloca %"class.std::map", align 8
  %5 = alloca i8*
  %6 = alloca i32
  %curr = alloca %struct.TreeNode*, align 8
  %lastVisited = alloca %struct.TreeNode*, align 8
  %movingDown = alloca i8, align 1
  %movingUpFromLeft = alloca i8, align 1
  ...
  %8 = load %struct.TreeNode** %2, align 8
  %9 = icmp eq %struct.TreeNode* %8, null
...
; <label>:11                                      ; preds = %0
  call void @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEC2Ev(%"class.std::map"* %parentMap) #2
  %12 = load %struct.TreeNode** %2, align 8
  invoke void @_ZN8Solution14buildParentMapEP8TreeNodeS1_RSt3mapIS1_S1_St4lessIS1_ESaISt4pairIKS1_S1_EEE(%class.Solution* %7, %struct.TreeNode* %12, %struct.TreeNode* null, %"class.std::map"* %parentMap)
          to label %13 unwind label %54

; <label>:13                                      ; preds = %11
  %14 = load %struct.TreeNode** %2, align 8
  store %struct.TreeNode* %14, %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* null, %struct.TreeNode** %lastVisited, align 8
  br label %15

; <label>:15                                      ; preds = %107, %13
  %16 = load %struct.TreeNode** %curr, align 8
  %17 = icmp ne %struct.TreeNode* %16, null
  br i1 %17, label %18, label %108

; <label>:18                                      ; preds = %15
  %19 = load %struct.TreeNode** %lastVisited, align 8
  %20 = load %struct.TreeNode** %curr, align 8
  %21 = getelementptr inbounds %struct.TreeNode* %20, i32 0, i32 1
  %22 = load %struct.TreeNode** %21, align 8
  %23 = icmp ne %struct.TreeNode* %19, %22
  br i1 %23, label %24, label %34

; <label>:24                                      ; preds = %18
  %25 = load %struct.TreeNode** %lastVisited, align 8
  %26 = load %struct.TreeNode** %curr, align 8
  %27 = getelementptr inbounds %struct.TreeNode* %26, i32 0, i32 2
  %28 = load %struct.TreeNode** %27, align 8
  %29 = icmp ne %struct.TreeNode* %25, %28
  br i1 %29, label %30, label %34

; <label>:30                                      ; preds = %24
  %31 = load %struct.TreeNode** %lastVisited, align 8
  %32 = load %struct.TreeNode** %curr, align 8
  %33 = icmp ne %struct.TreeNode* %31, %32
  br label %34

; <label>:34                                      ; preds = %30, %24, %18
  %35 = phi i1 [ false, %24 ], [ false, %18 ], [ %33, %30 ]
  %36 = zext i1 %35 to i8
  store i8 %36, i8* %movingDown, align 1
  %37 = load %struct.TreeNode** %lastVisited, align 8
  %38 = load %struct.TreeNode** %curr, align 8
  %39 = getelementptr inbounds %struct.TreeNode* %38, i32 0, i32 1
  %40 = load %struct.TreeNode** %39, align 8
  %41 = icmp eq %struct.TreeNode* %37, %40
  %42 = zext i1 %41 to i8
  store i8 %42, i8* %movingUpFromLeft, align 1
  %43 = load i8* %movingDown, align 1
  %44 = trunc i8 %43 to i1
  br i1 %44, label %45, label %77

; <label>:45                                      ; preds = %34
  %46 = load %struct.TreeNode** %curr, align 8
...
; <label>:50                                      ; preds = %45
  %51 = load %struct.TreeNode** %curr, align 8
  %52 = getelementptr inbounds %struct.TreeNode* %51, i32 0, i32 1
  %53 = load %struct.TreeNode** %52, align 8
  store %struct.TreeNode* %53, %struct.TreeNode** %curr, align 8
  br label %76

; <label>:54                                      ; preds = %101, %98, %92, %89, %70, %67, %11
  ...
  store i32 %57, i32* %6
  call void @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEED2Ev(%"class.std::map"* %parentMap) #2
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %agg.result) #2
  br label %113

; <label>:58                                      ; preds = %45
  %59 = load %struct.TreeNode** %curr, align 8
  %60 = getelementptr inbounds %struct.TreeNode* %59, i32 0, i32 2
  %61 = load %struct.TreeNode** %60, align 8
  %62 = icmp ne %struct.TreeNode* %61, null
  br i1 %62, label %63, label %67

; <label>:63                                      ; preds = %58
  %64 = load %struct.TreeNode** %curr, align 8
  %65 = getelementptr inbounds %struct.TreeNode* %64, i32 0, i32 2
  %66 = load %struct.TreeNode** %65, align 8
  store %struct.TreeNode* %66, %struct.TreeNode** %curr, align 8
  br label %75

; <label>:67                                      ; preds = %58
  %68 = load %struct.TreeNode** %curr, align 8
  %69 = getelementptr inbounds %struct.TreeNode* %68, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %69)
          to label %70 unwind label %54

; <label>:70                                      ; preds = %67
  %71 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %71, %struct.TreeNode** %lastVisited, align 8
  %72 = invoke %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %curr)
          to label %73 unwind label %54

; <label>:73                                      ; preds = %70
  %74 = load %struct.TreeNode** %72
  store %struct.TreeNode* %74, %struct.TreeNode** %curr, align 8
  br label %75
...
; <label>:77                                      ; preds = %34
  %78 = load i8* %movingUpFromLeft, align 1
  %79 = trunc i8 %78 to i1
  br i1 %79, label %80, label %98

; <label>:80                                      ; preds = %77
  %81 = load %struct.TreeNode** %curr, align 8
  %82 = getelementptr inbounds %struct.TreeNode* %81, i32 0, i32 2
  %83 = load %struct.TreeNode** %82, align 8
  %84 = icmp ne %struct.TreeNode* %83, null
  br i1 %84, label %85, label %89

; <label>:85                                      ; preds = %80
  %86 = load %struct.TreeNode** %curr, align 8
  %87 = getelementptr inbounds %struct.TreeNode* %86, i32 0, i32 2
  %88 = load %struct.TreeNode** %87, align 8
  store %struct.TreeNode* %88, %struct.TreeNode** %curr, align 8
  br label %97

; <label>:89                                      ; preds = %80
  %90 = load %struct.TreeNode** %curr, align 8
  %91 = getelementptr inbounds %struct.TreeNode* %90, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %91)
          to label %92 unwind label %54

; <label>:92                                      ; preds = %89
  %93 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %93, %struct.TreeNode** %lastVisited, align 8
  %94 = invoke %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %curr)
          to label %95 unwind label %54

; <label>:95                                      ; preds = %92
  %96 = load %struct.TreeNode** %94
  store %struct.TreeNode* %96, %struct.TreeNode** %curr, align 8
  br label %97
...
; <label>:98                                      ; preds = %77
  %99 = load %struct.TreeNode** %curr, align 8
  %100 = getelementptr inbounds %struct.TreeNode* %99, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %100)
          to label %101 unwind label %54

; <label>:101                                     ; preds = %98
  %102 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %102, %struct.TreeNode** %lastVisited, align 8
  %103 = invoke %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %parentMap, %struct.TreeNode** %curr)
          to label %104 unwind label %54

; <label>:104                                     ; preds = %101
  %105 = load %struct.TreeNode** %103
  store %struct.TreeNode* %105, %struct.TreeNode** %curr, align 8
  br label %106
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEC2Ev(%"class.std::map"* %this) unnamed_addr #5 align 2 {
  ...
  invoke void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EEC2Ev(%"class.std::_Rb_tree"* %3)
          to label %4 unwind label %5
...
define linkonce_odr void @_ZN8Solution14buildParentMapEP8TreeNodeS1_RSt3mapIS1_S1_St4lessIS1_ESaISt4pairIKS1_S1_EEE(%class.Solution* %this, %struct.TreeNode* %node, %struct.TreeNode* %parent, %"class.std::map"* %map) #3 align 2 {
  ...
  store %class.Solution* %this, %class.Solution** %1, align 8
  store %struct.TreeNode* %node, %struct.TreeNode** %2, align 8
  store %struct.TreeNode* %parent, %struct.TreeNode** %3, align 8
  store %"class.std::map"* %map, %"class.std::map"** %4, align 8
  %5 = load %class.Solution** %1
  %6 = load %struct.TreeNode** %2, align 8
...
; <label>:9                                       ; preds = %0
  ...
  %11 = load %"class.std::map"** %4, align 8
  %12 = call %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %11, %struct.TreeNode** %2)
  store %struct.TreeNode* %10, %struct.TreeNode** %12
  %13 = load %struct.TreeNode** %2, align 8
  %14 = getelementptr inbounds %struct.TreeNode* %13, i32 0, i32 1
  %15 = load %struct.TreeNode** %14, align 8
  %16 = load %struct.TreeNode** %2, align 8
  %17 = load %"class.std::map"** %4, align 8
  call void @_ZN8Solution14buildParentMapEP8TreeNodeS1_RSt3mapIS1_S1_St4lessIS1_ESaISt4pairIKS1_S1_EEE(%class.Solution* %5, %struct.TreeNode* %15, %struct.TreeNode* %16, %"class.std::map"* %17)
  %18 = load %struct.TreeNode** %2, align 8
  %19 = getelementptr inbounds %struct.TreeNode* %18, i32 0, i32 2
  %20 = load %struct.TreeNode** %19, align 8
  %21 = load %struct.TreeNode** %2, align 8
  %22 = load %"class.std::map"** %4, align 8
  call void @_ZN8Solution14buildParentMapEP8TreeNodeS1_RSt3mapIS1_S1_St4lessIS1_ESaISt4pairIKS1_S1_EEE(%class.Solution* %5, %struct.TreeNode* %20, %struct.TreeNode* %21, %"class.std::map"* %22)
  br label %23
...
define linkonce_odr %struct.TreeNode** @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEEixERS5_(%"class.std::map"* %this, %struct.TreeNode** %__k) #3 align 2 {
  ...
  %11 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEE11lower_boundERS5_(%"class.std::map"* %9, %struct.TreeNode** %10)
  ...
  %13 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEE3endEv(%"class.std::map"* %9) #2
  ...
  %15 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEeqERKS5_(%"struct.std::_Rb_tree_iterator"* %__i, %"struct.std::_Rb_tree_iterator"* %3) #2
  br i1 %15, label %21, label %16

; <label>:16                                      ; preds = %0
  call void @_ZNKSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEE8key_compEv(%"class.std::map"* %9)
  %17 = load %struct.TreeNode*** %2, align 8
  %18 = call %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEdeEv(%"struct.std::_Rb_tree_iterator"* %__i) #2
...
; <label>:21                                      ; preds = %16, %0
  ...
  call void @_ZNSt23_Rb_tree_const_iteratorISt4pairIKP8TreeNodeS2_EEC2ERKSt17_Rb_tree_iteratorIS4_E(%"struct.std::_Rb_tree_const_iterator"* %6, %"struct.std::_Rb_tree_iterator"* %__i) #2
...
; <label>:30                                      ; preds = %21, %16
  %31 = call %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEdeEv(%"struct.std::_Rb_tree_iterator"* %__i) #2
  %32 = getelementptr inbounds %"struct.std::pair"* %31, i32 0, i32 1
  ret %struct.TreeNode** %32
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEED2Ev(%"class.std::map"* %this) unnamed_addr #9 align 2 {
  %1 = alloca %"class.std::map"*, align 8
  store %"class.std::map"* %this, %"class.std::map"** %1, align 8
  %2 = load %"class.std::map"** %1
  %3 = getelementptr inbounds %"class.std::map"* %2, i32 0, i32 0
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EED2Ev(%"class.std::_Rb_tree"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EED2Ev(%"class.std::_Rb_tree"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  %2 = alloca i8*
  %3 = alloca i32
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %4 = load %"class.std::_Rb_tree"** %1
  %5 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_beginEv(%"class.std::_Rb_tree"* %4) #2
  invoke void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %4, %"struct.std::_Rb_tree_node"* %5)
          to label %6 unwind label %8

; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds %"class.std::_Rb_tree"* %4, i32 0, i32 0
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EED2Ev(%"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %7) #2
  ret void
...
; <label>:8                                       ; preds = %0
  ...
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EED2Ev(%"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %12) #2
  br label %13
...
; <label>:7                                       ; preds = %4
  ...
  %10 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %9) #2
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %3, %"struct.std::_Rb_tree_node"* %10)
  %11 = load %"struct.std::_Rb_tree_node"** %2, align 8
  %12 = bitcast %"struct.std::_Rb_tree_node"* %11 to %"struct.std::_Rb_tree_node_base"*
  %13 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %12) #2
  store %"struct.std::_Rb_tree_node"* %13, %"struct.std::_Rb_tree_node"** %__y, align 8
  %14 = load %"struct.std::_Rb_tree_node"** %2, align 8
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %3, %"struct.std::_Rb_tree_node"* %14) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_beginEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %3, i32 0, i32 1
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EED2Ev(%"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %this) unnamed_addr #9 align 2 {
  %1 = alloca %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"*, align 8
  ...
  %2 = load %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"** %1
  %3 = bitcast %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %2 to %"class.std::allocator.4"*
  call void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EEED2Ev(%"class.std::allocator.4"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EEED2Ev(%"class.std::allocator.4"* %this) unnamed_addr #5 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEED2Ev(%"class.__gnu_cxx::new_allocator.5"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEED2Ev(%"class.__gnu_cxx::new_allocator.5"* %this) unnamed_addr #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %1, align 8
  %2 = load %"struct.std::_Rb_tree_node_base"** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__p) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  %2 = alloca %"struct.std::_Rb_tree_node"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  ...
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %3, %"struct.std::_Rb_tree_node"* %4) #2
  %5 = load %"struct.std::_Rb_tree_node"** %2, align 8
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %3, %"struct.std::_Rb_tree_node"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE15_M_destroy_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__p) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  %2 = alloca %"struct.std::_Rb_tree_node"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  store %"struct.std::_Rb_tree_node"* %__p, %"struct.std::_Rb_tree_node"** %2, align 8
  %3 = load %"class.std::_Rb_tree"** %1
  %4 = call %"class.std::allocator.4"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %3) #2
  %5 = load %"struct.std::_Rb_tree_node"** %2, align 8
  %6 = invoke %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %5)
          to label %7 unwind label %10

; <label>:7                                       ; preds = %0
  invoke void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEE7destroyIS5_EEvRS7_PT_(%"class.std::allocator.4"* %4, %"struct.std::pair"* %6)
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_put_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__p) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  %2 = alloca %"struct.std::_Rb_tree_node"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  store %"struct.std::_Rb_tree_node"* %__p, %"struct.std::_Rb_tree_node"** %2, align 8
  ...
  %4 = call %"class.std::allocator.4"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %3) #2
  %5 = load %"struct.std::_Rb_tree_node"** %2, align 8
  invoke void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEE10deallocateERS7_PS6_m(%"class.std::allocator.4"* %4, %"struct.std::_Rb_tree_node"* %5, i64 1)
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEE10deallocateERS7_PS6_m(%"class.std::allocator.4"* %__a, %"struct.std::_Rb_tree_node"* %__p, i64 %__n) #3 align 2 {
  ...
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE10deallocateEPS7_m(%"class.__gnu_cxx::new_allocator.5"* %5, %"struct.std::_Rb_tree_node"* %6, i64 %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.4"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  %4 = bitcast %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %3 to %"class.std::allocator.4"*
  ret %"class.std::allocator.4"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE10deallocateEPS7_m(%"class.__gnu_cxx::new_allocator.5"* %this, %"struct.std::_Rb_tree_node"* %__p, i64) #5 align 2 {
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEE7destroyIS5_EEvRS7_PT_(%"class.std::allocator.4"* %__a, %"struct.std::pair"* %__p) #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE7destroyIS6_EEvPT_(%"class.__gnu_cxx::new_allocator.5"* %4, %"struct.std::pair"* %5)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %this) #5 align 2 {
  ...
  %4 = call %"struct.std::pair"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKP8TreeNodeS3_EE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %3) #2
  ret %"struct.std::pair"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKP8TreeNodeS3_EE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %this) #5 align 2 {
  ...
  %3 = call i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKP8TreeNodeS3_EE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* %2) #2
  %4 = bitcast i8* %3 to %"struct.std::pair"*
  ret %"struct.std::pair"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr i8* @_ZN9__gnu_cxx16__aligned_membufISt4pairIKP8TreeNodeS3_EE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* %this) #5 align 2 {
  %1 = alloca %"struct.__gnu_cxx::__aligned_membuf"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf"* %this, %"struct.__gnu_cxx::__aligned_membuf"** %1, align 8
  %2 = load %"struct.__gnu_cxx::__aligned_membuf"** %1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE7destroyIS6_EEvPT_(%"class.__gnu_cxx::new_allocator.5"* %this, %"struct.std::pair"* %__p) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  %2 = alloca %"struct.std::pair"*, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %1, align 8
  store %"struct.std::pair"* %__p, %"struct.std::pair"** %2, align 8
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEE11lower_boundERS5_(%"class.std::map"* %this, %struct.TreeNode** %__x) #3 align 2 {
  ...
  %7 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11lower_boundERS3_(%"class.std::_Rb_tree"* %5, %struct.TreeNode** %6)
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEeqERKS5_(%"struct.std::_Rb_tree_iterator"* %this, %"struct.std::_Rb_tree_iterator"* %__x) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEE3endEv(%"class.std::map"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %2 = alloca %"class.std::map"*, align 8
  store %"class.std::map"* %this, %"class.std::map"** %2, align 8
  %3 = load %"class.std::map"** %2
  %4 = getelementptr inbounds %"class.std::map"* %3, i32 0, i32 0
  %5 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE3endEv(%"class.std::_Rb_tree"* %4) #2
...
define linkonce_odr void @_ZNKSt3mapIP8TreeNodeS1_St4lessIS1_ESaISt4pairIKS1_S1_EEE8key_compEv(%"class.std::map"* %this) #3 align 2 {
  ...
  %4 = load %"class.std::map"** %2
  %5 = getelementptr inbounds %"class.std::map"* %4, i32 0, i32 0
  call void @_ZNKSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8key_compEv(%"class.std::_Rb_tree"* %5)
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEdeEv(%"struct.std::_Rb_tree_iterator"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator"*, align 8
  store %"struct.std::_Rb_tree_iterator"* %this, %"struct.std::_Rb_tree_iterator"** %1, align 8
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE22_M_emplace_hint_uniqueIJRKSt21piecewise_construct_tSt5tupleIJRS3_EESF_IJEEEEESt17_Rb_tree_iteratorIS4_ESt23_Rb_tree_const_iteratorIS4_EDpOT_(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node_base"* %__pos.coerce, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.7"* %__args2) #3 align 2 {
  ...
  store %"class.std::tuple.7"* %__args2, %"class.std::tuple.7"** %5, align 8
  ...
  %13 = load %"class.std::tuple.7"** %5, align 8
  %14 = call %"class.std::tuple.7"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.7"* %13) #2
  %15 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE14_M_create_nodeIJRKSt21piecewise_construct_tSt5tupleIJRS3_EESF_IJEEEEEPSt13_Rb_tree_nodeIS4_EDpOT_(%"class.std::_Rb_tree"* %8, %"struct.std::piecewise_construct_t"* %10, %"class.std::tuple"* %12, %"class.std::tuple.7"* %14)
  ...
  %19 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt13_Rb_tree_nodeIS4_E(%"struct.std::_Rb_tree_node"* %18)
  %20 = getelementptr %"struct.std::_Rb_tree_const_iterator"* %6, i32 0, i32 0
  %21 = load %"struct.std::_Rb_tree_node_base"** %20
  %22 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE29_M_get_insert_hint_unique_posESt23_Rb_tree_const_iteratorIS4_ERS3_(%"class.std::_Rb_tree"* %8, %"struct.std::_Rb_tree_node_base"* %21, %struct.TreeNode** %19)
  %23 = bitcast %"struct.std::pair.8"* %__res to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
  ...
  %28 = getelementptr inbounds %"struct.std::pair.8"* %__res, i32 0, i32 1
  %29 = load %"struct.std::_Rb_tree_node_base"** %28, align 8
  %30 = icmp ne %"struct.std::_Rb_tree_node_base"* %29, null
  br i1 %30, label %31, label %39

; <label>:31                                      ; preds = %0
  %32 = getelementptr inbounds %"struct.std::pair.8"* %__res, i32 0, i32 0
  %33 = load %"struct.std::_Rb_tree_node_base"** %32, align 8
  %34 = getelementptr inbounds %"struct.std::pair.8"* %__res, i32 0, i32 1
  %35 = load %"struct.std::_Rb_tree_node_base"** %34, align 8
  %36 = load %"struct.std::_Rb_tree_node"** %__z, align 8
  %37 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE14_M_insert_nodeEPSt18_Rb_tree_node_baseSC_PSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %8, %"struct.std::_Rb_tree_node_base"* %33, %"struct.std::_Rb_tree_node_base"* %35, %"struct.std::_Rb_tree_node"* %36)
...
; <label>:39                                      ; preds = %0
  ...
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS4_E(%"class.std::_Rb_tree"* %8, %"struct.std::_Rb_tree_node"* %40) #2
  %41 = getelementptr inbounds %"struct.std::pair.8"* %__res, i32 0, i32 0
  ...
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %44) #2
  br label %45
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt23_Rb_tree_const_iteratorISt4pairIKP8TreeNodeS2_EEC2ERKSt17_Rb_tree_iteratorIS4_E(%"struct.std::_Rb_tree_const_iterator"* %this, %"struct.std::_Rb_tree_iterator"* %__it) unnamed_addr #5 align 2 {
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE14_M_create_nodeIJRKSt21piecewise_construct_tSt5tupleIJRS3_EESF_IJEEEEEPSt13_Rb_tree_nodeIS4_EDpOT_(%"class.std::_Rb_tree"* %this, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.7"* %__args2) #3 align 2 {
  ...
  store %"class.std::tuple.7"* %__args2, %"class.std::tuple.7"** %4, align 8
  %5 = load %"class.std::_Rb_tree"** %1
  %6 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_get_nodeEv(%"class.std::_Rb_tree"* %5)
  ...
  %12 = load %"class.std::tuple.7"** %4, align 8
  %13 = call %"class.std::tuple.7"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.7"* %12) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::tuple.7"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.7"* %__t) #5 {
  %1 = alloca %"class.std::tuple.7"*, align 8
  store %"class.std::tuple.7"* %__t, %"class.std::tuple.7"** %1, align 8
  %2 = load %"class.std::tuple.7"** %1, align 8
  ret %"class.std::tuple.7"* %2
}
...
define linkonce_odr { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE29_M_get_insert_hint_unique_posESt23_Rb_tree_const_iteratorIS4_ERS3_(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node_base"* %__position.coerce, %struct.TreeNode** %__k) #3 align 2 {
  ...
  %11 = call %"struct.std::_Rb_tree_node_base"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIKP8TreeNodeS2_EE13_M_const_castEv(%"struct.std::_Rb_tree_const_iterator"* %__position) #2
  ...
  %15 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_M_endEv(%"class.std::_Rb_tree"* %10) #2
...
; <label>:18                                      ; preds = %0
  %19 = call i64 @_ZNKSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE4sizeEv(%"class.std::_Rb_tree"* %10) #2
  %20 = icmp ugt i64 %19, 0
  br i1 %20, label %21, label %31

; <label>:21                                      ; preds = %18
  %22 = getelementptr inbounds %"class.std::_Rb_tree"* %10, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %22, i32 0, i32 0
  %24 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %10) #2
  %25 = load %"struct.std::_Rb_tree_node_base"** %24
  %26 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %25)
...
; <label>:29                                      ; preds = %21
  ...
  %30 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %10) #2
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_vEERKS1_OT_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node_base"** %4, %"struct.std::_Rb_tree_node_base"** %30)
  br label %132

; <label>:31                                      ; preds = %21, %18
  %32 = load %struct.TreeNode*** %3, align 8
  %33 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE24_M_get_insert_unique_posERS3_(%"class.std::_Rb_tree"* %10, %struct.TreeNode** %32)
  %34 = bitcast %"struct.std::pair.8"* %1 to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
; <label>:39                                      ; preds = %0
  ...
  %41 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %40, i32 0, i32 0
  ...
  %45 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %44)
...
; <label>:47                                      ; preds = %39
  ...
  %52 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_leftmostEv(%"class.std::_Rb_tree"* %10) #2
  %53 = load %"struct.std::_Rb_tree_node_base"** %52
  %54 = icmp eq %"struct.std::_Rb_tree_node_base"* %51, %53
  br i1 %54, label %55, label %58

; <label>:55                                      ; preds = %47
  %56 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_leftmostEv(%"class.std::_Rb_tree"* %10) #2
  %57 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_leftmostEv(%"class.std::_Rb_tree"* %10) #2
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_S4_vEEOT_OT0_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node_base"** %56, %"struct.std::_Rb_tree_node_base"** %57)
  br label %132

; <label>:58                                      ; preds = %47
  %59 = getelementptr inbounds %"class.std::_Rb_tree"* %10, i32 0, i32 0
  %60 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %59, i32 0, i32 0
  %61 = call %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEmmEv(%"struct.std::_Rb_tree_iterator"* %__before) #2
  %62 = getelementptr inbounds %"struct.std::_Rb_tree_iterator"* %61, i32 0, i32 0
  %63 = load %"struct.std::_Rb_tree_node_base"** %62, align 8
  %64 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %63)
...
; <label>:67                                      ; preds = %58
  ...
  %70 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %69) #2
...
; <label>:72                                      ; preds = %67
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_vEERKS1_OT_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node_base"** %5, %"struct.std::_Rb_tree_node_base"** %73)
  br label %132
...
; <label>:74                                      ; preds = %67
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_S4_vEEOT_OT0_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node_base"** %75, %"struct.std::_Rb_tree_node_base"** %76)
  br label %132

; <label>:77                                      ; preds = %58
  %78 = load %struct.TreeNode*** %3, align 8
  %79 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE24_M_get_insert_unique_posERS3_(%"class.std::_Rb_tree"* %10, %struct.TreeNode** %78)
  %80 = bitcast %"struct.std::pair.8"* %1 to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
; <label>:85                                      ; preds = %39
  ...
  %87 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %86, i32 0, i32 0
  %88 = getelementptr inbounds %"struct.std::_Rb_tree_iterator"* %__pos, i32 0, i32 0
  %89 = load %"struct.std::_Rb_tree_node_base"** %88, align 8
  %90 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %89)
...
; <label>:93                                      ; preds = %85
  ...
  %98 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %10) #2
...
; <label>:101                                     ; preds = %93
  ...
  %102 = call %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %10) #2
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_vEERKS1_OT_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node_base"** %6, %"struct.std::_Rb_tree_node_base"** %102)
  br label %132

; <label>:103                                     ; preds = %93
  %104 = getelementptr inbounds %"class.std::_Rb_tree"* %10, i32 0, i32 0
  %105 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %104, i32 0, i32 0
  %106 = load %struct.TreeNode*** %3, align 8
  %107 = call %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEppEv(%"struct.std::_Rb_tree_iterator"* %__after) #2
  ...
  %110 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %109)
...
; <label>:112                                     ; preds = %103
  ...
  %115 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %114) #2
...
; <label>:117                                     ; preds = %112
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_vEERKS1_OT_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node_base"** %7, %"struct.std::_Rb_tree_node_base"** %118)
  br label %132
...
; <label>:119                                     ; preds = %112
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_S4_vEEOT_OT0_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node_base"** %120, %"struct.std::_Rb_tree_node_base"** %121)
  br label %132

; <label>:122                                     ; preds = %103
  %123 = load %struct.TreeNode*** %3, align 8
  %124 = call { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE24_M_get_insert_unique_posERS3_(%"class.std::_Rb_tree"* %10, %struct.TreeNode** %123)
  %125 = bitcast %"struct.std::pair.8"* %1 to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
; <label>:130                                     ; preds = %85
  ...
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_vEEOT_RKS1_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node_base"** %131, %"struct.std::_Rb_tree_node_base"** %8)
  br label %132

; <label>:132                                     ; preds = %130, %122, %119, %117, %101, %77, %74, %72, %55, %31, %29
  %133 = bitcast %"struct.std::pair.8"* %1 to { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* }*
...
define linkonce_odr %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt13_Rb_tree_nodeIS4_E(%"struct.std::_Rb_tree_node"* %__x) #3 align 2 {
  ...
  %4 = call %"struct.std::pair"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_valueEPKSt13_Rb_tree_nodeIS4_E(%"struct.std::_Rb_tree_node"* %3)
  %5 = call %struct.TreeNode** @_ZNKSt10_Select1stISt4pairIKP8TreeNodeS2_EEclERKS4_(%"struct.std::_Select1st"* %2, %"struct.std::pair"* %4)
...
; <label>:9                                       ; preds = %0
  ...
  %11 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_M_endEv(%"class.std::_Rb_tree"* %6) #2
  %12 = bitcast %"struct.std::_Rb_tree_node"* %11 to %"struct.std::_Rb_tree_node_base"*
...
; <label>:14                                      ; preds = %9
  ...
  %16 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %15, i32 0, i32 0
  %17 = load %"struct.std::_Rb_tree_node"** %5, align 8
  %18 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt13_Rb_tree_nodeIS4_E(%"struct.std::_Rb_tree_node"* %17)
  %19 = load %"struct.std::_Rb_tree_node_base"** %4, align 8
  %20 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %19)
...
; <label>:22                                      ; preds = %14, %9, %0
  ...
  %31 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %30, i32 0, i32 1
  ...
  %33 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %32, i32 0, i32 2
  %34 = load i64* %33, align 8
  %35 = add i64 %34, 1
  store i64 %35, i64* %33, align 8
  %36 = load %"struct.std::_Rb_tree_node"** %5, align 8
  %37 = bitcast %"struct.std::_Rb_tree_node"* %36 to %"struct.std::_Rb_tree_node_base"*
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %37) #2
  %38 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %this, %"struct.std::_Rb_tree_node_base"* %__x) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_M_endEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
...
define linkonce_odr %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #3 align 2 {
  ...
  %4 = call %"struct.std::pair"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_valueEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %3)
  %5 = call %struct.TreeNode** @_ZNKSt10_Select1stISt4pairIKP8TreeNodeS2_EEclERKS4_(%"struct.std::_Select1st"* %2, %"struct.std::pair"* %4)
  ret %struct.TreeNode** %5
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr %struct.TreeNode** @_ZNKSt10_Select1stISt4pairIKP8TreeNodeS2_EEclERKS4_(%"struct.std::_Select1st"* %this, %"struct.std::pair"* %__x) #5 align 2 {
...
define linkonce_odr %"struct.std::pair"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_valueEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #3 align 2 {
  ...
  %4 = call %"struct.std::pair"* @_ZNKSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %3)
  ret %"struct.std::pair"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNKSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_node"*, align 8
  store %"struct.std::_Rb_tree_node"* %this, %"struct.std::_Rb_tree_node"** %1, align 8
  %2 = load %"struct.std::_Rb_tree_node"** %1
  %3 = getelementptr inbounds %"struct.std::_Rb_tree_node"* %2, i32 0, i32 1
  %4 = call %"struct.std::pair"* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKP8TreeNodeS3_EE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %3) #2
  ret %"struct.std::pair"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKP8TreeNodeS3_EE6_M_ptrEv(%"struct.__gnu_cxx::__aligned_membuf"* %this) #5 align 2 {
  %1 = alloca %"struct.__gnu_cxx::__aligned_membuf"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf"* %this, %"struct.__gnu_cxx::__aligned_membuf"** %1, align 8
  %2 = load %"struct.__gnu_cxx::__aligned_membuf"** %1
  %3 = call i8* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKP8TreeNodeS3_EE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* %2) #2
  %4 = bitcast i8* %3 to %"struct.std::pair"*
  ret %"struct.std::pair"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr i8* @_ZNK9__gnu_cxx16__aligned_membufISt4pairIKP8TreeNodeS3_EE7_M_addrEv(%"struct.__gnu_cxx::__aligned_membuf"* %this) #5 align 2 {
  %1 = alloca %"struct.__gnu_cxx::__aligned_membuf"*, align 8
  store %"struct.__gnu_cxx::__aligned_membuf"* %this, %"struct.__gnu_cxx::__aligned_membuf"** %1, align 8
  %2 = load %"struct.__gnu_cxx::__aligned_membuf"** %1
  %3 = getelementptr inbounds %"struct.__gnu_cxx::__aligned_membuf"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_valueEPKSt13_Rb_tree_nodeIS4_E(%"struct.std::_Rb_tree_node"* %__x) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_node"*, align 8
  store %"struct.std::_Rb_tree_node"* %__x, %"struct.std::_Rb_tree_node"** %1, align 8
  %2 = load %"struct.std::_Rb_tree_node"** %1, align 8
  %3 = call %"struct.std::pair"* @_ZNKSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %2)
  ret %"struct.std::pair"* %3
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNKSt23_Rb_tree_const_iteratorISt4pairIKP8TreeNodeS2_EE13_M_const_castEv(%"struct.std::_Rb_tree_const_iterator"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator", align 8
  ...
  %4 = getelementptr inbounds %"struct.std::_Rb_tree_const_iterator"* %3, i32 0, i32 0
  %5 = load %"struct.std::_Rb_tree_node_base"** %4, align 8
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %5) #2
  %6 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNKSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE4sizeEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %3, i32 0, i32 2
  %5 = load i64* %4, align 8
  ret i64 %5
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE12_M_rightmostEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_vEERKS1_OT_(%"struct.std::pair.8"* %this, %"struct.std::_Rb_tree_node_base"** %__x, %"struct.std::_Rb_tree_node_base"** %__y) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::pair.8"*, align 8
  %2 = alloca %"struct.std::_Rb_tree_node_base"**, align 8
  %3 = alloca %"struct.std::_Rb_tree_node_base"**, align 8
  ...
  %8 = getelementptr inbounds %"struct.std::pair.8"* %4, i32 0, i32 1
...
define linkonce_odr { %"struct.std::_Rb_tree_node_base"*, %"struct.std::_Rb_tree_node_base"* } @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE24_M_get_insert_unique_posERS3_(%"class.std::_Rb_tree"* %this, %struct.TreeNode** %__k) #3 align 2 {
  ...
  store %struct.TreeNode** %__k, %struct.TreeNode*** %3, align 8
  %6 = load %"class.std::_Rb_tree"** %2
  %7 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_beginEv(%"class.std::_Rb_tree"* %6) #2
  store %"struct.std::_Rb_tree_node"* %7, %"struct.std::_Rb_tree_node"** %__x, align 8
  %8 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_M_endEv(%"class.std::_Rb_tree"* %6) #2
...
; <label>:12                                      ; preds = %9
  ...
  %15 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %14, i32 0, i32 0
...
; <label>:23                                      ; preds = %12
  ...
  %26 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %25) #2
  br label %31

; <label>:27                                      ; preds = %12
  %28 = load %"struct.std::_Rb_tree_node"** %__x, align 8
  %29 = bitcast %"struct.std::_Rb_tree_node"* %28 to %"struct.std::_Rb_tree_node_base"*
  %30 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %29) #2
  br label %31
...
; <label>:33                                      ; preds = %9
  ...
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %__j, %"struct.std::_Rb_tree_node_base"* %35) #2
  %36 = load i8* %__comp, align 1
  %37 = trunc i8 %36 to i1
  br i1 %37, label %38, label %46

; <label>:38                                      ; preds = %33
  %39 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE5beginEv(%"class.std::_Rb_tree"* %6) #2
  ...
  %41 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEeqERKS5_(%"struct.std::_Rb_tree_iterator"* %__j, %"struct.std::_Rb_tree_iterator"* %4) #2
  br i1 %41, label %42, label %43

; <label>:42                                      ; preds = %38
  call void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKP8TreeNodeS6_EESB_vEEOT_OT0_(%"struct.std::pair.8"* %1, %"struct.std::_Rb_tree_node"** %__x, %"struct.std::_Rb_tree_node"** %__y)
  br label %57

; <label>:43                                      ; preds = %38
  %44 = call %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEmmEv(%"struct.std::_Rb_tree_iterator"* %__j) #2
  br label %45
...
; <label>:46                                      ; preds = %45, %33
  ...
  %48 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %47, i32 0, i32 0
  %49 = getelementptr inbounds %"struct.std::_Rb_tree_iterator"* %__j, i32 0, i32 0
  %50 = load %"struct.std::_Rb_tree_node_base"** %49, align 8
  %51 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %50)
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_leftmostEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_S4_vEEOT_OT0_(%"struct.std::pair.8"* %this, %"struct.std::_Rb_tree_node_base"** %__x, %"struct.std::_Rb_tree_node_base"** %__y) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::pair.8"*, align 8
  %2 = alloca %"struct.std::_Rb_tree_node_base"**, align 8
  %3 = alloca %"struct.std::_Rb_tree_node_base"**, align 8
  store %"struct.std::pair.8"* %this, %"struct.std::pair.8"** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEmmEv(%"struct.std::_Rb_tree_iterator"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator"*, align 8
  store %"struct.std::_Rb_tree_iterator"* %this, %"struct.std::_Rb_tree_iterator"** %1, align 8
  %2 = load %"struct.std::_Rb_tree_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Rb_tree_iterator"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEppEv(%"struct.std::_Rb_tree_iterator"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator"*, align 8
  store %"struct.std::_Rb_tree_iterator"* %this, %"struct.std::_Rb_tree_iterator"** %1, align 8
  %2 = load %"struct.std::_Rb_tree_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Rb_tree_iterator"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRS1_vEEOT_RKS1_(%"struct.std::pair.8"* %this, %"struct.std::_Rb_tree_node_base"** %__x, %"struct.std::_Rb_tree_node_base"** %__y) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::pair.8"*, align 8
  %2 = alloca %"struct.std::_Rb_tree_node_base"**, align 8
  %3 = alloca %"struct.std::_Rb_tree_node_base"**, align 8
  store %"struct.std::pair.8"* %this, %"struct.std::pair.8"** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE5beginEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %2 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %2, align 8
  %3 = load %"class.std::_Rb_tree"** %2
  %4 = getelementptr inbounds %"class.std::_Rb_tree"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %4, i32 0, i32 1
  %6 = getelementptr inbounds %"struct.std::_Rb_tree_node_base"* %5, i32 0, i32 2
  %7 = load %"struct.std::_Rb_tree_node_base"** %6, align 8
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %7) #2
  %8 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt4pairIPSt18_Rb_tree_node_baseS1_EC2IRPSt13_Rb_tree_nodeIS_IKP8TreeNodeS6_EESB_vEEOT_OT0_(%"struct.std::pair.8"* %this, %"struct.std::_Rb_tree_node"** %__x, %"struct.std::_Rb_tree_node"** %__y) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::pair.8"*, align 8
  %2 = alloca %"struct.std::_Rb_tree_node"**, align 8
  %3 = alloca %"struct.std::_Rb_tree_node"**, align 8
  store %"struct.std::pair.8"* %this, %"struct.std::pair.8"** %1, align 8
  ...
  %5 = getelementptr inbounds %"struct.std::pair.8"* %4, i32 0, i32 0
  %6 = load %"struct.std::_Rb_tree_node"*** %2, align 8
  %7 = call %"struct.std::_Rb_tree_node"** @_ZSt7forwardIRPSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEOT_RNSt16remove_referenceIS9_E4typeE(%"struct.std::_Rb_tree_node"** %6) #2
  ...
  %12 = call %"struct.std::_Rb_tree_node"** @_ZSt7forwardIRPSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEOT_RNSt16remove_referenceIS9_E4typeE(%"struct.std::_Rb_tree_node"** %11) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"** @_ZSt7forwardIRPSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEOT_RNSt16remove_referenceIS9_E4typeE(%"struct.std::_Rb_tree_node"** %__t) #5 {
  %1 = alloca %"struct.std::_Rb_tree_node"**, align 8
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11_M_get_nodeEv(%"class.std::_Rb_tree"* %this) #3 align 2 {
  ...
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %1, align 8
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = call %"class.std::allocator.4"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %2) #2
  %4 = call %"struct.std::_Rb_tree_node"* @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEE8allocateERS7_m(%"class.std::allocator.4"* %3, i64 1)
...
; <label>:12                                      ; preds = %10, %0
  ...
  %14 = call %"class.std::allocator.4"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE21_M_get_Node_allocatorEv(%"class.std::_Rb_tree"* %6) #2
  %15 = load %"struct.std::_Rb_tree_node"** %2, align 8
  %16 = call %"struct.std::pair"* @_ZNSt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EE9_M_valptrEv(%"struct.std::_Rb_tree_node"* %15)
  ...
  %21 = load %"class.std::tuple.7"** %5, align 8
  %22 = call %"class.std::tuple.7"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.7"* %21) #2
  call void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESD_IJEEEEEvRS7_PT_DpOT0_(%"class.std::allocator.4"* %14, %"struct.std::pair"* %16, %"struct.std::piecewise_construct_t"* %18, %"class.std::tuple"* %20, %"class.std::tuple.7"* %22)
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEE9constructIS5_JRKSt21piecewise_construct_tSt5tupleIJRS4_EESD_IJEEEEEvRS7_PT_DpOT0_(%"class.std::allocator.4"* %__a, %"struct.std::pair"* %__p, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.7"* %__args2) #3 align 2 {
  ...
  store %"class.std::tuple"* %__args1, %"class.std::tuple"** %4, align 8
  store %"class.std::tuple.7"* %__args2, %"class.std::tuple.7"** %5, align 8
  %6 = load %"class.std::allocator.4"** %1, align 8
  %7 = bitcast %"class.std::allocator.4"* %6 to %"class.__gnu_cxx::new_allocator.5"*
  ...
  %13 = load %"class.std::tuple.7"** %5, align 8
  %14 = call %"class.std::tuple.7"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.7"* %13) #2
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE9constructIS6_JRKSt21piecewise_construct_tSt5tupleIJRS5_EESD_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.5"* %7, %"struct.std::pair"* %8, %"struct.std::piecewise_construct_t"* %10, %"class.std::tuple"* %12, %"class.std::tuple.7"* %14)
  ret void
}
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE9constructIS6_JRKSt21piecewise_construct_tSt5tupleIJRS5_EESD_IJEEEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.5"* %this, %"struct.std::pair"* %__p, %"struct.std::piecewise_construct_t"* %__args, %"class.std::tuple"* %__args1, %"class.std::tuple.7"* %__args2) #3 align 2 {
  ...
  store %"class.std::tuple"* %__args1, %"class.std::tuple"** %4, align 8
  store %"class.std::tuple.7"* %__args2, %"class.std::tuple.7"** %5, align 8
  %9 = load %"class.__gnu_cxx::new_allocator.5"** %1
...
; <label>:13                                      ; preds = %0
  ...
  %19 = load %"class.std::tuple.7"** %5, align 8
  %20 = call %"class.std::tuple.7"* @_ZSt7forwardISt5tupleIJEEEOT_RNSt16remove_referenceIS2_E4typeE(%"class.std::tuple.7"* %19) #2
  ...
  call void @_ZNSt4pairIKP8TreeNodeS1_EC2IJRS2_EJEEESt21piecewise_construct_tSt5tupleIJDpT_EES7_IJDpT0_EE(%"struct.std::pair"* %14, %struct.TreeNode** %24)
  br label %25
...
define linkonce_odr void @_ZNSt4pairIKP8TreeNodeS1_EC2IJRS2_EJEEESt21piecewise_construct_tSt5tupleIJDpT_EES7_IJDpT0_EE(%"struct.std::pair"* %this, %struct.TreeNode** %__first.coerce) unnamed_addr #3 align 2 {
  ...
  %4 = alloca %"struct.std::_Index_tuple.9", align 1
  ...
  call void @_ZNSt4pairIKP8TreeNodeS1_EC2IJRS2_EJLm0EEJEJEEERSt5tupleIJDpT_EERS6_IJDpT1_EESt12_Index_tupleIJXspT0_EEESF_IJXspT2_EEE(%"struct.std::pair"* %8, %"class.std::tuple"* %__first, %"class.std::tuple.7"* %__second)
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt4pairIKP8TreeNodeS1_EC2IJRS2_EJLm0EEJEJEEERSt5tupleIJDpT_EERS6_IJDpT1_EESt12_Index_tupleIJXspT0_EEESF_IJXspT2_EEE(%"struct.std::pair"* %this, %"class.std::tuple"* %__tuple1, %"class.std::tuple.7"* %__tuple2) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::pair"*, align 8
  %2 = alloca %"class.std::tuple"*, align 8
  ...
  store %"class.std::tuple.7"* %__tuple2, %"class.std::tuple.7"** %3, align 8
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt16allocator_traitsISaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS3_EEEE8allocateERS7_m(%"class.std::allocator.4"* %__a, i64 %__n) #3 align 2 {
  ...
  %4 = bitcast %"class.std::allocator.4"* %3 to %"class.__gnu_cxx::new_allocator.5"*
  %5 = load i64* %2, align 8
  %6 = call %"struct.std::_Rb_tree_node"* @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.5"* %4, i64 %5, i8* null)
...
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.5"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.5"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.5"* %5) #2
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.5"* %this) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.5"** %1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNKSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8key_compEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"struct.std::less", align 1
  %2 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %2, align 8
  %3 = load %"class.std::_Rb_tree"** %2
  %4 = getelementptr inbounds %"class.std::_Rb_tree"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %4, i32 0, i32 0
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE3endEv(%"class.std::_Rb_tree"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree_iterator", align 8
  %2 = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %2, align 8
  %3 = load %"class.std::_Rb_tree"** %2
...
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE11lower_boundERS3_(%"class.std::_Rb_tree"* %this, %struct.TreeNode** %__k) #3 align 2 {
  ...
  %5 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_M_beginEv(%"class.std::_Rb_tree"* %4) #2
  %6 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_M_endEv(%"class.std::_Rb_tree"* %4) #2
  %7 = load %struct.TreeNode*** %3, align 8
  %8 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS4_ESD_RS3_(%"class.std::_Rb_tree"* %4, %"struct.std::_Rb_tree_node"* %5, %"struct.std::_Rb_tree_node"* %6, %struct.TreeNode** %7)
  %9 = getelementptr %"struct.std::_Rb_tree_iterator"* %1, i32 0, i32 0
...
; <label>:10                                      ; preds = %7
  ...
  %12 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %11, i32 0, i32 0
  %13 = load %"struct.std::_Rb_tree_node"** %3, align 8
  %14 = call %struct.TreeNode** @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE6_S_keyEPKSt13_Rb_tree_nodeIS4_E(%"struct.std::_Rb_tree_node"* %13)
...
; <label>:17                                      ; preds = %10
  ...
  %21 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE7_S_leftEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %20) #2
...
; <label>:22                                      ; preds = %10
  ...
  %25 = call %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE8_S_rightEPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %24) #2
...
; <label>:27                                      ; preds = %7
  ...
  %29 = bitcast %"struct.std::_Rb_tree_node"* %28 to %"struct.std::_Rb_tree_node_base"*
  call void @_ZNSt17_Rb_tree_iteratorISt4pairIKP8TreeNodeS2_EEC2EPSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_iterator"* %1, %"struct.std::_Rb_tree_node_base"* %29) #2
...
define linkonce_odr void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EEC2Ev(%"class.std::_Rb_tree"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::_Rb_tree"** %1
  %3 = getelementptr inbounds %"class.std::_Rb_tree"* %2, i32 0, i32 0
  call void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EEC2Ev(%"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %3)
  ret void
}
...
define linkonce_odr void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EEC2Ev(%"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %this) unnamed_addr #3 align 2 {
  ...
  %3 = alloca i32
  store %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %this, %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"** %1, align 8
  %4 = load %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"** %1
  %5 = bitcast %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %4 to %"class.std::allocator.4"*
  call void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EEEC2Ev(%"class.std::allocator.4"* %5) #2
  %6 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %4, i32 0, i32 0
  %7 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %4, i32 0, i32 1
  %8 = bitcast %"struct.std::_Rb_tree_node_base"* %7 to i8*
  call void @llvm.memset.p0i8.i64(i8* %8, i8 0, i64 32, i32 8, i1 false)
  %9 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %4, i32 0, i32 2
  store i64 0, i64* %9, align 8
  invoke void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EE13_M_initializeEv(%"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %4)
...
; <label>:11                                      ; preds = %0
  ...
  store i32 %14, i32* %3
  %15 = bitcast %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %4 to %"class.std::allocator.4"*
  call void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EEED2Ev(%"class.std::allocator.4"* %15) #2
  br label %16
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS2_EEEC2Ev(%"class.std::allocator.4"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::allocator.4"*, align 8
  store %"class.std::allocator.4"* %this, %"class.std::allocator.4"** %1, align 8
  %2 = load %"class.std::allocator.4"** %1
  %3 = bitcast %"class.std::allocator.4"* %2 to %"class.__gnu_cxx::new_allocator.5"*
  call void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEEC2Ev(%"class.__gnu_cxx::new_allocator.5"* %3) #2
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt8_Rb_treeIP8TreeNodeSt4pairIKS1_S1_ESt10_Select1stIS4_ESt4lessIS1_ESaIS4_EE13_Rb_tree_implIS8_Lb1EE13_M_initializeEv(%"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"*, align 8
  store %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %this, %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"** %1, align 8
  %2 = load %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"** %1
  %3 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  %4 = getelementptr inbounds %"struct.std::_Rb_tree_node_base"* %3, i32 0, i32 0
  store i32 0, i32* %4, align 4
  %5 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  ...
  %7 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  %8 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  ...
  %10 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %2, i32 0, i32 1
  %11 = getelementptr inbounds %"struct.std::_Rb_tree<TreeNode *, std::pair<TreeNode *const, TreeNode *>, std::_Select1st<std::pair<TreeNode *const, TreeNode *> >, std::less<TreeNode *>, std::allocator<std::pair<TreeNode *const, TreeNode *> > >::_Rb_tree_impl"* %2, i32 0, i32 1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKP8TreeNodeS4_EEEC2Ev(%"class.__gnu_cxx::new_allocator.5"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.5"** %1
  ret void
