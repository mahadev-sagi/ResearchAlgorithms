...
define void @_Z18in_order_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  call void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEEC2EOS5_(%"class.std::stack"* %work_queue, %"class.std::deque"* %3)
  call void @_ZNSt5dequeISt8functionIFvvEESaIS2_EED2Ev(%"class.std::deque"* %3) #0
  call void @_ZNSt8functionIFvP4NodeEEC2Ev(%"class.std::function.3"* %schedule) #0
  %5 = getelementptr inbounds %class.anon* %4, i32 0, i32 0
  store %"class.std::stack"* %work_queue, %"class.std::stack"** %5, align 8
  %6 = getelementptr inbounds %class.anon* %4, i32 0, i32 1
  store %"class.std::function.3"* %schedule, %"class.std::function.3"** %6, align 8
  %7 = getelementptr inbounds %class.anon* %4, i32 0, i32 2
  %8 = load %"class.std::vector"** %2, align 8
  store %"class.std::vector"* %8, %"class.std::vector"** %7, align 8
  %9 = call %"class.std::function.3"* @"_ZNSt8functionIFvP4NodeEEaSIZ18in_order_traversalS1_RSt6vectorIiSaIiEEE3$_0EENSt9enable_ifIXsrNS3_9_CallableINSt5decayIT_E4typeENSt9result_ofIFSF_S1_EE4typeEEE5valueERS3_E4typeEOSD_"(%"class.std::function.3"* %schedule, %class.anon* %4)
  %10 = load %struct.Node** %1, align 8
  call void @_ZNKSt8functionIFvP4NodeEEclES1_(%"class.std::function.3"* %schedule, %struct.Node* %10)
  br label %11

; <label>:11                                      ; preds = %14, %0
  %12 = call zeroext i1 @_ZNKSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE5emptyEv(%"class.std::stack"* %work_queue)
  %13 = xor i1 %12, true
  br i1 %13, label %14, label %16

; <label>:14                                      ; preds = %11
  %15 = call %"class.std::function"* @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE3topEv(%"class.std::stack"* %work_queue)
  call void @_ZNSt8functionIFvvEEC2ERKS1_(%"class.std::function"* %task, %"class.std::function"* %15)
  call void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE3popEv(%"class.std::stack"* %work_queue)
  call void @_ZNKSt8functionIFvvEEclEv(%"class.std::function"* %task)
  call void @_ZNSt8functionIFvvEED2Ev(%"class.std::function"* %task) #0
  br label %11

; <label>:16                                      ; preds = %11
  call void @_ZNSt8functionIFvP4NodeEED2Ev(%"class.std::function.3"* %schedule) #0
  call void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEED2Ev(%"class.std::stack"* %work_queue) #0
  ret void
}
...
define linkonce_odr void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEEC2EOS5_(%"class.std::stack"* %this, %"class.std::deque"* %__c) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::deque"* @_ZSt4moveIRSt5dequeISt8functionIFvvEESaIS3_EEEONSt16remove_referenceIT_E4typeEOS8_(%"class.std::deque"* %5) #0
...
define linkonce_odr zeroext i1 @_ZNKSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE5emptyEv(%"class.std::stack"* %this) #3 align 2 {
  ...
  %4 = call zeroext i1 @_ZNKSt5dequeISt8functionIFvvEESaIS2_EE5emptyEv(%"class.std::deque"* %3) #0
  ret i1 %4
}
...
define linkonce_odr %"class.std::function"* @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE3topEv(%"class.std::stack"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  %4 = call %"class.std::function"* @_ZNSt5dequeISt8functionIFvvEESaIS2_EE4backEv(%"class.std::deque"* %3) #0
...
define linkonce_odr void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE3popEv(%"class.std::stack"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  call void @_ZNSt5dequeISt8functionIFvvEESaIS2_EE8pop_backEv(%"class.std::deque"* %3) #0
  ret void
}
...
; <label>:14                                      ; preds = %0
  ...
  call void @_ZNSt16allocator_traitsISaISt8functionIFvvEEEE7destroyIS2_EEvRS3_PT_(%"class.std::allocator.0"* %23, %"class.std::function"* %28)
  br label %30

; <label>:29                                      ; preds = %0
  call void @_ZNSt5dequeISt8functionIFvvEESaIS2_EE15_M_pop_back_auxEv(%"class.std::deque"* %2)
  br label %30
...
define linkonce_odr void @_ZNSt5dequeISt8functionIFvvEESaIS2_EE15_M_pop_back_auxEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  call void @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EE18_M_deallocate_nodeEPS2_(%"class.std::_Deque_base"* %3, %"class.std::function"* %8) #0
  ...
  call void @_ZNSt15_Deque_iteratorISt8functionIFvvEERS2_PS2_E11_M_set_nodeEPS4_(%"struct.std::_Deque_iterator"* %11, %"class.std::function"** %17) #0
  ...
  %29 = call %"class.std::allocator.0"* @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %28) #0
...
define linkonce_odr %"class.std::function"* @_ZNSt5dequeISt8functionIFvvEESaIS2_EE4backEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeISt8functionIFvvEESaIS2_EE3endEv(%"struct.std::_Deque_iterator"* sret %__tmp, %"class.std::deque"* %2) #0
  %3 = call %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorISt8functionIFvvEERS2_PS2_EmmEv(%"struct.std::_Deque_iterator"* %__tmp) #0
  %4 = call %"class.std::function"* @_ZNKSt15_Deque_iteratorISt8functionIFvvEERS2_PS2_EdeEv(%"struct.std::_Deque_iterator"* %__tmp) #0
  ret %"class.std::function"* %4
}
...
; <label>:8                                       ; preds = %0
  ...
  call void @_ZNSt15_Deque_iteratorISt8functionIFvvEERS2_PS2_E11_M_set_nodeEPS4_(%"struct.std::_Deque_iterator"* %2, %"class.std::function"** %11) #0
...
; <label>:13                                      ; preds = %0
  ...
  %15 = load %"class.std::stack"** %14, align 8
  ...
  %21 = bitcast %class.anon.9* %4 to { %"class.std::function.3"*, %struct.Node* }*
  %22 = getelementptr { %"class.std::function.3"*, %struct.Node* }* %21, i32 0, i32 0
  %23 = load %"class.std::function.3"** %22, align 1
  %24 = getelementptr { %"class.std::function.3"*, %struct.Node* }* %21, i32 0, i32 1
  %25 = load %struct.Node** %24, align 1
  call void @"_ZNSt8functionIFvvEEC2IZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES4_EUlvE_vvEET_"(%"class.std::function"* %3, %"class.std::function.3"* %23, %struct.Node* %25)
  call void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE4pushEOS2_(%"class.std::stack"* %15, %"class.std::function"* %3)
  call void @_ZNSt8functionIFvvEED2Ev(%"class.std::function"* %3) #0
  %26 = getelementptr inbounds %class.anon* %9, i32 0, i32 0
  %27 = load %"class.std::stack"** %26, align 8
  %28 = getelementptr inbounds %class.anon.10* %6, i32 0, i32 0
  %29 = getelementptr inbounds %class.anon* %9, i32 0, i32 2
  %30 = load %"class.std::vector"** %29, align 8
  store %"class.std::vector"* %30, %"class.std::vector"** %28, align 8
  %31 = getelementptr inbounds %class.anon.10* %6, i32 0, i32 1
  %32 = load %struct.Node** %2, align 8
  store %struct.Node* %32, %struct.Node** %31, align 8
  %33 = bitcast %class.anon.10* %6 to { %"class.std::vector"*, %struct.Node* }*
  %34 = getelementptr { %"class.std::vector"*, %struct.Node* }* %33, i32 0, i32 0
  %35 = load %"class.std::vector"** %34, align 1
  %36 = getelementptr { %"class.std::vector"*, %struct.Node* }* %33, i32 0, i32 1
  %37 = load %struct.Node** %36, align 1
  call void @"_ZNSt8functionIFvvEEC2IZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES4_EUlvE0_vvEET_"(%"class.std::function"* %5, %"class.std::vector"* %35, %struct.Node* %37)
  call void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE4pushEOS2_(%"class.std::stack"* %27, %"class.std::function"* %5)
  call void @_ZNSt8functionIFvvEED2Ev(%"class.std::function"* %5) #0
  %38 = getelementptr inbounds %class.anon* %9, i32 0, i32 0
  %39 = load %"class.std::stack"** %38, align 8
  %40 = getelementptr inbounds %class.anon.11* %8, i32 0, i32 0
  %41 = getelementptr inbounds %class.anon* %9, i32 0, i32 1
  %42 = load %"class.std::function.3"** %41, align 8
  store %"class.std::function.3"* %42, %"class.std::function.3"** %40, align 8
  %43 = getelementptr inbounds %class.anon.11* %8, i32 0, i32 1
  %44 = load %struct.Node** %2, align 8
  store %struct.Node* %44, %struct.Node** %43, align 8
  %45 = bitcast %class.anon.11* %8 to { %"class.std::function.3"*, %struct.Node* }*
  %46 = getelementptr { %"class.std::function.3"*, %struct.Node* }* %45, i32 0, i32 0
  %47 = load %"class.std::function.3"** %46, align 1
  %48 = getelementptr { %"class.std::function.3"*, %struct.Node* }* %45, i32 0, i32 1
  %49 = load %struct.Node** %48, align 1
  call void @"_ZNSt8functionIFvvEEC2IZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES4_EUlvE1_vvEET_"(%"class.std::function"* %7, %"class.std::function.3"* %47, %struct.Node* %49)
  call void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE4pushEOS2_(%"class.std::stack"* %39, %"class.std::function"* %7)
...
define linkonce_odr void @_ZNSt5stackISt8functionIFvvEESt5dequeIS2_SaIS2_EEE4pushEOS2_(%"class.std::stack"* %this, %"class.std::function"* %__x) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::stack"* %3, i32 0, i32 0
  %5 = load %"class.std::function"** %2, align 8
  %6 = call %"class.std::function"* @_ZSt4moveIRSt8functionIFvvEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::function"* %5) #0
...
define internal void @"_ZNSt8functionIFvvEEC2IZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES4_EUlvE_vvEET_"(%"class.std::function"* %this, %"class.std::function.3"* %__f.coerce0, %struct.Node* %__f.coerce1) unnamed_addr #3 align 2 {
  ...
  store %"class.std::function"* %this, %"class.std::function"** %1, align 8
  %2 = bitcast %class.anon.9* %__f to { %"class.std::function.3"*, %struct.Node* }*
  %3 = getelementptr { %"class.std::function.3"*, %struct.Node* }* %2, i32 0, i32 0
  store %"class.std::function.3"* %__f.coerce0, %"class.std::function.3"** %3
  %4 = getelementptr { %"class.std::function.3"*, %struct.Node* }* %2, i32 0, i32 1
  ...
  %8 = call zeroext i1 @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_E21_M_not_empty_functionIS8_EEbRKT_"(%class.anon.9* %__f)
  br i1 %8, label %9, label %16

; <label>:9                                       ; preds = %0
  %10 = bitcast %"class.std::function"* %5 to %"class.std::_Function_base"*
  %11 = getelementptr inbounds %"class.std::_Function_base"* %10, i32 0, i32 0
  %12 = call %class.anon.9* @"_ZSt4moveIRZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES1_EUlvE_EONSt16remove_referenceIT_E4typeEOSA_"(%class.anon.9* %__f) #0
  call void @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_E15_M_init_functorERSt9_Any_dataOS8_"(%"union.std::_Any_data"* %11, %class.anon.9* %12)
  %13 = getelementptr inbounds %"class.std::function"* %5, i32 0, i32 1
  store void (%"union.std::_Any_data"*)* @"_ZNSt17_Function_handlerIFvvEZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_E9_M_invokeERKSt9_Any_data", void (%"union.std::_Any_data"*)** %13, align 8
  ...
  store i1 (%"union.std::_Any_data"*, %"union.std::_Any_data"*, i32)* @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_E10_M_managerERSt9_Any_dataRKSA_St18_Manager_operation", i1 (%"union.std::_Any_data"*, %"union.std::_Any_data"*, i32)** %15, align 8
  br label %16
...
define internal void @"_ZNSt8functionIFvvEEC2IZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES4_EUlvE1_vvEET_"(%"class.std::function"* %this, %"class.std::function.3"* %__f.coerce0, %struct.Node* %__f.coerce1) unnamed_addr #3 align 2 {
  ...
  store %"class.std::function"* %this, %"class.std::function"** %1, align 8
  %2 = bitcast %class.anon.11* %__f to { %"class.std::function.3"*, %struct.Node* }*
  %3 = getelementptr { %"class.std::function.3"*, %struct.Node* }* %2, i32 0, i32 0
  store %"class.std::function.3"* %__f.coerce0, %"class.std::function.3"** %3
  %4 = getelementptr { %"class.std::function.3"*, %struct.Node* }* %2, i32 0, i32 1
  store %struct.Node* %__f.coerce1, %struct.Node** %4
  ...
  %7 = bitcast %"class.std::function"* %5 to %"class.std::_Function_base"*
  call void @_ZNSt14_Function_baseC2Ev(%"class.std::_Function_base"* %7)
  %8 = call zeroext i1 @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_E21_M_not_empty_functionIS8_EEbRKT_"(%class.anon.11* %__f)
  br i1 %8, label %9, label %16

; <label>:9                                       ; preds = %0
  %10 = bitcast %"class.std::function"* %5 to %"class.std::_Function_base"*
  %11 = getelementptr inbounds %"class.std::_Function_base"* %10, i32 0, i32 0
  %12 = call %class.anon.11* @"_ZSt4moveIRZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES1_EUlvE1_EONSt16remove_referenceIT_E4typeEOSA_"(%class.anon.11* %__f) #0
  call void @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_E15_M_init_functorERSt9_Any_dataOS8_"(%"union.std::_Any_data"* %11, %class.anon.11* %12)
  %13 = getelementptr inbounds %"class.std::function"* %5, i32 0, i32 1
  store void (%"union.std::_Any_data"*)* @"_ZNSt17_Function_handlerIFvvEZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_E9_M_invokeERKSt9_Any_data", void (%"union.std::_Any_data"*)** %13, align 8
  %14 = bitcast %"class.std::function"* %5 to %"class.std::_Function_base"*
  %15 = getelementptr inbounds %"class.std::_Function_base"* %14, i32 0, i32 1
  store i1 (%"union.std::_Any_data"*, %"union.std::_Any_data"*, i32)* @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_E10_M_managerERSt9_Any_dataRKSA_St18_Manager_operation", i1 (%"union.std::_Any_data"*, %"union.std::_Any_data"*, i32)** %15, align 8
  br label %16
...
define internal void @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_E15_M_init_functorERSt9_Any_dataOS8_"(%"union.std::_Any_data"* %__functor, %class.anon.11* %__f) #3 align 2 {
  ...
  call void @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_E15_M_init_functorERSt9_Any_dataOS8_St17integral_constantIbLb1EE"(%"union.std::_Any_data"* %4, %class.anon.11* %6)
  ret void
}
...
define internal %class.anon.11* @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_E14_M_get_pointerERKSt9_Any_data"(%"union.std::_Any_data"* %__source) #3 align 2 {
  ...
  store %"union.std::_Any_data"* %__source, %"union.std::_Any_data"** %1, align 8
  %2 = load %"union.std::_Any_data"** %1, align 8
  %3 = call %class.anon.11* @"_ZNKSt9_Any_data9_M_accessIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_EERKT_v"(%"union.std::_Any_data"* %2)
  %4 = call %class.anon.11* @"_ZSt11__addressofIKZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES1_EUlvE1_EPT_RS9_"(%class.anon.11* %3) #0
...
; <label>:7                                       ; preds = %0
  ...
  %10 = call %class.anon.11* @"_ZNKSt9_Any_data9_M_accessIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_EERKT_v"(%"union.std::_Any_data"* %9)
...
define internal void @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_E10_M_destroyERSt9_Any_dataSt17integral_constantIbLb1EE"(%"union.std::_Any_data"* %__victim) #3 align 2 {
  ...
  store %"union.std::_Any_data"* %__victim, %"union.std::_Any_data"** %1, align 8
  %3 = load %"union.std::_Any_data"** %1, align 8
  %4 = call %class.anon.11* @"_ZNSt9_Any_data9_M_accessIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE1_EERT_v"(%"union.std::_Any_data"* %3)
  ret void
}
...
; <label>:7                                       ; preds = %0
  ...
  %10 = call %class.anon.11* @"_ZSt4moveIRZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES1_EUlvE1_EONSt16remove_referenceIT_E4typeEOSA_"(%class.anon.11* %9) #0
  %11 = bitcast %class.anon.11* %8 to i8*
  %12 = bitcast %class.anon.11* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %11, i8* %12, i64 16, i32 8, i1 false)
  br label %13
...
define internal void @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_E15_M_init_functorERSt9_Any_dataOS8_"(%"union.std::_Any_data"* %__functor, %class.anon.9* %__f) #3 align 2 {
  ...
  call void @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_E15_M_init_functorERSt9_Any_dataOS8_St17integral_constantIbLb1EE"(%"union.std::_Any_data"* %4, %class.anon.9* %6)
  ret void
}
...
define internal %class.anon.9* @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_E14_M_get_pointerERKSt9_Any_data"(%"union.std::_Any_data"* %__source) #3 align 2 {
  ...
  store %"union.std::_Any_data"* %__source, %"union.std::_Any_data"** %1, align 8
  %2 = load %"union.std::_Any_data"** %1, align 8
  %3 = call %class.anon.9* @"_ZNKSt9_Any_data9_M_accessIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_EERKT_v"(%"union.std::_Any_data"* %2)
  %4 = call %class.anon.9* @"_ZSt11__addressofIKZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES1_EUlvE_EPT_RS9_"(%class.anon.9* %3) #0
...
; <label>:7                                       ; preds = %0
  %8 = bitcast i8* %5 to %class.anon.9*
  %9 = load %"union.std::_Any_data"** %2, align 8
  %10 = call %class.anon.9* @"_ZNKSt9_Any_data9_M_accessIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_EERKT_v"(%"union.std::_Any_data"* %9)
  %11 = bitcast %class.anon.9* %8 to i8*
  %12 = bitcast %class.anon.9* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %11, i8* %12, i64 16, i32 8, i1 false)
  br label %13

; <label>:13                                      ; preds = %7, %0
  %14 = phi %class.anon.9* [ %8, %7 ], [ null, %0 ]
  ret void
}
...
define internal void @"_ZNSt14_Function_base13_Base_managerIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_E10_M_destroyERSt9_Any_dataSt17integral_constantIbLb1EE"(%"union.std::_Any_data"* %__victim) #3 align 2 {
  ...
  store %"union.std::_Any_data"* %__victim, %"union.std::_Any_data"** %1, align 8
  %3 = load %"union.std::_Any_data"** %1, align 8
  %4 = call %class.anon.9* @"_ZNSt9_Any_data9_M_accessIZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES2_EUlvE_EERT_v"(%"union.std::_Any_data"* %3)
  ret void
}
...
define internal %class.anon.9* @"_ZSt11__addressofIKZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES1_EUlvE_EPT_RS9_"(%class.anon.9* %__r) #4 {
  %1 = alloca %class.anon.9*, align 8
  store %class.anon.9* %__r, %class.anon.9** %1, align 8
  %2 = load %class.anon.9** %1, align 8
  %3 = bitcast %class.anon.9* %2 to i8*
  %4 = bitcast i8* %3 to %class.anon.9*
  ret %class.anon.9* %4
}
...
define internal void @"_ZZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES0_ENKUlvE_clEv"(%class.anon.9* %this) #4 align 2 {
  ...
  %4 = load %"class.std::function.3"** %3, align 8
  %5 = getelementptr inbounds %class.anon.9* %2, i32 0, i32 1
  %6 = load %struct.Node** %5, align 8
...
; <label>:7                                       ; preds = %0
  %8 = bitcast i8* %5 to %class.anon.9*
  %9 = load %class.anon.9** %2, align 8
  %10 = call %class.anon.9* @"_ZSt4moveIRZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEENK3$_0clES1_EUlvE_EONSt16remove_referenceIT_E4typeEOSA_"(%class.anon.9* %9) #0
  %11 = bitcast %class.anon.9* %8 to i8*
  %12 = bitcast %class.anon.9* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %11, i8* %12, i64 16, i32 8, i1 false)
  br label %13
...
define linkonce_odr void @_ZNSt5dequeISt8functionIFvvEESaIS2_EE16_M_push_back_auxIJS2_EEEvDpOT_(%"class.std::deque"* %this, %"class.std::function"* %__args) #3 align 2 {
  ...
  %21 = call %"class.std::function"* @_ZSt7forwardISt8functionIFvvEEEOT_RNSt16remove_referenceIS3_E4typeE(%"class.std::function"* %20) #0
  ...
  call void @_ZNSt15_Deque_iteratorISt8functionIFvvEERS2_PS2_E11_M_set_nodeEPS4_(%"struct.std::_Deque_iterator"* %24, %"class.std::function"** %30) #0
...
define linkonce_odr void @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EEC2EOS4_(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %7 = call %"class.std::_Deque_base"* @_ZSt4moveIRSt11_Deque_baseISt8functionIFvvEESaIS3_EEEONSt16remove_referenceIT_E4typeEOS8_(%"class.std::_Deque_base"* %6) #0
  %8 = bitcast %"struct.__gnu_cxx::__allocator_always_compares_equal"* %4 to %"struct.std::integral_constant.12"*
...
define linkonce_odr void @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EEC2EOS4_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %5 = getelementptr inbounds %"class.std::_Deque_base"* %4, i32 0, i32 0
  %6 = load %"class.std::_Deque_base"** %2, align 8
  %7 = call %"class.std::allocator.0"* @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %6) #0
  %8 = call %"class.std::allocator.0"* @_ZSt4moveIRSaISt8functionIFvvEEEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::allocator.0"* %7) #0
  call void @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EE11_Deque_implC2EOS3_(%"struct.std::_Deque_base<std::function<void ()>, std::allocator<std::function<void ()> > >::_Deque_impl"* %5, %"class.std::allocator.0"* %8) #0
  call void @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %4, i64 0)
  %9 = load %"class.std::_Deque_base"** %2, align 8
  %10 = getelementptr inbounds %"class.std::_Deque_base"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<std::function<void ()>, std::allocator<std::function<void ()> > >::_Deque_impl"* %10, i32 0, i32 0
  %12 = load %"class.std::function"*** %11, align 8
  %13 = icmp ne %"class.std::function"** %12, null
...
; <label>:14                                      ; preds = %0
  ...
  call void @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EE11_Deque_impl12_M_swap_dataERS5_(%"struct.std::_Deque_base<std::function<void ()>, std::allocator<std::function<void ()> > >::_Deque_impl"* %15, %"struct.std::_Deque_base<std::function<void ()>, std::allocator<std::function<void ()> > >::_Deque_impl"* %17) #0
  br label %18
...
define linkonce_odr void @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EE11_Deque_implC2EOS3_(%"struct.std::_Deque_base<std::function<void ()>, std::allocator<std::function<void ()> > >::_Deque_impl"* %this, %"class.std::allocator.0"* %__a) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::allocator.0"* @_ZSt4moveIRSaISt8functionIFvvEEEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::allocator.0"* %5) #0
  call void @_ZNSaISt8functionIFvvEEEC2ERKS2_(%"class.std::allocator.0"* %4, %"class.std::allocator.0"* %6) #0
  ...
  call void @_ZNSt15_Deque_iteratorISt8functionIFvvEERS2_PS2_EC2Ev(%"struct.std::_Deque_iterator"* %9) #0
  ...
  call void @_ZNSt15_Deque_iteratorISt8functionIFvvEERS2_PS2_EC2Ev(%"struct.std::_Deque_iterator"* %10) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseISt8functionIFvvEESaIS2_EE11_Deque_impl12_M_swap_dataERS5_(%"struct.std::_Deque_base<std::function<void ()>, std::allocator<std::function<void ()> > >::_Deque_impl"* %this, %"struct.std::_Deque_base<std::function<void ()>, std::allocator<std::function<void ()> > >::_Deque_impl"* %__x) #3 align 2 {
  ...
  call void @_ZSt4swapISt15_Deque_iteratorISt8functionIFvvEERS3_PS3_EEvRT_S8_(%"struct.std::_Deque_iterator"* %4, %"struct.std::_Deque_iterator"* %6) #0
  ...
  call void @_ZSt4swapISt15_Deque_iteratorISt8functionIFvvEERS3_PS3_EEvRT_S8_(%"struct.std::_Deque_iterator"* %7, %"struct.std::_Deque_iterator"* %9) #0
  ...
  call void @_ZSt4swapIPPSt8functionIFvvEEEvRT_S6_(%"class.std::function"*** %10, %"class.std::function"*** %12) #0
...
define linkonce_odr void @_ZSt4swapISt15_Deque_iteratorISt8functionIFvvEERS3_PS3_EEvRT_S8_(%"struct.std::_Deque_iterator"* %__a, %"struct.std::_Deque_iterator"* %__b) #4 {
  ...
  %3 = load %"struct.std::_Deque_iterator"** %1, align 8
  %4 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorISt8functionIFvvEERS3_PS3_EEONSt16remove_referenceIT_E4typeEOS9_(%"struct.std::_Deque_iterator"* %3) #0
  call void @_ZNSt15_Deque_iteratorISt8functionIFvvEERS2_PS2_EC2ERKS5_(%"struct.std::_Deque_iterator"* %__tmp, %"struct.std::_Deque_iterator"* %4) #0
  %5 = load %"struct.std::_Deque_iterator"** %1, align 8
  %6 = load %"struct.std::_Deque_iterator"** %2, align 8
  %7 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorISt8functionIFvvEERS3_PS3_EEONSt16remove_referenceIT_E4typeEOS9_(%"struct.std::_Deque_iterator"* %6) #0
  ...
  %11 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorISt8functionIFvvEERS3_PS3_EEONSt16remove_referenceIT_E4typeEOS9_(%"struct.std::_Deque_iterator"* %__tmp) #0
...
define linkonce_odr void @_ZSt4swapIPPSt8functionIFvvEEEvRT_S6_(%"class.std::function"*** %__a, %"class.std::function"*** %__b) #4 {
  ...
  %4 = call %"class.std::function"*** @_ZSt4moveIRPPSt8functionIFvvEEEONSt16remove_referenceIT_E4typeEOS7_(%"class.std::function"*** %3) #0
  %5 = load %"class.std::function"*** %4
  store %"class.std::function"** %5, %"class.std::function"*** %__tmp, align 8
  %6 = load %"class.std::function"**** %2, align 8
  %7 = call %"class.std::function"*** @_ZSt4moveIRPPSt8functionIFvvEEEONSt16remove_referenceIT_E4typeEOS7_(%"class.std::function"*** %6) #0
  %8 = load %"class.std::function"*** %7
  %9 = load %"class.std::function"**** %1, align 8
  store %"class.std::function"** %8, %"class.std::function"*** %9, align 8
  %10 = call %"class.std::function"*** @_ZSt4moveIRPPSt8functionIFvvEEEONSt16remove_referenceIT_E4typeEOS7_(%"class.std::function"*** %__tmp) #0
...
define linkonce_odr void @_ZNSaISt8functionIFvvEEEC2ERKS2_(%"class.std::allocator.0"* %this, %"class.std::allocator.0"* %__a) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt8functionIFvvEEEC2ERKS4_(%"class.__gnu_cxx::new_allocator.1"* %4, %"class.__gnu_cxx::new_allocator.1"* %6) #0
  ret void
}
