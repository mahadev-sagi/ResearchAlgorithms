; ModuleID = 'InorderTraversals/in_18_destructive.cpp'
...
; <label>:19                                      ; preds = %7
  ...
  store %struct.Node* %22, %struct.Node** %prev, align 8
  %23 = load %struct.Node** %prev, align 8
  ...
  %31 = load %struct.Node** %prev, align 8
