; ModuleID = 'PostorderTraversals/po_09_recursive_helper.cpp'
...
; <label>:13                                      ; preds = %12
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %s, %"class.std::deque"* %5)
...
; <label>:16                                      ; preds = %109, %15
  %17 = invoke zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s)
...
; <label>:20                                      ; preds = %18
  %21 = invoke %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s)
          to label %22 unwind label %55

; <label>:22                                      ; preds = %20
  %23 = load %struct.TreeNode** %21
  store %struct.TreeNode* %23, %struct.TreeNode** %curr, align 8
  %24 = load %struct.TreeNode** %prev, align 8
  %25 = icmp ne %struct.TreeNode* %24, null
  br i1 %25, label %26, label %38

; <label>:26                                      ; preds = %22
  %27 = load %struct.TreeNode** %prev, align 8
  ...
  %31 = icmp eq %struct.TreeNode* %29, %30
  br i1 %31, label %38, label %32

; <label>:32                                      ; preds = %26
  %33 = load %struct.TreeNode** %prev, align 8
  %34 = getelementptr inbounds %struct.TreeNode* %33, i32 0, i32 2
  %35 = load %struct.TreeNode** %34, align 8
  %36 = load %struct.TreeNode** %curr, align 8
  %37 = icmp eq %struct.TreeNode* %35, %36
  br i1 %37, label %38, label %75

; <label>:38                                      ; preds = %32, %26, %22
  %39 = load %struct.TreeNode** %curr, align 8
  %40 = getelementptr inbounds %struct.TreeNode* %39, i32 0, i32 1
  %41 = load %struct.TreeNode** %40, align 8
  %42 = icmp ne %struct.TreeNode* %41, null
  br i1 %42, label %43, label %59

; <label>:43                                      ; preds = %38
  %44 = load %struct.TreeNode** %curr, align 8
  %45 = getelementptr inbounds %struct.TreeNode* %44, i32 0, i32 1
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %45)
...
; <label>:55                                      ; preds = %103, %102, %91, %90, %86, %69, %68, %64, %43, %20, %16, %14
  %56 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup
  %57 = extractvalue { i8*, i32 } %56, 0
  store i8* %57, i8** %6
...
; <label>:59                                      ; preds = %38
  %60 = load %struct.TreeNode** %curr, align 8
  %61 = getelementptr inbounds %struct.TreeNode* %60, i32 0, i32 2
  %62 = load %struct.TreeNode** %61, align 8
  %63 = icmp ne %struct.TreeNode* %62, null
  br i1 %63, label %64, label %68

; <label>:64                                      ; preds = %59
  %65 = load %struct.TreeNode** %curr, align 8
  %66 = getelementptr inbounds %struct.TreeNode* %65, i32 0, i32 2
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %66)
...
; <label>:69                                      ; preds = %68
  ...
  %71 = getelementptr inbounds %struct.TreeNode* %70, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %71)
...
; <label>:75                                      ; preds = %32
  %76 = load %struct.TreeNode** %curr, align 8
  %77 = getelementptr inbounds %struct.TreeNode* %76, i32 0, i32 1
  %78 = load %struct.TreeNode** %77, align 8
  %79 = load %struct.TreeNode** %prev, align 8
  %80 = icmp eq %struct.TreeNode* %78, %79
  br i1 %80, label %81, label %96

; <label>:81                                      ; preds = %75
  %82 = load %struct.TreeNode** %curr, align 8
  %83 = getelementptr inbounds %struct.TreeNode* %82, i32 0, i32 2
  %84 = load %struct.TreeNode** %83, align 8
  %85 = icmp ne %struct.TreeNode* %84, null
  br i1 %85, label %86, label %90

; <label>:86                                      ; preds = %81
  %87 = load %struct.TreeNode** %curr, align 8
  %88 = getelementptr inbounds %struct.TreeNode* %87, i32 0, i32 2
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %88)
...
; <label>:91                                      ; preds = %90
  ...
  %93 = getelementptr inbounds %struct.TreeNode* %92, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %93)
...
; <label>:96                                      ; preds = %75
  %97 = load %struct.TreeNode** %curr, align 8
  %98 = getelementptr inbounds %struct.TreeNode* %97, i32 0, i32 2
  %99 = load %struct.TreeNode** %98, align 8
  %100 = load %struct.TreeNode** %prev, align 8
  %101 = icmp eq %struct.TreeNode* %99, %100
...
; <label>:103                                     ; preds = %102
  %104 = load %struct.TreeNode** %curr, align 8
  %105 = getelementptr inbounds %struct.TreeNode* %104, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %105)
...
; <label>:109                                     ; preds = %108, %74
  %110 = load %struct.TreeNode** %curr, align 8
  store %struct.TreeNode* %110, %struct.TreeNode** %prev, align 8
  br label %16
