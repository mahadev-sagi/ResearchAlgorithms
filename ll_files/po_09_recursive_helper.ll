...
; <label>:11                                      ; preds = %81, %10
  %12 = call zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s)
  %13 = xor i1 %12, true
  br i1 %13, label %14, label %83

; <label>:14                                      ; preds = %11
  %15 = call %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s)
  %16 = load %struct.TreeNode** %15
  store %struct.TreeNode* %16, %struct.TreeNode** %curr, align 8
  %17 = load %struct.TreeNode** %prev, align 8
  %18 = icmp ne %struct.TreeNode* %17, null
  br i1 %18, label %19, label %31

; <label>:19                                      ; preds = %14
  %20 = load %struct.TreeNode** %prev, align 8
  ...
  %24 = icmp eq %struct.TreeNode* %22, %23
  br i1 %24, label %31, label %25

; <label>:25                                      ; preds = %19
  %26 = load %struct.TreeNode** %prev, align 8
  ...
  %30 = icmp eq %struct.TreeNode* %28, %29
...
; <label>:36                                      ; preds = %31
  %37 = load %struct.TreeNode** %curr, align 8
...
; <label>:52                                      ; preds = %25
  %53 = load %struct.TreeNode** %curr, align 8
  %54 = getelementptr inbounds %struct.TreeNode* %53, i32 0, i32 1
  %55 = load %struct.TreeNode** %54, align 8
  %56 = load %struct.TreeNode** %prev, align 8
  %57 = icmp eq %struct.TreeNode* %55, %56
...
; <label>:63                                      ; preds = %58
  ...
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %65)
  br label %69

; <label>:66                                      ; preds = %58
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s)
  %67 = load %struct.TreeNode** %curr, align 8
  %68 = getelementptr inbounds %struct.TreeNode* %67, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %68)
  br label %69
...
; <label>:70                                      ; preds = %52
  ...
  %72 = getelementptr inbounds %struct.TreeNode* %71, i32 0, i32 2
  %73 = load %struct.TreeNode** %72, align 8
  %74 = load %struct.TreeNode** %prev, align 8
  %75 = icmp eq %struct.TreeNode* %73, %74
...
; <label>:81                                      ; preds = %80, %51
  ...
  store %struct.TreeNode* %82, %struct.TreeNode** %prev, align 8
  br label %11
