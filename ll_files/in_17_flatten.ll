...
; <label>:6                                       ; preds = %0
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %temp) #0
  %7 = load %struct.Node** %1, align 8
  call void @_ZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEEN6Helper4walkES0_S4_(%struct.Node* %7, %"class.std::vector"* %temp)
  store %"class.std::vector"* %temp, %"class.std::vector"** %__range, align 8
  %8 = load %"class.std::vector"** %__range, align 8
  %9 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %8) #0
  %10 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__begin, i32 0, i32 0
  store i32* %9, i32** %10
  %11 = load %"class.std::vector"** %__range, align 8
  %12 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %11) #0
  %13 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__end, i32 0, i32 0
  store i32* %12, i32** %13
  br label %14

; <label>:14                                      ; preds = %20, %6
  %15 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* %__begin, %"class.__gnu_cxx::__normal_iterator"* %__end) #0
  br i1 %15, label %16, label %22

; <label>:16                                      ; preds = %14
  %17 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %__begin) #0
  %18 = load i32* %17
  store i32 %18, i32* %val, align 4
  %19 = load %"class.std::vector"** %2, align 8
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %19, i32* %val)
  br label %20

; <label>:20                                      ; preds = %16
  %21 = call %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin) #0
  br label %14

; <label>:22                                      ; preds = %14
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %temp) #0
  br label %23
