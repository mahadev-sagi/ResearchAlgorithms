; ModuleID = 'InorderTraversals/in_17_flatten.cpp'
...
; <label>:8                                       ; preds = %0
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %temp) #2
  %9 = load %struct.Node** %1, align 8
  invoke void @_ZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEEN6Helper4walkES0_S4_(%struct.Node* %9, %"class.std::vector"* %temp)
          to label %10 unwind label %26

; <label>:10                                      ; preds = %8
  store %"class.std::vector"* %temp, %"class.std::vector"** %__range, align 8
  %11 = load %"class.std::vector"** %__range, align 8
  %12 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %11) #2
  %13 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__begin, i32 0, i32 0
  store i32* %12, i32** %13
  %14 = load %"class.std::vector"** %__range, align 8
  %15 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %14) #2
  %16 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__end, i32 0, i32 0
  store i32* %15, i32** %16
  br label %17

; <label>:17                                      ; preds = %24, %10
  %18 = call zeroext i1 @_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_(%"class.__gnu_cxx::__normal_iterator"* %__begin, %"class.__gnu_cxx::__normal_iterator"* %__end) #2
  br i1 %18, label %19, label %30

; <label>:19                                      ; preds = %17
  %20 = call i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator"* %__begin) #2
  %21 = load i32* %20
  store i32 %21, i32* %val, align 4
  %22 = load %"class.std::vector"** %2, align 8
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %22, i32* %val)
...
; <label>:24                                      ; preds = %23
  %25 = call %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv(%"class.__gnu_cxx::__normal_iterator"* %__begin) #2
  br label %17
...
; <label>:26                                      ; preds = %19, %8
  ...
  store i32 %29, i32* %4
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %temp) #2
  br label %32
...
define internal void @_ZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEEN6Helper4walkES0_S4_(%struct.Node* %n, %"class.std::vector"* %out) #3 align 2 {
  ...
  store %"class.std::vector"* %out, %"class.std::vector"** %2, align 8
...
; <label>:6                                       ; preds = %0
  ...
  call void @_ZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEEN6Helper4walkES0_S4_(%struct.Node* %9, %"class.std::vector"* %10)
  ...
  call void @_ZZ18in_order_traversalP4NodeRSt6vectorIiSaIiEEEN6Helper4walkES0_S4_(%struct.Node* %16, %"class.std::vector"* %17)
  br label %18
