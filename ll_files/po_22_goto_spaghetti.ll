; ModuleID = 'PostorderTraversals/po_22_goto_spaghetti.cpp'
...
; <label>:18                                      ; preds = %61, %17
  %19 = invoke zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %st)
...
; <label>:30                                      ; preds = %62, %57, %47, %38, %36, %34, %18, %16
...
; <label>:34                                      ; preds = %20
  %35 = invoke %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %st)
          to label %36 unwind label %30

; <label>:36                                      ; preds = %34
  %37 = load %struct.TreeNode** %35
...
; <label>:38                                      ; preds = %36
  %39 = load %struct.TreeNode** %node, align 8
  %40 = getelementptr inbounds %struct.TreeNode* %39, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %40)
...
; <label>:41                                      ; preds = %38
  ...
  %45 = icmp eq %struct.TreeNode* %44, null
...
; <label>:47                                      ; preds = %41
  ...
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %49)
...
; <label>:57                                      ; preds = %51
  %58 = load %struct.TreeNode** %node, align 8
  %59 = getelementptr inbounds %struct.TreeNode* %58, i32 0, i32 2
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %59)
...
; <label>:62                                      ; preds = %21
  %63 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %agg.result) #2
  %64 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %8, i32 0, i32 0
  store i32* %63, i32** %64
  %65 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %agg.result) #2
  %66 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %9, i32 0, i32 0
  store i32* %65, i32** %66
  %67 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %8, i32 0, i32 0
  %68 = load i32** %67
  %69 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %9, i32 0, i32 0
  %70 = load i32** %69
  invoke void @_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEEvT_S7_(i32* %68, i32* %70)
