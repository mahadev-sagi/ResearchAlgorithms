; ModuleID = 'InorderTraversals/in_04_parent_pointer.cpp'
...
; <label>:11                                      ; preds = %8
  %12 = load %struct.Node** %prev, align 8
  %13 = load %struct.Node** %curr, align 8
  %14 = getelementptr inbounds %struct.Node* %13, i32 0, i32 3
  %15 = load %struct.Node** %14, align 8
  %16 = icmp eq %struct.Node* %12, %15
...
; <label>:22                                      ; preds = %17
  ...
  store %struct.Node* %23, %struct.Node** %prev, align 8
...
; <label>:29                                      ; preds = %28, %11
  ...
  %34 = icmp eq %struct.Node* %30, %33
  br i1 %34, label %35, label %50

; <label>:35                                      ; preds = %29
  %36 = load %"class.std::vector"** %2, align 8
  %37 = load %struct.Node** %curr, align 8
  %38 = getelementptr inbounds %struct.Node* %37, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %36, i32* %38)
