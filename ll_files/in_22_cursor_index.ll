...
; <label>:19                                      ; preds = %16
  ...
  call void @_ZNSaIiEC2Ev(%"class.std::allocator.2"* %7) #0
  ...
  call void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector.0"* %f, i32* %28, i64 %30, %"class.std::allocator.2"* %7)
  call void @_ZNSaIiED2Ev(%"class.std::allocator.2"* %7) #0
  store %"class.std::vector.0"* %f, %"class.std::vector.0"** %__range, align 8
  %31 = load %"class.std::vector.0"** %__range, align 8
  %32 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector.0"* %31) #0
  %33 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %__begin, i32 0, i32 0
  store i32* %32, i32** %33
  %34 = load %"class.std::vector.0"** %__range, align 8
  %35 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.0"* %34) #0
...
; <label>:47                                      ; preds = %37
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector.0"* %f) #0
  br label %66
...
; <label>:66                                      ; preds = %65, %47
  ...
  call void @_Z18in_order_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %67, %"class.std::vector.0"* %result)
...
; <label>:68                                      ; preds = %84, %66
  ...
  %70 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector.0"* %result) #0
  %71 = sub i64 %70, 1
...
; <label>:73                                      ; preds = %68
  ...
  %75 = call i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %result, i64 %74) #0
  %76 = load i32* %75
  %77 = load i64* %i1, align 8
  %78 = add i64 %77, 1
  %79 = call i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector.0"* %result, i64 %78) #0
  %80 = load i32* %79
...
; <label>:90                                      ; preds = %87
  %91 = call zeroext i1 @_ZNKSt6vectorIiSaIiEE5emptyEv(%"class.std::vector.0"* %result) #0
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector.0"* %this, i32* %__l.coerce0, i64 %__l.coerce1, %"class.std::allocator.2"* %__a) unnamed_addr #3 align 2 {
  ...
  %8 = load %"class.std::vector.0"** %1
  %9 = bitcast %"class.std::vector.0"* %8 to %"struct.std::_Vector_base.1"*
  %10 = load %"class.std::allocator.2"** %2, align 8
  call void @_ZNSt12_Vector_baseIiSaIiEEC2ERKS0_(%"struct.std::_Vector_base.1"* %9, %"class.std::allocator.2"* %10) #0
  ...
  call void @_ZNSt6vectorIiSaIiEE19_M_range_initializeIPKiEEvT_S5_St20forward_iterator_tag(%"class.std::vector.0"* %8, i32* %11, i32* %12)
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector.0"* %this) #3 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector.0"* %this) #3 align 2 {
  %1 = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %2 = alloca %"class.std::vector.0"*, align 8
  store %"class.std::vector.0"* %this, %"class.std::vector.0"** %2, align 8
  %3 = load %"class.std::vector.0"** %2
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt6vectorIiSaIiEE5emptyEv(%"class.std::vector.0"* %this) #3 align 2 {
  %1 = alloca %"class.std::vector.0"*, align 8
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.9", align 8
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.9", align 8
  store %"class.std::vector.0"* %this, %"class.std::vector.0"** %1, align 8
  %4 = load %"class.std::vector.0"** %1
  %5 = call i32* @_ZNKSt6vectorIiSaIiEE5beginEv(%"class.std::vector.0"* %4) #0
  %6 = getelementptr %"class.__gnu_cxx::__normal_iterator.9"* %2, i32 0, i32 0
  store i32* %5, i32** %6
  %7 = call i32* @_ZNKSt6vectorIiSaIiEE3endEv(%"class.std::vector.0"* %4) #0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEEC2ERKS0_(%"struct.std::_Vector_base.1"* %this, %"class.std::allocator.2"* %__a) unnamed_addr #3 align 2 {
  %1 = alloca %"struct.std::_Vector_base.1"*, align 8
  %2 = alloca %"class.std::allocator.2"*, align 8
  store %"struct.std::_Vector_base.1"* %this, %"struct.std::_Vector_base.1"** %1, align 8
  store %"class.std::allocator.2"* %__a, %"class.std::allocator.2"** %2, align 8
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2ERKS0_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, %"class.std::allocator.2"* %5) #0
  ret void
}
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE19_M_range_initializeIPKiEEvT_S5_St20forward_iterator_tag(%"class.std::vector.0"* %this, i32* %__first, i32* %__last) #3 align 2 {
  ...
  %31 = call %"class.std::allocator.2"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base.1"* %30) #0
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr i32* @_ZSt22__uninitialized_copy_aIPKiPiiET0_T_S4_S3_RSaIT1_E(i32* %__first, i32* %__last, i32* %__result, %"class.std::allocator.2"*) #4 {
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
...
define linkonce_odr void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.10"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  call void @_ZNSaIPiEC2IiEERKSaIT_E(%"class.std::allocator.10"* %agg.result, %"class.std::allocator.2"* %3) #0
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIPiEC2IiEERKSaIT_E(%"class.std::allocator.10"* %this, %"class.std::allocator.2"*) unnamed_addr #3 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt13move_iteratorIP10CursorNodeEC2ES1_(%"class.std::move_iterator.13"* %this, %struct.CursorNode* %__i) unnamed_addr #3 align 2 {
  %1 = alloca %"class.std::move_iterator.13"*, align 8
  %2 = alloca %struct.CursorNode*, align 8
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr zeroext i1 @_ZStneIP10CursorNodeEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator.13"* %__x, %"class.std::move_iterator.13"* %__y) #4 {
  %1 = alloca %"class.std::move_iterator.13"*, align 8
  %2 = alloca %"class.std::move_iterator.13"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CursorNode* @_ZNKSt13move_iteratorIP10CursorNodeEdeEv(%"class.std::move_iterator.13"* %this) #3 align 2 {
  %1 = alloca %"class.std::move_iterator.13"*, align 8
  store %"class.std::move_iterator.13"* %this, %"class.std::move_iterator.13"** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::move_iterator.13"* @_ZNSt13move_iteratorIP10CursorNodeEppEv(%"class.std::move_iterator.13"* %this) #3 align 2 {
  %1 = alloca %"class.std::move_iterator.13"*, align 8
  store %"class.std::move_iterator.13"* %this, %"class.std::move_iterator.13"** %1, align 8
  %2 = load %"class.std::move_iterator.13"** %1
  %3 = getelementptr inbounds %"class.std::move_iterator.13"* %2, i32 0, i32 0
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr zeroext i1 @_ZSteqIP10CursorNodeEbRKSt13move_iteratorIT_ES6_(%"class.std::move_iterator.13"* %__x, %"class.std::move_iterator.13"* %__y) #4 {
  %1 = alloca %"class.std::move_iterator.13"*, align 8
  %2 = alloca %"class.std::move_iterator.13"*, align 8
  store %"class.std::move_iterator.13"* %__x, %"class.std::move_iterator.13"** %1, align 8
  store %"class.std::move_iterator.13"* %__y, %"class.std::move_iterator.13"** %2, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CursorNode* @_ZNKSt13move_iteratorIP10CursorNodeE4baseEv(%"class.std::move_iterator.13"* %this) #3 align 2 {
  %1 = alloca %"class.std::move_iterator.13"*, align 8
  store %"class.std::move_iterator.13"* %this, %"class.std::move_iterator.13"** %1, align 8
  %2 = load %"class.std::move_iterator.13"** %1
  %3 = getelementptr inbounds %"class.std::move_iterator.13"* %2, i32 0, i32 0
