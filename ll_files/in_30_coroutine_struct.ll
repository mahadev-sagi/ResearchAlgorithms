...
define linkonce_odr %struct.CoState** @_ZNSt11_Deque_baseI7CoStateSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  ...
  store i64 %__n, i64* %2, align 8
  %4 = load %"class.std::_Deque_base"** %1
  call void @_ZNKSt11_Deque_baseI7CoStateSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.7"* sret %__map_alloc, %"class.std::_Deque_base"* %4) #0
  %5 = load i64* %2, align 8
  %6 = call %struct.CoState** @_ZNSt16allocator_traitsISaIP7CoStateEE8allocateERS2_m(%"class.std::allocator.7"* %__map_alloc, i64 %5)
  store i32 1, i32* %3
  call void @_ZNSaIP7CoStateED2Ev(%"class.std::allocator.7"* %__map_alloc) #0
...
define linkonce_odr void @_ZNKSt11_Deque_baseI7CoStateSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.7"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  call void @_ZNSaIP7CoStateEC2IS_EERKSaIT_E(%"class.std::allocator.7"* %agg.result, %"class.std::allocator"* %3) #0
  ret void
}
...
define linkonce_odr %struct.CoState** @_ZNSt16allocator_traitsISaIP7CoStateEE8allocateERS2_m(%"class.std::allocator.7"* %__a, i64 %__n) #3 align 2 {
  ...
  %5 = load i64* %2, align 8
  %6 = call %struct.CoState** @_ZN9__gnu_cxx13new_allocatorIP7CoStateE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.8"* %4, i64 %5, i8* null)
  ret %struct.CoState** %6
}
...
define linkonce_odr void @_ZNSaIP7CoStateED2Ev(%"class.std::allocator.7"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIP7CoStateED2Ev(%"class.__gnu_cxx::new_allocator.8"* %3) #0
  ret void
}
...
define linkonce_odr %struct.CoState** @_ZN9__gnu_cxx13new_allocatorIP7CoStateE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.8"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIP7CoStateE8max_sizeEv(%"class.__gnu_cxx::new_allocator.8"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
define linkonce_odr void @_ZNSaIP7CoStateEC2IS_EERKSaIT_E(%"class.std::allocator.7"* %this, %"class.std::allocator"*) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIP7CoStateEC2Ev(%"class.__gnu_cxx::new_allocator.8"* %5) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %this, %struct.CoState** %__p, i64 %__n) #3 align 2 {
  ...
  %5 = load %struct.CoState*** %2, align 8
  %6 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIP7CoStateEE10deallocateERS2_PS1_m(%"class.std::allocator.7"* %__map_alloc, %struct.CoState** %5, i64 %6)
  call void @_ZNSaIP7CoStateED2Ev(%"class.std::allocator.7"* %__map_alloc) #0
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIP7CoStateEE10deallocateERS2_PS1_m(%"class.std::allocator.7"* %__a, %struct.CoState** %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %struct.CoState*** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIP7CoStateE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.8"* %5, %struct.CoState** %6, i64 %7)
  ret void
}
