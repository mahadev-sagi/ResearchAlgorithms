; ModuleID = 'InorderTraversals/in_30_coroutine_struct.cpp'
...
define zeroext i1 @_Z6resumeRSt5stackI7CoStateSt5dequeIS0_SaIS0_EEERSt6vectorIiSaIiEE(%"class.std::stack"* %s, %"class.std::vector"* %result) #3 {
  ...
  %frame = alloca %struct.CoState*, align 8
  %4 = alloca %struct.CoState, align 8
  %5 = alloca %struct.CoState, align 8
  store %"class.std::stack"* %s, %"class.std::stack"** %2, align 8
  store %"class.std::vector"* %result, %"class.std::vector"** %3, align 8
  %6 = load %"class.std::stack"** %2, align 8
  %7 = call zeroext i1 @_ZNKSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE5emptyEv(%"class.std::stack"* %6)
...
; <label>:9                                       ; preds = %0
  %10 = load %"class.std::stack"** %2, align 8
  %11 = call %struct.CoState* @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE3topEv(%"class.std::stack"* %10)
  store %struct.CoState* %11, %struct.CoState** %frame, align 8
  %12 = load %struct.CoState** %frame, align 8
  %13 = getelementptr inbounds %struct.CoState* %12, i32 0, i32 1
...
; <label>:15                                      ; preds = %9
  %16 = load %struct.CoState** %frame, align 8
  %17 = getelementptr inbounds %struct.CoState* %16, i32 0, i32 1
  store i32 1, i32* %17, align 4
  %18 = load %struct.CoState** %frame, align 8
  %19 = getelementptr inbounds %struct.CoState* %18, i32 0, i32 0
...
; <label>:24                                      ; preds = %15
  %25 = load %"class.std::stack"** %2, align 8
  %26 = load %struct.CoState** %frame, align 8
  %27 = getelementptr inbounds %struct.CoState* %26, i32 0, i32 0
  %28 = load %struct.Node** %27, align 8
  %29 = getelementptr inbounds %struct.Node* %28, i32 0, i32 1
  %30 = load %struct.Node** %29, align 8
  call void @_ZN7CoStateC2EP4Nodei(%struct.CoState* %4, %struct.Node* %30, i32 0)
  call void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %25, %struct.CoState* %4)
  br label %31
...
; <label>:32                                      ; preds = %9
  %33 = load %"class.std::vector"** %3, align 8
  %34 = load %struct.CoState** %frame, align 8
  %35 = getelementptr inbounds %struct.CoState* %34, i32 0, i32 0
  %36 = load %struct.Node** %35, align 8
  %37 = getelementptr inbounds %struct.Node* %36, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %33, i32* %37)
  %38 = load %struct.CoState** %frame, align 8
  %39 = getelementptr inbounds %struct.CoState* %38, i32 0, i32 1
  store i32 2, i32* %39, align 4
  %40 = load %struct.CoState** %frame, align 8
  %41 = getelementptr inbounds %struct.CoState* %40, i32 0, i32 0
...
; <label>:46                                      ; preds = %32
  %47 = load %"class.std::stack"** %2, align 8
  %48 = load %struct.CoState** %frame, align 8
  %49 = getelementptr inbounds %struct.CoState* %48, i32 0, i32 0
  %50 = load %struct.Node** %49, align 8
  %51 = getelementptr inbounds %struct.Node* %50, i32 0, i32 2
  %52 = load %struct.Node** %51, align 8
  call void @_ZN7CoStateC2EP4Nodei(%struct.CoState* %5, %struct.Node* %52, i32 0)
  call void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %47, %struct.CoState* %5)
  br label %53
...
; <label>:54                                      ; preds = %9
  %55 = load %"class.std::stack"** %2, align 8
  call void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE3popEv(%"class.std::stack"* %55)
  store i1 true, i1* %1
  br label %57
...
define linkonce_odr zeroext i1 @_ZNKSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE5emptyEv(%"class.std::stack"* %this) #4 align 2 {
  ...
  %4 = call zeroext i1 @_ZNKSt5dequeI7CoStateSaIS0_EE5emptyEv(%"class.std::deque"* %3) #2
  ret i1 %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState* @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE3topEv(%"class.std::stack"* %this) #4 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  %4 = call %struct.CoState* @_ZNSt5dequeI7CoStateSaIS0_EE4backEv(%"class.std::deque"* %3) #2
  ret %struct.CoState* %4
}
...
define linkonce_odr void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %this, %struct.CoState* %__x) #3 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  %2 = alloca %struct.CoState*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  store %struct.CoState* %__x, %struct.CoState** %2, align 8
  %3 = load %"class.std::stack"** %1
  %4 = getelementptr inbounds %"class.std::stack"* %3, i32 0, i32 0
  %5 = load %struct.CoState** %2, align 8
  %6 = call %struct.CoState* @_ZSt4moveIR7CoStateEONSt16remove_referenceIT_E4typeEOS3_(%struct.CoState* %5) #2
  call void @_ZNSt5dequeI7CoStateSaIS0_EE9push_backEOS0_(%"class.std::deque"* %4, %struct.CoState* %6)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN7CoStateC2EP4Nodei(%struct.CoState* %this, %struct.Node* %n, i32 %s) unnamed_addr #4 align 2 {
  %1 = alloca %struct.CoState*, align 8
  %2 = alloca %struct.Node*, align 8
  %3 = alloca i32, align 4
  store %struct.CoState* %this, %struct.CoState** %1, align 8
  store %struct.Node* %n, %struct.Node** %2, align 8
  store i32 %s, i32* %3, align 4
  %4 = load %struct.CoState** %1
  %5 = getelementptr inbounds %struct.CoState* %4, i32 0, i32 0
  %6 = load %struct.Node** %2, align 8
  store %struct.Node* %6, %struct.Node** %5, align 8
  %7 = getelementptr inbounds %struct.CoState* %4, i32 0, i32 1
...
; <label>:13                                      ; preds = %0
  ...
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.0"* %16, i32* %20, i32* %21)
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE3popEv(%"class.std::stack"* %this) #4 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  call void @_ZNSt5dequeI7CoStateSaIS0_EE8pop_backEv(%"class.std::deque"* %3) #2
  ret void
}
...
define void @_Z18in_order_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  %4 = alloca i8*
  %5 = alloca i32
  %6 = alloca %struct.CoState, align 8
...
; <label>:10                                      ; preds = %0
  call void @_ZNSt5dequeI7CoStateSaIS0_EEC2Ev(%"class.std::deque"* %3)
  invoke void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEEC2EOS3_(%"class.std::stack"* %s, %"class.std::deque"* %3)
          to label %11 unwind label %20

; <label>:11                                      ; preds = %10
  call void @_ZNSt5dequeI7CoStateSaIS0_EED2Ev(%"class.std::deque"* %3) #2
  %12 = load %struct.Node** %1, align 8
  invoke void @_ZN7CoStateC2EP4Nodei(%struct.CoState* %6, %struct.Node* %12, i32 0)
          to label %13 unwind label %24

; <label>:13                                      ; preds = %11
  invoke void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %s, %struct.CoState* %6)
...
; <label>:15                                      ; preds = %19, %14
  ...
  %17 = invoke zeroext i1 @_Z6resumeRSt5stackI7CoStateSt5dequeIS0_SaIS0_EEERSt6vectorIiSaIiEE(%"class.std::stack"* %s, %"class.std::vector"* %16)
...
; <label>:24                                      ; preds = %15, %13, %11
  ...
  store i32 %27, i32* %5
  call void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEED2Ev(%"class.std::stack"* %s) #2
  br label %30
...
define linkonce_odr void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEEC2EOS3_(%"class.std::stack"* %this, %"class.std::deque"* %__c) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::deque"* @_ZSt4moveIRSt5dequeI7CoStateSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::deque"* %5) #2
  call void @_ZNSt5dequeI7CoStateSaIS0_EEC2EOS2_(%"class.std::deque"* %4, %"class.std::deque"* %6)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EEC2Ev(%"class.std::deque"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EEC2Ev(%"class.std::_Deque_base"* %3)
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EED2Ev(%"class.std::deque"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  ...
  call void @_ZNSt5dequeI7CoStateSaIS0_EE5beginEv(%"struct.std::_Deque_iterator"* sret %2, %"class.std::deque"* %6) #2
  call void @_ZNSt5dequeI7CoStateSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* sret %3, %"class.std::deque"* %6) #2
  %7 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  %8 = call %"class.std::allocator"* @_ZNSt11_Deque_baseI7CoStateSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %7) #2
  invoke void @_ZNSt5dequeI7CoStateSaIS0_EE15_M_destroy_dataESt15_Deque_iteratorIS0_RS0_PS0_ES6_RKS1_(%"class.std::deque"* %6, %"struct.std::_Deque_iterator"* %2, %"struct.std::_Deque_iterator"* %3, %"class.std::allocator"* %8)
          to label %9 unwind label %11

; <label>:9                                       ; preds = %0
  %10 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EED2Ev(%"class.std::_Deque_base"* %10) #2
  ret void
...
; <label>:11                                      ; preds = %0
  ...
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EED2Ev(%"class.std::_Deque_base"* %15) #2
  br label %16
...
define linkonce_odr void @_ZNSt5stackI7CoStateSt5dequeIS0_SaIS0_EEED2Ev(%"class.std::stack"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
...
; <label>:33                                      ; preds = %32
  ...
  call void @_ZNSaIiEC2Ev(%"class.std::allocator.0"* %9) #2
  ...
  invoke void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %f, i32* %42, i64 %44, %"class.std::allocator.0"* %9)
          to label %45 unwind label %67

; <label>:45                                      ; preds = %33
  call void @_ZNSaIiED2Ev(%"class.std::allocator.0"* %9) #2
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %this, i32* %__l.coerce0, i64 %__l.coerce1, %"class.std::allocator.0"* %__a) unnamed_addr #3 align 2 {
  ...
  %12 = load %"class.std::allocator.0"** %2, align 8
  call void @_ZNSt12_Vector_baseIiSaIiEEC2ERKS0_(%"struct.std::_Vector_base"* %11, %"class.std::allocator.0"* %12) #2
...
define linkonce_odr void @_ZNSaIiEC2Ev(%"class.std::allocator.0"* %this) unnamed_addr #4 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIiEC2Ev(%"class.__gnu_cxx::new_allocator.1"* %3) #2
  ret void
}
...
define linkonce_odr void @_ZNSaIiED2Ev(%"class.std::allocator.0"* %this) unnamed_addr #4 align 2 {
  ...
  %2 = load %"class.std::allocator.0"** %1
  %3 = bitcast %"class.std::allocator.0"* %2 to %"class.__gnu_cxx::new_allocator.1"*
  call void @_ZN9__gnu_cxx13new_allocatorIiED2Ev(%"class.__gnu_cxx::new_allocator.1"* %3) #2
  ret void
}
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %this) unnamed_addr #4 align 2 {
  ...
  %14 = call %"class.std::allocator.0"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %13) #2
  invoke void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %8, i32* %12, %"class.std::allocator.0"* %14)
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this) unnamed_addr #4 align 2 {
  ...
  call void @_ZNSaIiEC2Ev(%"class.std::allocator.0"* %3) #2
...
define linkonce_odr void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %__first, i32* %__last, %"class.std::allocator.0"*) #9 {
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.0"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %this) #4 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8
  %2 = load %"struct.std::_Vector_base"** %1
  %3 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0
...
; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %"struct.std::_Vector_base"* %4, i32 0, i32 0
  %9 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %8 to %"class.std::allocator.0"*
  %10 = load i32** %2, align 8
  %11 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIiEE10deallocateERS0_Pim(%"class.std::allocator.0"* %9, i32* %10, i64 %11)
  br label %12
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implD2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this) unnamed_addr #5 align 2 {
  ...
  %2 = load %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1
  %3 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2 to %"class.std::allocator.0"*
  call void @_ZNSaIiED2Ev(%"class.std::allocator.0"* %3) #2
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE10deallocateERS0_Pim(%"class.std::allocator.0"* %__a, i32* %__p, i64 %__n) #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIiE10deallocateEPim(%"class.__gnu_cxx::new_allocator.1"* %5, i32* %6, i64 %7)
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEEC2ERKS0_(%"struct.std::_Vector_base"* %this, %"class.std::allocator.0"* %__a) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8
  %2 = alloca %"class.std::allocator.0"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8
  store %"class.std::allocator.0"* %__a, %"class.std::allocator.0"** %2, align 8
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2ERKS0_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, %"class.std::allocator.0"* %5) #2
  ret void
}
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE19_M_range_initializeIPKiEEvT_S5_St20forward_iterator_tag(%"class.std::vector"* %this, i32* %__first, i32* %__last) #3 align 2 {
  ...
  %31 = call %"class.std::allocator.0"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %30) #2
  %32 = call i32* @_ZSt22__uninitialized_copy_aIPKiPiiET0_T_S4_S3_RSaIT1_E(i32* %24, i32* %25, i32* %29, %"class.std::allocator.0"* %31)
...
; <label>:6                                       ; preds = %0
  ...
  %8 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %7 to %"class.std::allocator.0"*
  %9 = load i64* %2, align 8
  %10 = call i32* @_ZNSt16allocator_traitsISaIiEE8allocateERS0_m(%"class.std::allocator.0"* %8, i64 %9)
  br label %12
...
; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt22__uninitialized_copy_aIPKiPiiET0_T_S4_S3_RSaIT1_E(i32* %__first, i32* %__last, i32* %__result, %"class.std::allocator.0"*) #9 {
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
...
define linkonce_odr i32* @_ZNSt16allocator_traitsISaIiEE8allocateERS0_m(%"class.std::allocator.0"* %__a, i64 %__n) #3 align 2 {
  ...
  %6 = call i32* @_ZN9__gnu_cxx13new_allocatorIiE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %4, i64 %5, i8* null)
  ret i32* %6
}
...
define linkonce_odr i32* @_ZN9__gnu_cxx13new_allocatorIiE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIiE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %5) #2
  %8 = icmp ugt i64 %6, %7
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2ERKS0_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"class.std::allocator.0"* %__a) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"*, align 8
  %2 = alloca %"class.std::allocator.0"*, align 8
  store %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1, align 8
  store %"class.std::allocator.0"* %__a, %"class.std::allocator.0"** %2, align 8
  ...
  %4 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3 to %"class.std::allocator.0"*
  %5 = load %"class.std::allocator.0"** %2, align 8
  call void @_ZNSaIiEC2ERKS_(%"class.std::allocator.0"* %4, %"class.std::allocator.0"* %5) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIiEC2ERKS_(%"class.std::allocator.0"* %this, %"class.std::allocator.0"* %__a) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator.0"*, align 8
  %2 = alloca %"class.std::allocator.0"*, align 8
  store %"class.std::allocator.0"* %this, %"class.std::allocator.0"** %1, align 8
  store %"class.std::allocator.0"* %__a, %"class.std::allocator.0"** %2, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIiEC2ERKS1_(%"class.__gnu_cxx::new_allocator.1"* %4, %"class.__gnu_cxx::new_allocator.1"* %6) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiEC2ERKS1_(%"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"*) unnamed_addr #4 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
...
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EEC2EOS2_(%"class.std::deque"* %this, %"class.std::deque"* %__x) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::deque"* @_ZSt4moveIRSt5dequeI7CoStateSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::deque"* %5) #2
  %7 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EEC2EOS2_(%"class.std::_Deque_base"* %4, %"class.std::_Deque_base"* %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::deque"* @_ZSt4moveIRSt5dequeI7CoStateSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::deque"* %__t) #4 {
  %1 = alloca %"class.std::deque"*, align 8
...
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EEC2EOS2_(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %7 = call %"class.std::_Deque_base"* @_ZSt4moveIRSt11_Deque_baseI7CoStateSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::_Deque_base"* %6) #2
  %8 = bitcast %"struct.__gnu_cxx::__allocator_always_compares_equal"* %4 to %"struct.std::integral_constant"*
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EEC2EOS2_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %5, %"class.std::_Deque_base"* %7)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EEC2EOS2_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %9 = call %"class.std::allocator"* @_ZNSt11_Deque_baseI7CoStateSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %8) #2
  %10 = call %"class.std::allocator"* @_ZSt4moveIRSaI7CoStateEEONSt16remove_referenceIT_E4typeEOS4_(%"class.std::allocator"* %9) #2
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_implC2EOS1_(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %7, %"class.std::allocator"* %10) #2
  invoke void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %6, i64 0)
          to label %11 unwind label %21

; <label>:11                                      ; preds = %0
  %12 = load %"class.std::_Deque_base"** %2, align 8
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %13, i32 0, i32 0
  %15 = load %struct.CoState*** %14, align 8
  %16 = icmp ne %struct.CoState** %15, null
...
; <label>:17                                      ; preds = %11
  ...
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_impl12_M_swap_dataERS3_(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %18, %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %20) #2
  br label %25
...
; <label>:21                                      ; preds = %0
  ...
  store i32 %24, i32* %5
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %7) #2
  br label %26
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::_Deque_base"* @_ZSt4moveIRSt11_Deque_baseI7CoStateSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::_Deque_base"* %__t) #4 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_implC2EOS1_(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %this, %"class.std::allocator"* %__a) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"*, align 8
  %2 = alloca %"class.std::allocator"*, align 8
  store %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %this, %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %1, align 8
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %2, align 8
  %3 = load %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %1
  %4 = bitcast %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3 to %"class.std::allocator"*
  %5 = load %"class.std::allocator"** %2, align 8
  %6 = call %"class.std::allocator"* @_ZSt4moveIRSaI7CoStateEEONSt16remove_referenceIT_E4typeEOS4_(%"class.std::allocator"* %5) #2
  call void @_ZNSaI7CoStateEC2ERKS0_(%"class.std::allocator"* %4, %"class.std::allocator"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 0
  store %struct.CoState** null, %struct.CoState*** %7, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 1
  store i64 0, i64* %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %9) #2
  %10 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %10) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator"* @_ZSt4moveIRSaI7CoStateEEONSt16remove_referenceIT_E4typeEOS4_(%"class.std::allocator"* %__t) #4 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator"* @_ZNSt11_Deque_baseI7CoStateSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %this) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
...
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %this, i64 %__num_elements) #3 align 2 {
  ...
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %__nstart = alloca %struct.CoState**, align 8
  %__nfinish = alloca %struct.CoState**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  ...
  %15 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %14, i32 0, i32 1
  store i64 %13, i64* %15, align 8
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %16, i32 0, i32 1
  %18 = load i64* %17, align 8
  %19 = call %struct.CoState** @_ZNSt11_Deque_baseI7CoStateSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %5, i64 %18)
  %20 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %20, i32 0, i32 0
  store %struct.CoState** %19, %struct.CoState*** %21, align 8
  %22 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %22, i32 0, i32 0
  %24 = load %struct.CoState*** %23, align 8
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %25, i32 0, i32 1
  %27 = load i64* %26, align 8
  %28 = load i64* %__num_nodes, align 8
  %29 = sub i64 %27, %28
  %30 = udiv i64 %29, 2
  %31 = getelementptr inbounds %struct.CoState** %24, i64 %30
  store %struct.CoState** %31, %struct.CoState*** %__nstart, align 8
  %32 = load %struct.CoState*** %__nstart, align 8
  %33 = load i64* %__num_nodes, align 8
  %34 = getelementptr inbounds %struct.CoState** %32, i64 %33
  store %struct.CoState** %34, %struct.CoState*** %__nfinish, align 8
  %35 = load %struct.CoState*** %__nstart, align 8
  %36 = load %struct.CoState*** %__nfinish, align 8
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE15_M_create_nodesEPPS0_S4_(%"class.std::_Deque_base"* %5, %struct.CoState** %35, %struct.CoState** %36)
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %37, i32 0, i32 2
  %39 = load %struct.CoState*** %__nstart, align 8
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %38, %struct.CoState** %39) #2
  %40 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %41 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %40, i32 0, i32 3
  %42 = load %struct.CoState*** %__nfinish, align 8
  %43 = getelementptr inbounds %struct.CoState** %42, i64 -1
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %41, %struct.CoState** %43) #2
  %44 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %45 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %44, i32 0, i32 2
  %46 = getelementptr inbounds %"struct.std::_Deque_iterator"* %45, i32 0, i32 1
  %47 = load %struct.CoState** %46, align 8
  %48 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %49 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %48, i32 0, i32 2
  %50 = getelementptr inbounds %"struct.std::_Deque_iterator"* %49, i32 0, i32 0
  store %struct.CoState* %47, %struct.CoState** %50, align 8
  %51 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %52 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %51, i32 0, i32 3
  %53 = getelementptr inbounds %"struct.std::_Deque_iterator"* %52, i32 0, i32 1
  %54 = load %struct.CoState** %53, align 8
  %55 = load i64* %2, align 8
  %56 = call i64 @_ZSt16__deque_buf_sizem(i64 16)
  %57 = urem i64 %55, %56
  %58 = getelementptr inbounds %struct.CoState* %54, i64 %57
  %59 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %60 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %59, i32 0, i32 3
  %61 = getelementptr inbounds %"struct.std::_Deque_iterator"* %60, i32 0, i32 0
  store %struct.CoState* %58, %struct.CoState** %61, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_impl12_M_swap_dataERS3_(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %this, %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %__x) #4 align 2 {
  %1 = alloca %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"*, align 8
  %2 = alloca %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %this, %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %1, align 8
  store %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %__x, %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %2, align 8
  %3 = load %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %1
  %4 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 2
  %5 = load %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %2, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %5, i32 0, i32 2
  call void @_ZSt4swapISt15_Deque_iteratorI7CoStateRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %4, %"struct.std::_Deque_iterator"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 3
  %8 = load %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %2, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %8, i32 0, i32 3
  call void @_ZSt4swapISt15_Deque_iteratorI7CoStateRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %7, %"struct.std::_Deque_iterator"* %9) #2
  %10 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 0
  %11 = load %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %2, align 8
  %12 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %11, i32 0, i32 0
  call void @_ZSt4swapIPP7CoStateEvRT_S4_(%struct.CoState*** %10, %struct.CoState*** %12) #2
  %13 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 1
  %14 = load %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %2, align 8
  %15 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %14, i32 0, i32 1
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %this, %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %1, align 8
  %2 = load %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %2 to %"class.std::allocator"*
  call void @_ZNSaI7CoStateED2Ev(%"class.std::allocator"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaI7CoStateED2Ev(%"class.std::allocator"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator"*, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorI7CoStateED2Ev(%"class.__gnu_cxx::new_allocator"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI7CoStateED2Ev(%"class.__gnu_cxx::new_allocator"* %this) unnamed_addr #4 align 2 {
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZSt4swapISt15_Deque_iteratorI7CoStateRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %__a, %"struct.std::_Deque_iterator"* %__b) #5 {
  ...
  %4 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI7CoStateRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %3) #2
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %__tmp, %"struct.std::_Deque_iterator"* %4) #2
  %5 = load %"struct.std::_Deque_iterator"** %1, align 8
  %6 = load %"struct.std::_Deque_iterator"** %2, align 8
  %7 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI7CoStateRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %6) #2
  ...
  %11 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI7CoStateRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %__tmp) #2
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZSt4swapIPP7CoStateEvRT_S4_(%struct.CoState*** %__a, %struct.CoState*** %__b) #5 {
  %1 = alloca %struct.CoState***, align 8
  %2 = alloca %struct.CoState***, align 8
  %__tmp = alloca %struct.CoState**, align 8
  store %struct.CoState*** %__a, %struct.CoState**** %1, align 8
  store %struct.CoState*** %__b, %struct.CoState**** %2, align 8
  %3 = load %struct.CoState**** %1, align 8
  %4 = call %struct.CoState*** @_ZSt4moveIRPP7CoStateEONSt16remove_referenceIT_E4typeEOS5_(%struct.CoState*** %3) #2
  %5 = load %struct.CoState*** %4
  store %struct.CoState** %5, %struct.CoState*** %__tmp, align 8
  %6 = load %struct.CoState**** %2, align 8
  %7 = call %struct.CoState*** @_ZSt4moveIRPP7CoStateEONSt16remove_referenceIT_E4typeEOS5_(%struct.CoState*** %6) #2
  %8 = load %struct.CoState*** %7
  %9 = load %struct.CoState**** %1, align 8
  store %struct.CoState** %8, %struct.CoState*** %9, align 8
  %10 = call %struct.CoState*** @_ZSt4moveIRPP7CoStateEONSt16remove_referenceIT_E4typeEOS5_(%struct.CoState*** %__tmp) #2
  %11 = load %struct.CoState*** %10
  %12 = load %struct.CoState**** %2, align 8
  store %struct.CoState** %11, %struct.CoState*** %12, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState*** @_ZSt4moveIRPP7CoStateEONSt16remove_referenceIT_E4typeEOS5_(%struct.CoState*** %__t) #4 {
  %1 = alloca %struct.CoState***, align 8
  store %struct.CoState*** %__t, %struct.CoState**** %1, align 8
  %2 = load %struct.CoState**** %1, align 8
  ret %struct.CoState*** %2
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"* %__x) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
  ...
  %7 = load %struct.CoState** %6, align 8
  store %struct.CoState* %7, %struct.CoState** %4, align 8
  ...
  %11 = load %struct.CoState** %10, align 8
  store %struct.CoState* %11, %struct.CoState** %8, align 8
  ...
  %15 = load %struct.CoState** %14, align 8
  store %struct.CoState* %15, %struct.CoState** %12, align 8
  ...
  %19 = load %struct.CoState*** %18, align 8
  store %struct.CoState** %19, %struct.CoState*** %16, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI7CoStateRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %__t) #4 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
...
define linkonce_odr %struct.CoState** @_ZNSt11_Deque_baseI7CoStateSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  ...
  store i64 %__n, i64* %2, align 8
  %6 = load %"class.std::_Deque_base"** %1
  call void @_ZNKSt11_Deque_baseI7CoStateSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.8"* sret %__map_alloc, %"class.std::_Deque_base"* %6) #2
  %7 = load i64* %2, align 8
  %8 = invoke %struct.CoState** @_ZNSt16allocator_traitsISaIP7CoStateEE8allocateERS2_m(%"class.std::allocator.8"* %__map_alloc, i64 %7)
          to label %9 unwind label %10

; <label>:9                                       ; preds = %0
  store i32 1, i32* %5
  call void @_ZNSaIP7CoStateED2Ev(%"class.std::allocator.8"* %__map_alloc) #2
  ret %struct.CoState** %8
...
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE15_M_create_nodesEPPS0_S4_(%"class.std::_Deque_base"* %this, %struct.CoState** %__nstart, %struct.CoState** %__nfinish) #3 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  %__cur = alloca %struct.CoState**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store %struct.CoState** %__nstart, %struct.CoState*** %2, align 8
  store %struct.CoState** %__nfinish, %struct.CoState*** %3, align 8
  %4 = load %"class.std::_Deque_base"** %1
  %5 = load %struct.CoState*** %2, align 8
  store %struct.CoState** %5, %struct.CoState*** %__cur, align 8
  br label %6

; <label>:6                                       ; preds = %13, %0
  %7 = load %struct.CoState*** %__cur, align 8
  %8 = load %struct.CoState*** %3, align 8
  %9 = icmp ult %struct.CoState** %7, %8
  br i1 %9, label %10, label %16

; <label>:10                                      ; preds = %6
  %11 = call %struct.CoState* @_ZNSt11_Deque_baseI7CoStateSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
  %12 = load %struct.CoState*** %__cur, align 8
  store %struct.CoState* %11, %struct.CoState** %12, align 8
  br label %13

; <label>:13                                      ; preds = %10
  %14 = load %struct.CoState*** %__cur, align 8
  %15 = getelementptr inbounds %struct.CoState** %14, i32 1
  store %struct.CoState** %15, %struct.CoState*** %__cur, align 8
  br label %6
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %this, %struct.CoState** %__new_node) #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %struct.CoState**, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  store %struct.CoState** %__new_node, %struct.CoState*** %2, align 8
  %3 = load %"struct.std::_Deque_iterator"** %1
  %4 = load %struct.CoState*** %2, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 3
  store %struct.CoState** %4, %struct.CoState*** %5, align 8
  %6 = load %struct.CoState*** %2, align 8
  %7 = load %struct.CoState** %6, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 1
  store %struct.CoState* %7, %struct.CoState** %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 1
  %10 = load %struct.CoState** %9, align 8
  %11 = call i64 @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E14_S_buffer_sizeEv() #2
  %12 = getelementptr inbounds %struct.CoState* %10, i64 %11
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 2
  store %struct.CoState* %12, %struct.CoState** %13, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E14_S_buffer_sizeEv() #4 align 2 {
...
define linkonce_odr %struct.CoState* @_ZNSt11_Deque_baseI7CoStateSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  %6 = call %struct.CoState* @_ZNSt16allocator_traitsISaI7CoStateEE8allocateERS1_m(%"class.std::allocator"* %4, i64 %5)
  ret %struct.CoState* %6
}
...
define linkonce_odr %struct.CoState* @_ZNSt16allocator_traitsISaI7CoStateEE8allocateERS1_m(%"class.std::allocator"* %__a, i64 %__n) #3 align 2 {
  ...
  %5 = load i64* %2, align 8
  %6 = call %struct.CoState* @_ZN9__gnu_cxx13new_allocatorI7CoStateE8allocateEmPKv(%"class.__gnu_cxx::new_allocator"* %4, i64 %5, i8* null)
  ret %struct.CoState* %6
}
...
define linkonce_odr %struct.CoState* @_ZN9__gnu_cxx13new_allocatorI7CoStateE8allocateEmPKv(%"class.__gnu_cxx::new_allocator"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorI7CoStateE8max_sizeEv(%"class.__gnu_cxx::new_allocator"* %5) #2
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; <label>:10                                      ; preds = %1
  ...
  %12 = mul i64 %11, 16
  %13 = call noalias i8* @_Znwm(i64 %12)
  %14 = bitcast i8* %13 to %struct.CoState*
  ret %struct.CoState* %14
}

; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorI7CoStateE8max_sizeEv(%"class.__gnu_cxx::new_allocator"* %this) #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator"** %1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNKSt11_Deque_baseI7CoStateSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.8"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = call %"class.std::allocator"* @_ZNKSt11_Deque_baseI7CoStateSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %2) #2
  call void @_ZNSaIP7CoStateEC2IS_EERKSaIT_E(%"class.std::allocator.8"* %agg.result, %"class.std::allocator"* %3) #2
  ret void
}
...
define linkonce_odr %struct.CoState** @_ZNSt16allocator_traitsISaIP7CoStateEE8allocateERS2_m(%"class.std::allocator.8"* %__a, i64 %__n) #3 align 2 {
  ...
  %5 = load i64* %2, align 8
  %6 = call %struct.CoState** @_ZN9__gnu_cxx13new_allocatorIP7CoStateE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.9"* %4, i64 %5, i8* null)
  ret %struct.CoState** %6
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIP7CoStateED2Ev(%"class.std::allocator.8"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator.8"*, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIP7CoStateED2Ev(%"class.__gnu_cxx::new_allocator.9"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIP7CoStateED2Ev(%"class.__gnu_cxx::new_allocator.9"* %this) unnamed_addr #4 align 2 {
...
define linkonce_odr %struct.CoState** @_ZN9__gnu_cxx13new_allocatorIP7CoStateE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.9"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIP7CoStateE8max_sizeEv(%"class.__gnu_cxx::new_allocator.9"* %5) #2
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorIP7CoStateE8max_sizeEv(%"class.__gnu_cxx::new_allocator.9"* %this) #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.9"*, align 8
  store %"class.__gnu_cxx::new_allocator.9"* %this, %"class.__gnu_cxx::new_allocator.9"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.9"** %1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIP7CoStateEC2IS_EERKSaIT_E(%"class.std::allocator.8"* %this, %"class.std::allocator"*) unnamed_addr #4 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIP7CoStateEC2Ev(%"class.__gnu_cxx::new_allocator.9"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator"* @_ZNKSt11_Deque_baseI7CoStateSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %this) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIP7CoStateEC2Ev(%"class.__gnu_cxx::new_allocator.9"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.9"*, align 8
  store %"class.__gnu_cxx::new_allocator.9"* %this, %"class.__gnu_cxx::new_allocator.9"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.9"** %1
  ret void
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaI7CoStateEC2ERKS0_(%"class.std::allocator"* %this, %"class.std::allocator"* %__a) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator"*, align 8
  %2 = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %this, %"class.std::allocator"** %1, align 8
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %2, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorI7CoStateEC2ERKS2_(%"class.__gnu_cxx::new_allocator"* %4, %"class.__gnu_cxx::new_allocator"* %6) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
  store %struct.CoState* null, %struct.CoState** %3, align 8
  %4 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 1
  store %struct.CoState* null, %struct.CoState** %4, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 2
  store %struct.CoState* null, %struct.CoState** %5, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 3
  store %struct.CoState** null, %struct.CoState*** %6, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI7CoStateEC2ERKS2_(%"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"*) unnamed_addr #4 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE15_M_destroy_dataESt15_Deque_iteratorIS0_RS0_PS0_ES6_RKS1_(%"class.std::deque"* %this, %"struct.std::_Deque_iterator"* %__first, %"struct.std::_Deque_iterator"* %__last, %"class.std::allocator"*) #4 align 2 {
  %2 = alloca %"class.std::deque"*, align 8
  %3 = alloca %"class.std::allocator"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE5beginEv(%"struct.std::_Deque_iterator"* noalias sret %agg.result, %"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %4, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %agg.result, %"struct.std::_Deque_iterator"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* noalias sret %agg.result, %"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %4, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %agg.result, %"struct.std::_Deque_iterator"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EED2Ev(%"class.std::_Deque_base"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %3, i32 0, i32 0
  %5 = load %struct.CoState*** %4, align 8
  %6 = icmp ne %struct.CoState** %5, null
  br i1 %6, label %7, label %23

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %9 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %8, i32 0, i32 2
  ...
  %13 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %12, i32 0, i32 3
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %13, i32 0, i32 3
  %15 = load %struct.CoState*** %14, align 8
  %16 = getelementptr inbounds %struct.CoState** %15, i64 1
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE16_M_destroy_nodesEPPS0_S4_(%"class.std::_Deque_base"* %2, %struct.CoState** %11, %struct.CoState** %16) #2
  %17 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %18 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %17, i32 0, i32 0
  %19 = load %struct.CoState*** %18, align 8
  %20 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %20, i32 0, i32 1
  %22 = load i64* %21, align 8
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %2, %struct.CoState** %19, i64 %22) #2
  br label %23

; <label>:23                                      ; preds = %7, %0
  %24 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %24) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE16_M_destroy_nodesEPPS0_S4_(%"class.std::_Deque_base"* %this, %struct.CoState** %__nstart, %struct.CoState** %__nfinish) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  %__n = alloca %struct.CoState**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store %struct.CoState** %__nstart, %struct.CoState*** %2, align 8
  store %struct.CoState** %__nfinish, %struct.CoState*** %3, align 8
  %4 = load %"class.std::_Deque_base"** %1
  %5 = load %struct.CoState*** %2, align 8
  store %struct.CoState** %5, %struct.CoState*** %__n, align 8
  br label %6

; <label>:6                                       ; preds = %13, %0
  %7 = load %struct.CoState*** %__n, align 8
  %8 = load %struct.CoState*** %3, align 8
  %9 = icmp ult %struct.CoState** %7, %8
  br i1 %9, label %10, label %16

; <label>:10                                      ; preds = %6
  %11 = load %struct.CoState*** %__n, align 8
  %12 = load %struct.CoState** %11, align 8
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %4, %struct.CoState* %12) #2
  br label %13

; <label>:13                                      ; preds = %10
  %14 = load %struct.CoState*** %__n, align 8
  %15 = getelementptr inbounds %struct.CoState** %14, i32 1
  store %struct.CoState** %15, %struct.CoState*** %__n, align 8
  br label %6
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %this, %struct.CoState** %__p, i64 %__n) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca i64, align 8
  %__map_alloc = alloca %"class.std::allocator.8", align 1
  ...
  %5 = alloca i32
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store %struct.CoState** %__p, %struct.CoState*** %2, align 8
  store i64 %__n, i64* %3, align 8
  %6 = load %"class.std::_Deque_base"** %1
  call void @_ZNKSt11_Deque_baseI7CoStateSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.8"* sret %__map_alloc, %"class.std::_Deque_base"* %6) #2
  %7 = load %struct.CoState*** %2, align 8
  %8 = load i64* %3, align 8
  invoke void @_ZNSt16allocator_traitsISaIP7CoStateEE10deallocateERS2_PS1_m(%"class.std::allocator.8"* %__map_alloc, %struct.CoState** %7, i64 %8)
          to label %9 unwind label %10
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIP7CoStateEE10deallocateERS2_PS1_m(%"class.std::allocator.8"* %__a, %struct.CoState** %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %struct.CoState*** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIP7CoStateE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.9"* %5, %struct.CoState** %6, i64 %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIP7CoStateE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.9"* %this, %struct.CoState** %__p, i64) #4 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator.9"*, align 8
  %3 = alloca %struct.CoState**, align 8
  %4 = alloca i64, align 8
  store %"class.__gnu_cxx::new_allocator.9"* %this, %"class.__gnu_cxx::new_allocator.9"** %2, align 8
  store %struct.CoState** %__p, %struct.CoState*** %3, align 8
  store i64 %0, i64* %4, align 8
  %5 = load %"class.__gnu_cxx::new_allocator.9"** %2
  %6 = load %struct.CoState*** %3, align 8
  %7 = bitcast %struct.CoState** %6 to i8*
  call void @_ZdlPv(i8* %7) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %this, %struct.CoState* %__p) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca %struct.CoState*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store %struct.CoState* %__p, %struct.CoState** %2, align 8
  ...
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = bitcast %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %4 to %"class.std::allocator"*
  %6 = load %struct.CoState** %2, align 8
  %7 = invoke i64 @_ZSt16__deque_buf_sizem(i64 16)
          to label %8 unwind label %10

; <label>:8                                       ; preds = %0
  invoke void @_ZNSt16allocator_traitsISaI7CoStateEE10deallocateERS1_PS0_m(%"class.std::allocator"* %5, %struct.CoState* %6, i64 %7)
          to label %9 unwind label %10
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI7CoStateEE10deallocateERS1_PS0_m(%"class.std::allocator"* %__a, %struct.CoState* %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %struct.CoState** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorI7CoStateE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator"* %5, %struct.CoState* %6, i64 %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI7CoStateE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator"* %this, %struct.CoState* %__p, i64) #4 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %3 = alloca %struct.CoState*, align 8
  %4 = alloca i64, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %2, align 8
...
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EEC2Ev(%"class.std::_Deque_base"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_implC2Ev(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %5)
  invoke void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %4, i64 0)
...
; <label>:7                                       ; preds = %0
  ...
  store i32 %10, i32* %3
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %5) #2
  br label %11
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE11_Deque_implC2Ev(%"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %this, %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %1, align 8
  %2 = load %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %2 to %"class.std::allocator"*
  call void @_ZNSaI7CoStateEC2Ev(%"class.std::allocator"* %3) #2
  %4 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %2, i32 0, i32 0
  store %struct.CoState** null, %struct.CoState*** %4, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %2, i32 0, i32 1
  store i64 0, i64* %5, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %2, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %2, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %7) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaI7CoStateEC2Ev(%"class.std::allocator"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %this, %"class.std::allocator"** %1, align 8
  %2 = load %"class.std::allocator"** %1
  %3 = bitcast %"class.std::allocator"* %2 to %"class.__gnu_cxx::new_allocator"*
  call void @_ZN9__gnu_cxx13new_allocatorI7CoStateEC2Ev(%"class.__gnu_cxx::new_allocator"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI7CoStateEC2Ev(%"class.__gnu_cxx::new_allocator"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator"** %1
  ret void
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE8pop_backEv(%"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  ...
  %10 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %9, i32 0, i32 3
  %11 = getelementptr inbounds %"struct.std::_Deque_iterator"* %10, i32 0, i32 1
  %12 = load %struct.CoState** %11, align 8
  %13 = icmp ne %struct.CoState* %7, %12
  br i1 %13, label %14, label %30

; <label>:14                                      ; preds = %0
  %15 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %16, i32 0, i32 3
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator"* %17, i32 0, i32 0
  %19 = load %struct.CoState** %18, align 8
  %20 = getelementptr inbounds %struct.CoState* %19, i32 -1
  store %struct.CoState* %20, %struct.CoState** %18, align 8
  %21 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %22 = getelementptr inbounds %"class.std::_Deque_base"* %21, i32 0, i32 0
  %23 = bitcast %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %22 to %"class.std::allocator"*
  %24 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %25, i32 0, i32 3
  %27 = getelementptr inbounds %"struct.std::_Deque_iterator"* %26, i32 0, i32 0
  %28 = load %struct.CoState** %27, align 8
  invoke void @_ZNSt16allocator_traitsISaI7CoStateEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator"* %23, %struct.CoState* %28)
...
; <label>:30                                      ; preds = %0
  invoke void @_ZNSt5dequeI7CoStateSaIS0_EE15_M_pop_back_auxEv(%"class.std::deque"* %2)
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI7CoStateEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator"* %__a, %struct.CoState* %__p) #3 align 2 {
  ...
  %4 = bitcast %"class.std::allocator"* %3 to %"class.__gnu_cxx::new_allocator"*
  %5 = load %struct.CoState** %2, align 8
  call void @_ZN9__gnu_cxx13new_allocatorI7CoStateE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator"* %4, %struct.CoState* %5)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE15_M_pop_back_auxEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  %5 = getelementptr inbounds %"class.std::_Deque_base"* %4, i32 0, i32 0
  %6 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %5, i32 0, i32 3
  %7 = getelementptr inbounds %"struct.std::_Deque_iterator"* %6, i32 0, i32 1
  %8 = load %struct.CoState** %7, align 8
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %3, %struct.CoState* %8) #2
  %9 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %10 = getelementptr inbounds %"class.std::_Deque_base"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %10, i32 0, i32 3
  %12 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %13, i32 0, i32 3
  %15 = getelementptr inbounds %"struct.std::_Deque_iterator"* %14, i32 0, i32 3
  %16 = load %struct.CoState*** %15, align 8
  %17 = getelementptr inbounds %struct.CoState** %16, i64 -1
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %11, %struct.CoState** %17) #2
  %18 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %19 = getelementptr inbounds %"class.std::_Deque_base"* %18, i32 0, i32 0
  %20 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %19, i32 0, i32 3
  %21 = getelementptr inbounds %"struct.std::_Deque_iterator"* %20, i32 0, i32 2
  %22 = load %struct.CoState** %21, align 8
  %23 = getelementptr inbounds %struct.CoState* %22, i64 -1
  %24 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %25, i32 0, i32 3
  %27 = getelementptr inbounds %"struct.std::_Deque_iterator"* %26, i32 0, i32 0
  store %struct.CoState* %23, %struct.CoState** %27, align 8
  %28 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %29 = call %"class.std::allocator"* @_ZNSt11_Deque_baseI7CoStateSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %28) #2
  %30 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %31 = getelementptr inbounds %"class.std::_Deque_base"* %30, i32 0, i32 0
  %32 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %31, i32 0, i32 3
  %33 = getelementptr inbounds %"struct.std::_Deque_iterator"* %32, i32 0, i32 0
  %34 = load %struct.CoState** %33, align 8
  call void @_ZNSt16allocator_traitsISaI7CoStateEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator"* %29, %struct.CoState* %34)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI7CoStateE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator"* %this, %struct.CoState* %__p) #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %2 = alloca %struct.CoState*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %1, align 8
  store %struct.CoState* %__p, %struct.CoState** %2, align 8
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.0"* %__a, i32* %__p, i32* %__args) #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRKiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %5, i32* %6, i32* %8)
  ret void
}
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE19_M_emplace_back_auxIJRKiEEEvDpOT_(%"class.std::vector"* %this, i32* %__args) #3 align 2 {
  ...
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.0"* %11, i32* %14, i32* %16)
  ...
  %27 = call %"class.std::allocator.0"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %26) #2
  %28 = call i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %20, i32* %24, i32* %25, %"class.std::allocator.0"* %27)
  ...
  %40 = call %"class.std::allocator.0"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %39) #2
  call void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %34, i32* %38, %"class.std::allocator.0"* %40)
...
; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %__first, i32* %__last, i32* %__result, %"class.std::allocator.0"* %__alloc) #9 {
  %1 = alloca i32*, align 8
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
  %4 = alloca %"class.std::allocator.0"*, align 8
  ...
  store i32* %__last, i32** %2, align 8
  store i32* %__result, i32** %3, align 8
  store %"class.std::allocator.0"* %__alloc, %"class.std::allocator.0"** %4, align 8
  ...
  store i32* %11, i32** %12
  %13 = load i32** %3, align 8
  %14 = load %"class.std::allocator.0"** %4, align 8
  %15 = getelementptr %"class.std::move_iterator"* %5, i32 0, i32 0
  %16 = load i32** %15
  %17 = getelementptr %"class.std::move_iterator"* %6, i32 0, i32 0
  %18 = load i32** %17
  %19 = call i32* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPiES1_iET0_T_S4_S3_RSaIT1_E(i32* %16, i32* %18, i32* %13, %"class.std::allocator.0"* %14)
  ret i32* %19
}

; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPiES1_iET0_T_S4_S3_RSaIT1_E(i32* %__first.coerce, i32* %__last.coerce, i32* %__result, %"class.std::allocator.0"*) #9 {
...
define linkonce_odr i64 @_ZNKSt6vectorIiSaIiEE8max_sizeEv(%"class.std::vector"* %this) #4 align 2 {
  ...
  %2 = load %"class.std::vector"** %1
  %3 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*
  %4 = call %"class.std::allocator.0"* @_ZNKSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %3) #2
  %5 = call i64 @_ZNSt16allocator_traitsISaIiEE8max_sizeERKS0_(%"class.std::allocator.0"* %4) #2
  ret i64 %5
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNSt16allocator_traitsISaIiEE8max_sizeERKS0_(%"class.std::allocator.0"* %__a) #4 align 2 {
  %1 = alloca %"class.std::allocator.0"*, align 8
  store %"class.std::allocator.0"* %__a, %"class.std::allocator.0"** %1, align 8
  %2 = load %"class.std::allocator.0"** %1, align 8
  %3 = bitcast %"class.std::allocator.0"* %2 to %"class.__gnu_cxx::new_allocator.1"*
  %4 = call i64 @_ZNK9__gnu_cxx13new_allocatorIiE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %3) #2
  ret i64 %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.0"* @_ZNKSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %this) #4 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8
  %2 = load %"struct.std::_Vector_base"** %1
  %3 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRKiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %this, i32* %__p, i32* %__args) #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
  store %"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"** %1, align 8
...
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE9push_backEOS0_(%"class.std::deque"* %this, %struct.CoState* %__x) #3 align 2 {
  ...
  %3 = load %"class.std::deque"** %1
  %4 = load %struct.CoState** %2, align 8
  %5 = call %struct.CoState* @_ZSt4moveIR7CoStateEONSt16remove_referenceIT_E4typeEOS3_(%struct.CoState* %4) #2
  call void @_ZNSt5dequeI7CoStateSaIS0_EE12emplace_backIJS0_EEEvDpOT_(%"class.std::deque"* %3, %struct.CoState* %5)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState* @_ZSt4moveIR7CoStateEONSt16remove_referenceIT_E4typeEOS3_(%struct.CoState* %__t) #4 {
  %1 = alloca %struct.CoState*, align 8
  store %struct.CoState* %__t, %struct.CoState** %1, align 8
  %2 = load %struct.CoState** %1, align 8
  ret %struct.CoState* %2
...
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE12emplace_backIJS0_EEEvDpOT_(%"class.std::deque"* %this, %struct.CoState* %__args) #3 align 2 {
  ...
  %2 = alloca %struct.CoState*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  store %struct.CoState* %__args, %struct.CoState** %2, align 8
  %3 = load %"class.std::deque"** %1
  %4 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %5 = getelementptr inbounds %"class.std::_Deque_base"* %4, i32 0, i32 0
  %6 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %5, i32 0, i32 3
  ...
  %13 = load %struct.CoState** %12, align 8
  %14 = getelementptr inbounds %struct.CoState* %13, i64 -1
  %15 = icmp ne %struct.CoState* %8, %14
  br i1 %15, label %16, label %33

; <label>:16                                      ; preds = %0
  %17 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %18 = getelementptr inbounds %"class.std::_Deque_base"* %17, i32 0, i32 0
  %19 = bitcast %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %18 to %"class.std::allocator"*
  %20 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %21 = getelementptr inbounds %"class.std::_Deque_base"* %20, i32 0, i32 0
  %22 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %21, i32 0, i32 3
  %23 = getelementptr inbounds %"struct.std::_Deque_iterator"* %22, i32 0, i32 0
  %24 = load %struct.CoState** %23, align 8
  %25 = load %struct.CoState** %2, align 8
  %26 = call %struct.CoState* @_ZSt7forwardI7CoStateEOT_RNSt16remove_referenceIS1_E4typeE(%struct.CoState* %25) #2
  call void @_ZNSt16allocator_traitsISaI7CoStateEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator"* %19, %struct.CoState* %24, %struct.CoState* %26)
  %27 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %28 = getelementptr inbounds %"class.std::_Deque_base"* %27, i32 0, i32 0
  %29 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %28, i32 0, i32 3
  %30 = getelementptr inbounds %"struct.std::_Deque_iterator"* %29, i32 0, i32 0
  %31 = load %struct.CoState** %30, align 8
  %32 = getelementptr inbounds %struct.CoState* %31, i32 1
  store %struct.CoState* %32, %struct.CoState** %30, align 8
  br label %36

; <label>:33                                      ; preds = %0
  %34 = load %struct.CoState** %2, align 8
  %35 = call %struct.CoState* @_ZSt7forwardI7CoStateEOT_RNSt16remove_referenceIS1_E4typeE(%struct.CoState* %34) #2
  call void @_ZNSt5dequeI7CoStateSaIS0_EE16_M_push_back_auxIJS0_EEEvDpOT_(%"class.std::deque"* %3, %struct.CoState* %35)
  br label %36
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI7CoStateEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator"* %__a, %struct.CoState* %__p, %struct.CoState* %__args) #3 align 2 {
  ...
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %1, align 8
  store %struct.CoState* %__p, %struct.CoState** %2, align 8
  store %struct.CoState* %__args, %struct.CoState** %3, align 8
  %4 = load %"class.std::allocator"** %1, align 8
  %5 = bitcast %"class.std::allocator"* %4 to %"class.__gnu_cxx::new_allocator"*
  %6 = load %struct.CoState** %2, align 8
  %7 = load %struct.CoState** %3, align 8
  %8 = call %struct.CoState* @_ZSt7forwardI7CoStateEOT_RNSt16remove_referenceIS1_E4typeE(%struct.CoState* %7) #2
  call void @_ZN9__gnu_cxx13new_allocatorI7CoStateE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %5, %struct.CoState* %6, %struct.CoState* %8)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState* @_ZSt7forwardI7CoStateEOT_RNSt16remove_referenceIS1_E4typeE(%struct.CoState* %__t) #4 {
  %1 = alloca %struct.CoState*, align 8
  store %struct.CoState* %__t, %struct.CoState** %1, align 8
  %2 = load %struct.CoState** %1, align 8
  ret %struct.CoState* %2
...
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE16_M_push_back_auxIJS0_EEEvDpOT_(%"class.std::deque"* %this, %struct.CoState* %__args) #3 align 2 {
  ...
  store %struct.CoState* %__args, %struct.CoState** %2, align 8
  %3 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeI7CoStateSaIS0_EE22_M_reserve_map_at_backEm(%"class.std::deque"* %3, i64 1)
  %4 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %5 = call %struct.CoState* @_ZNSt11_Deque_baseI7CoStateSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %7, i32 0, i32 3
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator"* %8, i32 0, i32 3
  %10 = load %struct.CoState*** %9, align 8
  %11 = getelementptr inbounds %struct.CoState** %10, i64 1
  store %struct.CoState* %5, %struct.CoState** %11, align 8
  %12 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = bitcast %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %13 to %"class.std::allocator"*
  %15 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %16, i32 0, i32 3
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator"* %17, i32 0, i32 0
  %19 = load %struct.CoState** %18, align 8
  %20 = load %struct.CoState** %2, align 8
  %21 = call %struct.CoState* @_ZSt7forwardI7CoStateEOT_RNSt16remove_referenceIS1_E4typeE(%struct.CoState* %20) #2
  call void @_ZNSt16allocator_traitsISaI7CoStateEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator"* %14, %struct.CoState* %19, %struct.CoState* %21)
  %22 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %23 = getelementptr inbounds %"class.std::_Deque_base"* %22, i32 0, i32 0
  %24 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %23, i32 0, i32 3
  %25 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %26 = getelementptr inbounds %"class.std::_Deque_base"* %25, i32 0, i32 0
  %27 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %26, i32 0, i32 3
  %28 = getelementptr inbounds %"struct.std::_Deque_iterator"* %27, i32 0, i32 3
  %29 = load %struct.CoState*** %28, align 8
  %30 = getelementptr inbounds %struct.CoState** %29, i64 1
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %24, %struct.CoState** %30) #2
  %31 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %32 = getelementptr inbounds %"class.std::_Deque_base"* %31, i32 0, i32 0
  %33 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %32, i32 0, i32 3
  %34 = getelementptr inbounds %"struct.std::_Deque_iterator"* %33, i32 0, i32 1
  %35 = load %struct.CoState** %34, align 8
  %36 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %37, i32 0, i32 3
  %39 = getelementptr inbounds %"struct.std::_Deque_iterator"* %38, i32 0, i32 0
  store %struct.CoState* %35, %struct.CoState** %39, align 8
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE22_M_reserve_map_at_backEm(%"class.std::deque"* %this, i64 %__nodes_to_add) #3 align 2 {
  ...
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %7, i32 0, i32 1
  %9 = load i64* %8, align 8
  %10 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %11 = getelementptr inbounds %"class.std::_Deque_base"* %10, i32 0, i32 0
  %12 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %11, i32 0, i32 3
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator"* %12, i32 0, i32 3
  %14 = load %struct.CoState*** %13, align 8
  %15 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %16, i32 0, i32 0
  %18 = load %struct.CoState*** %17, align 8
  %19 = ptrtoint %struct.CoState** %14 to i64
  %20 = ptrtoint %struct.CoState** %18 to i64
  %21 = sub i64 %19, %20
...
; <label>:25                                      ; preds = %0
  ...
  call void @_ZNSt5dequeI7CoStateSaIS0_EE17_M_reallocate_mapEmb(%"class.std::deque"* %3, i64 %26, i1 zeroext false)
  br label %27
...
define linkonce_odr void @_ZNSt5dequeI7CoStateSaIS0_EE17_M_reallocate_mapEmb(%"class.std::deque"* %this, i64 %__nodes_to_add, i1 zeroext %__add_at_front) #3 align 2 {
  ...
  %__new_nstart = alloca %struct.CoState**, align 8
  %__new_map_size = alloca i64, align 8
  %__new_map = alloca %struct.CoState**, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  store i64 %__nodes_to_add, i64* %2, align 8
  ...
  %13 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %12, i32 0, i32 2
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %13, i32 0, i32 3
  %15 = load %struct.CoState*** %14, align 8
  %16 = ptrtoint %struct.CoState** %10 to i64
  %17 = ptrtoint %struct.CoState** %15 to i64
  %18 = sub i64 %16, %17
...
; <label>:31                                      ; preds = %0
  ...
  %34 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %33, i32 0, i32 0
  %35 = load %struct.CoState*** %34, align 8
  %36 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %37, i32 0, i32 1
  %39 = load i64* %38, align 8
  %40 = load i64* %__new_num_nodes, align 8
  %41 = sub i64 %39, %40
  %42 = udiv i64 %41, 2
  %43 = getelementptr inbounds %struct.CoState** %35, i64 %42
...
; <label>:49                                      ; preds = %48, %46
  ...
  %51 = getelementptr inbounds %struct.CoState** %43, i64 %50
  store %struct.CoState** %51, %struct.CoState*** %__new_nstart, align 8
  %52 = load %struct.CoState*** %__new_nstart, align 8
  %53 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %54 = getelementptr inbounds %"class.std::_Deque_base"* %53, i32 0, i32 0
  %55 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %54, i32 0, i32 2
  %56 = getelementptr inbounds %"struct.std::_Deque_iterator"* %55, i32 0, i32 3
  %57 = load %struct.CoState*** %56, align 8
  %58 = icmp ult %struct.CoState** %52, %57
  br i1 %58, label %59, label %73

; <label>:59                                      ; preds = %49
  %60 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %61 = getelementptr inbounds %"class.std::_Deque_base"* %60, i32 0, i32 0
  %62 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %61, i32 0, i32 2
  %63 = getelementptr inbounds %"struct.std::_Deque_iterator"* %62, i32 0, i32 3
  %64 = load %struct.CoState*** %63, align 8
  %65 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %66 = getelementptr inbounds %"class.std::_Deque_base"* %65, i32 0, i32 0
  %67 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %66, i32 0, i32 3
  %68 = getelementptr inbounds %"struct.std::_Deque_iterator"* %67, i32 0, i32 3
  %69 = load %struct.CoState*** %68, align 8
  %70 = getelementptr inbounds %struct.CoState** %69, i64 1
  %71 = load %struct.CoState*** %__new_nstart, align 8
  %72 = call %struct.CoState** @_ZSt4copyIPP7CoStateS2_ET0_T_S4_S3_(%struct.CoState** %64, %struct.CoState** %70, %struct.CoState** %71)
  br label %89

; <label>:73                                      ; preds = %49
  %74 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %75 = getelementptr inbounds %"class.std::_Deque_base"* %74, i32 0, i32 0
  %76 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %75, i32 0, i32 2
  %77 = getelementptr inbounds %"struct.std::_Deque_iterator"* %76, i32 0, i32 3
  %78 = load %struct.CoState*** %77, align 8
  %79 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %80 = getelementptr inbounds %"class.std::_Deque_base"* %79, i32 0, i32 0
  %81 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %80, i32 0, i32 3
  %82 = getelementptr inbounds %"struct.std::_Deque_iterator"* %81, i32 0, i32 3
  %83 = load %struct.CoState*** %82, align 8
  %84 = getelementptr inbounds %struct.CoState** %83, i64 1
  %85 = load %struct.CoState*** %__new_nstart, align 8
  %86 = load i64* %__old_num_nodes, align 8
  %87 = getelementptr inbounds %struct.CoState** %85, i64 %86
  %88 = call %struct.CoState** @_ZSt13copy_backwardIPP7CoStateS2_ET0_T_S4_S3_(%struct.CoState** %78, %struct.CoState** %84, %struct.CoState** %87)
  br label %89
...
; <label>:90                                      ; preds = %0
  ...
  %93 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %92, i32 0, i32 1
  ...
  %97 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %96, i32 0, i32 1
  ...
  %104 = call %struct.CoState** @_ZNSt11_Deque_baseI7CoStateSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %102, i64 %103)
  store %struct.CoState** %104, %struct.CoState*** %__new_map, align 8
  %105 = load %struct.CoState*** %__new_map, align 8
  %106 = load i64* %__new_map_size, align 8
  %107 = load i64* %__new_num_nodes, align 8
  %108 = sub i64 %106, %107
  %109 = udiv i64 %108, 2
  %110 = getelementptr inbounds %struct.CoState** %105, i64 %109
...
; <label>:116                                     ; preds = %115, %113
  ...
  %118 = getelementptr inbounds %struct.CoState** %110, i64 %117
  store %struct.CoState** %118, %struct.CoState*** %__new_nstart, align 8
  %119 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %120 = getelementptr inbounds %"class.std::_Deque_base"* %119, i32 0, i32 0
  %121 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %120, i32 0, i32 2
  %122 = getelementptr inbounds %"struct.std::_Deque_iterator"* %121, i32 0, i32 3
  %123 = load %struct.CoState*** %122, align 8
  %124 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %125 = getelementptr inbounds %"class.std::_Deque_base"* %124, i32 0, i32 0
  %126 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %125, i32 0, i32 3
  %127 = getelementptr inbounds %"struct.std::_Deque_iterator"* %126, i32 0, i32 3
  %128 = load %struct.CoState*** %127, align 8
  %129 = getelementptr inbounds %struct.CoState** %128, i64 1
  %130 = load %struct.CoState*** %__new_nstart, align 8
  %131 = call %struct.CoState** @_ZSt4copyIPP7CoStateS2_ET0_T_S4_S3_(%struct.CoState** %123, %struct.CoState** %129, %struct.CoState** %130)
  ...
  %135 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %134, i32 0, i32 0
  %136 = load %struct.CoState*** %135, align 8
  %137 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %138 = getelementptr inbounds %"class.std::_Deque_base"* %137, i32 0, i32 0
  %139 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %138, i32 0, i32 1
  %140 = load i64* %139, align 8
  call void @_ZNSt11_Deque_baseI7CoStateSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %132, %struct.CoState** %136, i64 %140) #2
  %141 = load %struct.CoState*** %__new_map, align 8
  %142 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %143 = getelementptr inbounds %"class.std::_Deque_base"* %142, i32 0, i32 0
  %144 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %143, i32 0, i32 0
  store %struct.CoState** %141, %struct.CoState*** %144, align 8
  ...
  %148 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %147, i32 0, i32 1
...
; <label>:149                                     ; preds = %116, %89
  ...
  %152 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %151, i32 0, i32 2
  %153 = load %struct.CoState*** %__new_nstart, align 8
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %152, %struct.CoState** %153) #2
  %154 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %155 = getelementptr inbounds %"class.std::_Deque_base"* %154, i32 0, i32 0
  %156 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %155, i32 0, i32 3
  %157 = load %struct.CoState*** %__new_nstart, align 8
  %158 = load i64* %__old_num_nodes, align 8
  %159 = getelementptr inbounds %struct.CoState** %157, i64 %158
  %160 = getelementptr inbounds %struct.CoState** %159, i64 -1
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %156, %struct.CoState** %160) #2
  ret void
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.CoState** @_ZSt4copyIPP7CoStateS2_ET0_T_S4_S3_(%struct.CoState** %__first, %struct.CoState** %__last, %struct.CoState** %__result) #9 {
  %1 = alloca %struct.CoState**, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  store %struct.CoState** %__first, %struct.CoState*** %1, align 8
  store %struct.CoState** %__last, %struct.CoState*** %2, align 8
  store %struct.CoState** %__result, %struct.CoState*** %3, align 8
  %4 = load %struct.CoState*** %1, align 8
  %5 = call %struct.CoState** @_ZSt12__miter_baseIPP7CoStateENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.CoState** %4)
  %6 = load %struct.CoState*** %2, align 8
  %7 = call %struct.CoState** @_ZSt12__miter_baseIPP7CoStateENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.CoState** %6)
  %8 = load %struct.CoState*** %3, align 8
  %9 = call %struct.CoState** @_ZSt14__copy_move_a2ILb0EPP7CoStateS2_ET1_T0_S4_S3_(%struct.CoState** %5, %struct.CoState** %7, %struct.CoState** %8)
  ret %struct.CoState** %9
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.CoState** @_ZSt13copy_backwardIPP7CoStateS2_ET0_T_S4_S3_(%struct.CoState** %__first, %struct.CoState** %__last, %struct.CoState** %__result) #9 {
  %1 = alloca %struct.CoState**, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  store %struct.CoState** %__first, %struct.CoState*** %1, align 8
  ...
  %7 = call %struct.CoState** @_ZSt12__miter_baseIPP7CoStateENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.CoState** %6)
  %8 = load %struct.CoState*** %3, align 8
  %9 = call %struct.CoState** @_ZSt23__copy_move_backward_a2ILb0EPP7CoStateS2_ET1_T0_S4_S3_(%struct.CoState** %5, %struct.CoState** %7, %struct.CoState** %8)
  ret %struct.CoState** %9
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.CoState** @_ZSt23__copy_move_backward_a2ILb0EPP7CoStateS2_ET1_T0_S4_S3_(%struct.CoState** %__first, %struct.CoState** %__last, %struct.CoState** %__result) #9 {
  %1 = alloca %struct.CoState**, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  store %struct.CoState** %__first, %struct.CoState*** %1, align 8
  ...
  store %struct.CoState** %__result, %struct.CoState*** %3, align 8
  %4 = load %struct.CoState*** %1, align 8
  %5 = call %struct.CoState** @_ZSt12__niter_baseIPP7CoStateENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.CoState** %4)
  %6 = load %struct.CoState*** %2, align 8
  %7 = call %struct.CoState** @_ZSt12__niter_baseIPP7CoStateENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.CoState** %6)
  %8 = load %struct.CoState*** %3, align 8
  %9 = call %struct.CoState** @_ZSt12__niter_baseIPP7CoStateENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.CoState** %8)
  %10 = call %struct.CoState** @_ZSt22__copy_move_backward_aILb0EPP7CoStateS2_ET1_T0_S4_S3_(%struct.CoState** %5, %struct.CoState** %7, %struct.CoState** %9)
  ret %struct.CoState** %10
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.CoState** @_ZSt12__miter_baseIPP7CoStateENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.CoState** %__it) #9 {
  %1 = alloca %struct.CoState**, align 8
  store %struct.CoState** %__it, %struct.CoState*** %1, align 8
  %2 = load %struct.CoState*** %1, align 8
  %3 = call %struct.CoState** @_ZNSt10_Iter_baseIPP7CoStateLb0EE7_S_baseES2_(%struct.CoState** %2)
  ret %struct.CoState** %3
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState** @_ZNSt10_Iter_baseIPP7CoStateLb0EE7_S_baseES2_(%struct.CoState** %__it) #4 align 2 {
  %1 = alloca %struct.CoState**, align 8
  store %struct.CoState** %__it, %struct.CoState*** %1, align 8
  %2 = load %struct.CoState*** %1, align 8
  ret %struct.CoState** %2
...
; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.CoState** @_ZSt22__copy_move_backward_aILb0EPP7CoStateS2_ET1_T0_S4_S3_(%struct.CoState** %__first, %struct.CoState** %__last, %struct.CoState** %__result) #9 {
  %1 = alloca %struct.CoState**, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  %__simple = alloca i8, align 1
  ...
  %5 = load %struct.CoState*** %2, align 8
  %6 = load %struct.CoState*** %3, align 8
  %7 = call %struct.CoState** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIP7CoStateEEPT_PKS5_S8_S6_(%struct.CoState** %4, %struct.CoState** %5, %struct.CoState** %6)
  ret %struct.CoState** %7
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr %struct.CoState** @_ZSt12__niter_baseIPP7CoStateENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.CoState** %__it) #5 {
  %1 = alloca %struct.CoState**, align 8
  store %struct.CoState** %__it, %struct.CoState*** %1, align 8
  %2 = load %struct.CoState*** %1, align 8
  %3 = call %struct.CoState** @_ZNSt10_Iter_baseIPP7CoStateLb0EE7_S_baseES2_(%struct.CoState** %2)
...
; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIP7CoStateEEPT_PKS5_S8_S6_(%struct.CoState** %__first, %struct.CoState** %__last, %struct.CoState** %__result) #4 align 2 {
  %1 = alloca %struct.CoState**, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  %_Num = alloca i64, align 8
  ...
  store %struct.CoState** %__result, %struct.CoState*** %3, align 8
  %4 = load %struct.CoState*** %2, align 8
  %5 = load %struct.CoState*** %1, align 8
  %6 = ptrtoint %struct.CoState** %4 to i64
  %7 = ptrtoint %struct.CoState** %5 to i64
  %8 = sub i64 %6, %7
...
; <label>:12                                      ; preds = %0
  %13 = load %struct.CoState*** %3, align 8
  %14 = load i64* %_Num, align 8
  %15 = sub i64 0, %14
  %16 = getelementptr inbounds %struct.CoState** %13, i64 %15
  %17 = bitcast %struct.CoState** %16 to i8*
  %18 = load %struct.CoState*** %1, align 8
  %19 = bitcast %struct.CoState** %18 to i8*
...
; <label>:22                                      ; preds = %12, %0
  %23 = load %struct.CoState*** %3, align 8
  %24 = load i64* %_Num, align 8
  %25 = sub i64 0, %24
  %26 = getelementptr inbounds %struct.CoState** %23, i64 %25
  ret %struct.CoState** %26
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.CoState** @_ZSt14__copy_move_a2ILb0EPP7CoStateS2_ET1_T0_S4_S3_(%struct.CoState** %__first, %struct.CoState** %__last, %struct.CoState** %__result) #9 {
  %1 = alloca %struct.CoState**, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  store %struct.CoState** %__first, %struct.CoState*** %1, align 8
  ...
  %8 = load %struct.CoState*** %3, align 8
  %9 = call %struct.CoState** @_ZSt12__niter_baseIPP7CoStateENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.CoState** %8)
  %10 = call %struct.CoState** @_ZSt13__copy_move_aILb0EPP7CoStateS2_ET1_T0_S4_S3_(%struct.CoState** %5, %struct.CoState** %7, %struct.CoState** %9)
  ret %struct.CoState** %10
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.CoState** @_ZSt13__copy_move_aILb0EPP7CoStateS2_ET1_T0_S4_S3_(%struct.CoState** %__first, %struct.CoState** %__last, %struct.CoState** %__result) #9 {
  %1 = alloca %struct.CoState**, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  %__simple = alloca i8, align 1
  ...
  %5 = load %struct.CoState*** %2, align 8
  %6 = load %struct.CoState*** %3, align 8
  %7 = call %struct.CoState** @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIP7CoStateEEPT_PKS5_S8_S6_(%struct.CoState** %4, %struct.CoState** %5, %struct.CoState** %6)
  ret %struct.CoState** %7
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState** @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIP7CoStateEEPT_PKS5_S8_S6_(%struct.CoState** %__first, %struct.CoState** %__last, %struct.CoState** %__result) #4 align 2 {
  %1 = alloca %struct.CoState**, align 8
  %2 = alloca %struct.CoState**, align 8
  %3 = alloca %struct.CoState**, align 8
  %_Num = alloca i64, align 8
...
; <label>:12                                      ; preds = %0
  %13 = load %struct.CoState*** %3, align 8
  %14 = bitcast %struct.CoState** %13 to i8*
  %15 = load %struct.CoState*** %1, align 8
  %16 = bitcast %struct.CoState** %15 to i8*
  %17 = load i64* %_Num, align 8
  %18 = mul i64 8, %17
...
; <label>:19                                      ; preds = %12, %0
  %20 = load %struct.CoState*** %3, align 8
  %21 = load i64* %_Num, align 8
  %22 = getelementptr inbounds %struct.CoState** %20, i64 %21
  ret %struct.CoState** %22
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI7CoStateE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %this, %struct.CoState* %__p, %struct.CoState* %__args) #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %2 = alloca %struct.CoState*, align 8
  %3 = alloca %struct.CoState*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %1, align 8
  ...
  %5 = load %struct.CoState** %2, align 8
  %6 = bitcast %struct.CoState* %5 to i8*
  %7 = icmp eq i8* %6, null
  br i1 %7, label %14, label %8

; <label>:8                                       ; preds = %0
  %9 = bitcast i8* %6 to %struct.CoState*
  %10 = load %struct.CoState** %3, align 8
  %11 = call %struct.CoState* @_ZSt7forwardI7CoStateEOT_RNSt16remove_referenceIS1_E4typeE(%struct.CoState* %10) #2
  %12 = bitcast %struct.CoState* %9 to i8*
  %13 = bitcast %struct.CoState* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %12, i8* %13, i64 16, i32 8, i1 false)
  br label %14

; <label>:14                                      ; preds = %8, %0
  %15 = phi %struct.CoState* [ %9, %8 ], [ null, %0 ]
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState* @_ZNSt5dequeI7CoStateSaIS0_EE4backEv(%"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  %__tmp = alloca %"struct.std::_Deque_iterator", align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeI7CoStateSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* sret %__tmp, %"class.std::deque"* %2) #2
  %3 = call %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EmmEv(%"struct.std::_Deque_iterator"* %__tmp) #2
  %4 = call %struct.CoState* @_ZNKSt15_Deque_iteratorI7CoStateRS0_PS0_EdeEv(%"struct.std::_Deque_iterator"* %__tmp) #2
  ret %struct.CoState* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_EmmEv(%"struct.std::_Deque_iterator"* %this) #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
  %4 = load %struct.CoState** %3, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 1
  %6 = load %struct.CoState** %5, align 8
  %7 = icmp eq %struct.CoState* %4, %6
...
; <label>:8                                       ; preds = %0
  ...
  %10 = load %struct.CoState*** %9, align 8
  %11 = getelementptr inbounds %struct.CoState** %10, i64 -1
  call void @_ZNSt15_Deque_iteratorI7CoStateRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %2, %struct.CoState** %11) #2
  ...
  store %struct.CoState* %13, %struct.CoState** %14, align 8
  br label %15

; <label>:15                                      ; preds = %8, %0
  %16 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
  %17 = load %struct.CoState** %16, align 8
  %18 = getelementptr inbounds %struct.CoState* %17, i32 -1
  store %struct.CoState* %18, %struct.CoState** %16, align 8
  ret %"struct.std::_Deque_iterator"* %2
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.CoState* @_ZNKSt15_Deque_iteratorI7CoStateRS0_PS0_EdeEv(%"struct.std::_Deque_iterator"* %this) #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt5dequeI7CoStateSaIS0_EE5emptyEv(%"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  ...
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<CoState, std::allocator<CoState> >::_Deque_impl"* %7, i32 0, i32 2
  %9 = call zeroext i1 @_ZSteqI7CoStateRS0_PS0_EbRKSt15_Deque_iteratorIT_T0_T1_ES9_(%"struct.std::_Deque_iterator"* %5, %"struct.std::_Deque_iterator"* %8) #2
  ret i1 %9
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr zeroext i1 @_ZSteqI7CoStateRS0_PS0_EbRKSt15_Deque_iteratorIT_T0_T1_ES9_(%"struct.std::_Deque_iterator"* %__x, %"struct.std::_Deque_iterator"* %__y) #5 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
