; ModuleID = 'PostorderTraversals/po_05_iterative_complex.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %6 = alloca i8*
  %7 = alloca i32
  %current = alloca %struct.TreeNode*, align 8
...
; <label>:14                                      ; preds = %13
  ...
  store %struct.TreeNode* %15, %struct.TreeNode** %current, align 8
  store %struct.TreeNode* null, %struct.TreeNode** %lastVisited, align 8
  br label %16

; <label>:16                                      ; preds = %70, %14
  %17 = load %struct.TreeNode** %current, align 8
  %18 = icmp ne %struct.TreeNode* %17, null
  br i1 %18, label %23, label %19

; <label>:19                                      ; preds = %16
  %20 = invoke zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %st)
...
; <label>:25                                      ; preds = %23
  %26 = load %struct.TreeNode** %current, align 8
  %27 = icmp ne %struct.TreeNode* %26, null
  br i1 %27, label %28, label %45

; <label>:28                                      ; preds = %25
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %current)
          to label %29 unwind label %41

; <label>:29                                      ; preds = %28
  %30 = load %struct.TreeNode** %current, align 8
  %31 = getelementptr inbounds %struct.TreeNode* %30, i32 0, i32 1
  %32 = load %struct.TreeNode** %31, align 8
  store %struct.TreeNode* %32, %struct.TreeNode** %current, align 8
  br label %70
...
; <label>:45                                      ; preds = %25
  %46 = invoke %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %st)
          to label %47 unwind label %41

; <label>:47                                      ; preds = %45
  %48 = load %struct.TreeNode** %46
  store %struct.TreeNode* %48, %struct.TreeNode** %peekNode, align 8
  %49 = load %struct.TreeNode** %peekNode, align 8
  %50 = getelementptr inbounds %struct.TreeNode* %49, i32 0, i32 2
  %51 = load %struct.TreeNode** %50, align 8
  %52 = icmp ne %struct.TreeNode* %51, null
  br i1 %52, label %53, label %63

; <label>:53                                      ; preds = %47
  %54 = load %struct.TreeNode** %lastVisited, align 8
  %55 = load %struct.TreeNode** %peekNode, align 8
  %56 = getelementptr inbounds %struct.TreeNode* %55, i32 0, i32 2
  %57 = load %struct.TreeNode** %56, align 8
  %58 = icmp ne %struct.TreeNode* %54, %57
  br i1 %58, label %59, label %63

; <label>:59                                      ; preds = %53
  %60 = load %struct.TreeNode** %peekNode, align 8
  %61 = getelementptr inbounds %struct.TreeNode* %60, i32 0, i32 2
  %62 = load %struct.TreeNode** %61, align 8
  store %struct.TreeNode* %62, %struct.TreeNode** %current, align 8
  br label %69

; <label>:63                                      ; preds = %53, %47
  %64 = load %struct.TreeNode** %peekNode, align 8
  %65 = getelementptr inbounds %struct.TreeNode* %64, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %65)
          to label %66 unwind label %41

; <label>:66                                      ; preds = %63
  %67 = load %struct.TreeNode** %peekNode, align 8
  store %struct.TreeNode* %67, %struct.TreeNode** %lastVisited, align 8
