...
; <label>:10                                      ; preds = %0
  ...
  store %struct.TreeNode* %11, %struct.TreeNode** %current, align 8
  store %struct.TreeNode* null, %struct.TreeNode** %lastVisited, align 8
  br label %12

; <label>:12                                      ; preds = %49, %10
  %13 = load %struct.TreeNode** %current, align 8
  %14 = icmp ne %struct.TreeNode* %13, null
  br i1 %14, label %18, label %15

; <label>:15                                      ; preds = %12
  %16 = call zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %st)
  %17 = xor i1 %16, true
  br label %18
...
; <label>:20                                      ; preds = %18
  %21 = load %struct.TreeNode** %current, align 8
  %22 = icmp ne %struct.TreeNode* %21, null
  br i1 %22, label %23, label %27

; <label>:23                                      ; preds = %20
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %current)
  %24 = load %struct.TreeNode** %current, align 8
  %25 = getelementptr inbounds %struct.TreeNode* %24, i32 0, i32 1
  %26 = load %struct.TreeNode** %25, align 8
  store %struct.TreeNode* %26, %struct.TreeNode** %current, align 8
  br label %49

; <label>:27                                      ; preds = %20
  %28 = call %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %st)
...
; <label>:34                                      ; preds = %27
  %35 = load %struct.TreeNode** %lastVisited, align 8
  %36 = load %struct.TreeNode** %peekNode, align 8
  %37 = getelementptr inbounds %struct.TreeNode* %36, i32 0, i32 2
  %38 = load %struct.TreeNode** %37, align 8
  %39 = icmp ne %struct.TreeNode* %35, %38
  br i1 %39, label %40, label %44

; <label>:40                                      ; preds = %34
  %41 = load %struct.TreeNode** %peekNode, align 8
  %42 = getelementptr inbounds %struct.TreeNode* %41, i32 0, i32 2
  %43 = load %struct.TreeNode** %42, align 8
  store %struct.TreeNode* %43, %struct.TreeNode** %current, align 8
  br label %48

; <label>:44                                      ; preds = %34, %27
  %45 = load %struct.TreeNode** %peekNode, align 8
  %46 = getelementptr inbounds %struct.TreeNode* %45, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %46)
  %47 = load %struct.TreeNode** %peekNode, align 8
  store %struct.TreeNode* %47, %struct.TreeNode** %lastVisited, align 8
