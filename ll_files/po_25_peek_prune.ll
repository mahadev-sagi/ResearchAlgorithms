...
; <label>:22                                      ; preds = %20
  ...
  %25 = getelementptr inbounds %struct.TreeNode* %24, i32 0, i32 1
  %26 = load %struct.TreeNode** %25, align 8
  %27 = icmp eq %struct.TreeNode* %26, null
...
; <label>:33                                      ; preds = %28, %22
  ...
  %35 = zext i1 %34 to i8
  store i8 %35, i8* %isLeaf, align 1
  %36 = load %struct.TreeNode** %prev, align 8
...
; <label>:38                                      ; preds = %33
  ...
  %42 = load %struct.TreeNode** %prev, align 8
  %43 = icmp eq %struct.TreeNode* %41, %42
...
; <label>:44                                      ; preds = %38
  ...
  %48 = load %struct.TreeNode** %prev, align 8
  %49 = icmp eq %struct.TreeNode* %47, %48
  br label %50
...
; <label>:52                                      ; preds = %50, %33
  ...
  %54 = zext i1 %53 to i8
  store i8 %54, i8* %childrenVisited, align 1
  %55 = load i8* %isLeaf, align 1
  %56 = trunc i8 %55 to i1
  br i1 %56, label %60, label %57

; <label>:57                                      ; preds = %52
  %58 = load i8* %childrenVisited, align 1
...
; <label>:60                                      ; preds = %57, %52
  ...
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %62)
...
; <label>:64                                      ; preds = %63
  ...
  store %struct.TreeNode* %65, %struct.TreeNode** %prev, align 8
  br label %97
...
; <label>:74                                      ; preds = %92, %83, %63, %60, %20, %16, %14
...
; <label>:78                                      ; preds = %57
  ...
  %82 = icmp ne %struct.TreeNode* %81, null
  br i1 %82, label %83, label %87

; <label>:83                                      ; preds = %78
  %84 = load %struct.TreeNode** %curr, align 8
  %85 = getelementptr inbounds %struct.TreeNode* %84, i32 0, i32 2
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %85)
...
; <label>:87                                      ; preds = %86, %78
  ...
  %90 = load %struct.TreeNode** %89, align 8
  %91 = icmp ne %struct.TreeNode* %90, null
  br i1 %91, label %92, label %96

; <label>:92                                      ; preds = %87
  %93 = load %struct.TreeNode** %curr, align 8
  %94 = getelementptr inbounds %struct.TreeNode* %93, i32 0, i32 1
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %94)
