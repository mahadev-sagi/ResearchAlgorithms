...
define void @_Z18in_order_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  call void @_ZN15InOrderIteratorC2EP4Node(%class.InOrderIterator* %it, %struct.Node* %4)
  call void @_ZN15InOrderIteratorC2Ev(%class.InOrderIterator* %end)
  br label %5

; <label>:5                                       ; preds = %7, %0
  %6 = call zeroext i1 @_ZNK15InOrderIteratorneERKS_(%class.InOrderIterator* %it, %class.InOrderIterator* %end)
  br i1 %6, label %7, label %11

; <label>:7                                       ; preds = %5
  %8 = load %"class.std::vector"** %2, align 8
  %9 = call i32 @_ZNK15InOrderIteratordeEv(%class.InOrderIterator* %it)
  store i32 %9, i32* %3
  call void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %8, i32* %3)
  %10 = call %class.InOrderIterator* @_ZN15InOrderIteratorppEv(%class.InOrderIterator* %it)
  br label %5

; <label>:11                                      ; preds = %5
  call void @_ZN15InOrderIteratorD2Ev(%class.InOrderIterator* %end) #0
  call void @_ZN15InOrderIteratorD2Ev(%class.InOrderIterator* %it) #0
  ret void
}
...
define linkonce_odr void @_ZN15InOrderIteratorC2EP4Node(%class.InOrderIterator* %this, %struct.Node* %root) unnamed_addr #3 align 2 {
  ...
  %4 = load %class.InOrderIterator** %1
  %5 = bitcast %class.InOrderIterator* %4 to %"struct.std::iterator"*
  %6 = getelementptr inbounds %class.InOrderIterator* %4, i32 0, i32 0
  call void @_ZNSt5dequeIP4NodeSaIS1_EEC2Ev(%"class.std::deque"* %3)
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %6, %"class.std::deque"* %3)
  call void @_ZNSt5dequeIP4NodeSaIS1_EED2Ev(%"class.std::deque"* %3) #0
  %7 = getelementptr inbounds %class.InOrderIterator* %4, i32 0, i32 1
  %8 = load %struct.Node** %2, align 8
  store %struct.Node* %8, %struct.Node** %7, align 8
  call void @_ZN15InOrderIterator9push_leftEv(%class.InOrderIterator* %4)
  ret void
}
...
define linkonce_odr void @_ZN15InOrderIteratorC2Ev(%class.InOrderIterator* %this) unnamed_addr #3 align 2 {
  ...
  %4 = bitcast %class.InOrderIterator* %3 to %"struct.std::iterator"*
  %5 = getelementptr inbounds %class.InOrderIterator* %3, i32 0, i32 0
  call void @_ZNSt5dequeIP4NodeSaIS1_EEC2Ev(%"class.std::deque"* %2)
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %5, %"class.std::deque"* %2)
  call void @_ZNSt5dequeIP4NodeSaIS1_EED2Ev(%"class.std::deque"* %2) #0
  %6 = getelementptr inbounds %class.InOrderIterator* %3, i32 0, i32 1
...
define linkonce_odr %struct.Node** @_ZNKSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  %4 = call %struct.Node** @_ZNKSt5dequeIP4NodeSaIS1_EE4backEv(%"class.std::deque"* %3) #0
  ret %struct.Node** %4
}
...
define linkonce_odr %struct.Node** @_ZNKSt5dequeIP4NodeSaIS1_EE4backEv(%"class.std::deque"* %this) #3 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  %__tmp = alloca %"struct.std::_Deque_iterator.10", align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  call void @_ZNKSt5dequeIP4NodeSaIS1_EE3endEv(%"struct.std::_Deque_iterator.10"* sret %__tmp, %"class.std::deque"* %2) #0
  %3 = call %"struct.std::_Deque_iterator.10"* @_ZNSt15_Deque_iteratorIP4NodeRKS1_PS2_EmmEv(%"struct.std::_Deque_iterator.10"* %__tmp) #0
  %4 = call %struct.Node** @_ZNKSt15_Deque_iteratorIP4NodeRKS1_PS2_EdeEv(%"struct.std::_Deque_iterator.10"* %__tmp) #0
  ret %struct.Node** %4
}
...
define linkonce_odr void @_ZNKSt5dequeIP4NodeSaIS1_EE3endEv(%"struct.std::_Deque_iterator.10"* noalias sret %agg.result, %"class.std::deque"* %this) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %4, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorIP4NodeRKS1_PS2_EC2ERKS_IS1_RS1_PS1_E(%"struct.std::_Deque_iterator.10"* %agg.result, %"struct.std::_Deque_iterator"* %5) #0
  ret void
}
...
define linkonce_odr %"struct.std::_Deque_iterator.10"* @_ZNSt15_Deque_iteratorIP4NodeRKS1_PS2_EmmEv(%"struct.std::_Deque_iterator.10"* %this) #3 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator.10"*, align 8
  store %"struct.std::_Deque_iterator.10"* %this, %"struct.std::_Deque_iterator.10"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator.10"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %2, i32 0, i32 0
  %4 = load %struct.Node*** %3, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %2, i32 0, i32 1
  %6 = load %struct.Node*** %5, align 8
  %7 = icmp eq %struct.Node** %4, %6
  br i1 %7, label %8, label %15

; <label>:8                                       ; preds = %0
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %2, i32 0, i32 3
  %10 = load %struct.Node**** %9, align 8
  %11 = getelementptr inbounds %struct.Node*** %10, i64 -1
  call void @_ZNSt15_Deque_iteratorIP4NodeRKS1_PS2_E11_M_set_nodeEPPS1_(%"struct.std::_Deque_iterator.10"* %2, %struct.Node*** %11) #0
  %12 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %2, i32 0, i32 2
  %13 = load %struct.Node*** %12, align 8
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %2, i32 0, i32 0
  store %struct.Node** %13, %struct.Node*** %14, align 8
  br label %15

; <label>:15                                      ; preds = %8, %0
  %16 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %2, i32 0, i32 0
  %17 = load %struct.Node*** %16, align 8
  %18 = getelementptr inbounds %struct.Node** %17, i32 -1
  store %struct.Node** %18, %struct.Node*** %16, align 8
  ret %"struct.std::_Deque_iterator.10"* %2
}
...
define linkonce_odr void @_ZNSt15_Deque_iteratorIP4NodeRKS1_PS2_E11_M_set_nodeEPPS1_(%"struct.std::_Deque_iterator.10"* %this, %struct.Node*** %__new_node) #3 align 2 {
  ...
  store %"struct.std::_Deque_iterator.10"* %this, %"struct.std::_Deque_iterator.10"** %1, align 8
  store %struct.Node*** %__new_node, %struct.Node**** %2, align 8
  %3 = load %"struct.std::_Deque_iterator.10"** %1
  %4 = load %struct.Node**** %2, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %3, i32 0, i32 3
  store %struct.Node*** %4, %struct.Node**** %5, align 8
  %6 = load %struct.Node**** %2, align 8
  %7 = load %struct.Node*** %6, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %3, i32 0, i32 1
  store %struct.Node** %7, %struct.Node*** %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %3, i32 0, i32 1
  %10 = load %struct.Node*** %9, align 8
  %11 = call i64 @_ZNSt15_Deque_iteratorIP4NodeRKS1_PS2_E14_S_buffer_sizeEv() #0
  %12 = getelementptr inbounds %struct.Node** %10, i64 %11
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %3, i32 0, i32 2
  store %struct.Node** %12, %struct.Node*** %13, align 8
  ret void
}
...
define linkonce_odr void @_ZNSt15_Deque_iteratorIP4NodeRKS1_PS2_EC2ERKS_IS1_RS1_PS1_E(%"struct.std::_Deque_iterator.10"* %this, %"struct.std::_Deque_iterator"* %__x) unnamed_addr #3 align 2 {
  ...
  store %"struct.std::_Deque_iterator"* %__x, %"struct.std::_Deque_iterator"** %2, align 8
  %3 = load %"struct.std::_Deque_iterator.10"** %1
  %4 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %3, i32 0, i32 0
  %5 = load %"struct.std::_Deque_iterator"** %2, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator"* %5, i32 0, i32 0
  %7 = load %struct.Node*** %6, align 8
  store %struct.Node** %7, %struct.Node*** %4, align 8
  ...
  %11 = load %struct.Node*** %10, align 8
  store %struct.Node** %11, %struct.Node*** %8, align 8
  %12 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %3, i32 0, i32 2
  %13 = load %"struct.std::_Deque_iterator"** %2, align 8
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %13, i32 0, i32 2
  %15 = load %struct.Node*** %14, align 8
  store %struct.Node** %15, %struct.Node*** %12, align 8
  %16 = getelementptr inbounds %"struct.std::_Deque_iterator.10"* %3, i32 0, i32 3
  %17 = load %"struct.std::_Deque_iterator"** %2, align 8
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator"* %17, i32 0, i32 3
  %19 = load %struct.Node**** %18, align 8
  store %struct.Node*** %19, %struct.Node**** %16, align 8
