...
; <label>:9                                       ; preds = %0
  ...
  %14 = getelementptr inbounds [2000 x %struct.TreeNode*]* %stack, i32 0, i64 %13
  store %struct.TreeNode* %10, %struct.TreeNode** %14, align 8
  br label %15

; <label>:15                                      ; preds = %56, %9
  %16 = load i32* %top, align 4
...
; <label>:18                                      ; preds = %15
  ...
  %20 = add nsw i32 %19, -1
  store i32 %20, i32* %top, align 4
  %21 = sext i32 %19 to i64
  %22 = getelementptr inbounds [2000 x %struct.TreeNode*]* %stack, i32 0, i64 %21
  ...
  %27 = load i32* %outIndex, align 4
  %28 = add nsw i32 %27, 1
  store i32 %28, i32* %outIndex, align 4
  %29 = sext i32 %27 to i64
  %30 = getelementptr inbounds [2000 x i32]* %output, i32 0, i64 %29
...
; <label>:35                                      ; preds = %18
  ...
  %42 = getelementptr inbounds [2000 x %struct.TreeNode*]* %stack, i32 0, i64 %41
  store %struct.TreeNode* %38, %struct.TreeNode** %42, align 8
  br label %43

; <label>:43                                      ; preds = %35, %18
  %44 = load %struct.TreeNode** %node, align 8
  %45 = getelementptr inbounds %struct.TreeNode* %44, i32 0, i32 2
...
; <label>:48                                      ; preds = %43
  ...
  %53 = add nsw i32 %52, 1
  store i32 %53, i32* %top, align 4
  %54 = sext i32 %53 to i64
  %55 = getelementptr inbounds [2000 x %struct.TreeNode*]* %stack, i32 0, i64 %54
  store %struct.TreeNode* %51, %struct.TreeNode** %55, align 8
  br label %56
...
; <label>:63                                      ; preds = %60
  ...
  %66 = getelementptr inbounds [2000 x i32]* %output, i32 0, i64 %65
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %66)
  br label %67
