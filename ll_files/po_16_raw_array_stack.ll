; ModuleID = 'PostorderTraversals/po_16_raw_array_stack.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %stack = alloca [2000 x %struct.TreeNode*], align 16
  %top = alloca i32, align 4
  %output = alloca [2000 x i32], align 16
...
; <label>:11                                      ; preds = %0
  store i32 2000, i32* %MAX_SIZE, align 4
  store i32 -1, i32* %top, align 4
  store i32 0, i32* %outIndex, align 4
  %12 = load %struct.TreeNode** %2, align 8
  %13 = load i32* %top, align 4
  %14 = add nsw i32 %13, 1
  store i32 %14, i32* %top, align 4
  %15 = sext i32 %14 to i64
  %16 = getelementptr inbounds [2000 x %struct.TreeNode*]* %stack, i32 0, i64 %15
  store %struct.TreeNode* %12, %struct.TreeNode** %16, align 8
  br label %17
...
; <label>:20                                      ; preds = %17
  ...
  %24 = getelementptr inbounds [2000 x %struct.TreeNode*]* %stack, i32 0, i64 %23
  ...
  %29 = load i32* %outIndex, align 4
  %30 = add nsw i32 %29, 1
  store i32 %30, i32* %outIndex, align 4
  %31 = sext i32 %29 to i64
  %32 = getelementptr inbounds [2000 x i32]* %output, i32 0, i64 %31
  ...
  %36 = icmp ne %struct.TreeNode* %35, null
...
; <label>:37                                      ; preds = %20
  ...
  %41 = load i32* %top, align 4
  %42 = add nsw i32 %41, 1
  store i32 %42, i32* %top, align 4
  %43 = sext i32 %42 to i64
  %44 = getelementptr inbounds [2000 x %struct.TreeNode*]* %stack, i32 0, i64 %43
  store %struct.TreeNode* %40, %struct.TreeNode** %44, align 8
  br label %45

; <label>:45                                      ; preds = %37, %20
  %46 = load %struct.TreeNode** %node, align 8
  %47 = getelementptr inbounds %struct.TreeNode* %46, i32 0, i32 2
...
; <label>:50                                      ; preds = %45
  ...
  %54 = load i32* %top, align 4
  %55 = add nsw i32 %54, 1
  store i32 %55, i32* %top, align 4
  %56 = sext i32 %55 to i64
  %57 = getelementptr inbounds [2000 x %struct.TreeNode*]* %stack, i32 0, i64 %56
  store %struct.TreeNode* %53, %struct.TreeNode** %57, align 8
  br label %58
...
; <label>:65                                      ; preds = %62
  ...
  %68 = getelementptr inbounds [2000 x i32]* %output, i32 0, i64 %67
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %68)
