...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %stack = alloca [100000 x %struct.TreeNode*], align 16
  %top = alloca i32, align 4
  %output = alloca [100000 x i32], align 16
...
; <label>:9                                       ; preds = %0
  ...
  %14 = getelementptr inbounds [100000 x %struct.TreeNode*]* %stack, i32 0, i64 %13
...
; <label>:18                                      ; preds = %15
  ...
  %22 = getelementptr inbounds [100000 x %struct.TreeNode*]* %stack, i32 0, i64 %21
  ...
  %30 = getelementptr inbounds [100000 x i32]* %output, i32 0, i64 %29
...
; <label>:35                                      ; preds = %18
  ...
  %42 = getelementptr inbounds [100000 x %struct.TreeNode*]* %stack, i32 0, i64 %41
...
; <label>:48                                      ; preds = %43
  ...
  %55 = getelementptr inbounds [100000 x %struct.TreeNode*]* %stack, i32 0, i64 %54
...
; <label>:63                                      ; preds = %60
  ...
  %66 = getelementptr inbounds [100000 x i32]* %output, i32 0, i64 %65
