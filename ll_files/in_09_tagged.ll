...
define linkonce_odr %"struct.std::pair"** @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  ...
  call void @_ZNKSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE20_M_get_map_allocatorEv(%"class.std::allocator.8"* sret %__map_alloc, %"class.std::_Deque_base"* %4) #0
  %5 = load i64* %2, align 8
  %6 = call %"struct.std::pair"** @_ZNSt16allocator_traitsISaIPSt4pairIiP4NodeEEE8allocateERS5_m(%"class.std::allocator.8"* %__map_alloc, i64 %5)
  store i32 1, i32* %3
  call void @_ZNSaIPSt4pairIiP4NodeEED2Ev(%"class.std::allocator.8"* %__map_alloc) #0
  ret %"struct.std::pair"** %6
}
...
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE17_M_deallocate_mapEPPS3_m(%"class.std::_Deque_base"* %this, %"struct.std::pair"** %__p, i64 %__n) #3 align 2 {
  ...
  %5 = load %"struct.std::pair"*** %2, align 8
  %6 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIPSt4pairIiP4NodeEEE10deallocateERS5_PS4_m(%"class.std::allocator.8"* %__map_alloc, %"struct.std::pair"** %5, i64 %6)
  call void @_ZNSaIPSt4pairIiP4NodeEED2Ev(%"class.std::allocator.8"* %__map_alloc) #0
  ret void
}
...
define linkonce_odr void @_ZNKSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE20_M_get_map_allocatorEv(%"class.std::allocator.8"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  call void @_ZNSaIPSt4pairIiP4NodeEEC2IS2_EERKSaIT_E(%"class.std::allocator.8"* %agg.result, %"class.std::allocator.0"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaIPSt4pairIiP4NodeEED2Ev(%"class.std::allocator.8"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEED2Ev(%"class.__gnu_cxx::new_allocator.9"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaIPSt4pairIiP4NodeEEC2IS2_EERKSaIT_E(%"class.std::allocator.8"* %this, %"class.std::allocator.0"*) unnamed_addr #3 align 2 {
  ...
  %5 = bitcast %"class.std::allocator.8"* %4 to %"class.__gnu_cxx::new_allocator.9"*
  call void @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEEC2Ev(%"class.__gnu_cxx::new_allocator.9"* %5) #0
  ret void
}
...
define linkonce_odr %"struct.std::pair"** @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.9"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.9"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.9"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
