; ModuleID = 'InorderTraversals/in_09_tagged.cpp'
...
; <label>:17                                      ; preds = %0
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EEC2Ev(%"class.std::deque"* %3)
  invoke void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEEC2EOS6_(%"class.std::stack"* %s, %"class.std::deque"* %3)
          to label %18 unwind label %38

; <label>:18                                      ; preds = %17
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EED2Ev(%"class.std::deque"* %3) #2
  store i32 0, i32* %7
  invoke void @_ZNSt4pairIiP4NodeEC2IiRS1_vEEOT_OT0_(%"struct.std::pair"* %6, i32* %7, %struct.Node** %1)
          to label %19 unwind label %42

; <label>:19                                      ; preds = %18
  invoke void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE4pushEOS3_(%"class.std::stack"* %s, %"struct.std::pair"* %6)
          to label %20 unwind label %42

; <label>:20                                      ; preds = %19
  br label %21

; <label>:21                                      ; preds = %65, %37, %20
  %22 = invoke zeroext i1 @_ZNKSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE5emptyEv(%"class.std::stack"* %s)
...
; <label>:25                                      ; preds = %23
  %26 = invoke %"struct.std::pair"* @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE3topEv(%"class.std::stack"* %s)
          to label %27 unwind label %42

; <label>:27                                      ; preds = %25
  %28 = getelementptr inbounds %"struct.std::pair"* %26, i32 0, i32 0
  %29 = load i32* %28, align 4
  store i32 %29, i32* %color, align 4
  %30 = invoke %"struct.std::pair"* @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE3topEv(%"class.std::stack"* %s)
          to label %31 unwind label %42

; <label>:31                                      ; preds = %27
  %32 = getelementptr inbounds %"struct.std::pair"* %30, i32 0, i32 1
  %33 = load %struct.Node** %32, align 8
  store %struct.Node* %33, %struct.Node** %node, align 8
  invoke void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE3popEv(%"class.std::stack"* %s)
...
; <label>:42                                      ; preds = %60, %58, %55, %54, %53, %52, %49, %31, %27, %25, %21, %19, %18
  ...
  store i32 %45, i32* %5
  call void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEED2Ev(%"class.std::stack"* %s) #2
  br label %68

; <label>:46                                      ; preds = %34
  %47 = load i32* %color, align 4
  %48 = icmp eq i32 %47, 0
  br i1 %48, label %49, label %60

; <label>:49                                      ; preds = %46
  store i32 0, i32* %9
  %50 = load %struct.Node** %node, align 8
  %51 = getelementptr inbounds %struct.Node* %50, i32 0, i32 2
  invoke void @_ZNSt4pairIiP4NodeEC2IiRS1_vEEOT_OT0_(%"struct.std::pair"* %8, i32* %9, %struct.Node** %51)
          to label %52 unwind label %42

; <label>:52                                      ; preds = %49
  invoke void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE4pushEOS3_(%"class.std::stack"* %s, %"struct.std::pair"* %8)
          to label %53 unwind label %42

; <label>:53                                      ; preds = %52
  store i32 1, i32* %11
  invoke void @_ZNSt4pairIiP4NodeEC2IiRS1_vEEOT_OT0_(%"struct.std::pair"* %10, i32* %11, %struct.Node** %node)
          to label %54 unwind label %42

; <label>:54                                      ; preds = %53
  invoke void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE4pushEOS3_(%"class.std::stack"* %s, %"struct.std::pair"* %10)
...
; <label>:55                                      ; preds = %54
  ...
  invoke void @_ZNSt4pairIiP4NodeEC2IiRS1_vEEOT_OT0_(%"struct.std::pair"* %12, i32* %13, %struct.Node** %57)
          to label %58 unwind label %42

; <label>:58                                      ; preds = %55
  invoke void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE4pushEOS3_(%"class.std::stack"* %s, %"struct.std::pair"* %12)
...
; <label>:60                                      ; preds = %46
  %61 = load %"class.std::vector"** %2, align 8
  %62 = load %struct.Node** %node, align 8
  %63 = getelementptr inbounds %struct.Node* %62, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %61, i32* %63)
...
define linkonce_odr void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEEC2EOS6_(%"class.std::stack"* %this, %"class.std::deque"* %__c) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::deque"* @_ZSt4moveIRSt5dequeISt4pairIiP4NodeESaIS4_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::deque"* %5) #2
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EEC2EOS5_(%"class.std::deque"* %4, %"class.std::deque"* %6)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EEC2Ev(%"class.std::deque"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EEC2Ev(%"class.std::_Deque_base"* %3)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EED2Ev(%"class.std::deque"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  ...
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE5beginEv(%"struct.std::_Deque_iterator"* sret %2, %"class.std::deque"* %6) #2
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE3endEv(%"struct.std::_Deque_iterator"* sret %3, %"class.std::deque"* %6) #2
  %7 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  %8 = call %"class.std::allocator.0"* @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %7) #2
  invoke void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE15_M_destroy_dataESt15_Deque_iteratorIS3_RS3_PS3_ES9_RKS4_(%"class.std::deque"* %6, %"struct.std::_Deque_iterator"* %2, %"struct.std::_Deque_iterator"* %3, %"class.std::allocator.0"* %8)
          to label %9 unwind label %11

; <label>:9                                       ; preds = %0
  %10 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EED2Ev(%"class.std::_Deque_base"* %10) #2
  ret void
...
; <label>:11                                      ; preds = %0
  ...
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EED2Ev(%"class.std::_Deque_base"* %15) #2
  br label %16
...
define linkonce_odr void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE4pushEOS3_(%"class.std::stack"* %this, %"struct.std::pair"* %__x) #3 align 2 {
  ...
  %6 = call %"struct.std::pair"* @_ZSt4moveIRSt4pairIiP4NodeEEONSt16remove_referenceIT_E4typeEOS6_(%"struct.std::pair"* %5) #2
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE9push_backEOS3_(%"class.std::deque"* %4, %"struct.std::pair"* %6)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt4pairIiP4NodeEC2IiRS1_vEEOT_OT0_(%"struct.std::pair"* %this, i32* %__x, %struct.Node** %__y) unnamed_addr #4 align 2 {
  ...
  %11 = call %struct.Node** @_ZSt7forwardIRP4NodeEOT_RNSt16remove_referenceIS3_E4typeE(%struct.Node** %10) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE5emptyEv(%"class.std::stack"* %this) #4 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  %4 = call zeroext i1 @_ZNKSt5dequeISt4pairIiP4NodeESaIS3_EE5emptyEv(%"class.std::deque"* %3) #2
  ret i1 %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE3topEv(%"class.std::stack"* %this) #4 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  %4 = call %"struct.std::pair"* @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE4backEv(%"class.std::deque"* %3) #2
  ret %"struct.std::pair"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEE3popEv(%"class.std::stack"* %this) #4 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE8pop_backEv(%"class.std::deque"* %3) #2
  ret void
}
...
define linkonce_odr void @_ZNSt5stackISt4pairIiP4NodeESt5dequeIS3_SaIS3_EEED2Ev(%"class.std::stack"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE8pop_backEv(%"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %4, i32 0, i32 3
  ...
  %10 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %9, i32 0, i32 3
...
; <label>:14                                      ; preds = %0
  ...
  %17 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %16, i32 0, i32 3
  ...
  %23 = bitcast %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %22 to %"class.std::allocator.0"*
  %24 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %25, i32 0, i32 3
  %27 = getelementptr inbounds %"struct.std::_Deque_iterator"* %26, i32 0, i32 0
  %28 = load %"struct.std::pair"** %27, align 8
  invoke void @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE7destroyIS3_EEvRS4_PT_(%"class.std::allocator.0"* %23, %"struct.std::pair"* %28)
...
; <label>:30                                      ; preds = %0
  invoke void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE15_M_pop_back_auxEv(%"class.std::deque"* %2)
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE7destroyIS3_EEvRS4_PT_(%"class.std::allocator.0"* %__a, %"struct.std::pair"* %__p) #3 align 2 {
  ...
  %5 = load %"struct.std::pair"** %2, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE7destroyIS4_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %4, %"struct.std::pair"* %5)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE15_M_pop_back_auxEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  %6 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %5, i32 0, i32 3
  %7 = getelementptr inbounds %"struct.std::_Deque_iterator"* %6, i32 0, i32 1
  %8 = load %"struct.std::pair"** %7, align 8
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE18_M_deallocate_nodeEPS3_(%"class.std::_Deque_base"* %3, %"struct.std::pair"* %8) #2
  %9 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %10 = getelementptr inbounds %"class.std::_Deque_base"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %10, i32 0, i32 3
  %12 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %13, i32 0, i32 3
  ...
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E11_M_set_nodeEPS5_(%"struct.std::_Deque_iterator"* %11, %"struct.std::pair"** %17) #2
  %18 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %19 = getelementptr inbounds %"class.std::_Deque_base"* %18, i32 0, i32 0
  %20 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %19, i32 0, i32 3
  ...
  %29 = call %"class.std::allocator.0"* @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %28) #2
  %30 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %31 = getelementptr inbounds %"class.std::_Deque_base"* %30, i32 0, i32 0
  %32 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %31, i32 0, i32 3
  %33 = getelementptr inbounds %"struct.std::_Deque_iterator"* %32, i32 0, i32 0
  %34 = load %"struct.std::pair"** %33, align 8
  call void @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE7destroyIS3_EEvRS4_PT_(%"class.std::allocator.0"* %29, %"struct.std::pair"* %34)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE18_M_deallocate_nodeEPS3_(%"class.std::_Deque_base"* %this, %"struct.std::pair"* %__p) #4 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = bitcast %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %4 to %"class.std::allocator.0"*
  %6 = load %"struct.std::pair"** %2, align 8
  %7 = invoke i64 @_ZSt16__deque_buf_sizem(i64 16)
          to label %8 unwind label %10

; <label>:8                                       ; preds = %0
  invoke void @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE10deallocateERS4_PS3_m(%"class.std::allocator.0"* %5, %"struct.std::pair"* %6, i64 %7)
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E11_M_set_nodeEPS5_(%"struct.std::_Deque_iterator"* %this, %"struct.std::pair"** %__new_node) #4 align 2 {
  ...
  %11 = call i64 @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E14_S_buffer_sizeEv() #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.0"* @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %this) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %4 = bitcast %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3 to %"class.std::allocator.0"*
  ret %"class.std::allocator.0"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E14_S_buffer_sizeEv() #4 align 2 {
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE10deallocateERS4_PS3_m(%"class.std::allocator.0"* %__a, %"struct.std::pair"* %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %"struct.std::pair"** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE10deallocateEPS4_m(%"class.__gnu_cxx::new_allocator.1"* %5, %"struct.std::pair"* %6, i64 %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE10deallocateEPS4_m(%"class.__gnu_cxx::new_allocator.1"* %this, %"struct.std::pair"* %__p, i64) #4 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE7destroyIS4_EEvPT_(%"class.__gnu_cxx::new_allocator.1"* %this, %"struct.std::pair"* %__p) #4 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE4backEv(%"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  %__tmp = alloca %"struct.std::_Deque_iterator", align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE3endEv(%"struct.std::_Deque_iterator"* sret %__tmp, %"class.std::deque"* %2) #2
  %3 = call %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EmmEv(%"struct.std::_Deque_iterator"* %__tmp) #2
  %4 = call %"struct.std::pair"* @_ZNKSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EdeEv(%"struct.std::_Deque_iterator"* %__tmp) #2
  ret %"struct.std::pair"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE3endEv(%"struct.std::_Deque_iterator"* noalias sret %agg.result, %"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %4, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2ERKS6_(%"struct.std::_Deque_iterator"* %agg.result, %"struct.std::_Deque_iterator"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EmmEv(%"struct.std::_Deque_iterator"* %this) #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
...
; <label>:8                                       ; preds = %0
  ...
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E11_M_set_nodeEPS5_(%"struct.std::_Deque_iterator"* %2, %"struct.std::pair"** %11) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZNKSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EdeEv(%"struct.std::_Deque_iterator"* %this) #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2ERKS6_(%"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"* %__x) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt5dequeISt4pairIiP4NodeESaIS3_EE5emptyEv(%"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  ...
  %8 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %7, i32 0, i32 2
  %9 = call zeroext i1 @_ZSteqISt4pairIiP4NodeERS3_PS3_EbRKSt15_Deque_iteratorIT_T0_T1_ESC_(%"struct.std::_Deque_iterator"* %5, %"struct.std::_Deque_iterator"* %8) #2
  ret i1 %9
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr zeroext i1 @_ZSteqISt4pairIiP4NodeERS3_PS3_EbRKSt15_Deque_iteratorIT_T0_T1_ESC_(%"struct.std::_Deque_iterator"* %__x, %"struct.std::_Deque_iterator"* %__y) #5 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
...
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE9push_backEOS3_(%"class.std::deque"* %this, %"struct.std::pair"* %__x) #3 align 2 {
  ...
  %4 = load %"struct.std::pair"** %2, align 8
  %5 = call %"struct.std::pair"* @_ZSt4moveIRSt4pairIiP4NodeEEONSt16remove_referenceIT_E4typeEOS6_(%"struct.std::pair"* %4) #2
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE12emplace_backIJS3_EEEvDpOT_(%"class.std::deque"* %3, %"struct.std::pair"* %5)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt4moveIRSt4pairIiP4NodeEEONSt16remove_referenceIT_E4typeEOS6_(%"struct.std::pair"* %__t) #4 {
  %1 = alloca %"struct.std::pair"*, align 8
...
; <label>:16                                      ; preds = %0
  ...
  %19 = bitcast %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %18 to %"class.std::allocator.0"*
  %20 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %21 = getelementptr inbounds %"class.std::_Deque_base"* %20, i32 0, i32 0
  %22 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %21, i32 0, i32 3
  ...
  %26 = call %"struct.std::pair"* @_ZSt7forwardISt4pairIiP4NodeEEOT_RNSt16remove_referenceIS4_E4typeE(%"struct.std::pair"* %25) #2
  call void @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE9constructIS3_JS3_EEEvRS4_PT_DpOT0_(%"class.std::allocator.0"* %19, %"struct.std::pair"* %24, %"struct.std::pair"* %26)
  %27 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %28 = getelementptr inbounds %"class.std::_Deque_base"* %27, i32 0, i32 0
  %29 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %28, i32 0, i32 3
...
; <label>:33                                      ; preds = %0
  ...
  %35 = call %"struct.std::pair"* @_ZSt7forwardISt4pairIiP4NodeEEOT_RNSt16remove_referenceIS4_E4typeE(%"struct.std::pair"* %34) #2
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE16_M_push_back_auxIJS3_EEEvDpOT_(%"class.std::deque"* %3, %"struct.std::pair"* %35)
  br label %36
...
define linkonce_odr void @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE9constructIS3_JS3_EEEvRS4_PT_DpOT0_(%"class.std::allocator.0"* %__a, %"struct.std::pair"* %__p, %"struct.std::pair"* %__args) #3 align 2 {
  ...
  %8 = call %"struct.std::pair"* @_ZSt7forwardISt4pairIiP4NodeEEOT_RNSt16remove_referenceIS4_E4typeE(%"struct.std::pair"* %7) #2
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE9constructIS4_JS4_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %5, %"struct.std::pair"* %6, %"struct.std::pair"* %8)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"* @_ZSt7forwardISt4pairIiP4NodeEEOT_RNSt16remove_referenceIS4_E4typeE(%"struct.std::pair"* %__t) #4 {
  %1 = alloca %"struct.std::pair"*, align 8
  store %"struct.std::pair"* %__t, %"struct.std::pair"** %1, align 8
  %2 = load %"struct.std::pair"** %1, align 8
  ret %"struct.std::pair"* %2
...
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE16_M_push_back_auxIJS3_EEEvDpOT_(%"class.std::deque"* %this, %"struct.std::pair"* %__args) #3 align 2 {
  ...
  store %"struct.std::pair"* %__args, %"struct.std::pair"** %2, align 8
  %3 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE22_M_reserve_map_at_backEm(%"class.std::deque"* %3, i64 1)
  %4 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %5 = call %"struct.std::pair"* @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %7, i32 0, i32 3
  ...
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = bitcast %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %13 to %"class.std::allocator.0"*
  ...
  %21 = call %"struct.std::pair"* @_ZSt7forwardISt4pairIiP4NodeEEOT_RNSt16remove_referenceIS4_E4typeE(%"struct.std::pair"* %20) #2
  call void @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE9constructIS3_JS3_EEEvRS4_PT_DpOT0_(%"class.std::allocator.0"* %14, %"struct.std::pair"* %19, %"struct.std::pair"* %21)
  %22 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %23 = getelementptr inbounds %"class.std::_Deque_base"* %22, i32 0, i32 0
  %24 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %23, i32 0, i32 3
  %25 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %26 = getelementptr inbounds %"class.std::_Deque_base"* %25, i32 0, i32 0
  %27 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %26, i32 0, i32 3
  ...
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E11_M_set_nodeEPS5_(%"struct.std::_Deque_iterator"* %24, %"struct.std::pair"** %30) #2
  %31 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %32 = getelementptr inbounds %"class.std::_Deque_base"* %31, i32 0, i32 0
  %33 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %32, i32 0, i32 3
  ...
  %38 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %37, i32 0, i32 3
...
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE22_M_reserve_map_at_backEm(%"class.std::deque"* %this, i64 %__nodes_to_add) #3 align 2 {
  ...
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %7, i32 0, i32 1
  %9 = load i64* %8, align 8
  %10 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %11 = getelementptr inbounds %"class.std::_Deque_base"* %10, i32 0, i32 0
  %12 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %11, i32 0, i32 3
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator"* %12, i32 0, i32 3
  %14 = load %"struct.std::pair"*** %13, align 8
  %15 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %16, i32 0, i32 0
...
; <label>:25                                      ; preds = %0
  ...
  call void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE17_M_reallocate_mapEmb(%"class.std::deque"* %3, i64 %26, i1 zeroext false)
  br label %27
...
define linkonce_odr %"struct.std::pair"* @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  %6 = call %"struct.std::pair"* @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE8allocateERS4_m(%"class.std::allocator.0"* %4, i64 %5)
...
define linkonce_odr %"struct.std::pair"* @_ZNSt16allocator_traitsISaISt4pairIiP4NodeEEE8allocateERS4_m(%"class.std::allocator.0"* %__a, i64 %__n) #3 align 2 {
  ...
  %4 = bitcast %"class.std::allocator.0"* %3 to %"class.__gnu_cxx::new_allocator.1"*
  %5 = load i64* %2, align 8
  %6 = call %"struct.std::pair"* @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %4, i64 %5, i8* null)
  ret %"struct.std::pair"* %6
}
...
define linkonce_odr %"struct.std::pair"* @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.1"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %5) #2
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %this) #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
  store %"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"** %1, align 8
...
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE17_M_reallocate_mapEmb(%"class.std::deque"* %this, i64 %__nodes_to_add, i1 zeroext %__add_at_front) #3 align 2 {
  ...
  %13 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %12, i32 0, i32 2
  ...
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %25, i32 0, i32 1
...
; <label>:31                                      ; preds = %0
  ...
  %34 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %33, i32 0, i32 0
  %35 = load %"struct.std::pair"*** %34, align 8
  %36 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %37, i32 0, i32 1
...
; <label>:49                                      ; preds = %48, %46
  ...
  %55 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %54, i32 0, i32 2
...
; <label>:59                                      ; preds = %49
  ...
  %62 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %61, i32 0, i32 2
  ...
  %67 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %66, i32 0, i32 3
  ...
  %72 = call %"struct.std::pair"** @_ZSt4copyIPPSt4pairIiP4NodeES5_ET0_T_S7_S6_(%"struct.std::pair"** %64, %"struct.std::pair"** %70, %"struct.std::pair"** %71)
  br label %89

; <label>:73                                      ; preds = %49
  %74 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %75 = getelementptr inbounds %"class.std::_Deque_base"* %74, i32 0, i32 0
  %76 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %75, i32 0, i32 2
  ...
  %81 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %80, i32 0, i32 3
  ...
  %88 = call %"struct.std::pair"** @_ZSt13copy_backwardIPPSt4pairIiP4NodeES5_ET0_T_S7_S6_(%"struct.std::pair"** %78, %"struct.std::pair"** %84, %"struct.std::pair"** %87)
  br label %89
...
; <label>:90                                      ; preds = %0
  ...
  %93 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %92, i32 0, i32 1
  ...
  %97 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %96, i32 0, i32 1
  ...
  %104 = call %"struct.std::pair"** @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %102, i64 %103)
...
; <label>:116                                     ; preds = %115, %113
  ...
  %121 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %120, i32 0, i32 2
  ...
  %126 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %125, i32 0, i32 3
  ...
  %131 = call %"struct.std::pair"** @_ZSt4copyIPPSt4pairIiP4NodeES5_ET0_T_S7_S6_(%"struct.std::pair"** %123, %"struct.std::pair"** %129, %"struct.std::pair"** %130)
  ...
  %135 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %134, i32 0, i32 0
  ...
  %139 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %138, i32 0, i32 1
  %140 = load i64* %139, align 8
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE17_M_deallocate_mapEPPS3_m(%"class.std::_Deque_base"* %132, %"struct.std::pair"** %136, i64 %140) #2
  ...
  %144 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %143, i32 0, i32 0
  ...
  %148 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %147, i32 0, i32 1
...
; <label>:149                                     ; preds = %116, %89
  ...
  %152 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %151, i32 0, i32 2
  %153 = load %"struct.std::pair"*** %__new_nstart, align 8
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E11_M_set_nodeEPS5_(%"struct.std::_Deque_iterator"* %152, %"struct.std::pair"** %153) #2
  %154 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %155 = getelementptr inbounds %"class.std::_Deque_base"* %154, i32 0, i32 0
  %156 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %155, i32 0, i32 3
  ...
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E11_M_set_nodeEPS5_(%"struct.std::_Deque_iterator"* %156, %"struct.std::pair"** %160) #2
  ret void
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %"struct.std::pair"** @_ZSt4copyIPPSt4pairIiP4NodeES5_ET0_T_S7_S6_(%"struct.std::pair"** %__first, %"struct.std::pair"** %__last, %"struct.std::pair"** %__result) #9 {
  %1 = alloca %"struct.std::pair"**, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
  ...
  %5 = call %"struct.std::pair"** @_ZSt12__miter_baseIPPSt4pairIiP4NodeEENSt11_Miter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %4)
  %6 = load %"struct.std::pair"*** %2, align 8
  %7 = call %"struct.std::pair"** @_ZSt12__miter_baseIPPSt4pairIiP4NodeEENSt11_Miter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %6)
  %8 = load %"struct.std::pair"*** %3, align 8
  %9 = call %"struct.std::pair"** @_ZSt14__copy_move_a2ILb0EPPSt4pairIiP4NodeES5_ET1_T0_S7_S6_(%"struct.std::pair"** %5, %"struct.std::pair"** %7, %"struct.std::pair"** %8)
  ret %"struct.std::pair"** %9
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %"struct.std::pair"** @_ZSt13copy_backwardIPPSt4pairIiP4NodeES5_ET0_T_S7_S6_(%"struct.std::pair"** %__first, %"struct.std::pair"** %__last, %"struct.std::pair"** %__result) #9 {
  %1 = alloca %"struct.std::pair"**, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
  store %"struct.std::pair"** %__first, %"struct.std::pair"*** %1, align 8
  ...
  %7 = call %"struct.std::pair"** @_ZSt12__miter_baseIPPSt4pairIiP4NodeEENSt11_Miter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %6)
  %8 = load %"struct.std::pair"*** %3, align 8
  %9 = call %"struct.std::pair"** @_ZSt23__copy_move_backward_a2ILb0EPPSt4pairIiP4NodeES5_ET1_T0_S7_S6_(%"struct.std::pair"** %5, %"struct.std::pair"** %7, %"struct.std::pair"** %8)
  ret %"struct.std::pair"** %9
}
...
define linkonce_odr %"struct.std::pair"** @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  ...
  call void @_ZNKSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE20_M_get_map_allocatorEv(%"class.std::allocator.8"* sret %__map_alloc, %"class.std::_Deque_base"* %6) #2
  %7 = load i64* %2, align 8
  %8 = invoke %"struct.std::pair"** @_ZNSt16allocator_traitsISaIPSt4pairIiP4NodeEEE8allocateERS5_m(%"class.std::allocator.8"* %__map_alloc, i64 %7)
          to label %9 unwind label %10

; <label>:9                                       ; preds = %0
  store i32 1, i32* %5
  call void @_ZNSaIPSt4pairIiP4NodeEED2Ev(%"class.std::allocator.8"* %__map_alloc) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE17_M_deallocate_mapEPPS3_m(%"class.std::_Deque_base"* %this, %"struct.std::pair"** %__p, i64 %__n) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca i64, align 8
  %__map_alloc = alloca %"class.std::allocator.8", align 1
  ...
  invoke void @_ZNSt16allocator_traitsISaIPSt4pairIiP4NodeEEE10deallocateERS5_PS4_m(%"class.std::allocator.8"* %__map_alloc, %"struct.std::pair"** %7, i64 %8)
          to label %9 unwind label %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNKSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE20_M_get_map_allocatorEv(%"class.std::allocator.8"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = call %"class.std::allocator.0"* @_ZNKSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %2) #2
  call void @_ZNSaIPSt4pairIiP4NodeEEC2IS2_EERKSaIT_E(%"class.std::allocator.8"* %agg.result, %"class.std::allocator.0"* %3) #2
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIPSt4pairIiP4NodeEEE10deallocateERS5_PS4_m(%"class.std::allocator.8"* %__a, %"struct.std::pair"** %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %"struct.std::pair"*** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEE10deallocateEPS5_m(%"class.__gnu_cxx::new_allocator.9"* %5, %"struct.std::pair"** %6, i64 %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIPSt4pairIiP4NodeEED2Ev(%"class.std::allocator.8"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator.8"*, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEED2Ev(%"class.__gnu_cxx::new_allocator.9"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEED2Ev(%"class.__gnu_cxx::new_allocator.9"* %this) unnamed_addr #4 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEE10deallocateEPS5_m(%"class.__gnu_cxx::new_allocator.9"* %this, %"struct.std::pair"** %__p, i64) #4 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIPSt4pairIiP4NodeEEC2IS2_EERKSaIT_E(%"class.std::allocator.8"* %this, %"class.std::allocator.0"*) unnamed_addr #4 align 2 {
  ...
  %5 = bitcast %"class.std::allocator.8"* %4 to %"class.__gnu_cxx::new_allocator.9"*
  call void @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEEC2Ev(%"class.__gnu_cxx::new_allocator.9"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.0"* @_ZNKSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %this) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEEC2Ev(%"class.__gnu_cxx::new_allocator.9"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.9"*, align 8
  store %"class.__gnu_cxx::new_allocator.9"* %this, %"class.__gnu_cxx::new_allocator.9"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.9"** %1
  ret void
...
define linkonce_odr %"struct.std::pair"** @_ZNSt16allocator_traitsISaIPSt4pairIiP4NodeEEE8allocateERS5_m(%"class.std::allocator.8"* %__a, i64 %__n) #3 align 2 {
  ...
  %5 = load i64* %2, align 8
  %6 = call %"struct.std::pair"** @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.9"* %4, i64 %5, i8* null)
  ret %"struct.std::pair"** %6
}
...
define linkonce_odr %"struct.std::pair"** @_ZN9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.9"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.9"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.9"* %5) #2
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorIPSt4pairIiP4NodeEE8max_sizeEv(%"class.__gnu_cxx::new_allocator.9"* %this) #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.9"*, align 8
  store %"class.__gnu_cxx::new_allocator.9"* %this, %"class.__gnu_cxx::new_allocator.9"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.9"** %1
...
; Function Attrs: inlinehint uwtable
define linkonce_odr %"struct.std::pair"** @_ZSt23__copy_move_backward_a2ILb0EPPSt4pairIiP4NodeES5_ET1_T0_S7_S6_(%"struct.std::pair"** %__first, %"struct.std::pair"** %__last, %"struct.std::pair"** %__result) #9 {
  %1 = alloca %"struct.std::pair"**, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
  store %"struct.std::pair"** %__first, %"struct.std::pair"*** %1, align 8
  ...
  store %"struct.std::pair"** %__result, %"struct.std::pair"*** %3, align 8
  %4 = load %"struct.std::pair"*** %1, align 8
  %5 = call %"struct.std::pair"** @_ZSt12__niter_baseIPPSt4pairIiP4NodeEENSt11_Niter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %4)
  %6 = load %"struct.std::pair"*** %2, align 8
  %7 = call %"struct.std::pair"** @_ZSt12__niter_baseIPPSt4pairIiP4NodeEENSt11_Niter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %6)
  %8 = load %"struct.std::pair"*** %3, align 8
  %9 = call %"struct.std::pair"** @_ZSt12__niter_baseIPPSt4pairIiP4NodeEENSt11_Niter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %8)
  %10 = call %"struct.std::pair"** @_ZSt22__copy_move_backward_aILb0EPPSt4pairIiP4NodeES5_ET1_T0_S7_S6_(%"struct.std::pair"** %5, %"struct.std::pair"** %7, %"struct.std::pair"** %9)
  ret %"struct.std::pair"** %10
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %"struct.std::pair"** @_ZSt12__miter_baseIPPSt4pairIiP4NodeEENSt11_Miter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %__it) #9 {
  %1 = alloca %"struct.std::pair"**, align 8
  store %"struct.std::pair"** %__it, %"struct.std::pair"*** %1, align 8
  %2 = load %"struct.std::pair"*** %1, align 8
  %3 = call %"struct.std::pair"** @_ZNSt10_Iter_baseIPPSt4pairIiP4NodeELb0EE7_S_baseES5_(%"struct.std::pair"** %2)
  ret %"struct.std::pair"** %3
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"** @_ZNSt10_Iter_baseIPPSt4pairIiP4NodeELb0EE7_S_baseES5_(%"struct.std::pair"** %__it) #4 align 2 {
  %1 = alloca %"struct.std::pair"**, align 8
  store %"struct.std::pair"** %__it, %"struct.std::pair"*** %1, align 8
  %2 = load %"struct.std::pair"*** %1, align 8
  ret %"struct.std::pair"** %2
...
; Function Attrs: inlinehint uwtable
define linkonce_odr %"struct.std::pair"** @_ZSt22__copy_move_backward_aILb0EPPSt4pairIiP4NodeES5_ET1_T0_S7_S6_(%"struct.std::pair"** %__first, %"struct.std::pair"** %__last, %"struct.std::pair"** %__result) #9 {
  %1 = alloca %"struct.std::pair"**, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
  %__simple = alloca i8, align 1
  ...
  %5 = load %"struct.std::pair"*** %2, align 8
  %6 = load %"struct.std::pair"*** %3, align 8
  %7 = call %"struct.std::pair"** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIPSt4pairIiP4NodeEEEPT_PKS8_SB_S9_(%"struct.std::pair"** %4, %"struct.std::pair"** %5, %"struct.std::pair"** %6)
  ret %"struct.std::pair"** %7
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr %"struct.std::pair"** @_ZSt12__niter_baseIPPSt4pairIiP4NodeEENSt11_Niter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %__it) #5 {
  %1 = alloca %"struct.std::pair"**, align 8
  store %"struct.std::pair"** %__it, %"struct.std::pair"*** %1, align 8
  %2 = load %"struct.std::pair"*** %1, align 8
  %3 = call %"struct.std::pair"** @_ZNSt10_Iter_baseIPPSt4pairIiP4NodeELb0EE7_S_baseES5_(%"struct.std::pair"** %2)
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIPSt4pairIiP4NodeEEEPT_PKS8_SB_S9_(%"struct.std::pair"** %__first, %"struct.std::pair"** %__last, %"struct.std::pair"** %__result) #4 align 2 {
  %1 = alloca %"struct.std::pair"**, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
  %_Num = alloca i64, align 8
...
; Function Attrs: inlinehint uwtable
define linkonce_odr %"struct.std::pair"** @_ZSt14__copy_move_a2ILb0EPPSt4pairIiP4NodeES5_ET1_T0_S7_S6_(%"struct.std::pair"** %__first, %"struct.std::pair"** %__last, %"struct.std::pair"** %__result) #9 {
  %1 = alloca %"struct.std::pair"**, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
  store %"struct.std::pair"** %__first, %"struct.std::pair"*** %1, align 8
  ...
  %8 = load %"struct.std::pair"*** %3, align 8
  %9 = call %"struct.std::pair"** @_ZSt12__niter_baseIPPSt4pairIiP4NodeEENSt11_Niter_baseIT_E13iterator_typeES7_(%"struct.std::pair"** %8)
  %10 = call %"struct.std::pair"** @_ZSt13__copy_move_aILb0EPPSt4pairIiP4NodeES5_ET1_T0_S7_S6_(%"struct.std::pair"** %5, %"struct.std::pair"** %7, %"struct.std::pair"** %9)
  ret %"struct.std::pair"** %10
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %"struct.std::pair"** @_ZSt13__copy_move_aILb0EPPSt4pairIiP4NodeES5_ET1_T0_S7_S6_(%"struct.std::pair"** %__first, %"struct.std::pair"** %__last, %"struct.std::pair"** %__result) #9 {
  %1 = alloca %"struct.std::pair"**, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
  %__simple = alloca i8, align 1
  ...
  %5 = load %"struct.std::pair"*** %2, align 8
  %6 = load %"struct.std::pair"*** %3, align 8
  %7 = call %"struct.std::pair"** @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIPSt4pairIiP4NodeEEEPT_PKS8_SB_S9_(%"struct.std::pair"** %4, %"struct.std::pair"** %5, %"struct.std::pair"** %6)
  ret %"struct.std::pair"** %7
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"** @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIPSt4pairIiP4NodeEEEPT_PKS8_SB_S9_(%"struct.std::pair"** %__first, %"struct.std::pair"** %__last, %"struct.std::pair"** %__result) #4 align 2 {
  %1 = alloca %"struct.std::pair"**, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
  %_Num = alloca i64, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEE9constructIS4_JS4_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %this, %"struct.std::pair"* %__p, %"struct.std::pair"* %__args) #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
  %2 = alloca %"struct.std::pair"*, align 8
  %3 = alloca %"struct.std::pair"*, align 8
  store %"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"** %1, align 8
...
; <label>:8                                       ; preds = %0
  ...
  %11 = call %"struct.std::pair"* @_ZSt7forwardISt4pairIiP4NodeEEOT_RNSt16remove_referenceIS4_E4typeE(%"struct.std::pair"* %10) #2
...
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EEC2EOS5_(%"class.std::deque"* %this, %"class.std::deque"* %__x) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::deque"* @_ZSt4moveIRSt5dequeISt4pairIiP4NodeESaIS4_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::deque"* %5) #2
  %7 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EEC2EOS5_(%"class.std::_Deque_base"* %4, %"class.std::_Deque_base"* %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::deque"* @_ZSt4moveIRSt5dequeISt4pairIiP4NodeESaIS4_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::deque"* %__t) #4 {
  %1 = alloca %"class.std::deque"*, align 8
...
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EEC2EOS5_(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %7 = call %"class.std::_Deque_base"* @_ZSt4moveIRSt11_Deque_baseISt4pairIiP4NodeESaIS4_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::_Deque_base"* %6) #2
  %8 = bitcast %"struct.__gnu_cxx::__allocator_always_compares_equal"* %4 to %"struct.std::integral_constant"*
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EEC2EOS5_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %5, %"class.std::_Deque_base"* %7)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EEC2EOS5_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %9 = call %"class.std::allocator.0"* @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %8) #2
  %10 = call %"class.std::allocator.0"* @_ZSt4moveIRSaISt4pairIiP4NodeEEEONSt16remove_referenceIT_E4typeEOS7_(%"class.std::allocator.0"* %9) #2
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_implC2EOS4_(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %7, %"class.std::allocator.0"* %10) #2
  invoke void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %6, i64 0)
          to label %11 unwind label %21

; <label>:11                                      ; preds = %0
  %12 = load %"class.std::_Deque_base"** %2, align 8
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %13, i32 0, i32 0
  %15 = load %"struct.std::pair"*** %14, align 8
...
; <label>:17                                      ; preds = %11
  ...
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_impl12_M_swap_dataERS6_(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %18, %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %20) #2
  br label %25
...
; <label>:21                                      ; preds = %0
  ...
  store i32 %24, i32* %5
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %7) #2
  br label %26
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::_Deque_base"* @_ZSt4moveIRSt11_Deque_baseISt4pairIiP4NodeESaIS4_EEEONSt16remove_referenceIT_E4typeEOS9_(%"class.std::_Deque_base"* %__t) #4 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_implC2EOS4_(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %this, %"class.std::allocator.0"* %__a) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"*, align 8
  %2 = alloca %"class.std::allocator.0"*, align 8
  store %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %this, %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %1, align 8
  store %"class.std::allocator.0"* %__a, %"class.std::allocator.0"** %2, align 8
  %3 = load %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %1
  %4 = bitcast %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3 to %"class.std::allocator.0"*
  %5 = load %"class.std::allocator.0"** %2, align 8
  %6 = call %"class.std::allocator.0"* @_ZSt4moveIRSaISt4pairIiP4NodeEEEONSt16remove_referenceIT_E4typeEOS7_(%"class.std::allocator.0"* %5) #2
  call void @_ZNSaISt4pairIiP4NodeEEC2ERKS3_(%"class.std::allocator.0"* %4, %"class.std::allocator.0"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 0
  store %"struct.std::pair"** null, %"struct.std::pair"*** %7, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 1
  store i64 0, i64* %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2Ev(%"struct.std::_Deque_iterator"* %9) #2
  %10 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2Ev(%"struct.std::_Deque_iterator"* %10) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.0"* @_ZSt4moveIRSaISt4pairIiP4NodeEEEONSt16remove_referenceIT_E4typeEOS7_(%"class.std::allocator.0"* %__t) #4 {
  %1 = alloca %"class.std::allocator.0"*, align 8
...
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %this, i64 %__num_elements) #3 align 2 {
  ...
  %15 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %14, i32 0, i32 1
  store i64 %13, i64* %15, align 8
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %16, i32 0, i32 1
  %18 = load i64* %17, align 8
  %19 = call %"struct.std::pair"** @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %5, i64 %18)
  %20 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %20, i32 0, i32 0
  store %"struct.std::pair"** %19, %"struct.std::pair"*** %21, align 8
  %22 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %22, i32 0, i32 0
  %24 = load %"struct.std::pair"*** %23, align 8
  ...
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE15_M_create_nodesEPPS3_S7_(%"class.std::_Deque_base"* %5, %"struct.std::pair"** %35, %"struct.std::pair"** %36)
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %37, i32 0, i32 2
  %39 = load %"struct.std::pair"*** %__nstart, align 8
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E11_M_set_nodeEPS5_(%"struct.std::_Deque_iterator"* %38, %"struct.std::pair"** %39) #2
  %40 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %41 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %40, i32 0, i32 3
  %42 = load %"struct.std::pair"*** %__nfinish, align 8
  %43 = getelementptr inbounds %"struct.std::pair"** %42, i64 -1
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_E11_M_set_nodeEPS5_(%"struct.std::_Deque_iterator"* %41, %"struct.std::pair"** %43) #2
  %44 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %45 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %44, i32 0, i32 2
  ...
  %49 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %48, i32 0, i32 2
  ...
  %52 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %51, i32 0, i32 3
  ...
  %60 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %59, i32 0, i32 3
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_impl12_M_swap_dataERS6_(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %this, %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %__x) #4 align 2 {
  %1 = alloca %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"*, align 8
  %2 = alloca %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %this, %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %1, align 8
  store %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %__x, %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %2, align 8
  %3 = load %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %1
  %4 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 2
  %5 = load %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %2, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %5, i32 0, i32 2
  call void @_ZSt4swapISt15_Deque_iteratorISt4pairIiP4NodeERS4_PS4_EEvRT_S9_(%"struct.std::_Deque_iterator"* %4, %"struct.std::_Deque_iterator"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 3
  %8 = load %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %2, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %8, i32 0, i32 3
  call void @_ZSt4swapISt15_Deque_iteratorISt4pairIiP4NodeERS4_PS4_EEvRT_S9_(%"struct.std::_Deque_iterator"* %7, %"struct.std::_Deque_iterator"* %9) #2
  %10 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 0
  %11 = load %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %2, align 8
  %12 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %11, i32 0, i32 0
  call void @_ZSt4swapIPPSt4pairIiP4NodeEEvRT_S7_(%"struct.std::pair"*** %10, %"struct.std::pair"*** %12) #2
  %13 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 1
  %14 = load %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %2, align 8
  %15 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %14, i32 0, i32 1
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %this, %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %1, align 8
  %2 = load %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %2 to %"class.std::allocator.0"*
  call void @_ZNSaISt4pairIiP4NodeEED2Ev(%"class.std::allocator.0"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIiP4NodeEED2Ev(%"class.std::allocator.0"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator.0"*, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEED2Ev(%"class.__gnu_cxx::new_allocator.1"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEED2Ev(%"class.__gnu_cxx::new_allocator.1"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
  store %"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.1"** %1
  ret void
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZSt4swapISt15_Deque_iteratorISt4pairIiP4NodeERS4_PS4_EEvRT_S9_(%"struct.std::_Deque_iterator"* %__a, %"struct.std::_Deque_iterator"* %__b) #5 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
  %__tmp = alloca %"struct.std::_Deque_iterator", align 8
  ...
  %3 = load %"struct.std::_Deque_iterator"** %1, align 8
  %4 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorISt4pairIiP4NodeERS4_PS4_EEONSt16remove_referenceIT_E4typeEOSA_(%"struct.std::_Deque_iterator"* %3) #2
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2ERKS6_(%"struct.std::_Deque_iterator"* %__tmp, %"struct.std::_Deque_iterator"* %4) #2
  %5 = load %"struct.std::_Deque_iterator"** %1, align 8
  %6 = load %"struct.std::_Deque_iterator"** %2, align 8
  %7 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorISt4pairIiP4NodeERS4_PS4_EEONSt16remove_referenceIT_E4typeEOSA_(%"struct.std::_Deque_iterator"* %6) #2
  ...
  %11 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorISt4pairIiP4NodeERS4_PS4_EEONSt16remove_referenceIT_E4typeEOSA_(%"struct.std::_Deque_iterator"* %__tmp) #2
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZSt4swapIPPSt4pairIiP4NodeEEvRT_S7_(%"struct.std::pair"*** %__a, %"struct.std::pair"*** %__b) #5 {
  %1 = alloca %"struct.std::pair"***, align 8
  %2 = alloca %"struct.std::pair"***, align 8
  ...
  %4 = call %"struct.std::pair"*** @_ZSt4moveIRPPSt4pairIiP4NodeEEONSt16remove_referenceIT_E4typeEOS8_(%"struct.std::pair"*** %3) #2
  %5 = load %"struct.std::pair"*** %4
  store %"struct.std::pair"** %5, %"struct.std::pair"*** %__tmp, align 8
  %6 = load %"struct.std::pair"**** %2, align 8
  %7 = call %"struct.std::pair"*** @_ZSt4moveIRPPSt4pairIiP4NodeEEONSt16remove_referenceIT_E4typeEOS8_(%"struct.std::pair"*** %6) #2
  %8 = load %"struct.std::pair"*** %7
  %9 = load %"struct.std::pair"**** %1, align 8
  store %"struct.std::pair"** %8, %"struct.std::pair"*** %9, align 8
  %10 = call %"struct.std::pair"*** @_ZSt4moveIRPPSt4pairIiP4NodeEEONSt16remove_referenceIT_E4typeEOS8_(%"struct.std::pair"*** %__tmp) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::pair"*** @_ZSt4moveIRPPSt4pairIiP4NodeEEONSt16remove_referenceIT_E4typeEOS8_(%"struct.std::pair"*** %__t) #4 {
  %1 = alloca %"struct.std::pair"***, align 8
  store %"struct.std::pair"*** %__t, %"struct.std::pair"**** %1, align 8
  %2 = load %"struct.std::pair"**** %1, align 8
  ret %"struct.std::pair"*** %2
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorISt4pairIiP4NodeERS4_PS4_EEONSt16remove_referenceIT_E4typeEOSA_(%"struct.std::_Deque_iterator"* %__t) #4 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
...
; <label>:10                                      ; preds = %6
  %11 = call %"struct.std::pair"* @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIiP4NodeEEC2ERKS3_(%"class.std::allocator.0"* %this, %"class.std::allocator.0"* %__a) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator.0"*, align 8
  %2 = alloca %"class.std::allocator.0"*, align 8
  store %"class.std::allocator.0"* %this, %"class.std::allocator.0"** %1, align 8
  store %"class.std::allocator.0"* %__a, %"class.std::allocator.0"** %2, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEEC2ERKS5_(%"class.__gnu_cxx::new_allocator.1"* %4, %"class.__gnu_cxx::new_allocator.1"* %6) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2Ev(%"struct.std::_Deque_iterator"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEEC2ERKS5_(%"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"*) unnamed_addr #4 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE15_M_destroy_dataESt15_Deque_iteratorIS3_RS3_PS3_ES9_RKS4_(%"class.std::deque"* %this, %"struct.std::_Deque_iterator"* %__first, %"struct.std::_Deque_iterator"* %__last, %"class.std::allocator.0"*) #4 align 2 {
  %2 = alloca %"class.std::deque"*, align 8
  %3 = alloca %"class.std::allocator.0"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeISt4pairIiP4NodeESaIS3_EE5beginEv(%"struct.std::_Deque_iterator"* noalias sret %agg.result, %"class.std::deque"* %this) #4 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %4, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2ERKS6_(%"struct.std::_Deque_iterator"* %agg.result, %"struct.std::_Deque_iterator"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EED2Ev(%"class.std::_Deque_base"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %3, i32 0, i32 0
  %5 = load %"struct.std::pair"*** %4, align 8
...
; <label>:7                                       ; preds = %0
  ...
  %9 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %8, i32 0, i32 2
  ...
  %13 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %12, i32 0, i32 3
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %13, i32 0, i32 3
  %15 = load %"struct.std::pair"*** %14, align 8
  %16 = getelementptr inbounds %"struct.std::pair"** %15, i64 1
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE16_M_destroy_nodesEPPS3_S7_(%"class.std::_Deque_base"* %2, %"struct.std::pair"** %11, %"struct.std::pair"** %16) #2
  %17 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %18 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %17, i32 0, i32 0
  %19 = load %"struct.std::pair"*** %18, align 8
  %20 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %20, i32 0, i32 1
  %22 = load i64* %21, align 8
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE17_M_deallocate_mapEPPS3_m(%"class.std::_Deque_base"* %2, %"struct.std::pair"** %19, i64 %22) #2
  br label %23

; <label>:23                                      ; preds = %7, %0
  %24 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %24) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE16_M_destroy_nodesEPPS3_S7_(%"class.std::_Deque_base"* %this, %"struct.std::pair"** %__nstart, %"struct.std::pair"** %__nfinish) #4 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca %"struct.std::pair"**, align 8
  %3 = alloca %"struct.std::pair"**, align 8
...
; <label>:10                                      ; preds = %6
  ...
  %12 = load %"struct.std::pair"** %11, align 8
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE18_M_deallocate_nodeEPS3_(%"class.std::_Deque_base"* %4, %"struct.std::pair"* %12) #2
  br label %13
...
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EEC2Ev(%"class.std::_Deque_base"* %this) unnamed_addr #3 align 2 {
  ...
  %4 = load %"class.std::_Deque_base"** %1
  %5 = getelementptr inbounds %"class.std::_Deque_base"* %4, i32 0, i32 0
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_implC2Ev(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %5)
  invoke void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %4, i64 0)
...
; <label>:7                                       ; preds = %0
  ...
  store i32 %10, i32* %3
  call void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %5) #2
  br label %11
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseISt4pairIiP4NodeESaIS3_EE11_Deque_implC2Ev(%"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %this, %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %1, align 8
  %2 = load %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %2 to %"class.std::allocator.0"*
  call void @_ZNSaISt4pairIiP4NodeEEC2Ev(%"class.std::allocator.0"* %3) #2
  %4 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %2, i32 0, i32 0
  store %"struct.std::pair"** null, %"struct.std::pair"*** %4, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %2, i32 0, i32 1
  store i64 0, i64* %5, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %2, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2Ev(%"struct.std::_Deque_iterator"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<std::pair<int, Node *>, std::allocator<std::pair<int, Node *> > >::_Deque_impl"* %2, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorISt4pairIiP4NodeERS3_PS3_EC2Ev(%"struct.std::_Deque_iterator"* %7) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaISt4pairIiP4NodeEEC2Ev(%"class.std::allocator.0"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::allocator.0"*, align 8
  store %"class.std::allocator.0"* %this, %"class.std::allocator.0"** %1, align 8
  %2 = load %"class.std::allocator.0"** %1
  %3 = bitcast %"class.std::allocator.0"* %2 to %"class.__gnu_cxx::new_allocator.1"*
  call void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEEC2Ev(%"class.__gnu_cxx::new_allocator.1"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorISt4pairIiP4NodeEEC2Ev(%"class.__gnu_cxx::new_allocator.1"* %this) unnamed_addr #4 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
  store %"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.1"** %1
  ret void
