; ModuleID = 'InorderTraversals/in_06_parent_iterative.cpp'
...
; <label>:6                                       ; preds = %0
  ...
  store %struct.Node* %7, %struct.Node** %cur, align 8
  br label %8

; <label>:8                                       ; preds = %18, %6
  %9 = load %struct.Node** %cur, align 8
...
; <label>:23                                      ; preds = %72, %22
  %24 = load %struct.Node** %cur, align 8
  %25 = icmp ne %struct.Node* %24, null
  br i1 %25, label %26, label %73

; <label>:26                                      ; preds = %23
  %27 = load %"class.std::vector"** %2, align 8
  %28 = load %struct.Node** %cur, align 8
  %29 = getelementptr inbounds %struct.Node* %28, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %27, i32* %29)
  %30 = load %struct.Node** %cur, align 8
...
; <label>:34                                      ; preds = %26
  %35 = load %struct.Node** %cur, align 8
  %36 = getelementptr inbounds %struct.Node* %35, i32 0, i32 2
  %37 = load %struct.Node** %36, align 8
  store %struct.Node* %37, %struct.Node** %cur, align 8
  br label %38

; <label>:38                                      ; preds = %43, %34
  %39 = load %struct.Node** %cur, align 8
...
; <label>:49                                      ; preds = %64, %48
  %50 = load %struct.Node** %cur, align 8
...
; <label>:54                                      ; preds = %49
  %55 = load %struct.Node** %cur, align 8
  %56 = load %struct.Node** %cur, align 8
  %57 = getelementptr inbounds %struct.Node* %56, i32 0, i32 3
  %58 = load %struct.Node** %57, align 8
  %59 = getelementptr inbounds %struct.Node* %58, i32 0, i32 2
  %60 = load %struct.Node** %59, align 8
  %61 = icmp eq %struct.Node* %55, %60
  br label %62
...
; <label>:64                                      ; preds = %62
  %65 = load %struct.Node** %cur, align 8
  %66 = getelementptr inbounds %struct.Node* %65, i32 0, i32 3
  %67 = load %struct.Node** %66, align 8
  store %struct.Node* %67, %struct.Node** %cur, align 8
  br label %49

; <label>:68                                      ; preds = %62
  %69 = load %struct.Node** %cur, align 8
  %70 = getelementptr inbounds %struct.Node* %69, i32 0, i32 3
  %71 = load %struct.Node** %70, align 8
  store %struct.Node* %71, %struct.Node** %cur, align 8
  br label %72
...
; <label>:8                                       ; preds = %0
  %9 = call noalias i8* @_Znwm(i64 32) #11
...
; <label>:105                                     ; preds = %102
  %106 = load %struct.Node** %root, align 8
  invoke void @_Z18in_order_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %106, %"class.std::vector"* %result)
          to label %107 unwind label %108

; <label>:107                                     ; preds = %105
  br label %112

; <label>:108                                     ; preds = %144, %142, %139, %137, %105
...
; <label>:113                                     ; preds = %129, %112
  ...
  %115 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %result) #2
  %116 = sub i64 %115, 1
  %117 = icmp ult i64 %114, %116
  br i1 %117, label %118, label %132

; <label>:118                                     ; preds = %113
  %119 = load i64* %i1, align 8
  %120 = call i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %result, i64 %119) #2
  %121 = load i32* %120
  %122 = load i64* %i1, align 8
  %123 = add i64 %122, 1
  %124 = call i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %result, i64 %123) #2
  %125 = load i32* %124
...
; <label>:129                                     ; preds = %128
  %130 = load i64* %i1, align 8
  %131 = add i64 %130, 1
  store i64 %131, i64* %i1, align 8
  br label %113

; <label>:132                                     ; preds = %127, %113
  %133 = load i8* %passed, align 1
...
; <label>:137                                     ; preds = %135
  %138 = invoke %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([20 x i8]* @.str1, i32 0, i32 0))
          to label %139 unwind label %108

; <label>:139                                     ; preds = %137
  %140 = invoke %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %138, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
; <label>:142                                     ; preds = %135, %132
  %143 = invoke %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* @_ZSt4cout, i8* getelementptr inbounds ([7 x i8]* @.str2, i32 0, i32 0))
          to label %144 unwind label %108

; <label>:144                                     ; preds = %142
  %145 = invoke %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %143, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
...
; <label>:149                                     ; preds = %108, %75, %71, %67
  call void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEED1Ev(%"class.std::basic_ifstream"* %file) #2
  br label %150

; <label>:150                                     ; preds = %149, %24
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %filename) #2
  br label %151
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr zeroext i1 @_ZN9__gnu_cxxeqIPKiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESB_(%"class.__gnu_cxx::__normal_iterator.4"* %__lhs, %"class.__gnu_cxx::__normal_iterator.4"* %__rhs) #7 {
