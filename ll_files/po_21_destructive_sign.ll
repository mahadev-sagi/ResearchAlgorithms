...
; <label>:14                                      ; preds = %11
  ...
  %17 = load %struct.TreeNode** %node, align 8
  %18 = getelementptr inbounds %struct.TreeNode* %17, i32 0, i32 0
...
; <label>:40                                      ; preds = %35
  %41 = load %struct.TreeNode** %node, align 8
...
; <label>:44                                      ; preds = %14
  ...
  %52 = getelementptr inbounds %struct.TreeNode* %51, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %52)
