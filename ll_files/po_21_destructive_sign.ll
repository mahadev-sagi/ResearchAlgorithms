; ModuleID = 'PostorderTraversals/po_21_destructive_sign.cpp'
...
; <label>:22                                      ; preds = %20
  ...
  %25 = getelementptr inbounds %struct.TreeNode* %24, i32 0, i32 0
...
; <label>:28                                      ; preds = %22
  ...
  %32 = sub nsw i32 0, %31
  %33 = load %struct.TreeNode** %node, align 8
...
; <label>:39                                      ; preds = %28
  ...
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %41)
...
; <label>:51                                      ; preds = %74, %65, %60, %39, %20, %16, %14
...
; <label>:55                                      ; preds = %42, %28
  ...
  %57 = getelementptr inbounds %struct.TreeNode* %56, i32 0, i32 1
  %58 = load %struct.TreeNode** %57, align 8
  %59 = icmp ne %struct.TreeNode* %58, null
  br i1 %59, label %60, label %64

; <label>:60                                      ; preds = %55
  %61 = load %struct.TreeNode** %node, align 8
  %62 = getelementptr inbounds %struct.TreeNode* %61, i32 0, i32 1
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %62)
...
; <label>:65                                      ; preds = %22
  ...
  %69 = sub nsw i32 0, %68
  %70 = load %struct.TreeNode** %node, align 8
