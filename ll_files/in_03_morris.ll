; ModuleID = 'InorderTraversals/in_03_morris.cpp'
...
; <label>:12                                      ; preds = %7
  ...
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %13, i32* %15)
...
; <label>:19                                      ; preds = %7
  ...
  store %struct.Node* %22, %struct.Node** %pre, align 8
  br label %23

; <label>:23                                      ; preds = %36, %19
  %24 = load %struct.Node** %pre, align 8
...
; <label>:28                                      ; preds = %23
  %29 = load %struct.Node** %pre, align 8
...
; <label>:36                                      ; preds = %34
  %37 = load %struct.Node** %pre, align 8
  %38 = getelementptr inbounds %struct.Node* %37, i32 0, i32 2
  %39 = load %struct.Node** %38, align 8
  store %struct.Node* %39, %struct.Node** %pre, align 8
  br label %23

; <label>:40                                      ; preds = %34
  %41 = load %struct.Node** %pre, align 8
...
; <label>:45                                      ; preds = %40
  ...
  %47 = load %struct.Node** %pre, align 8
