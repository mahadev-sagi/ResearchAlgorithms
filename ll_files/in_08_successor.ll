...
; <label>:16                                      ; preds = %10
  ...
  store %struct.Node* %21, %struct.Node** %lchild, align 8
  %22 = load %struct.Node** %lchild, align 8
  ...
  %26 = load %struct.Node** %lchild, align 8
...
; <label>:28                                      ; preds = %10
  ...
  store %struct.Node* %33, %struct.Node** %rchild, align 8
  %34 = load %struct.Node** %rchild, align 8
  ...
  %38 = load %struct.Node** %rchild, align 8
