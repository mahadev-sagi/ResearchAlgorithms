; ModuleID = 'InorderTraversals/in_08_successor.cpp'
...
define %struct.Node* @_Z14tree_successorP4Node(%struct.Node* %p) #3 {
  ...
  %4 = getelementptr inbounds %struct.Node* %3, i32 0, i32 2
  %5 = load %struct.Node** %4, align 8
  store %struct.Node* %5, %struct.Node** %h, align 8
  %6 = load %struct.Node** %h, align 8
...
; <label>:14                                      ; preds = %9
  %15 = load %struct.Node** %h, align 8
  %16 = getelementptr inbounds %struct.Node* %15, i32 0, i32 1
  %17 = load %struct.Node** %16, align 8
  store %struct.Node* %17, %struct.Node** %h, align 8
  br label %9

; <label>:18                                      ; preds = %9
  %19 = load %struct.Node** %h, align 8
...
; <label>:35                                      ; preds = %33
  %36 = load %struct.Node** %y, align 8
  store %struct.Node* %36, %struct.Node** %2, align 8
  %37 = load %struct.Node** %y, align 8
  %38 = getelementptr inbounds %struct.Node* %37, i32 0, i32 3
  %39 = load %struct.Node** %38, align 8
  store %struct.Node* %39, %struct.Node** %y, align 8
  br label %24

; <label>:40                                      ; preds = %33
  %41 = load %struct.Node** %y, align 8
...
define void @_Z18in_order_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #4 {
  %1 = alloca %struct.Node*, align 8
...
; <label>:13                                      ; preds = %8
  ...
  store %struct.Node* %16, %struct.Node** %curr, align 8
  br label %8
...
; <label>:21                                      ; preds = %18
  ...
  %26 = call %struct.Node* @_Z14tree_successorP4Node(%struct.Node* %25)
...
; Function Attrs: uwtable
define %struct.Node* @_Z6insertP4Nodei(%struct.Node* %root, i32 %val) #4 {
  %1 = alloca %struct.Node*, align 8
  %2 = alloca %struct.Node*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i8*
  %5 = alloca i32
  %lchild = alloca %struct.Node*, align 8
  %rchild = alloca %struct.Node*, align 8
...
; <label>:23                                      ; preds = %17
  ...
  store %struct.Node* %28, %struct.Node** %lchild, align 8
  %29 = load %struct.Node** %lchild, align 8
  ...
  %33 = load %struct.Node** %lchild, align 8
...
; <label>:35                                      ; preds = %17
  ...
  store %struct.Node* %40, %struct.Node** %rchild, align 8
  %41 = load %struct.Node** %rchild, align 8
  ...
  %45 = load %struct.Node** %rchild, align 8
...
; Function Attrs: uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2ESt16initializer_listIiERKS0_(%"class.std::vector"* %this, i32* %__l.coerce0, i64 %__l.coerce1, %"class.std::allocator"* %__a) unnamed_addr #4 align 2 {
  %1 = alloca %"class.std::vector"*, align 8
...
; Function Attrs: uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE19_M_range_initializeIPKiEEvT_S5_St20forward_iterator_tag(%"class.std::vector"* %this, i32* %__first, i32* %__last) #4 align 2 {
  %1 = alloca %"class.std::vector"*, align 8
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
...
; Function Attrs: uwtable
define linkonce_odr i32* @_ZNSt20__uninitialized_copyILb1EE13__uninit_copyIPKiPiEET0_T_S6_S5_(i32* %__first, i32* %__last, i32* %__result) #4 align 2 {
  %1 = alloca i32*, align 8
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
  store i32* %__first, i32** %1, align 8
