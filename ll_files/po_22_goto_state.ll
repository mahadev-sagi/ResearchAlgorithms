; ModuleID = 'PostorderTraversals/po_22_goto_state.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %peek = alloca %struct.TreeNode*, align 8
...
; <label>:15                                      ; preds = %12
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %curr)
  %16 = load %struct.TreeNode** %curr, align 8
  %17 = getelementptr inbounds %struct.TreeNode* %16, i32 0, i32 1
  %18 = load %struct.TreeNode** %17, align 8
  store %struct.TreeNode* %18, %struct.TreeNode** %curr, align 8
  br label %12
...
; <label>:20                                      ; preds = %40, %19
  %21 = call zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s)
...
; <label>:23                                      ; preds = %20
  %24 = call %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s)
  %25 = load %struct.TreeNode** %24
  store %struct.TreeNode* %25, %struct.TreeNode** %peek, align 8
  %26 = load %struct.TreeNode** %peek, align 8
...
; <label>:40                                      ; preds = %30, %23
  ...
  %43 = load %struct.TreeNode** %peek, align 8
  store %struct.TreeNode* %43, %struct.TreeNode** %lastVisited, align 8
