...
; <label>:26                                      ; preds = %22
  %27 = load i32* %array_root_idx, align 4
  %28 = load i64* %i, align 8
  %29 = call i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %f, i64 %28) #0
  %30 = load i32* %29
  %31 = call i32 @_Z11insertArrayii(i32 %27, i32 %30)
  store i32 %31, i32* %array_root_idx, align 4
  br label %32
...
; <label>:49                                      ; preds = %37
  %50 = load i32* %array_root_idx, align 4
  %51 = load i32* %num, align 4
  %52 = call i32 @_Z11insertArrayii(i32 %50, i32 %51)
  store i32 %52, i32* %array_root_idx, align 4
  br label %37
...
; <label>:54                                      ; preds = %53, %35
  %55 = load i32* %array_root_idx, align 4
  call void @_ZN8Solution18postorderTraversalEi(%"class.std::vector"* sret %result, %class.Solution* %sol, i32 %55)
...
; <label>:15                                      ; preds = %12
  ...
  %19 = sext i32 %18 to i64
  %20 = getelementptr inbounds [2000 x i32]* @left_child, i32 0, i64 %19
  %21 = load i32* %20, align 4
  %22 = icmp ne i32 %21, -1
...
; <label>:27                                      ; preds = %23, %15
  ...
  %30 = getelementptr inbounds [2000 x i32]* @right_child, i32 0, i64 %29
...
; <label>:33                                      ; preds = %27
  ...
  %36 = getelementptr inbounds [2000 x i32]* @right_child, i32 0, i64 %35
...
; <label>:42                                      ; preds = %39
  ...
  %47 = getelementptr inbounds [2000 x i32]* @val, i32 0, i64 %46
...
define linkonce_odr i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %__first, i32* %__last, i32* %__result, %"class.std::allocator.1"* %__alloc) #4 {
  %1 = alloca i32*, align 8
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %__first, i32* %__last, %"class.std::allocator.1"*) #4 {
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
  %4 = alloca %"class.std::allocator.1"*, align 8
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr i32* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPiES1_iET0_T_S4_S3_RSaIT1_E(i32* %__first.coerce, i32* %__last.coerce, i32* %__result, %"class.std::allocator.1"*) #4 {
...
; <label>:14                                      ; preds = %0
  ...
  call void @_ZNSt16allocator_traitsISaIiEE7destroyIiEEvRS0_PT_(%"class.std::allocator.1"* %23, i32* %28)
  br label %30
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE7destroyIiEEvRS0_PT_(%"class.std::allocator.1"* %__a, i32* %__p) #3 align 2 {
  %1 = alloca %"class.std::allocator.1"*, align 8
  %2 = alloca i32*, align 8
  store %"class.std::allocator.1"* %__a, %"class.std::allocator.1"** %1, align 8
  store i32* %__p, i32** %2, align 8
...
define linkonce_odr void @_ZNSt5dequeIiSaIiEE15_M_pop_back_auxEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  %29 = call %"class.std::allocator.1"* @_ZNSt11_Deque_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %28) #0
...
define linkonce_odr i32** @_ZNSt11_Deque_baseIiSaIiEE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  ...
  call void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.4"* sret %__map_alloc, %"class.std::_Deque_base"* %4) #0
  %5 = load i64* %2, align 8
  %6 = call i32** @_ZNSt16allocator_traitsISaIPiEE8allocateERS1_m(%"class.std::allocator.4"* %__map_alloc, i64 %5)
  store i32 1, i32* %3
  call void @_ZNSaIPiED2Ev(%"class.std::allocator.4"* %__map_alloc) #0
  ret i32** %6
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIiSaIiEE17_M_deallocate_mapEPPim(%"class.std::_Deque_base"* %this, i32** %__p, i64 %__n) #3 align 2 {
  ...
  %5 = load i32*** %2, align 8
  %6 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIPiEE10deallocateERS1_PS0_m(%"class.std::allocator.4"* %__map_alloc, i32** %5, i64 %6)
  call void @_ZNSaIPiED2Ev(%"class.std::allocator.4"* %__map_alloc) #0
  ret void
}
...
define linkonce_odr void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.4"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  call void @_ZNSaIPiEC2IiEERKSaIT_E(%"class.std::allocator.4"* %agg.result, %"class.std::allocator.1"* %3) #0
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaIPiEE10deallocateERS1_PS0_m(%"class.std::allocator.4"* %__a, i32** %__p, i64 %__n) #3 align 2 {
...
define linkonce_odr void @_ZNSaIPiED2Ev(%"class.std::allocator.4"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIPiED2Ev(%"class.__gnu_cxx::new_allocator.5"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaIPiEC2IiEERKSaIT_E(%"class.std::allocator.4"* %this, %"class.std::allocator.1"*) unnamed_addr #3 align 2 {
  ...
  %5 = bitcast %"class.std::allocator.4"* %4 to %"class.__gnu_cxx::new_allocator.5"*
  call void @_ZN9__gnu_cxx13new_allocatorIPiEC2Ev(%"class.__gnu_cxx::new_allocator.5"* %5) #0
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32** @_ZNSt16allocator_traitsISaIPiEE8allocateERS1_m(%"class.std::allocator.4"* %__a, i64 %__n) #3 align 2 {
  %1 = alloca %"class.std::allocator.4"*, align 8
  %2 = alloca i64, align 8
  store %"class.std::allocator.4"* %__a, %"class.std::allocator.4"** %1, align 8
  store i64 %__n, i64* %2, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32** @_ZN9__gnu_cxx13new_allocatorIPiE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.5"* %this, i64 %__n, i8*) #3 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  %3 = alloca i64, align 8
  %4 = alloca i8*, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %2, align 8
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.5"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIPiE8max_sizeEv(%"class.__gnu_cxx::new_allocator.5"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
define linkonce_odr void @_ZNSt11_Deque_baseIiSaIiEEC2EOS1_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %5 = getelementptr inbounds %"class.std::_Deque_base"* %4, i32 0, i32 0
  %6 = load %"class.std::_Deque_base"** %2, align 8
  %7 = call %"class.std::allocator.1"* @_ZNSt11_Deque_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %6) #0
  %8 = call %"class.std::allocator.1"* @_ZSt4moveIRSaIiEEONSt16remove_referenceIT_E4typeEOS3_(%"class.std::allocator.1"* %7) #0
  call void @_ZNSt11_Deque_baseIiSaIiEE11_Deque_implC2EOS0_(%"struct.std::_Deque_base<int, std::allocator<int> >::_Deque_impl"* %5, %"class.std::allocator.1"* %8) #0
...
define linkonce_odr void @_ZNSt11_Deque_baseIiSaIiEE11_Deque_implC2EOS0_(%"struct.std::_Deque_base<int, std::allocator<int> >::_Deque_impl"* %this, %"class.std::allocator.1"* %__a) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::allocator.1"* @_ZSt4moveIRSaIiEEONSt16remove_referenceIT_E4typeEOS3_(%"class.std::allocator.1"* %5) #0
  call void @_ZNSaIiEC2ERKS_(%"class.std::allocator.1"* %4, %"class.std::allocator.1"* %6) #0
