...
; <label>:27                                      ; preds = %15
  %28 = load %struct.Node** %c_root, align 8
  %29 = load i32* %num, align 4
  %30 = call %struct.Node* @_Z7insertCP4Nodei(%struct.Node* %28, i32 %29)
  store %struct.Node* %30, %struct.Node** %c_root, align 8
  br label %15
...
; <label>:31                                      ; preds = %15
  ...
  %32 = load %struct.Node** %c_root, align 8
  call void @_Z9postOrderP4Node(%struct.Node* %32)
  store i64 0, i64* %i, align 8
  br label %33

; <label>:33                                      ; preds = %43, %31
  %34 = load i64* %i, align 8
  %35 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* @global_result) #0
  %36 = icmp ult i64 %34, %35
  br i1 %36, label %37, label %46

; <label>:37                                      ; preds = %33
  %38 = load i64* %i, align 8
  %39 = call i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* @global_result, i64 %38) #0
  %40 = load i32* %39
