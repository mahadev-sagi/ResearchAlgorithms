; ModuleID = 'InorderTraversals/in_12_bst_iterator.cpp'
...
define linkonce_odr zeroext i1 @_ZN11BSTIterator7hasNextEv(%class.BSTIterator* %this) #3 align 2 {
  ...
  %4 = call zeroext i1 @_ZNKSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %3)
  %5 = xor i1 %4, true
  ret i1 %5
}
...
define linkonce_odr i32 @_ZN11BSTIterator4nextEv(%class.BSTIterator* %this) #3 align 2 {
  ...
  store %struct.Node* %5, %struct.Node** %tmpNode, align 8
  ...
  %7 = load %struct.Node** %tmpNode, align 8
  %8 = getelementptr inbounds %struct.Node* %7, i32 0, i32 2
  %9 = load %struct.Node** %8, align 8
  call void @_ZN11BSTIterator11pushAllLeftEP4Node(%class.BSTIterator* %2, %struct.Node* %9)
  %10 = load %struct.Node** %tmpNode, align 8
...
; <label>:7                                       ; preds = %4
  %8 = getelementptr inbounds %class.BSTIterator* %3, i32 0, i32 0
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %8, %struct.Node** %2)
