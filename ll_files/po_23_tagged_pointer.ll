...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %6 = alloca i8*
  %7 = alloca i32
  %rawPtr = alloca %struct.TreeNode*, align 8
  %ptrVal = alloca i64, align 8
  %markedVal = alloca i64, align 8
  %8 = alloca %struct.TreeNode*, align 8
  %cleanVal = alloca i64, align 8
...
; <label>:23                                      ; preds = %21
  ...
  store %struct.TreeNode* %24, %struct.TreeNode** %rawPtr, align 8
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %st)
          to label %25 unwind label %53

; <label>:25                                      ; preds = %23
  %26 = load %struct.TreeNode** %rawPtr, align 8
  %27 = ptrtoint %struct.TreeNode* %26 to i64
  store i64 %27, i64* %ptrVal, align 8
  %28 = load i64* %ptrVal, align 8
  %29 = and i64 %28, 1
  %30 = icmp eq i64 %29, 0
  br i1 %30, label %31, label %67

; <label>:31                                      ; preds = %25
  %32 = load i64* %ptrVal, align 8
  %33 = or i64 %32, 1
  store i64 %33, i64* %markedVal, align 8
  %34 = load i64* %markedVal, align 8
  %35 = inttoptr i64 %34 to %struct.TreeNode*
  store %struct.TreeNode* %35, %struct.TreeNode** %8
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushEOS1_(%"class.std::stack"* %st, %struct.TreeNode** %8)
          to label %36 unwind label %53

; <label>:36                                      ; preds = %31
  %37 = load %struct.TreeNode** %rawPtr, align 8
  %38 = getelementptr inbounds %struct.TreeNode* %37, i32 0, i32 2
...
; <label>:41                                      ; preds = %36
  %42 = load %struct.TreeNode** %rawPtr, align 8
  %43 = getelementptr inbounds %struct.TreeNode* %42, i32 0, i32 2
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %43)
...
; <label>:53                                      ; preds = %67, %62, %41, %31, %23, %21, %17, %15
...
; <label>:57                                      ; preds = %44, %36
  %58 = load %struct.TreeNode** %rawPtr, align 8
  %59 = getelementptr inbounds %struct.TreeNode* %58, i32 0, i32 1
  %60 = load %struct.TreeNode** %59, align 8
  %61 = icmp ne %struct.TreeNode* %60, null
  br i1 %61, label %62, label %66

; <label>:62                                      ; preds = %57
  %63 = load %struct.TreeNode** %rawPtr, align 8
  %64 = getelementptr inbounds %struct.TreeNode* %63, i32 0, i32 1
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %st, %struct.TreeNode** %64)
...
; <label>:67                                      ; preds = %25
  %68 = load i64* %ptrVal, align 8
  %69 = and i64 %68, -2
  store i64 %69, i64* %cleanVal, align 8
  %70 = load i64* %cleanVal, align 8
  %71 = inttoptr i64 %70 to %struct.TreeNode*
  store %struct.TreeNode* %71, %struct.TreeNode** %node, align 8
...
define linkonce_odr void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushEOS1_(%"class.std::stack"* %this, %struct.TreeNode** %__x) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::stack"* %3, i32 0, i32 0
  %5 = load %struct.TreeNode*** %2, align 8
  %6 = call %struct.TreeNode** @_ZSt4moveIRP8TreeNodeEONSt16remove_referenceIT_E4typeEOS4_(%struct.TreeNode** %5) #2
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EE9push_backEOS1_(%"class.std::deque"* %4, %struct.TreeNode** %6)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIP8TreeNodeSaIS1_EE9push_backEOS1_(%"class.std::deque"* %this, %struct.TreeNode** %__x) #3 align 2 {
  ...
  %5 = call %struct.TreeNode** @_ZSt4moveIRP8TreeNodeEONSt16remove_referenceIT_E4typeEOS4_(%struct.TreeNode** %4) #2
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EE12emplace_backIJS1_EEEvDpOT_(%"class.std::deque"* %3, %struct.TreeNode** %5)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.TreeNode** @_ZSt4moveIRP8TreeNodeEONSt16remove_referenceIT_E4typeEOS4_(%struct.TreeNode** %__t) #5 {
  %1 = alloca %struct.TreeNode**, align 8
...
; <label>:16                                      ; preds = %0
  ...
  %26 = call %struct.TreeNode** @_ZSt7forwardIP8TreeNodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.TreeNode** %25) #2
  call void @_ZNSt16allocator_traitsISaIP8TreeNodeEE9constructIS1_JS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.4"* %19, %struct.TreeNode** %24, %struct.TreeNode** %26)
  %27 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %28 = getelementptr inbounds %"class.std::_Deque_base"* %27, i32 0, i32 0
  %29 = getelementptr inbounds %"struct.std::_Deque_base<TreeNode *, std::allocator<TreeNode *> >::_Deque_impl"* %28, i32 0, i32 3
  %30 = getelementptr inbounds %"struct.std::_Deque_iterator"* %29, i32 0, i32 0
  %31 = load %struct.TreeNode*** %30, align 8
  %32 = getelementptr inbounds %struct.TreeNode** %31, i32 1
  store %struct.TreeNode** %32, %struct.TreeNode*** %30, align 8
  br label %36

; <label>:33                                      ; preds = %0
  %34 = load %struct.TreeNode*** %2, align 8
  %35 = call %struct.TreeNode** @_ZSt7forwardIP8TreeNodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.TreeNode** %34) #2
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EE16_M_push_back_auxIJS1_EEEvDpOT_(%"class.std::deque"* %3, %struct.TreeNode** %35)
  br label %36
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIP8TreeNodeEE9constructIS1_JS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.4"* %__a, %struct.TreeNode** %__p, %struct.TreeNode** %__args) #3 align 2 {
  ...
  %8 = call %struct.TreeNode** @_ZSt7forwardIP8TreeNodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.TreeNode** %7) #2
  call void @_ZN9__gnu_cxx13new_allocatorIP8TreeNodeE9constructIS2_JS2_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.5"* %5, %struct.TreeNode** %6, %struct.TreeNode** %8)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.TreeNode** @_ZSt7forwardIP8TreeNodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.TreeNode** %__t) #5 {
  %1 = alloca %struct.TreeNode**, align 8
  store %struct.TreeNode** %__t, %struct.TreeNode*** %1, align 8
  %2 = load %struct.TreeNode*** %1, align 8
  ret %struct.TreeNode** %2
...
define linkonce_odr void @_ZNSt5dequeIP8TreeNodeSaIS1_EE16_M_push_back_auxIJS1_EEEvDpOT_(%"class.std::deque"* %this, %struct.TreeNode** %__args) #3 align 2 {
  ...
  %21 = call %struct.TreeNode** @_ZSt7forwardIP8TreeNodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.TreeNode** %20) #2
  call void @_ZNSt16allocator_traitsISaIP8TreeNodeEE9constructIS1_JS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.4"* %14, %struct.TreeNode** %19, %struct.TreeNode** %21)
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIP8TreeNodeE9constructIS2_JS2_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.5"* %this, %struct.TreeNode** %__p, %struct.TreeNode** %__args) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  %2 = alloca %struct.TreeNode**, align 8
  %3 = alloca %struct.TreeNode**, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %1, align 8
...
; <label>:8                                       ; preds = %0
  ...
  %11 = call %struct.TreeNode** @_ZSt7forwardIP8TreeNodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.TreeNode** %10) #2
