; ModuleID = 'PostorderTraversals/po_23_tagged_pointer.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %rootTagged = alloca %struct.TaggedNode, align 8
  %current = alloca %struct.TaggedNode, align 8
  %r = alloca %struct.TaggedNode, align 8
  %l = alloca %struct.TaggedNode, align 8
...
; <label>:10                                      ; preds = %0
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EEC2Ev(%"class.std::deque"* %5)
  call void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEEC2EOS3_(%"class.std::stack"* %s, %"class.std::deque"* %5)
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EED2Ev(%"class.std::deque"* %5) #0
  %11 = load %struct.TreeNode** %2, align 8
  %12 = getelementptr inbounds %struct.TaggedNode* %rootTagged, i32 0, i32 0
  store %struct.TreeNode* %11, %struct.TreeNode** %12, align 8
  %13 = getelementptr inbounds %struct.TaggedNode* %rootTagged, i32 0, i32 1
  store i8 0, i8* %13, align 1
  call void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE4pushERKS0_(%"class.std::stack"* %s, %struct.TaggedNode* %rootTagged)
  br label %14

; <label>:14                                      ; preds = %56, %10
  %15 = call zeroext i1 @_ZNKSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE5emptyEv(%"class.std::stack"* %s)
  %16 = xor i1 %15, true
  br i1 %16, label %17, label %57

; <label>:17                                      ; preds = %14
  %18 = call %struct.TaggedNode* @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE3topEv(%"class.std::stack"* %s)
  %19 = bitcast %struct.TaggedNode* %current to i8*
  %20 = bitcast %struct.TaggedNode* %18 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %19, i8* %20, i64 16, i32 8, i1 false)
  call void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE3popEv(%"class.std::stack"* %s)
  %21 = getelementptr inbounds %struct.TaggedNode* %current, i32 0, i32 1
  %22 = load i8* %21, align 1
  %23 = trunc i8 %22 to i1
  br i1 %23, label %24, label %28

; <label>:24                                      ; preds = %17
  %25 = getelementptr inbounds %struct.TaggedNode* %current, i32 0, i32 0
  %26 = load %struct.TreeNode** %25, align 8
  %27 = getelementptr inbounds %struct.TreeNode* %26, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %27)
  br label %56

; <label>:28                                      ; preds = %17
  %29 = getelementptr inbounds %struct.TaggedNode* %current, i32 0, i32 1
  store i8 1, i8* %29, align 1
  call void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE4pushERKS0_(%"class.std::stack"* %s, %struct.TaggedNode* %current)
  %30 = getelementptr inbounds %struct.TaggedNode* %current, i32 0, i32 0
  %31 = load %struct.TreeNode** %30, align 8
  %32 = getelementptr inbounds %struct.TreeNode* %31, i32 0, i32 2
  %33 = load %struct.TreeNode** %32, align 8
  %34 = icmp ne %struct.TreeNode* %33, null
  br i1 %34, label %35, label %42

; <label>:35                                      ; preds = %28
  %36 = getelementptr inbounds %struct.TaggedNode* %current, i32 0, i32 0
  ...
  %40 = getelementptr inbounds %struct.TaggedNode* %r, i32 0, i32 0
  store %struct.TreeNode* %39, %struct.TreeNode** %40, align 8
  %41 = getelementptr inbounds %struct.TaggedNode* %r, i32 0, i32 1
  store i8 0, i8* %41, align 1
  call void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE4pushERKS0_(%"class.std::stack"* %s, %struct.TaggedNode* %r)
  br label %42

; <label>:42                                      ; preds = %35, %28
  %43 = getelementptr inbounds %struct.TaggedNode* %current, i32 0, i32 0
...
; <label>:48                                      ; preds = %42
  %49 = getelementptr inbounds %struct.TaggedNode* %current, i32 0, i32 0
  %50 = load %struct.TreeNode** %49, align 8
  %51 = getelementptr inbounds %struct.TreeNode* %50, i32 0, i32 1
  %52 = load %struct.TreeNode** %51, align 8
  %53 = getelementptr inbounds %struct.TaggedNode* %l, i32 0, i32 0
  store %struct.TreeNode* %52, %struct.TreeNode** %53, align 8
  %54 = getelementptr inbounds %struct.TaggedNode* %l, i32 0, i32 1
  store i8 0, i8* %54, align 1
  call void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE4pushERKS0_(%"class.std::stack"* %s, %struct.TaggedNode* %l)
  br label %55
...
; <label>:57                                      ; preds = %14
  store i1 true, i1* %3
  store i32 1, i32* %4
  call void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEED2Ev(%"class.std::stack"* %s) #0
  br label %58
...
define linkonce_odr void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEEC2EOS3_(%"class.std::stack"* %this, %"class.std::deque"* %__c) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::deque"* @_ZSt4moveIRSt5dequeI10TaggedNodeSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::deque"* %5) #0
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EEC2EOS2_(%"class.std::deque"* %4, %"class.std::deque"* %6)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EEC2Ev(%"class.std::deque"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EEC2Ev(%"class.std::_Deque_base"* %3)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EED2Ev(%"class.std::deque"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE5beginEv(%"struct.std::_Deque_iterator"* sret %2, %"class.std::deque"* %4) #0
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* sret %3, %"class.std::deque"* %4) #0
  %5 = bitcast %"class.std::deque"* %4 to %"class.std::_Deque_base"*
  %6 = call %"class.std::allocator.4"* @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %5) #0
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE15_M_destroy_dataESt15_Deque_iteratorIS0_RS0_PS0_ES6_RKS1_(%"class.std::deque"* %4, %"struct.std::_Deque_iterator"* %2, %"struct.std::_Deque_iterator"* %3, %"class.std::allocator.4"* %6)
  %7 = bitcast %"class.std::deque"* %4 to %"class.std::_Deque_base"*
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EED2Ev(%"class.std::_Deque_base"* %7) #0
  ret void
}
...
define linkonce_odr void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE4pushERKS0_(%"class.std::stack"* %this, %struct.TaggedNode* %__x) #3 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  %2 = alloca %struct.TaggedNode*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  store %struct.TaggedNode* %__x, %struct.TaggedNode** %2, align 8
  %3 = load %"class.std::stack"** %1
  %4 = getelementptr inbounds %"class.std::stack"* %3, i32 0, i32 0
  %5 = load %struct.TaggedNode** %2, align 8
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE9push_backERKS0_(%"class.std::deque"* %4, %struct.TaggedNode* %5)
  ret void
}
...
define linkonce_odr zeroext i1 @_ZNKSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE5emptyEv(%"class.std::stack"* %this) #3 align 2 {
  ...
  %4 = call zeroext i1 @_ZNKSt5dequeI10TaggedNodeSaIS0_EE5emptyEv(%"class.std::deque"* %3) #0
  ret i1 %4
}
...
define linkonce_odr %struct.TaggedNode* @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE3topEv(%"class.std::stack"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  %4 = call %struct.TaggedNode* @_ZNSt5dequeI10TaggedNodeSaIS0_EE4backEv(%"class.std::deque"* %3) #0
  ret %struct.TaggedNode* %4
}
...
define linkonce_odr void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEE3popEv(%"class.std::stack"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE8pop_backEv(%"class.std::deque"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt5stackI10TaggedNodeSt5dequeIS0_SaIS0_EEED2Ev(%"class.std::stack"* %this) unnamed_addr #5 align 2 {
  ...
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EED2Ev(%"class.std::deque"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EE8pop_backEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  %5 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %4, i32 0, i32 3
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator"* %5, i32 0, i32 0
  %7 = load %struct.TaggedNode** %6, align 8
  %8 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %9 = getelementptr inbounds %"class.std::_Deque_base"* %8, i32 0, i32 0
  %10 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %9, i32 0, i32 3
  %11 = getelementptr inbounds %"struct.std::_Deque_iterator"* %10, i32 0, i32 1
  %12 = load %struct.TaggedNode** %11, align 8
  %13 = icmp ne %struct.TaggedNode* %7, %12
  br i1 %13, label %14, label %29

; <label>:14                                      ; preds = %0
  %15 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %16, i32 0, i32 3
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator"* %17, i32 0, i32 0
  %19 = load %struct.TaggedNode** %18, align 8
  %20 = getelementptr inbounds %struct.TaggedNode* %19, i32 -1
  store %struct.TaggedNode* %20, %struct.TaggedNode** %18, align 8
  %21 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %22 = getelementptr inbounds %"class.std::_Deque_base"* %21, i32 0, i32 0
  %23 = bitcast %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %22 to %"class.std::allocator.4"*
  %24 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %25, i32 0, i32 3
  %27 = getelementptr inbounds %"struct.std::_Deque_iterator"* %26, i32 0, i32 0
  %28 = load %struct.TaggedNode** %27, align 8
  call void @_ZNSt16allocator_traitsISaI10TaggedNodeEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.4"* %23, %struct.TaggedNode* %28)
  br label %30

; <label>:29                                      ; preds = %0
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE15_M_pop_back_auxEv(%"class.std::deque"* %2)
  br label %30
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI10TaggedNodeEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.4"* %__a, %struct.TaggedNode* %__p) #3 align 2 {
  ...
  store %struct.TaggedNode* %__p, %struct.TaggedNode** %2, align 8
  %3 = load %"class.std::allocator.4"** %1, align 8
  %4 = bitcast %"class.std::allocator.4"* %3 to %"class.__gnu_cxx::new_allocator.5"*
  %5 = load %struct.TaggedNode** %2, align 8
  call void @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator.5"* %4, %struct.TaggedNode* %5)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EE15_M_pop_back_auxEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  %6 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %5, i32 0, i32 3
  %7 = getelementptr inbounds %"struct.std::_Deque_iterator"* %6, i32 0, i32 1
  %8 = load %struct.TaggedNode** %7, align 8
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %3, %struct.TaggedNode* %8) #0
  %9 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %10 = getelementptr inbounds %"class.std::_Deque_base"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %10, i32 0, i32 3
  %12 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %13, i32 0, i32 3
  %15 = getelementptr inbounds %"struct.std::_Deque_iterator"* %14, i32 0, i32 3
  %16 = load %struct.TaggedNode*** %15, align 8
  %17 = getelementptr inbounds %struct.TaggedNode** %16, i64 -1
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %11, %struct.TaggedNode** %17) #0
  %18 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %19 = getelementptr inbounds %"class.std::_Deque_base"* %18, i32 0, i32 0
  %20 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %19, i32 0, i32 3
  %21 = getelementptr inbounds %"struct.std::_Deque_iterator"* %20, i32 0, i32 2
  %22 = load %struct.TaggedNode** %21, align 8
  %23 = getelementptr inbounds %struct.TaggedNode* %22, i64 -1
  %24 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %25, i32 0, i32 3
  %27 = getelementptr inbounds %"struct.std::_Deque_iterator"* %26, i32 0, i32 0
  store %struct.TaggedNode* %23, %struct.TaggedNode** %27, align 8
  %28 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %29 = call %"class.std::allocator.4"* @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %28) #0
  %30 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %31 = getelementptr inbounds %"class.std::_Deque_base"* %30, i32 0, i32 0
  %32 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %31, i32 0, i32 3
  %33 = getelementptr inbounds %"struct.std::_Deque_iterator"* %32, i32 0, i32 0
  %34 = load %struct.TaggedNode** %33, align 8
  call void @_ZNSt16allocator_traitsISaI10TaggedNodeEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.4"* %29, %struct.TaggedNode* %34)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %this, %struct.TaggedNode* %__p) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = bitcast %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %4 to %"class.std::allocator.4"*
  %6 = load %struct.TaggedNode** %2, align 8
  %7 = call i64 @_ZSt16__deque_buf_sizem(i64 16)
  call void @_ZNSt16allocator_traitsISaI10TaggedNodeEE10deallocateERS1_PS0_m(%"class.std::allocator.4"* %5, %struct.TaggedNode* %6, i64 %7)
  ret void
}
...
define linkonce_odr void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %this, %struct.TaggedNode** %__new_node) #3 align 2 {
  ...
  store %struct.TaggedNode** %__new_node, %struct.TaggedNode*** %2, align 8
  %3 = load %"struct.std::_Deque_iterator"** %1
  %4 = load %struct.TaggedNode*** %2, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 3
  store %struct.TaggedNode** %4, %struct.TaggedNode*** %5, align 8
  %6 = load %struct.TaggedNode*** %2, align 8
  %7 = load %struct.TaggedNode** %6, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 1
  store %struct.TaggedNode* %7, %struct.TaggedNode** %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 1
  %10 = load %struct.TaggedNode** %9, align 8
  %11 = call i64 @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E14_S_buffer_sizeEv() #0
  %12 = getelementptr inbounds %struct.TaggedNode* %10, i64 %11
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 2
  store %struct.TaggedNode* %12, %struct.TaggedNode** %13, align 8
  ret void
}
...
define linkonce_odr %"class.std::allocator.4"* @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  %4 = bitcast %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3 to %"class.std::allocator.4"*
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI10TaggedNodeEE10deallocateERS1_PS0_m(%"class.std::allocator.4"* %__a, %struct.TaggedNode* %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %struct.TaggedNode** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.5"* %5, %struct.TaggedNode* %6, i64 %7)
  ret void
}
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.5"* %this, %struct.TaggedNode* %__p, i64) #3 align 2 {
  ...
  %3 = alloca %struct.TaggedNode*, align 8
  %4 = alloca i64, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %2, align 8
  store %struct.TaggedNode* %__p, %struct.TaggedNode** %3, align 8
  store i64 %0, i64* %4, align 8
  %5 = load %"class.__gnu_cxx::new_allocator.5"** %2
  %6 = load %struct.TaggedNode** %3, align 8
  %7 = bitcast %struct.TaggedNode* %6 to i8*
  call void @_ZdlPv(i8* %7) #0
  ret void
}
...
define linkonce_odr %struct.TaggedNode* @_ZNSt5dequeI10TaggedNodeSaIS0_EE4backEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* sret %__tmp, %"class.std::deque"* %2) #0
  %3 = call %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EmmEv(%"struct.std::_Deque_iterator"* %__tmp) #0
  %4 = call %struct.TaggedNode* @_ZNKSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EdeEv(%"struct.std::_Deque_iterator"* %__tmp) #0
  ret %struct.TaggedNode* %4
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* noalias sret %agg.result, %"class.std::deque"* %this) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %4, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %agg.result, %"struct.std::_Deque_iterator"* %5) #0
  ret void
}
...
define linkonce_odr %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EmmEv(%"struct.std::_Deque_iterator"* %this) #3 align 2 {
  ...
  %4 = load %struct.TaggedNode** %3, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 1
  %6 = load %struct.TaggedNode** %5, align 8
  %7 = icmp eq %struct.TaggedNode* %4, %6
  br i1 %7, label %8, label %15

; <label>:8                                       ; preds = %0
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 3
  %10 = load %struct.TaggedNode*** %9, align 8
  %11 = getelementptr inbounds %struct.TaggedNode** %10, i64 -1
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %2, %struct.TaggedNode** %11) #0
  %12 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 2
  %13 = load %struct.TaggedNode** %12, align 8
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
  store %struct.TaggedNode* %13, %struct.TaggedNode** %14, align 8
  br label %15

; <label>:15                                      ; preds = %8, %0
  %16 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
  %17 = load %struct.TaggedNode** %16, align 8
  %18 = getelementptr inbounds %struct.TaggedNode* %17, i32 -1
  store %struct.TaggedNode* %18, %struct.TaggedNode** %16, align 8
...
define linkonce_odr void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"* %__x) unnamed_addr #3 align 2 {
  ...
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator"* %5, i32 0, i32 0
  %7 = load %struct.TaggedNode** %6, align 8
  store %struct.TaggedNode* %7, %struct.TaggedNode** %4, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 1
  %9 = load %"struct.std::_Deque_iterator"** %2, align 8
  %10 = getelementptr inbounds %"struct.std::_Deque_iterator"* %9, i32 0, i32 1
  %11 = load %struct.TaggedNode** %10, align 8
  store %struct.TaggedNode* %11, %struct.TaggedNode** %8, align 8
  ...
  %15 = load %struct.TaggedNode** %14, align 8
  store %struct.TaggedNode* %15, %struct.TaggedNode** %12, align 8
  ...
  %19 = load %struct.TaggedNode*** %18, align 8
  store %struct.TaggedNode** %19, %struct.TaggedNode*** %16, align 8
  ret void
}
...
define linkonce_odr zeroext i1 @_ZNKSt5dequeI10TaggedNodeSaIS0_EE5emptyEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  %8 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %7, i32 0, i32 2
  %9 = call zeroext i1 @_ZSteqI10TaggedNodeRS0_PS0_EbRKSt15_Deque_iteratorIT_T0_T1_ES9_(%"struct.std::_Deque_iterator"* %5, %"struct.std::_Deque_iterator"* %8) #0
  ret i1 %9
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EE9push_backERKS0_(%"class.std::deque"* %this, %struct.TaggedNode* %__x) #3 align 2 {
  ...
  %13 = load %struct.TaggedNode** %12, align 8
  %14 = getelementptr inbounds %struct.TaggedNode* %13, i64 -1
  %15 = icmp ne %struct.TaggedNode* %8, %14
  br i1 %15, label %16, label %32

; <label>:16                                      ; preds = %0
  %17 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %18 = getelementptr inbounds %"class.std::_Deque_base"* %17, i32 0, i32 0
  %19 = bitcast %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %18 to %"class.std::allocator.4"*
  %20 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %21 = getelementptr inbounds %"class.std::_Deque_base"* %20, i32 0, i32 0
  %22 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %21, i32 0, i32 3
  %23 = getelementptr inbounds %"struct.std::_Deque_iterator"* %22, i32 0, i32 0
  %24 = load %struct.TaggedNode** %23, align 8
  %25 = load %struct.TaggedNode** %2, align 8
  call void @_ZNSt16allocator_traitsISaI10TaggedNodeEE9constructIS0_JRKS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.4"* %19, %struct.TaggedNode* %24, %struct.TaggedNode* %25)
  %26 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %27 = getelementptr inbounds %"class.std::_Deque_base"* %26, i32 0, i32 0
  %28 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %27, i32 0, i32 3
  %29 = getelementptr inbounds %"struct.std::_Deque_iterator"* %28, i32 0, i32 0
  %30 = load %struct.TaggedNode** %29, align 8
  %31 = getelementptr inbounds %struct.TaggedNode* %30, i32 1
  store %struct.TaggedNode* %31, %struct.TaggedNode** %29, align 8
  br label %34

; <label>:32                                      ; preds = %0
  %33 = load %struct.TaggedNode** %2, align 8
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE16_M_push_back_auxIJRKS0_EEEvDpOT_(%"class.std::deque"* %3, %struct.TaggedNode* %33)
  br label %34
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI10TaggedNodeEE9constructIS0_JRKS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.4"* %__a, %struct.TaggedNode* %__p, %struct.TaggedNode* %__args) #3 align 2 {
  ...
  store %"class.std::allocator.4"* %__a, %"class.std::allocator.4"** %1, align 8
  store %struct.TaggedNode* %__p, %struct.TaggedNode** %2, align 8
  store %struct.TaggedNode* %__args, %struct.TaggedNode** %3, align 8
  %4 = load %"class.std::allocator.4"** %1, align 8
  %5 = bitcast %"class.std::allocator.4"* %4 to %"class.__gnu_cxx::new_allocator.5"*
  %6 = load %struct.TaggedNode** %2, align 8
  %7 = load %struct.TaggedNode** %3, align 8
  %8 = call %struct.TaggedNode* @_ZSt7forwardIRK10TaggedNodeEOT_RNSt16remove_referenceIS3_E4typeE(%struct.TaggedNode* %7) #0
  call void @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeE9constructIS1_JRKS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.5"* %5, %struct.TaggedNode* %6, %struct.TaggedNode* %8)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EE16_M_push_back_auxIJRKS0_EEEvDpOT_(%"class.std::deque"* %this, %struct.TaggedNode* %__args) #3 align 2 {
  ...
  %2 = alloca %struct.TaggedNode*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  store %struct.TaggedNode* %__args, %struct.TaggedNode** %2, align 8
  %3 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE22_M_reserve_map_at_backEm(%"class.std::deque"* %3, i64 1)
  %4 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %5 = call %struct.TaggedNode* @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %7, i32 0, i32 3
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator"* %8, i32 0, i32 3
  %10 = load %struct.TaggedNode*** %9, align 8
  %11 = getelementptr inbounds %struct.TaggedNode** %10, i64 1
  store %struct.TaggedNode* %5, %struct.TaggedNode** %11, align 8
  %12 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = bitcast %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %13 to %"class.std::allocator.4"*
  %15 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %16, i32 0, i32 3
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator"* %17, i32 0, i32 0
  %19 = load %struct.TaggedNode** %18, align 8
  %20 = load %struct.TaggedNode** %2, align 8
  %21 = call %struct.TaggedNode* @_ZSt7forwardIRK10TaggedNodeEOT_RNSt16remove_referenceIS3_E4typeE(%struct.TaggedNode* %20) #0
  call void @_ZNSt16allocator_traitsISaI10TaggedNodeEE9constructIS0_JRKS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.4"* %14, %struct.TaggedNode* %19, %struct.TaggedNode* %21)
  %22 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %23 = getelementptr inbounds %"class.std::_Deque_base"* %22, i32 0, i32 0
  %24 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %23, i32 0, i32 3
  %25 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %26 = getelementptr inbounds %"class.std::_Deque_base"* %25, i32 0, i32 0
  %27 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %26, i32 0, i32 3
  %28 = getelementptr inbounds %"struct.std::_Deque_iterator"* %27, i32 0, i32 3
  %29 = load %struct.TaggedNode*** %28, align 8
  %30 = getelementptr inbounds %struct.TaggedNode** %29, i64 1
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %24, %struct.TaggedNode** %30) #0
  %31 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %32 = getelementptr inbounds %"class.std::_Deque_base"* %31, i32 0, i32 0
  %33 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %32, i32 0, i32 3
  %34 = getelementptr inbounds %"struct.std::_Deque_iterator"* %33, i32 0, i32 1
  %35 = load %struct.TaggedNode** %34, align 8
  %36 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %37, i32 0, i32 3
  %39 = getelementptr inbounds %"struct.std::_Deque_iterator"* %38, i32 0, i32 0
  store %struct.TaggedNode* %35, %struct.TaggedNode** %39, align 8
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EE22_M_reserve_map_at_backEm(%"class.std::deque"* %this, i64 %__nodes_to_add) #3 align 2 {
  ...
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %7, i32 0, i32 1
  %9 = load i64* %8, align 8
  %10 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %11 = getelementptr inbounds %"class.std::_Deque_base"* %10, i32 0, i32 0
  %12 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %11, i32 0, i32 3
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator"* %12, i32 0, i32 3
  %14 = load %struct.TaggedNode*** %13, align 8
  %15 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %16, i32 0, i32 0
  %18 = load %struct.TaggedNode*** %17, align 8
  %19 = ptrtoint %struct.TaggedNode** %14 to i64
  %20 = ptrtoint %struct.TaggedNode** %18 to i64
  %21 = sub i64 %19, %20
...
; <label>:25                                      ; preds = %0
  ...
  call void @_ZNSt5dequeI10TaggedNodeSaIS0_EE17_M_reallocate_mapEmb(%"class.std::deque"* %3, i64 %26, i1 zeroext false)
  br label %27
...
define linkonce_odr %struct.TaggedNode* @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  %6 = call %struct.TaggedNode* @_ZNSt16allocator_traitsISaI10TaggedNodeEE8allocateERS1_m(%"class.std::allocator.4"* %4, i64 %5)
  ret %struct.TaggedNode* %6
}
...
define linkonce_odr %struct.TaggedNode* @_ZSt7forwardIRK10TaggedNodeEOT_RNSt16remove_referenceIS3_E4typeE(%struct.TaggedNode* %__t) #3 {
  %1 = alloca %struct.TaggedNode*, align 8
  store %struct.TaggedNode* %__t, %struct.TaggedNode** %1, align 8
  %2 = load %struct.TaggedNode** %1, align 8
  ret %struct.TaggedNode* %2
}
...
define linkonce_odr %struct.TaggedNode* @_ZNSt16allocator_traitsISaI10TaggedNodeEE8allocateERS1_m(%"class.std::allocator.4"* %__a, i64 %__n) #3 align 2 {
  ...
  %4 = bitcast %"class.std::allocator.4"* %3 to %"class.__gnu_cxx::new_allocator.5"*
  %5 = load i64* %2, align 8
  %6 = call %struct.TaggedNode* @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.5"* %4, i64 %5, i8* null)
  ret %struct.TaggedNode* %6
}
...
define linkonce_odr %struct.TaggedNode* @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.5"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.5"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorI10TaggedNodeE8max_sizeEv(%"class.__gnu_cxx::new_allocator.5"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; <label>:10                                      ; preds = %1
  ...
  %12 = mul i64 %11, 16
  %13 = call noalias i8* @_Znwm(i64 %12)
  %14 = bitcast i8* %13 to %struct.TaggedNode*
  ret %struct.TaggedNode* %14
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EE17_M_reallocate_mapEmb(%"class.std::deque"* %this, i64 %__nodes_to_add, i1 zeroext %__add_at_front) #3 align 2 {
  ...
  %__new_nstart = alloca %struct.TaggedNode**, align 8
  %__new_map_size = alloca i64, align 8
  %__new_map = alloca %struct.TaggedNode**, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  store i64 %__nodes_to_add, i64* %2, align 8
  ...
  %13 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %12, i32 0, i32 2
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %13, i32 0, i32 3
  %15 = load %struct.TaggedNode*** %14, align 8
  %16 = ptrtoint %struct.TaggedNode** %10 to i64
  %17 = ptrtoint %struct.TaggedNode** %15 to i64
  %18 = sub i64 %16, %17
  ...
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %25, i32 0, i32 1
...
; <label>:31                                      ; preds = %0
  ...
  %34 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %33, i32 0, i32 0
  %35 = load %struct.TaggedNode*** %34, align 8
  %36 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %37, i32 0, i32 1
  %39 = load i64* %38, align 8
  %40 = load i64* %__new_num_nodes, align 8
  %41 = sub i64 %39, %40
  %42 = udiv i64 %41, 2
  %43 = getelementptr inbounds %struct.TaggedNode** %35, i64 %42
...
; <label>:49                                      ; preds = %48, %46
  ...
  %51 = getelementptr inbounds %struct.TaggedNode** %43, i64 %50
  store %struct.TaggedNode** %51, %struct.TaggedNode*** %__new_nstart, align 8
  %52 = load %struct.TaggedNode*** %__new_nstart, align 8
  %53 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %54 = getelementptr inbounds %"class.std::_Deque_base"* %53, i32 0, i32 0
  %55 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %54, i32 0, i32 2
  %56 = getelementptr inbounds %"struct.std::_Deque_iterator"* %55, i32 0, i32 3
  %57 = load %struct.TaggedNode*** %56, align 8
  %58 = icmp ult %struct.TaggedNode** %52, %57
  br i1 %58, label %59, label %73

; <label>:59                                      ; preds = %49
  %60 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %61 = getelementptr inbounds %"class.std::_Deque_base"* %60, i32 0, i32 0
  %62 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %61, i32 0, i32 2
  %63 = getelementptr inbounds %"struct.std::_Deque_iterator"* %62, i32 0, i32 3
  %64 = load %struct.TaggedNode*** %63, align 8
  %65 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %66 = getelementptr inbounds %"class.std::_Deque_base"* %65, i32 0, i32 0
  %67 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %66, i32 0, i32 3
  %68 = getelementptr inbounds %"struct.std::_Deque_iterator"* %67, i32 0, i32 3
  %69 = load %struct.TaggedNode*** %68, align 8
  %70 = getelementptr inbounds %struct.TaggedNode** %69, i64 1
  %71 = load %struct.TaggedNode*** %__new_nstart, align 8
  %72 = call %struct.TaggedNode** @_ZSt4copyIPP10TaggedNodeS2_ET0_T_S4_S3_(%struct.TaggedNode** %64, %struct.TaggedNode** %70, %struct.TaggedNode** %71)
  br label %89

; <label>:73                                      ; preds = %49
  %74 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %75 = getelementptr inbounds %"class.std::_Deque_base"* %74, i32 0, i32 0
  %76 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %75, i32 0, i32 2
  %77 = getelementptr inbounds %"struct.std::_Deque_iterator"* %76, i32 0, i32 3
  %78 = load %struct.TaggedNode*** %77, align 8
  %79 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %80 = getelementptr inbounds %"class.std::_Deque_base"* %79, i32 0, i32 0
  %81 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %80, i32 0, i32 3
  %82 = getelementptr inbounds %"struct.std::_Deque_iterator"* %81, i32 0, i32 3
  %83 = load %struct.TaggedNode*** %82, align 8
  %84 = getelementptr inbounds %struct.TaggedNode** %83, i64 1
  %85 = load %struct.TaggedNode*** %__new_nstart, align 8
  %86 = load i64* %__old_num_nodes, align 8
  %87 = getelementptr inbounds %struct.TaggedNode** %85, i64 %86
  %88 = call %struct.TaggedNode** @_ZSt13copy_backwardIPP10TaggedNodeS2_ET0_T_S4_S3_(%struct.TaggedNode** %78, %struct.TaggedNode** %84, %struct.TaggedNode** %87)
  br label %89
...
; <label>:90                                      ; preds = %0
  ...
  %93 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %92, i32 0, i32 1
  ...
  %97 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %96, i32 0, i32 1
  ...
  %104 = call %struct.TaggedNode** @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %102, i64 %103)
  store %struct.TaggedNode** %104, %struct.TaggedNode*** %__new_map, align 8
  %105 = load %struct.TaggedNode*** %__new_map, align 8
  %106 = load i64* %__new_map_size, align 8
  %107 = load i64* %__new_num_nodes, align 8
  %108 = sub i64 %106, %107
  %109 = udiv i64 %108, 2
  %110 = getelementptr inbounds %struct.TaggedNode** %105, i64 %109
...
; <label>:116                                     ; preds = %115, %113
  ...
  %118 = getelementptr inbounds %struct.TaggedNode** %110, i64 %117
  store %struct.TaggedNode** %118, %struct.TaggedNode*** %__new_nstart, align 8
  %119 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %120 = getelementptr inbounds %"class.std::_Deque_base"* %119, i32 0, i32 0
  %121 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %120, i32 0, i32 2
  %122 = getelementptr inbounds %"struct.std::_Deque_iterator"* %121, i32 0, i32 3
  %123 = load %struct.TaggedNode*** %122, align 8
  %124 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %125 = getelementptr inbounds %"class.std::_Deque_base"* %124, i32 0, i32 0
  %126 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %125, i32 0, i32 3
  %127 = getelementptr inbounds %"struct.std::_Deque_iterator"* %126, i32 0, i32 3
  %128 = load %struct.TaggedNode*** %127, align 8
  %129 = getelementptr inbounds %struct.TaggedNode** %128, i64 1
  %130 = load %struct.TaggedNode*** %__new_nstart, align 8
  %131 = call %struct.TaggedNode** @_ZSt4copyIPP10TaggedNodeS2_ET0_T_S4_S3_(%struct.TaggedNode** %123, %struct.TaggedNode** %129, %struct.TaggedNode** %130)
  ...
  %135 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %134, i32 0, i32 0
  %136 = load %struct.TaggedNode*** %135, align 8
  %137 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %138 = getelementptr inbounds %"class.std::_Deque_base"* %137, i32 0, i32 0
  %139 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %138, i32 0, i32 1
  %140 = load i64* %139, align 8
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %132, %struct.TaggedNode** %136, i64 %140) #0
  %141 = load %struct.TaggedNode*** %__new_map, align 8
  %142 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %143 = getelementptr inbounds %"class.std::_Deque_base"* %142, i32 0, i32 0
  %144 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %143, i32 0, i32 0
  store %struct.TaggedNode** %141, %struct.TaggedNode*** %144, align 8
  ...
  %148 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %147, i32 0, i32 1
...
; <label>:149                                     ; preds = %116, %89
  ...
  %152 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %151, i32 0, i32 2
  %153 = load %struct.TaggedNode*** %__new_nstart, align 8
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %152, %struct.TaggedNode** %153) #0
  %154 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %155 = getelementptr inbounds %"class.std::_Deque_base"* %154, i32 0, i32 0
  %156 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %155, i32 0, i32 3
  %157 = load %struct.TaggedNode*** %__new_nstart, align 8
  %158 = load i64* %__old_num_nodes, align 8
  %159 = getelementptr inbounds %struct.TaggedNode** %157, i64 %158
  %160 = getelementptr inbounds %struct.TaggedNode** %159, i64 -1
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %156, %struct.TaggedNode** %160) #0
  ret void
}
...
define linkonce_odr %struct.TaggedNode** @_ZSt4copyIPP10TaggedNodeS2_ET0_T_S4_S3_(%struct.TaggedNode** %__first, %struct.TaggedNode** %__last, %struct.TaggedNode** %__result) #5 {
  ...
  %2 = alloca %struct.TaggedNode**, align 8
  %3 = alloca %struct.TaggedNode**, align 8
  store %struct.TaggedNode** %__first, %struct.TaggedNode*** %1, align 8
  store %struct.TaggedNode** %__last, %struct.TaggedNode*** %2, align 8
  store %struct.TaggedNode** %__result, %struct.TaggedNode*** %3, align 8
  %4 = load %struct.TaggedNode*** %1, align 8
  %5 = call %struct.TaggedNode** @_ZSt12__miter_baseIPP10TaggedNodeENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.TaggedNode** %4)
  %6 = load %struct.TaggedNode*** %2, align 8
  %7 = call %struct.TaggedNode** @_ZSt12__miter_baseIPP10TaggedNodeENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.TaggedNode** %6)
  %8 = load %struct.TaggedNode*** %3, align 8
  %9 = call %struct.TaggedNode** @_ZSt14__copy_move_a2ILb0EPP10TaggedNodeS2_ET1_T0_S4_S3_(%struct.TaggedNode** %5, %struct.TaggedNode** %7, %struct.TaggedNode** %8)
  ret %struct.TaggedNode** %9
}
...
define linkonce_odr %struct.TaggedNode** @_ZSt13copy_backwardIPP10TaggedNodeS2_ET0_T_S4_S3_(%struct.TaggedNode** %__first, %struct.TaggedNode** %__last, %struct.TaggedNode** %__result) #5 {
  ...
  %7 = call %struct.TaggedNode** @_ZSt12__miter_baseIPP10TaggedNodeENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.TaggedNode** %6)
  %8 = load %struct.TaggedNode*** %3, align 8
  %9 = call %struct.TaggedNode** @_ZSt23__copy_move_backward_a2ILb0EPP10TaggedNodeS2_ET1_T0_S4_S3_(%struct.TaggedNode** %5, %struct.TaggedNode** %7, %struct.TaggedNode** %8)
  ret %struct.TaggedNode** %9
}
...
define linkonce_odr %struct.TaggedNode** @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  ...
  call void @_ZNKSt11_Deque_baseI10TaggedNodeSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.7"* sret %__map_alloc, %"class.std::_Deque_base"* %4) #0
  %5 = load i64* %2, align 8
  %6 = call %struct.TaggedNode** @_ZNSt16allocator_traitsISaIP10TaggedNodeEE8allocateERS2_m(%"class.std::allocator.7"* %__map_alloc, i64 %5)
  store i32 1, i32* %3
  call void @_ZNSaIP10TaggedNodeED2Ev(%"class.std::allocator.7"* %__map_alloc) #0
  ret %struct.TaggedNode** %6
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %this, %struct.TaggedNode** %__p, i64 %__n) #3 align 2 {
  ...
  %5 = load %struct.TaggedNode*** %2, align 8
  %6 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIP10TaggedNodeEE10deallocateERS2_PS1_m(%"class.std::allocator.7"* %__map_alloc, %struct.TaggedNode** %5, i64 %6)
  call void @_ZNSaIP10TaggedNodeED2Ev(%"class.std::allocator.7"* %__map_alloc) #0
  ret void
}
...
define linkonce_odr void @_ZNKSt11_Deque_baseI10TaggedNodeSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.7"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = call %"class.std::allocator.4"* @_ZNKSt11_Deque_baseI10TaggedNodeSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %2) #0
  call void @_ZNSaIP10TaggedNodeEC2IS_EERKSaIT_E(%"class.std::allocator.7"* %agg.result, %"class.std::allocator.4"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIP10TaggedNodeEE10deallocateERS2_PS1_m(%"class.std::allocator.7"* %__a, %struct.TaggedNode** %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %struct.TaggedNode*** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIP10TaggedNodeE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.8"* %5, %struct.TaggedNode** %6, i64 %7)
  ret void
}
...
define linkonce_odr void @_ZNSaIP10TaggedNodeED2Ev(%"class.std::allocator.7"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIP10TaggedNodeED2Ev(%"class.__gnu_cxx::new_allocator.8"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaIP10TaggedNodeEC2IS_EERKSaIT_E(%"class.std::allocator.7"* %this, %"class.std::allocator.4"*) unnamed_addr #3 align 2 {
  ...
  %5 = bitcast %"class.std::allocator.7"* %4 to %"class.__gnu_cxx::new_allocator.8"*
  call void @_ZN9__gnu_cxx13new_allocatorIP10TaggedNodeEC2Ev(%"class.__gnu_cxx::new_allocator.8"* %5) #0
  ret void
}
...
define linkonce_odr %struct.TaggedNode** @_ZNSt16allocator_traitsISaIP10TaggedNodeEE8allocateERS2_m(%"class.std::allocator.7"* %__a, i64 %__n) #3 align 2 {
  ...
  %5 = load i64* %2, align 8
  %6 = call %struct.TaggedNode** @_ZN9__gnu_cxx13new_allocatorIP10TaggedNodeE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.8"* %4, i64 %5, i8* null)
  ret %struct.TaggedNode** %6
}
...
define linkonce_odr %struct.TaggedNode** @_ZN9__gnu_cxx13new_allocatorIP10TaggedNodeE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.8"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.8"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIP10TaggedNodeE8max_sizeEv(%"class.__gnu_cxx::new_allocator.8"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
define linkonce_odr %struct.TaggedNode** @_ZSt23__copy_move_backward_a2ILb0EPP10TaggedNodeS2_ET1_T0_S4_S3_(%struct.TaggedNode** %__first, %struct.TaggedNode** %__last, %struct.TaggedNode** %__result) #5 {
  ...
  store %struct.TaggedNode** %__result, %struct.TaggedNode*** %3, align 8
  %4 = load %struct.TaggedNode*** %1, align 8
  %5 = call %struct.TaggedNode** @_ZSt12__niter_baseIPP10TaggedNodeENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.TaggedNode** %4)
  %6 = load %struct.TaggedNode*** %2, align 8
  %7 = call %struct.TaggedNode** @_ZSt12__niter_baseIPP10TaggedNodeENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.TaggedNode** %6)
  %8 = load %struct.TaggedNode*** %3, align 8
  %9 = call %struct.TaggedNode** @_ZSt12__niter_baseIPP10TaggedNodeENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.TaggedNode** %8)
  %10 = call %struct.TaggedNode** @_ZSt22__copy_move_backward_aILb0EPP10TaggedNodeS2_ET1_T0_S4_S3_(%struct.TaggedNode** %5, %struct.TaggedNode** %7, %struct.TaggedNode** %9)
  ret %struct.TaggedNode** %10
}
...
define linkonce_odr %struct.TaggedNode** @_ZSt12__miter_baseIPP10TaggedNodeENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.TaggedNode** %__it) #5 {
  %1 = alloca %struct.TaggedNode**, align 8
  store %struct.TaggedNode** %__it, %struct.TaggedNode*** %1, align 8
  %2 = load %struct.TaggedNode*** %1, align 8
  %3 = call %struct.TaggedNode** @_ZNSt10_Iter_baseIPP10TaggedNodeLb0EE7_S_baseES2_(%struct.TaggedNode** %2)
  ret %struct.TaggedNode** %3
}
...
define linkonce_odr %struct.TaggedNode** @_ZSt22__copy_move_backward_aILb0EPP10TaggedNodeS2_ET1_T0_S4_S3_(%struct.TaggedNode** %__first, %struct.TaggedNode** %__last, %struct.TaggedNode** %__result) #5 {
  ...
  %5 = load %struct.TaggedNode*** %2, align 8
  %6 = load %struct.TaggedNode*** %3, align 8
  %7 = call %struct.TaggedNode** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIP10TaggedNodeEEPT_PKS5_S8_S6_(%struct.TaggedNode** %4, %struct.TaggedNode** %5, %struct.TaggedNode** %6)
  ret %struct.TaggedNode** %7
}
...
define linkonce_odr %struct.TaggedNode** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIP10TaggedNodeEEPT_PKS5_S8_S6_(%struct.TaggedNode** %__first, %struct.TaggedNode** %__last, %struct.TaggedNode** %__result) #3 align 2 {
  ...
  store %struct.TaggedNode** %__result, %struct.TaggedNode*** %3, align 8
  %4 = load %struct.TaggedNode*** %2, align 8
  %5 = load %struct.TaggedNode*** %1, align 8
  %6 = ptrtoint %struct.TaggedNode** %4 to i64
  %7 = ptrtoint %struct.TaggedNode** %5 to i64
  %8 = sub i64 %6, %7
...
; <label>:12                                      ; preds = %0
  %13 = load %struct.TaggedNode*** %3, align 8
  %14 = load i64* %_Num, align 8
  %15 = sub i64 0, %14
  %16 = getelementptr inbounds %struct.TaggedNode** %13, i64 %15
  %17 = bitcast %struct.TaggedNode** %16 to i8*
  %18 = load %struct.TaggedNode*** %1, align 8
  %19 = bitcast %struct.TaggedNode** %18 to i8*
...
; <label>:22                                      ; preds = %12, %0
  %23 = load %struct.TaggedNode*** %3, align 8
  %24 = load i64* %_Num, align 8
  %25 = sub i64 0, %24
  %26 = getelementptr inbounds %struct.TaggedNode** %23, i64 %25
  ret %struct.TaggedNode** %26
}
...
define linkonce_odr %struct.TaggedNode** @_ZSt14__copy_move_a2ILb0EPP10TaggedNodeS2_ET1_T0_S4_S3_(%struct.TaggedNode** %__first, %struct.TaggedNode** %__last, %struct.TaggedNode** %__result) #5 {
  ...
  %8 = load %struct.TaggedNode*** %3, align 8
  %9 = call %struct.TaggedNode** @_ZSt12__niter_baseIPP10TaggedNodeENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.TaggedNode** %8)
  %10 = call %struct.TaggedNode** @_ZSt13__copy_move_aILb0EPP10TaggedNodeS2_ET1_T0_S4_S3_(%struct.TaggedNode** %5, %struct.TaggedNode** %7, %struct.TaggedNode** %9)
  ret %struct.TaggedNode** %10
}
...
define linkonce_odr %struct.TaggedNode** @_ZSt13__copy_move_aILb0EPP10TaggedNodeS2_ET1_T0_S4_S3_(%struct.TaggedNode** %__first, %struct.TaggedNode** %__last, %struct.TaggedNode** %__result) #5 {
  ...
  %5 = load %struct.TaggedNode*** %2, align 8
  %6 = load %struct.TaggedNode*** %3, align 8
  %7 = call %struct.TaggedNode** @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIP10TaggedNodeEEPT_PKS5_S8_S6_(%struct.TaggedNode** %4, %struct.TaggedNode** %5, %struct.TaggedNode** %6)
  ret %struct.TaggedNode** %7
}
...
; <label>:12                                      ; preds = %0
  %13 = load %struct.TaggedNode*** %3, align 8
  %14 = bitcast %struct.TaggedNode** %13 to i8*
  %15 = load %struct.TaggedNode*** %1, align 8
  %16 = bitcast %struct.TaggedNode** %15 to i8*
  %17 = load i64* %_Num, align 8
  %18 = mul i64 8, %17
...
; <label>:19                                      ; preds = %12, %0
  %20 = load %struct.TaggedNode*** %3, align 8
  %21 = load i64* %_Num, align 8
  %22 = getelementptr inbounds %struct.TaggedNode** %20, i64 %21
  ret %struct.TaggedNode** %22
}
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeE9constructIS1_JRKS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.5"* %this, %struct.TaggedNode* %__p, %struct.TaggedNode* %__args) #3 align 2 {
  ...
  %5 = load %struct.TaggedNode** %2, align 8
  %6 = bitcast %struct.TaggedNode* %5 to i8*
  %7 = icmp eq i8* %6, null
  br i1 %7, label %14, label %8

; <label>:8                                       ; preds = %0
  %9 = bitcast i8* %6 to %struct.TaggedNode*
  %10 = load %struct.TaggedNode** %3, align 8
  %11 = call %struct.TaggedNode* @_ZSt7forwardIRK10TaggedNodeEOT_RNSt16remove_referenceIS3_E4typeE(%struct.TaggedNode* %10) #0
  %12 = bitcast %struct.TaggedNode* %9 to i8*
  %13 = bitcast %struct.TaggedNode* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %12, i8* %13, i64 16, i32 8, i1 false)
  br label %14

; <label>:14                                      ; preds = %8, %0
  %15 = phi %struct.TaggedNode* [ %9, %8 ], [ null, %0 ]
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EE5beginEv(%"struct.std::_Deque_iterator"* noalias sret %agg.result, %"class.std::deque"* %this) #3 align 2 {
  ...
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %4, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %agg.result, %"struct.std::_Deque_iterator"* %5) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EED2Ev(%"class.std::_Deque_base"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 0
  %5 = load %struct.TaggedNode*** %4, align 8
  %6 = icmp ne %struct.TaggedNode** %5, null
  br i1 %6, label %7, label %23

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %9 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %8, i32 0, i32 2
  ...
  %13 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %12, i32 0, i32 3
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %13, i32 0, i32 3
  %15 = load %struct.TaggedNode*** %14, align 8
  %16 = getelementptr inbounds %struct.TaggedNode** %15, i64 1
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE16_M_destroy_nodesEPPS0_S4_(%"class.std::_Deque_base"* %2, %struct.TaggedNode** %11, %struct.TaggedNode** %16) #0
  %17 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %18 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %17, i32 0, i32 0
  %19 = load %struct.TaggedNode*** %18, align 8
  %20 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %20, i32 0, i32 1
  %22 = load i64* %21, align 8
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %2, %struct.TaggedNode** %19, i64 %22) #0
  br label %23

; <label>:23                                      ; preds = %7, %0
  %24 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %24) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE16_M_destroy_nodesEPPS0_S4_(%"class.std::_Deque_base"* %this, %struct.TaggedNode** %__nstart, %struct.TaggedNode** %__nfinish) #3 align 2 {
  ...
  %2 = alloca %struct.TaggedNode**, align 8
  %3 = alloca %struct.TaggedNode**, align 8
  %__n = alloca %struct.TaggedNode**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store %struct.TaggedNode** %__nstart, %struct.TaggedNode*** %2, align 8
  store %struct.TaggedNode** %__nfinish, %struct.TaggedNode*** %3, align 8
  %4 = load %"class.std::_Deque_base"** %1
  %5 = load %struct.TaggedNode*** %2, align 8
  store %struct.TaggedNode** %5, %struct.TaggedNode*** %__n, align 8
  br label %6

; <label>:6                                       ; preds = %13, %0
  %7 = load %struct.TaggedNode*** %__n, align 8
  %8 = load %struct.TaggedNode*** %3, align 8
  %9 = icmp ult %struct.TaggedNode** %7, %8
  br i1 %9, label %10, label %16

; <label>:10                                      ; preds = %6
  %11 = load %struct.TaggedNode*** %__n, align 8
  %12 = load %struct.TaggedNode** %11, align 8
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %4, %struct.TaggedNode* %12) #0
  br label %13

; <label>:13                                      ; preds = %10
  %14 = load %struct.TaggedNode*** %__n, align 8
  %15 = getelementptr inbounds %struct.TaggedNode** %14, i32 1
  store %struct.TaggedNode** %15, %struct.TaggedNode*** %__n, align 8
  br label %6
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %this, %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %1, align 8
  %2 = load %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %2 to %"class.std::allocator.4"*
  call void @_ZNSaI10TaggedNodeED2Ev(%"class.std::allocator.4"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaI10TaggedNodeED2Ev(%"class.std::allocator.4"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeED2Ev(%"class.__gnu_cxx::new_allocator.5"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EEC2Ev(%"class.std::_Deque_base"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE11_Deque_implC2Ev(%"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3)
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %2, i64 0)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE11_Deque_implC2Ev(%"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %2 to %"class.std::allocator.4"*
  call void @_ZNSaI10TaggedNodeEC2Ev(%"class.std::allocator.4"* %3) #0
  %4 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %2, i32 0, i32 0
  store %struct.TaggedNode** null, %struct.TaggedNode*** %4, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %2, i32 0, i32 1
  store i64 0, i64* %5, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %2, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %6) #0
  %7 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %2, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %7) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %this, i64 %__num_elements) #3 align 2 {
  ...
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %__nstart = alloca %struct.TaggedNode**, align 8
  %__nfinish = alloca %struct.TaggedNode**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  ...
  %15 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %14, i32 0, i32 1
  store i64 %13, i64* %15, align 8
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %16, i32 0, i32 1
  %18 = load i64* %17, align 8
  %19 = call %struct.TaggedNode** @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %5, i64 %18)
  %20 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %20, i32 0, i32 0
  store %struct.TaggedNode** %19, %struct.TaggedNode*** %21, align 8
  %22 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %22, i32 0, i32 0
  %24 = load %struct.TaggedNode*** %23, align 8
  ...
  %29 = sub i64 %27, %28
  %30 = udiv i64 %29, 2
  %31 = getelementptr inbounds %struct.TaggedNode** %24, i64 %30
  store %struct.TaggedNode** %31, %struct.TaggedNode*** %__nstart, align 8
  %32 = load %struct.TaggedNode*** %__nstart, align 8
  %33 = load i64* %__num_nodes, align 8
  %34 = getelementptr inbounds %struct.TaggedNode** %32, i64 %33
  store %struct.TaggedNode** %34, %struct.TaggedNode*** %__nfinish, align 8
  %35 = load %struct.TaggedNode*** %__nstart, align 8
  %36 = load %struct.TaggedNode*** %__nfinish, align 8
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE15_M_create_nodesEPPS0_S4_(%"class.std::_Deque_base"* %5, %struct.TaggedNode** %35, %struct.TaggedNode** %36)
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %37, i32 0, i32 2
  %39 = load %struct.TaggedNode*** %__nstart, align 8
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %38, %struct.TaggedNode** %39) #0
  %40 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %41 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %40, i32 0, i32 3
  %42 = load %struct.TaggedNode*** %__nfinish, align 8
  %43 = getelementptr inbounds %struct.TaggedNode** %42, i64 -1
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %41, %struct.TaggedNode** %43) #0
  %44 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %45 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %44, i32 0, i32 2
  %46 = getelementptr inbounds %"struct.std::_Deque_iterator"* %45, i32 0, i32 1
  %47 = load %struct.TaggedNode** %46, align 8
  %48 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %49 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %48, i32 0, i32 2
  %50 = getelementptr inbounds %"struct.std::_Deque_iterator"* %49, i32 0, i32 0
  store %struct.TaggedNode* %47, %struct.TaggedNode** %50, align 8
  %51 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %52 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %51, i32 0, i32 3
  %53 = getelementptr inbounds %"struct.std::_Deque_iterator"* %52, i32 0, i32 1
  %54 = load %struct.TaggedNode** %53, align 8
  %55 = load i64* %2, align 8
  %56 = call i64 @_ZSt16__deque_buf_sizem(i64 16)
  %57 = urem i64 %55, %56
  %58 = getelementptr inbounds %struct.TaggedNode* %54, i64 %57
  %59 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %60 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %59, i32 0, i32 3
  %61 = getelementptr inbounds %"struct.std::_Deque_iterator"* %60, i32 0, i32 0
  store %struct.TaggedNode* %58, %struct.TaggedNode** %61, align 8
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE15_M_create_nodesEPPS0_S4_(%"class.std::_Deque_base"* %this, %struct.TaggedNode** %__nstart, %struct.TaggedNode** %__nfinish) #3 align 2 {
  ...
  %2 = alloca %struct.TaggedNode**, align 8
  %3 = alloca %struct.TaggedNode**, align 8
  %__cur = alloca %struct.TaggedNode**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store %struct.TaggedNode** %__nstart, %struct.TaggedNode*** %2, align 8
  store %struct.TaggedNode** %__nfinish, %struct.TaggedNode*** %3, align 8
  %4 = load %"class.std::_Deque_base"** %1
  %5 = load %struct.TaggedNode*** %2, align 8
  store %struct.TaggedNode** %5, %struct.TaggedNode*** %__cur, align 8
  br label %6

; <label>:6                                       ; preds = %13, %0
  %7 = load %struct.TaggedNode*** %__cur, align 8
  %8 = load %struct.TaggedNode*** %3, align 8
  %9 = icmp ult %struct.TaggedNode** %7, %8
  br i1 %9, label %10, label %16

; <label>:10                                      ; preds = %6
  %11 = call %struct.TaggedNode* @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
  %12 = load %struct.TaggedNode*** %__cur, align 8
  store %struct.TaggedNode* %11, %struct.TaggedNode** %12, align 8
  br label %13

; <label>:13                                      ; preds = %10
  %14 = load %struct.TaggedNode*** %__cur, align 8
  %15 = getelementptr inbounds %struct.TaggedNode** %14, i32 1
  store %struct.TaggedNode** %15, %struct.TaggedNode*** %__cur, align 8
  br label %6
...
define linkonce_odr void @_ZNSaI10TaggedNodeEC2Ev(%"class.std::allocator.4"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::allocator.4"** %1
  %3 = bitcast %"class.std::allocator.4"* %2 to %"class.__gnu_cxx::new_allocator.5"*
  call void @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeEC2Ev(%"class.__gnu_cxx::new_allocator.5"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
  store %struct.TaggedNode* null, %struct.TaggedNode** %3, align 8
  ...
  store %struct.TaggedNode* null, %struct.TaggedNode** %5, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 3
  store %struct.TaggedNode** null, %struct.TaggedNode*** %6, align 8
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI10TaggedNodeSaIS0_EEC2EOS2_(%"class.std::deque"* %this, %"class.std::deque"* %__x) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EEC2EOS2_(%"class.std::_Deque_base"* %4, %"class.std::_Deque_base"* %7)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EEC2EOS2_(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %7 = call %"class.std::_Deque_base"* @_ZSt4moveIRSt11_Deque_baseI10TaggedNodeSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::_Deque_base"* %6) #0
  %8 = bitcast %"struct.__gnu_cxx::__allocator_always_compares_equal"* %4 to %"struct.std::integral_constant"*
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EEC2EOS2_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %5, %"class.std::_Deque_base"* %7)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EEC2EOS2_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %5 = getelementptr inbounds %"class.std::_Deque_base"* %4, i32 0, i32 0
  %6 = load %"class.std::_Deque_base"** %2, align 8
  %7 = call %"class.std::allocator.4"* @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %6) #0
  %8 = call %"class.std::allocator.4"* @_ZSt4moveIRSaI10TaggedNodeEEONSt16remove_referenceIT_E4typeEOS4_(%"class.std::allocator.4"* %7) #0
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE11_Deque_implC2EOS1_(%"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %5, %"class.std::allocator.4"* %8) #0
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %4, i64 0)
  %9 = load %"class.std::_Deque_base"** %2, align 8
  %10 = getelementptr inbounds %"class.std::_Deque_base"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %10, i32 0, i32 0
  %12 = load %struct.TaggedNode*** %11, align 8
  %13 = icmp ne %struct.TaggedNode** %12, null
...
; <label>:14                                      ; preds = %0
  ...
  call void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE11_Deque_impl12_M_swap_dataERS3_(%"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %15, %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %17) #0
  br label %18
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE11_Deque_implC2EOS1_(%"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %this, %"class.std::allocator.4"* %__a) unnamed_addr #3 align 2 {
  ...
  %3 = load %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %1
  %4 = bitcast %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3 to %"class.std::allocator.4"*
  %5 = load %"class.std::allocator.4"** %2, align 8
  %6 = call %"class.std::allocator.4"* @_ZSt4moveIRSaI10TaggedNodeEEONSt16remove_referenceIT_E4typeEOS4_(%"class.std::allocator.4"* %5) #0
  call void @_ZNSaI10TaggedNodeEC2ERKS0_(%"class.std::allocator.4"* %4, %"class.std::allocator.4"* %6) #0
  %7 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 0
  store %struct.TaggedNode** null, %struct.TaggedNode*** %7, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 1
  store i64 0, i64* %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %9) #0
  %10 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %10) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI10TaggedNodeSaIS0_EE11_Deque_impl12_M_swap_dataERS3_(%"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %this, %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %__x) #3 align 2 {
  %1 = alloca %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"*, align 8
  %2 = alloca %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %this, %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %1, align 8
  store %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %__x, %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %2, align 8
  %3 = load %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %1
  %4 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 2
  %5 = load %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %2, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %5, i32 0, i32 2
  call void @_ZSt4swapISt15_Deque_iteratorI10TaggedNodeRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %4, %"struct.std::_Deque_iterator"* %6) #0
  %7 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 3
  %8 = load %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %2, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %8, i32 0, i32 3
  call void @_ZSt4swapISt15_Deque_iteratorI10TaggedNodeRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %7, %"struct.std::_Deque_iterator"* %9) #0
  %10 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 0
  %11 = load %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %2, align 8
  %12 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %11, i32 0, i32 0
  call void @_ZSt4swapIPP10TaggedNodeEvRT_S4_(%struct.TaggedNode*** %10, %struct.TaggedNode*** %12) #0
  %13 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %3, i32 0, i32 1
  %14 = load %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"** %2, align 8
  %15 = getelementptr inbounds %"struct.std::_Deque_base<TaggedNode, std::allocator<TaggedNode> >::_Deque_impl"* %14, i32 0, i32 1
...
define linkonce_odr void @_ZSt4swapISt15_Deque_iteratorI10TaggedNodeRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %__a, %"struct.std::_Deque_iterator"* %__b) #5 {
  ...
  %3 = load %"struct.std::_Deque_iterator"** %1, align 8
  %4 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI10TaggedNodeRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %3) #0
  call void @_ZNSt15_Deque_iteratorI10TaggedNodeRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %__tmp, %"struct.std::_Deque_iterator"* %4) #0
  %5 = load %"struct.std::_Deque_iterator"** %1, align 8
  %6 = load %"struct.std::_Deque_iterator"** %2, align 8
  %7 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI10TaggedNodeRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %6) #0
  ...
  %11 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI10TaggedNodeRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %__tmp) #0
...
define linkonce_odr void @_ZSt4swapIPP10TaggedNodeEvRT_S4_(%struct.TaggedNode*** %__a, %struct.TaggedNode*** %__b) #5 {
  %1 = alloca %struct.TaggedNode***, align 8
  %2 = alloca %struct.TaggedNode***, align 8
  %__tmp = alloca %struct.TaggedNode**, align 8
  store %struct.TaggedNode*** %__a, %struct.TaggedNode**** %1, align 8
  store %struct.TaggedNode*** %__b, %struct.TaggedNode**** %2, align 8
  %3 = load %struct.TaggedNode**** %1, align 8
  %4 = call %struct.TaggedNode*** @_ZSt4moveIRPP10TaggedNodeEONSt16remove_referenceIT_E4typeEOS5_(%struct.TaggedNode*** %3) #0
  %5 = load %struct.TaggedNode*** %4
  store %struct.TaggedNode** %5, %struct.TaggedNode*** %__tmp, align 8
  %6 = load %struct.TaggedNode**** %2, align 8
  %7 = call %struct.TaggedNode*** @_ZSt4moveIRPP10TaggedNodeEONSt16remove_referenceIT_E4typeEOS5_(%struct.TaggedNode*** %6) #0
  %8 = load %struct.TaggedNode*** %7
  %9 = load %struct.TaggedNode**** %1, align 8
  store %struct.TaggedNode** %8, %struct.TaggedNode*** %9, align 8
  %10 = call %struct.TaggedNode*** @_ZSt4moveIRPP10TaggedNodeEONSt16remove_referenceIT_E4typeEOS5_(%struct.TaggedNode*** %__tmp) #0
  %11 = load %struct.TaggedNode*** %10
  %12 = load %struct.TaggedNode**** %2, align 8
  store %struct.TaggedNode** %11, %struct.TaggedNode*** %12, align 8
  ret void
}
...
define linkonce_odr void @_ZNSaI10TaggedNodeEC2ERKS0_(%"class.std::allocator.4"* %this, %"class.std::allocator.4"* %__a) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorI10TaggedNodeEC2ERKS2_(%"class.__gnu_cxx::new_allocator.5"* %4, %"class.__gnu_cxx::new_allocator.5"* %6) #0
  ret void
}
