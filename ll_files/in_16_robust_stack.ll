...
; <label>:9                                       ; preds = %0
  call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([16 x i8]* @.str3, i32 0, i32 0)) #8
  unreachable
...
; <label>:14                                      ; preds = %10
  ...
  %22 = getelementptr %"class.std::move_iterator.9"* %3, i32 0, i32 0
  ...
  %28 = getelementptr %"class.std::move_iterator.9"* %4, i32 0, i32 0
  store %struct.Node** %27, %struct.Node*** %28
  %29 = getelementptr %"class.std::move_iterator.9"* %3, i32 0, i32 0
  %30 = load %struct.Node*** %29
  %31 = getelementptr %"class.std::move_iterator.9"* %4, i32 0, i32 0
...
define linkonce_odr zeroext i1 @_ZNKSt6vectorIP4NodeSaIS1_EE5emptyEv(%"class.std::vector.0"* %this) #3 align 2 {
  ...
  %9 = call zeroext i1 @_ZN9__gnu_cxxeqIPKP4NodeSt6vectorIS2_SaIS2_EEEEbRKNS_17__normal_iteratorIT_T0_EESD_(%"class.__gnu_cxx::__normal_iterator.10"* %2, %"class.__gnu_cxx::__normal_iterator.10"* %3) #0
  ret i1 %9
}
...
define linkonce_odr zeroext i1 @_ZN9__gnu_cxxeqIPKP4NodeSt6vectorIS2_SaIS2_EEEEbRKNS_17__normal_iteratorIT_T0_EESD_(%"class.__gnu_cxx::__normal_iterator.10"* %__lhs, %"class.__gnu_cxx::__normal_iterator.10"* %__rhs) #5 {
  ...
  %4 = call %struct.Node*** @_ZNK9__gnu_cxx17__normal_iteratorIPKP4NodeSt6vectorIS2_SaIS2_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.10"* %3) #0
  %5 = load %struct.Node*** %4
  %6 = load %"class.__gnu_cxx::__normal_iterator.10"** %2, align 8
  %7 = call %struct.Node*** @_ZNK9__gnu_cxx17__normal_iteratorIPKP4NodeSt6vectorIS2_SaIS2_EEE4baseEv(%"class.__gnu_cxx::__normal_iterator.10"* %6) #0
  %8 = load %struct.Node*** %7
...
define linkonce_odr %struct.Node** @_ZNKSt6vectorIP4NodeSaIS1_EE5beginEv(%"class.std::vector.0"* %this) #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx17__normal_iteratorIPKP4NodeSt6vectorIS2_SaIS2_EEEC2ERKS4_(%"class.__gnu_cxx::__normal_iterator.10"* %1, %struct.Node*** %3) #0
...
define linkonce_odr %struct.Node** @_ZNSt6vectorIP4NodeSaIS1_EE20_M_allocate_and_copyISt13move_iteratorIPS1_EEES6_mT_S8_(%"class.std::vector.0"* %this, i64 %__n, %struct.Node** %__first.coerce, %struct.Node** %__last.coerce) #3 align 2 {
  ...
  store %"class.std::vector.0"* %this, %"class.std::vector.0"** %1, align 8
  store i64 %__n, i64* %2, align 8
  %5 = getelementptr %"class.std::move_iterator.9"* %__first, i32 0, i32 0
  store %struct.Node** %__first.coerce, %struct.Node*** %5
  %6 = getelementptr %"class.std::move_iterator.9"* %__last, i32 0, i32 0
  ...
  %11 = bitcast %"class.std::move_iterator.9"* %3 to i8*
  %12 = bitcast %"class.std::move_iterator.9"* %__first to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %11, i8* %12, i64 8, i32 8, i1 false)
  %13 = bitcast %"class.std::move_iterator.9"* %4 to i8*
  %14 = bitcast %"class.std::move_iterator.9"* %__last to i8*
  ...
  %18 = getelementptr %"class.std::move_iterator.9"* %3, i32 0, i32 0
  %19 = load %struct.Node*** %18
  %20 = getelementptr %"class.std::move_iterator.9"* %4, i32 0, i32 0
