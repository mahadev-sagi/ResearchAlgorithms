; ModuleID = 'PostorderTraversals/po_04_morris.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %2 = alloca %struct.TreeNode*, align 8
  %3 = alloca i1
  %cur = alloca %struct.TreeNode*, align 8
  ...
  store %struct.TreeNode* %8, %struct.TreeNode** %cur, align 8
  br label %9

; <label>:9                                       ; preds = %65, %0
  %10 = load %struct.TreeNode** %cur, align 8
  %11 = icmp ne %struct.TreeNode* %10, null
  br i1 %11, label %12, label %66

; <label>:12                                      ; preds = %9
  %13 = load %struct.TreeNode** %cur, align 8
...
; <label>:17                                      ; preds = %12
  %18 = load %struct.TreeNode** %cur, align 8
  ...
  %20 = load %struct.TreeNode** %cur, align 8
  %21 = getelementptr inbounds %struct.TreeNode* %20, i32 0, i32 1
  %22 = load %struct.TreeNode** %21, align 8
  store %struct.TreeNode* %22, %struct.TreeNode** %cur, align 8
  br label %65

; <label>:23                                      ; preds = %12
  %24 = load %struct.TreeNode** %cur, align 8
  %25 = getelementptr inbounds %struct.TreeNode* %24, i32 0, i32 2
  %26 = load %struct.TreeNode** %25, align 8
  store %struct.TreeNode* %26, %struct.TreeNode** %prev, align 8
  br label %27

; <label>:27                                      ; preds = %40, %23
  %28 = load %struct.TreeNode** %prev, align 8
  %29 = getelementptr inbounds %struct.TreeNode* %28, i32 0, i32 1
...
; <label>:32                                      ; preds = %27
  ...
  %34 = getelementptr inbounds %struct.TreeNode* %33, i32 0, i32 1
  %35 = load %struct.TreeNode** %34, align 8
  %36 = load %struct.TreeNode** %cur, align 8
  %37 = icmp ne %struct.TreeNode* %35, %36
  br label %38
...
; <label>:40                                      ; preds = %38
  ...
  %42 = getelementptr inbounds %struct.TreeNode* %41, i32 0, i32 1
  %43 = load %struct.TreeNode** %42, align 8
  store %struct.TreeNode* %43, %struct.TreeNode** %prev, align 8
  br label %27

; <label>:44                                      ; preds = %38
  %45 = load %struct.TreeNode** %prev, align 8
...
; <label>:49                                      ; preds = %44
  %50 = load %struct.TreeNode** %cur, align 8
  %51 = getelementptr inbounds %struct.TreeNode* %50, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %51)
  %52 = load %struct.TreeNode** %cur, align 8
  %53 = load %struct.TreeNode** %prev, align 8
  %54 = getelementptr inbounds %struct.TreeNode* %53, i32 0, i32 1
  store %struct.TreeNode* %52, %struct.TreeNode** %54, align 8
  %55 = load %struct.TreeNode** %cur, align 8
  %56 = getelementptr inbounds %struct.TreeNode* %55, i32 0, i32 2
  %57 = load %struct.TreeNode** %56, align 8
  store %struct.TreeNode* %57, %struct.TreeNode** %cur, align 8
  br label %64

; <label>:58                                      ; preds = %44
  %59 = load %struct.TreeNode** %prev, align 8
  %60 = getelementptr inbounds %struct.TreeNode* %59, i32 0, i32 1
  store %struct.TreeNode* null, %struct.TreeNode** %60, align 8
  %61 = load %struct.TreeNode** %cur, align 8
  %62 = getelementptr inbounds %struct.TreeNode* %61, i32 0, i32 1
  %63 = load %struct.TreeNode** %62, align 8
  store %struct.TreeNode* %63, %struct.TreeNode** %cur, align 8
  br label %64
...
; <label>:66                                      ; preds = %9
  %67 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %agg.result) #0
  %68 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  store i32* %67, i32** %68
  %69 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %agg.result) #0
  %70 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  store i32* %69, i32** %70
  %71 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %4, i32 0, i32 0
  %72 = load i32** %71
  %73 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %5, i32 0, i32 0
  %74 = load i32** %73
  call void @_ZSt7reverseIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEEvT_S7_(i32* %72, i32* %74)
  store i1 true, i1* %3
  store i32 1, i32* %6
  %75 = load i1* %3
