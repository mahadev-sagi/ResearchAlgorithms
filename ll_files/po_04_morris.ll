...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  store %struct.TreeNode* %10, %struct.TreeNode** %cur, align 8
  br label %11

; <label>:11                                      ; preds = %73, %0
  %12 = load %struct.TreeNode** %cur, align 8
  %13 = icmp ne %struct.TreeNode* %12, null
  br i1 %13, label %14, label %74

; <label>:14                                      ; preds = %11
  %15 = load %struct.TreeNode** %cur, align 8
  %16 = getelementptr inbounds %struct.TreeNode* %15, i32 0, i32 2
...
; <label>:19                                      ; preds = %14
  ...
  %21 = getelementptr inbounds %struct.TreeNode* %20, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %21)
          to label %22 unwind label %26

; <label>:22                                      ; preds = %19
  %23 = load %struct.TreeNode** %cur, align 8
  %24 = getelementptr inbounds %struct.TreeNode* %23, i32 0, i32 1
  %25 = load %struct.TreeNode** %24, align 8
  store %struct.TreeNode* %25, %struct.TreeNode** %cur, align 8
  br label %73

; <label>:26                                      ; preds = %74, %56, %19
  %27 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup
  %28 = extractvalue { i8*, i32 } %27, 0
  store i8* %28, i8** %4
...
; <label>:39                                      ; preds = %34
  %40 = load %struct.TreeNode** %prev, align 8
  %41 = getelementptr inbounds %struct.TreeNode* %40, i32 0, i32 1
  %42 = load %struct.TreeNode** %41, align 8
  %43 = load %struct.TreeNode** %cur, align 8
  %44 = icmp ne %struct.TreeNode* %42, %43
  br label %45
...
; <label>:47                                      ; preds = %45
  ...
  store %struct.TreeNode* %50, %struct.TreeNode** %prev, align 8
  br label %34

; <label>:51                                      ; preds = %45
  %52 = load %struct.TreeNode** %prev, align 8
...
; <label>:56                                      ; preds = %51
  %57 = load %struct.TreeNode** %cur, align 8
...
; <label>:59                                      ; preds = %56
  %60 = load %struct.TreeNode** %cur, align 8
  %61 = load %struct.TreeNode** %prev, align 8
  %62 = getelementptr inbounds %struct.TreeNode* %61, i32 0, i32 1
  store %struct.TreeNode* %60, %struct.TreeNode** %62, align 8
  %63 = load %struct.TreeNode** %cur, align 8
  %64 = getelementptr inbounds %struct.TreeNode* %63, i32 0, i32 2
  %65 = load %struct.TreeNode** %64, align 8
  store %struct.TreeNode* %65, %struct.TreeNode** %cur, align 8
  br label %72

; <label>:66                                      ; preds = %51
  %67 = load %struct.TreeNode** %prev, align 8
  %68 = getelementptr inbounds %struct.TreeNode* %67, i32 0, i32 1
  store %struct.TreeNode* null, %struct.TreeNode** %68, align 8
  %69 = load %struct.TreeNode** %cur, align 8
  %70 = getelementptr inbounds %struct.TreeNode* %69, i32 0, i32 1
  %71 = load %struct.TreeNode** %70, align 8
  store %struct.TreeNode* %71, %struct.TreeNode** %cur, align 8
  br label %72
...
; <label>:74                                      ; preds = %11
  %75 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %agg.result) #2
  %76 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  store i32* %75, i32** %76
  %77 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %agg.result) #2
  %78 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %7, i32 0, i32 0
  store i32* %77, i32** %78
  %79 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %6, i32 0, i32 0
  %80 = load i32** %79
  %81 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %7, i32 0, i32 0
  %82 = load i32** %81
