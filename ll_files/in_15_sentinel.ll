; ModuleID = 'InorderTraversals/in_15_sentinel.cpp'
...
; <label>:8                                       ; preds = %0
  ...
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %s, %"class.std::deque"* %3)
  call void @_ZNSt5dequeIP4NodeSaIS1_EED2Ev(%"class.std::deque"* %3) #0
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.Node** %1)
  br label %9

; <label>:9                                       ; preds = %42, %8
  %10 = call zeroext i1 @_ZNKSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s)
  %11 = xor i1 %10, true
  br i1 %11, label %12, label %43

; <label>:12                                      ; preds = %9
  %13 = call %struct.Node** @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s)
  %14 = load %struct.Node** %13
  store %struct.Node* %14, %struct.Node** %node, align 8
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s)
...
; <label>:17                                      ; preds = %12
  ...
  %19 = getelementptr inbounds %struct.Node* %18, i32 0, i32 2
...
; <label>:22                                      ; preds = %17
  ...
  %24 = getelementptr inbounds %struct.Node* %23, i32 0, i32 2
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.Node** %24)
  br label %25

; <label>:25                                      ; preds = %22, %17
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.Node** %node)
  store %struct.Node* null, %struct.Node** %4
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE4pushEOS1_(%"class.std::stack"* %s, %struct.Node** %4)
...
; <label>:30                                      ; preds = %25
  ...
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.Node** %32)
  br label %33
...
; <label>:34                                      ; preds = %12
  %35 = call zeroext i1 @_ZNKSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s)
  br i1 %35, label %41, label %36

; <label>:36                                      ; preds = %34
  %37 = load %"class.std::vector"** %2, align 8
  %38 = call %struct.Node** @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s)
  %39 = load %struct.Node** %38
  %40 = getelementptr inbounds %struct.Node* %39, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %37, i32* %40)
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s)
  br label %41
...
; <label>:43                                      ; preds = %9
  call void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::stack"* %s) #0
  br label %44
...
define linkonce_odr void @_ZNSt5stackIP4NodeSt5dequeIS1_SaIS1_EEE4pushEOS1_(%"class.std::stack"* %this, %struct.Node** %__x) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::stack"* %3, i32 0, i32 0
  %5 = load %struct.Node*** %2, align 8
  %6 = call %struct.Node** @_ZSt4moveIRP4NodeEONSt16remove_referenceIT_E4typeEOS4_(%struct.Node** %5) #0
  call void @_ZNSt5dequeIP4NodeSaIS1_EE9push_backEOS1_(%"class.std::deque"* %4, %struct.Node** %6)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIP4NodeSaIS1_EE9push_backEOS1_(%"class.std::deque"* %this, %struct.Node** %__x) #3 align 2 {
  ...
  %4 = load %struct.Node*** %2, align 8
  %5 = call %struct.Node** @_ZSt4moveIRP4NodeEONSt16remove_referenceIT_E4typeEOS4_(%struct.Node** %4) #0
  call void @_ZNSt5dequeIP4NodeSaIS1_EE12emplace_backIJS1_EEEvDpOT_(%"class.std::deque"* %3, %struct.Node** %5)
  ret void
}
...
; <label>:16                                      ; preds = %0
  ...
  %25 = load %struct.Node*** %2, align 8
  %26 = call %struct.Node** @_ZSt7forwardIP4NodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.Node** %25) #0
  call void @_ZNSt16allocator_traitsISaIP4NodeEE9constructIS1_JS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.0"* %19, %struct.Node** %24, %struct.Node** %26)
  %27 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %28 = getelementptr inbounds %"class.std::_Deque_base"* %27, i32 0, i32 0
  %29 = getelementptr inbounds %"struct.std::_Deque_base<Node *, std::allocator<Node *> >::_Deque_impl"* %28, i32 0, i32 3
  %30 = getelementptr inbounds %"struct.std::_Deque_iterator"* %29, i32 0, i32 0
  %31 = load %struct.Node*** %30, align 8
  %32 = getelementptr inbounds %struct.Node** %31, i32 1
  store %struct.Node** %32, %struct.Node*** %30, align 8
  br label %36

; <label>:33                                      ; preds = %0
  %34 = load %struct.Node*** %2, align 8
  %35 = call %struct.Node** @_ZSt7forwardIP4NodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.Node** %34) #0
  call void @_ZNSt5dequeIP4NodeSaIS1_EE16_M_push_back_auxIJS1_EEEvDpOT_(%"class.std::deque"* %3, %struct.Node** %35)
  br label %36
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIP4NodeEE9constructIS1_JS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.0"* %__a, %struct.Node** %__p, %struct.Node** %__args) #3 align 2 {
  ...
  %8 = call %struct.Node** @_ZSt7forwardIP4NodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.Node** %7) #0
  call void @_ZN9__gnu_cxx13new_allocatorIP4NodeE9constructIS2_JS2_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.1"* %5, %struct.Node** %6, %struct.Node** %8)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIP4NodeSaIS1_EE16_M_push_back_auxIJS1_EEEvDpOT_(%"class.std::deque"* %this, %struct.Node** %__args) #3 align 2 {
  ...
  %21 = call %struct.Node** @_ZSt7forwardIP4NodeEOT_RNSt16remove_referenceIS2_E4typeE(%struct.Node** %20) #0
  call void @_ZNSt16allocator_traitsISaIP4NodeEE9constructIS1_JS1_EEEvRS2_PT_DpOT0_(%"class.std::allocator.0"* %14, %struct.Node** %19, %struct.Node** %21)
