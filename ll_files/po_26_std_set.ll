...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %9 = icmp ne %struct.TreeNode* %8, null
...
; <label>:15                                      ; preds = %12
  ...
  store %struct.TreeNode* %17, %struct.TreeNode** %node, align 8
  %18 = call i64 @_ZNKSt3setIP8TreeNodeSt4lessIS1_ESaIS1_EE5countERKS1_(%"class.std::set"* %visited, %struct.TreeNode** %node)
  %19 = icmp ne i64 %18, 0
  br i1 %19, label %20, label %23

; <label>:20                                      ; preds = %15
  %21 = load %struct.TreeNode** %node, align 8
  %22 = getelementptr inbounds %struct.TreeNode* %21, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %22)
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s)
  br label %46

; <label>:23                                      ; preds = %15
  %24 = call { %"struct.std::_Rb_tree_node_base"*, i8 } @_ZNSt3setIP8TreeNodeSt4lessIS1_ESaIS1_EE6insertERKS1_(%"class.std::set"* %visited, %struct.TreeNode** %node)
  %25 = bitcast %"struct.std::pair"* %6 to { %"struct.std::_Rb_tree_node_base"*, i8 }*
  %26 = getelementptr { %"struct.std::_Rb_tree_node_base"*, i8 }* %25, i32 0, i32 0
  ...
  %28 = getelementptr { %"struct.std::_Rb_tree_node_base"*, i8 }* %25, i32 0, i32 1
...
; <label>:34                                      ; preds = %23
  ...
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %36)
  br label %37

; <label>:37                                      ; preds = %34, %23
  %38 = load %struct.TreeNode** %node, align 8
  %39 = getelementptr inbounds %struct.TreeNode* %38, i32 0, i32 1
  %40 = load %struct.TreeNode** %39, align 8
  %41 = icmp ne %struct.TreeNode* %40, null
  br i1 %41, label %42, label %45

; <label>:42                                      ; preds = %37
  %43 = load %struct.TreeNode** %node, align 8
  %44 = getelementptr inbounds %struct.TreeNode* %43, i32 0, i32 1
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %44)
  br label %45
