; ModuleID = 'PostorderTraversals/po_24_task_stack.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %3 = alloca i1
  %4 = alloca i32
  %taskStack = alloca %"class.std::stack", align 8
...
; <label>:16                                      ; preds = %0
  invoke void @_ZNSt5dequeI4TaskSaIS0_EEC2Ev(%"class.std::deque"* %5)
          to label %17 unwind label %36

; <label>:17                                      ; preds = %16
  invoke void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEEC2EOS3_(%"class.std::stack"* %taskStack, %"class.std::deque"* %5)
          to label %18 unwind label %40

; <label>:18                                      ; preds = %17
  call void @_ZNSt5dequeI4TaskSaIS0_EED2Ev(%"class.std::deque"* %5) #2
  %19 = load %struct.TreeNode** %2, align 8
  invoke void @_ZN4TaskC2EP8TreeNode6Action(%struct.Task* %8, %struct.TreeNode* %19, i32 0)
          to label %20 unwind label %44

; <label>:20                                      ; preds = %18
  invoke void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %taskStack, %struct.Task* %8)
          to label %21 unwind label %44

; <label>:21                                      ; preds = %20
  br label %22

; <label>:22                                      ; preds = %74, %35, %21
  %23 = invoke zeroext i1 @_ZNKSt5stackI4TaskSt5dequeIS0_SaIS0_EEE5emptyEv(%"class.std::stack"* %taskStack)
...
; <label>:26                                      ; preds = %24
  %27 = invoke %struct.Task* @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE3topEv(%"class.std::stack"* %taskStack)
          to label %28 unwind label %44

; <label>:28                                      ; preds = %26
  %29 = bitcast %struct.Task* %t to i8*
  %30 = bitcast %struct.Task* %27 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %29, i8* %30, i64 16, i32 8, i1 false)
  invoke void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE3popEv(%"class.std::stack"* %taskStack)
          to label %31 unwind label %44

; <label>:31                                      ; preds = %28
  %32 = getelementptr inbounds %struct.Task* %t, i32 0, i32 0
  %33 = load %struct.TreeNode** %32, align 8
  %34 = icmp eq %struct.TreeNode* %33, null
...
; <label>:44                                      ; preds = %72, %67, %66, %61, %60, %57, %52, %28, %26, %22, %20, %18
  ...
  store i32 %47, i32* %7
  call void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEED2Ev(%"class.std::stack"* %taskStack) #2
  br label %80

; <label>:48                                      ; preds = %31
  %49 = getelementptr inbounds %struct.Task* %t, i32 0, i32 1
  %50 = load i32* %49, align 4
  %51 = icmp eq i32 %50, 1
  br i1 %51, label %52, label %57

; <label>:52                                      ; preds = %48
  %53 = getelementptr inbounds %struct.Task* %t, i32 0, i32 0
  %54 = load %struct.TreeNode** %53, align 8
  %55 = getelementptr inbounds %struct.TreeNode* %54, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %55)
...
; <label>:57                                      ; preds = %48
  %58 = getelementptr inbounds %struct.Task* %t, i32 0, i32 0
  %59 = load %struct.TreeNode** %58, align 8
  invoke void @_ZN4TaskC2EP8TreeNode6Action(%struct.Task* %9, %struct.TreeNode* %59, i32 1)
          to label %60 unwind label %44

; <label>:60                                      ; preds = %57
  invoke void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %taskStack, %struct.Task* %9)
          to label %61 unwind label %44

; <label>:61                                      ; preds = %60
  %62 = getelementptr inbounds %struct.Task* %t, i32 0, i32 0
  %63 = load %struct.TreeNode** %62, align 8
  %64 = getelementptr inbounds %struct.TreeNode* %63, i32 0, i32 2
  %65 = load %struct.TreeNode** %64, align 8
  invoke void @_ZN4TaskC2EP8TreeNode6Action(%struct.Task* %10, %struct.TreeNode* %65, i32 0)
          to label %66 unwind label %44

; <label>:66                                      ; preds = %61
  invoke void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %taskStack, %struct.Task* %10)
          to label %67 unwind label %44

; <label>:67                                      ; preds = %66
  %68 = getelementptr inbounds %struct.Task* %t, i32 0, i32 0
  %69 = load %struct.TreeNode** %68, align 8
  %70 = getelementptr inbounds %struct.TreeNode* %69, i32 0, i32 1
  %71 = load %struct.TreeNode** %70, align 8
  invoke void @_ZN4TaskC2EP8TreeNode6Action(%struct.Task* %11, %struct.TreeNode* %71, i32 0)
          to label %72 unwind label %44

; <label>:72                                      ; preds = %67
  invoke void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %taskStack, %struct.Task* %11)
...
define linkonce_odr void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEEC2EOS3_(%"class.std::stack"* %this, %"class.std::deque"* %__c) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::deque"* @_ZSt4moveIRSt5dequeI4TaskSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::deque"* %5) #2
  call void @_ZNSt5dequeI4TaskSaIS0_EEC2EOS2_(%"class.std::deque"* %4, %"class.std::deque"* %6)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EEC2Ev(%"class.std::deque"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EEC2Ev(%"class.std::_Deque_base"* %3)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EED2Ev(%"class.std::deque"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  ...
  call void @_ZNSt5dequeI4TaskSaIS0_EE5beginEv(%"struct.std::_Deque_iterator"* sret %2, %"class.std::deque"* %6) #2
  call void @_ZNSt5dequeI4TaskSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* sret %3, %"class.std::deque"* %6) #2
  %7 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  %8 = call %"class.std::allocator.4"* @_ZNSt11_Deque_baseI4TaskSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %7) #2
  invoke void @_ZNSt5dequeI4TaskSaIS0_EE15_M_destroy_dataESt15_Deque_iteratorIS0_RS0_PS0_ES6_RKS1_(%"class.std::deque"* %6, %"struct.std::_Deque_iterator"* %2, %"struct.std::_Deque_iterator"* %3, %"class.std::allocator.4"* %8)
          to label %9 unwind label %11

; <label>:9                                       ; preds = %0
  %10 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EED2Ev(%"class.std::_Deque_base"* %10) #2
  ret void
...
; <label>:11                                      ; preds = %0
  ...
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EED2Ev(%"class.std::_Deque_base"* %15) #2
  br label %16
...
define linkonce_odr void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE4pushEOS0_(%"class.std::stack"* %this, %struct.Task* %__x) #3 align 2 {
  ...
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  store %struct.Task* %__x, %struct.Task** %2, align 8
  %3 = load %"class.std::stack"** %1
  %4 = getelementptr inbounds %"class.std::stack"* %3, i32 0, i32 0
  %5 = load %struct.Task** %2, align 8
  %6 = call %struct.Task* @_ZSt4moveIR4TaskEONSt16remove_referenceIT_E4typeEOS3_(%struct.Task* %5) #2
  call void @_ZNSt5dequeI4TaskSaIS0_EE9push_backEOS0_(%"class.std::deque"* %4, %struct.Task* %6)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN4TaskC2EP8TreeNode6Action(%struct.Task* %this, %struct.TreeNode* %n, i32 %a) unnamed_addr #5 align 2 {
  %1 = alloca %struct.Task*, align 8
  %2 = alloca %struct.TreeNode*, align 8
  %3 = alloca i32, align 4
  store %struct.Task* %this, %struct.Task** %1, align 8
  store %struct.TreeNode* %n, %struct.TreeNode** %2, align 8
  store i32 %a, i32* %3, align 4
  %4 = load %struct.Task** %1
  %5 = getelementptr inbounds %struct.Task* %4, i32 0, i32 0
  %6 = load %struct.TreeNode** %2, align 8
  store %struct.TreeNode* %6, %struct.TreeNode** %5, align 8
  %7 = getelementptr inbounds %struct.Task* %4, i32 0, i32 1
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt5stackI4TaskSt5dequeIS0_SaIS0_EEE5emptyEv(%"class.std::stack"* %this) #5 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  %4 = call zeroext i1 @_ZNKSt5dequeI4TaskSaIS0_EE5emptyEv(%"class.std::deque"* %3) #2
  ret i1 %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task* @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE3topEv(%"class.std::stack"* %this) #5 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  %4 = call %struct.Task* @_ZNSt5dequeI4TaskSaIS0_EE4backEv(%"class.std::deque"* %3) #2
  ret %struct.Task* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEE3popEv(%"class.std::stack"* %this) #5 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  call void @_ZNSt5dequeI4TaskSaIS0_EE8pop_backEv(%"class.std::deque"* %3) #2
  ret void
}
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZNSt5stackI4TaskSt5dequeIS0_SaIS0_EEED2Ev(%"class.std::stack"* %this) unnamed_addr #9 align 2 {
  %1 = alloca %"class.std::stack"*, align 8
  store %"class.std::stack"* %this, %"class.std::stack"** %1, align 8
  %2 = load %"class.std::stack"** %1
  %3 = getelementptr inbounds %"class.std::stack"* %2, i32 0, i32 0
  call void @_ZNSt5dequeI4TaskSaIS0_EED2Ev(%"class.std::deque"* %3) #2
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE8pop_backEv(%"class.std::deque"* %this) #5 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %4, i32 0, i32 3
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator"* %5, i32 0, i32 0
  %7 = load %struct.Task** %6, align 8
  %8 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %9 = getelementptr inbounds %"class.std::_Deque_base"* %8, i32 0, i32 0
  %10 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %9, i32 0, i32 3
  %11 = getelementptr inbounds %"struct.std::_Deque_iterator"* %10, i32 0, i32 1
  %12 = load %struct.Task** %11, align 8
  %13 = icmp ne %struct.Task* %7, %12
  br i1 %13, label %14, label %30

; <label>:14                                      ; preds = %0
  %15 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %16, i32 0, i32 3
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator"* %17, i32 0, i32 0
  %19 = load %struct.Task** %18, align 8
  %20 = getelementptr inbounds %struct.Task* %19, i32 -1
  ...
  %23 = bitcast %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %22 to %"class.std::allocator.4"*
  %24 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %25, i32 0, i32 3
  %27 = getelementptr inbounds %"struct.std::_Deque_iterator"* %26, i32 0, i32 0
  %28 = load %struct.Task** %27, align 8
  invoke void @_ZNSt16allocator_traitsISaI4TaskEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.4"* %23, %struct.Task* %28)
...
; <label>:30                                      ; preds = %0
  invoke void @_ZNSt5dequeI4TaskSaIS0_EE15_M_pop_back_auxEv(%"class.std::deque"* %2)
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI4TaskEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.4"* %__a, %struct.Task* %__p) #3 align 2 {
  ...
  store %struct.Task* %__p, %struct.Task** %2, align 8
  %3 = load %"class.std::allocator.4"** %1, align 8
  %4 = bitcast %"class.std::allocator.4"* %3 to %"class.__gnu_cxx::new_allocator.5"*
  %5 = load %struct.Task** %2, align 8
  call void @_ZN9__gnu_cxx13new_allocatorI4TaskE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator.5"* %4, %struct.Task* %5)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE15_M_pop_back_auxEv(%"class.std::deque"* %this) #3 align 2 {
  ...
  %6 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %5, i32 0, i32 3
  %7 = getelementptr inbounds %"struct.std::_Deque_iterator"* %6, i32 0, i32 1
  %8 = load %struct.Task** %7, align 8
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %3, %struct.Task* %8) #2
  %9 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %10 = getelementptr inbounds %"class.std::_Deque_base"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %10, i32 0, i32 3
  %12 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %13, i32 0, i32 3
  %15 = getelementptr inbounds %"struct.std::_Deque_iterator"* %14, i32 0, i32 3
  %16 = load %struct.Task*** %15, align 8
  %17 = getelementptr inbounds %struct.Task** %16, i64 -1
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %11, %struct.Task** %17) #2
  %18 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %19 = getelementptr inbounds %"class.std::_Deque_base"* %18, i32 0, i32 0
  %20 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %19, i32 0, i32 3
  %21 = getelementptr inbounds %"struct.std::_Deque_iterator"* %20, i32 0, i32 2
  %22 = load %struct.Task** %21, align 8
  %23 = getelementptr inbounds %struct.Task* %22, i64 -1
  %24 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %25, i32 0, i32 3
  %27 = getelementptr inbounds %"struct.std::_Deque_iterator"* %26, i32 0, i32 0
  store %struct.Task* %23, %struct.Task** %27, align 8
  %28 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %29 = call %"class.std::allocator.4"* @_ZNSt11_Deque_baseI4TaskSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %28) #2
  %30 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %31 = getelementptr inbounds %"class.std::_Deque_base"* %30, i32 0, i32 0
  %32 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %31, i32 0, i32 3
  %33 = getelementptr inbounds %"struct.std::_Deque_iterator"* %32, i32 0, i32 0
  %34 = load %struct.Task** %33, align 8
  call void @_ZNSt16allocator_traitsISaI4TaskEE7destroyIS0_EEvRS1_PT_(%"class.std::allocator.4"* %29, %struct.Task* %34)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %this, %struct.Task* %__p) #5 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = bitcast %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %4 to %"class.std::allocator.4"*
  %6 = load %struct.Task** %2, align 8
  %7 = invoke i64 @_ZSt16__deque_buf_sizem(i64 16)
          to label %8 unwind label %10

; <label>:8                                       ; preds = %0
  invoke void @_ZNSt16allocator_traitsISaI4TaskEE10deallocateERS1_PS0_m(%"class.std::allocator.4"* %5, %struct.Task* %6, i64 %7)
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %this, %struct.Task** %__new_node) #5 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %struct.Task**, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  store %struct.Task** %__new_node, %struct.Task*** %2, align 8
  %3 = load %"struct.std::_Deque_iterator"** %1
  %4 = load %struct.Task*** %2, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 3
  store %struct.Task** %4, %struct.Task*** %5, align 8
  %6 = load %struct.Task*** %2, align 8
  %7 = load %struct.Task** %6, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 1
  store %struct.Task* %7, %struct.Task** %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 1
  %10 = load %struct.Task** %9, align 8
  %11 = call i64 @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E14_S_buffer_sizeEv() #2
  %12 = getelementptr inbounds %struct.Task* %10, i64 %11
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 2
  store %struct.Task* %12, %struct.Task** %13, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.4"* @_ZNSt11_Deque_baseI4TaskSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %4 = bitcast %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3 to %"class.std::allocator.4"*
  ret %"class.std::allocator.4"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E14_S_buffer_sizeEv() #5 align 2 {
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI4TaskEE10deallocateERS1_PS0_m(%"class.std::allocator.4"* %__a, %struct.Task* %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %struct.Task** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorI4TaskE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.5"* %5, %struct.Task* %6, i64 %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4TaskE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.5"* %this, %struct.Task* %__p, i64) #5 align 2 {
  ...
  store %struct.Task* %__p, %struct.Task** %3, align 8
  store i64 %0, i64* %4, align 8
  %5 = load %"class.__gnu_cxx::new_allocator.5"** %2
  %6 = load %struct.Task** %3, align 8
  %7 = bitcast %struct.Task* %6 to i8*
  call void @_ZdlPv(i8* %7) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4TaskE7destroyIS1_EEvPT_(%"class.__gnu_cxx::new_allocator.5"* %this, %struct.Task* %__p) #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task* @_ZNSt5dequeI4TaskSaIS0_EE4backEv(%"class.std::deque"* %this) #5 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  %__tmp = alloca %"struct.std::_Deque_iterator", align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeI4TaskSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* sret %__tmp, %"class.std::deque"* %2) #2
  %3 = call %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EmmEv(%"struct.std::_Deque_iterator"* %__tmp) #2
  %4 = call %struct.Task* @_ZNKSt15_Deque_iteratorI4TaskRS0_PS0_EdeEv(%"struct.std::_Deque_iterator"* %__tmp) #2
  ret %struct.Task* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE3endEv(%"struct.std::_Deque_iterator"* noalias sret %agg.result, %"class.std::deque"* %this) #5 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %4, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %agg.result, %"struct.std::_Deque_iterator"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Deque_iterator"* @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EmmEv(%"struct.std::_Deque_iterator"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
  %4 = load %struct.Task** %3, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 1
  %6 = load %struct.Task** %5, align 8
...
; <label>:8                                       ; preds = %0
  ...
  %10 = load %struct.Task*** %9, align 8
  %11 = getelementptr inbounds %struct.Task** %10, i64 -1
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %2, %struct.Task** %11) #2
  %12 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 2
  %13 = load %struct.Task** %12, align 8
...
; <label>:15                                      ; preds = %8, %0
  ...
  %17 = load %struct.Task** %16, align 8
  %18 = getelementptr inbounds %struct.Task* %17, i32 -1
  store %struct.Task* %18, %struct.Task** %16, align 8
  ret %"struct.std::_Deque_iterator"* %2
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task* @_ZNKSt15_Deque_iteratorI4TaskRS0_PS0_EdeEv(%"struct.std::_Deque_iterator"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"* %__x) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  ...
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator"* %5, i32 0, i32 0
  %7 = load %struct.Task** %6, align 8
  store %struct.Task* %7, %struct.Task** %4, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_iterator"* %3, i32 0, i32 1
  %9 = load %"struct.std::_Deque_iterator"** %2, align 8
  %10 = getelementptr inbounds %"struct.std::_Deque_iterator"* %9, i32 0, i32 1
  %11 = load %struct.Task** %10, align 8
  store %struct.Task* %11, %struct.Task** %8, align 8
  ...
  %15 = load %struct.Task** %14, align 8
  store %struct.Task* %15, %struct.Task** %12, align 8
  ...
  %19 = load %struct.Task*** %18, align 8
  store %struct.Task** %19, %struct.Task*** %16, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt5dequeI4TaskSaIS0_EE5emptyEv(%"class.std::deque"* %this) #5 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  ...
  %8 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %7, i32 0, i32 2
  %9 = call zeroext i1 @_ZSteqI4TaskRS0_PS0_EbRKSt15_Deque_iteratorIT_T0_T1_ES9_(%"struct.std::_Deque_iterator"* %5, %"struct.std::_Deque_iterator"* %8) #2
  ret i1 %9
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr zeroext i1 @_ZSteqI4TaskRS0_PS0_EbRKSt15_Deque_iteratorIT_T0_T1_ES9_(%"struct.std::_Deque_iterator"* %__x, %"struct.std::_Deque_iterator"* %__y) #9 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
...
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE9push_backEOS0_(%"class.std::deque"* %this, %struct.Task* %__x) #3 align 2 {
  ...
  %4 = load %struct.Task** %2, align 8
  %5 = call %struct.Task* @_ZSt4moveIR4TaskEONSt16remove_referenceIT_E4typeEOS3_(%struct.Task* %4) #2
  call void @_ZNSt5dequeI4TaskSaIS0_EE12emplace_backIJS0_EEEvDpOT_(%"class.std::deque"* %3, %struct.Task* %5)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task* @_ZSt4moveIR4TaskEONSt16remove_referenceIT_E4typeEOS3_(%struct.Task* %__t) #5 {
  %1 = alloca %struct.Task*, align 8
  store %struct.Task* %__t, %struct.Task** %1, align 8
  %2 = load %struct.Task** %1, align 8
  ret %struct.Task* %2
}
...
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE12emplace_backIJS0_EEEvDpOT_(%"class.std::deque"* %this, %struct.Task* %__args) #3 align 2 {
  ...
  %2 = alloca %struct.Task*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  store %struct.Task* %__args, %struct.Task** %2, align 8
  %3 = load %"class.std::deque"** %1
  ...
  %13 = load %struct.Task** %12, align 8
  %14 = getelementptr inbounds %struct.Task* %13, i64 -1
  %15 = icmp ne %struct.Task* %8, %14
  br i1 %15, label %16, label %33

; <label>:16                                      ; preds = %0
  %17 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %18 = getelementptr inbounds %"class.std::_Deque_base"* %17, i32 0, i32 0
  %19 = bitcast %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %18 to %"class.std::allocator.4"*
  %20 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %21 = getelementptr inbounds %"class.std::_Deque_base"* %20, i32 0, i32 0
  %22 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %21, i32 0, i32 3
  %23 = getelementptr inbounds %"struct.std::_Deque_iterator"* %22, i32 0, i32 0
  %24 = load %struct.Task** %23, align 8
  %25 = load %struct.Task** %2, align 8
  %26 = call %struct.Task* @_ZSt7forwardI4TaskEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Task* %25) #2
  call void @_ZNSt16allocator_traitsISaI4TaskEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.4"* %19, %struct.Task* %24, %struct.Task* %26)
  %27 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %28 = getelementptr inbounds %"class.std::_Deque_base"* %27, i32 0, i32 0
  %29 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %28, i32 0, i32 3
  %30 = getelementptr inbounds %"struct.std::_Deque_iterator"* %29, i32 0, i32 0
  %31 = load %struct.Task** %30, align 8
  %32 = getelementptr inbounds %struct.Task* %31, i32 1
  store %struct.Task* %32, %struct.Task** %30, align 8
  br label %36

; <label>:33                                      ; preds = %0
  %34 = load %struct.Task** %2, align 8
  %35 = call %struct.Task* @_ZSt7forwardI4TaskEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Task* %34) #2
  call void @_ZNSt5dequeI4TaskSaIS0_EE16_M_push_back_auxIJS0_EEEvDpOT_(%"class.std::deque"* %3, %struct.Task* %35)
  br label %36
...
define linkonce_odr void @_ZNSt16allocator_traitsISaI4TaskEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.4"* %__a, %struct.Task* %__p, %struct.Task* %__args) #3 align 2 {
  ...
  store %"class.std::allocator.4"* %__a, %"class.std::allocator.4"** %1, align 8
  store %struct.Task* %__p, %struct.Task** %2, align 8
  store %struct.Task* %__args, %struct.Task** %3, align 8
  %4 = load %"class.std::allocator.4"** %1, align 8
  %5 = bitcast %"class.std::allocator.4"* %4 to %"class.__gnu_cxx::new_allocator.5"*
  %6 = load %struct.Task** %2, align 8
  %7 = load %struct.Task** %3, align 8
  %8 = call %struct.Task* @_ZSt7forwardI4TaskEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Task* %7) #2
  call void @_ZN9__gnu_cxx13new_allocatorI4TaskE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.5"* %5, %struct.Task* %6, %struct.Task* %8)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task* @_ZSt7forwardI4TaskEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Task* %__t) #5 {
  %1 = alloca %struct.Task*, align 8
  store %struct.Task* %__t, %struct.Task** %1, align 8
  %2 = load %struct.Task** %1, align 8
  ret %struct.Task* %2
...
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE16_M_push_back_auxIJS0_EEEvDpOT_(%"class.std::deque"* %this, %struct.Task* %__args) #3 align 2 {
  ...
  store %struct.Task* %__args, %struct.Task** %2, align 8
  %3 = load %"class.std::deque"** %1
  call void @_ZNSt5dequeI4TaskSaIS0_EE22_M_reserve_map_at_backEm(%"class.std::deque"* %3, i64 1)
  %4 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %5 = call %struct.Task* @_ZNSt11_Deque_baseI4TaskSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %7, i32 0, i32 3
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator"* %8, i32 0, i32 3
  %10 = load %struct.Task*** %9, align 8
  %11 = getelementptr inbounds %struct.Task** %10, i64 1
  store %struct.Task* %5, %struct.Task** %11, align 8
  %12 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = bitcast %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %13 to %"class.std::allocator.4"*
  %15 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %16, i32 0, i32 3
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator"* %17, i32 0, i32 0
  %19 = load %struct.Task** %18, align 8
  %20 = load %struct.Task** %2, align 8
  %21 = call %struct.Task* @_ZSt7forwardI4TaskEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Task* %20) #2
  call void @_ZNSt16allocator_traitsISaI4TaskEE9constructIS0_JS0_EEEvRS1_PT_DpOT0_(%"class.std::allocator.4"* %14, %struct.Task* %19, %struct.Task* %21)
  %22 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %23 = getelementptr inbounds %"class.std::_Deque_base"* %22, i32 0, i32 0
  %24 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %23, i32 0, i32 3
  %25 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %26 = getelementptr inbounds %"class.std::_Deque_base"* %25, i32 0, i32 0
  %27 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %26, i32 0, i32 3
  %28 = getelementptr inbounds %"struct.std::_Deque_iterator"* %27, i32 0, i32 3
  %29 = load %struct.Task*** %28, align 8
  %30 = getelementptr inbounds %struct.Task** %29, i64 1
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %24, %struct.Task** %30) #2
  %31 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %32 = getelementptr inbounds %"class.std::_Deque_base"* %31, i32 0, i32 0
  %33 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %32, i32 0, i32 3
  %34 = getelementptr inbounds %"struct.std::_Deque_iterator"* %33, i32 0, i32 1
  %35 = load %struct.Task** %34, align 8
  %36 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %37, i32 0, i32 3
  %39 = getelementptr inbounds %"struct.std::_Deque_iterator"* %38, i32 0, i32 0
  store %struct.Task* %35, %struct.Task** %39, align 8
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE22_M_reserve_map_at_backEm(%"class.std::deque"* %this, i64 %__nodes_to_add) #3 align 2 {
  ...
  %6 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %7 = getelementptr inbounds %"class.std::_Deque_base"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %7, i32 0, i32 1
  %9 = load i64* %8, align 8
  %10 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %11 = getelementptr inbounds %"class.std::_Deque_base"* %10, i32 0, i32 0
  %12 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %11, i32 0, i32 3
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator"* %12, i32 0, i32 3
  %14 = load %struct.Task*** %13, align 8
  %15 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %16, i32 0, i32 0
  %18 = load %struct.Task*** %17, align 8
  %19 = ptrtoint %struct.Task** %14 to i64
  %20 = ptrtoint %struct.Task** %18 to i64
  %21 = sub i64 %19, %20
...
; <label>:25                                      ; preds = %0
  ...
  call void @_ZNSt5dequeI4TaskSaIS0_EE17_M_reallocate_mapEmb(%"class.std::deque"* %3, i64 %26, i1 zeroext false)
  br label %27
...
define linkonce_odr %struct.Task* @_ZNSt11_Deque_baseI4TaskSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  %6 = call %struct.Task* @_ZNSt16allocator_traitsISaI4TaskEE8allocateERS1_m(%"class.std::allocator.4"* %4, i64 %5)
  ret %struct.Task* %6
}
...
define linkonce_odr %struct.Task* @_ZNSt16allocator_traitsISaI4TaskEE8allocateERS1_m(%"class.std::allocator.4"* %__a, i64 %__n) #3 align 2 {
  ...
  %4 = bitcast %"class.std::allocator.4"* %3 to %"class.__gnu_cxx::new_allocator.5"*
  %5 = load i64* %2, align 8
  %6 = call %struct.Task* @_ZN9__gnu_cxx13new_allocatorI4TaskE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.5"* %4, i64 %5, i8* null)
  ret %struct.Task* %6
}
...
define linkonce_odr %struct.Task* @_ZN9__gnu_cxx13new_allocatorI4TaskE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.5"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.5"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorI4TaskE8max_sizeEv(%"class.__gnu_cxx::new_allocator.5"* %5) #2
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorI4TaskE8max_sizeEv(%"class.__gnu_cxx::new_allocator.5"* %this) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %1, align 8
...
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE17_M_reallocate_mapEmb(%"class.std::deque"* %this, i64 %__nodes_to_add, i1 zeroext %__add_at_front) #3 align 2 {
  ...
  %__new_nstart = alloca %struct.Task**, align 8
  %__new_map_size = alloca i64, align 8
  %__new_map = alloca %struct.Task**, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  store i64 %__nodes_to_add, i64* %2, align 8
  ...
  %13 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %12, i32 0, i32 2
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %13, i32 0, i32 3
  %15 = load %struct.Task*** %14, align 8
  %16 = ptrtoint %struct.Task** %10 to i64
  %17 = ptrtoint %struct.Task** %15 to i64
  %18 = sub i64 %16, %17
  ...
  %25 = getelementptr inbounds %"class.std::_Deque_base"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %25, i32 0, i32 1
...
; <label>:31                                      ; preds = %0
  ...
  %34 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %33, i32 0, i32 0
  %35 = load %struct.Task*** %34, align 8
  %36 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %37, i32 0, i32 1
  %39 = load i64* %38, align 8
  %40 = load i64* %__new_num_nodes, align 8
  %41 = sub i64 %39, %40
  %42 = udiv i64 %41, 2
  %43 = getelementptr inbounds %struct.Task** %35, i64 %42
...
; <label>:49                                      ; preds = %48, %46
  ...
  %51 = getelementptr inbounds %struct.Task** %43, i64 %50
  store %struct.Task** %51, %struct.Task*** %__new_nstart, align 8
  %52 = load %struct.Task*** %__new_nstart, align 8
  %53 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %54 = getelementptr inbounds %"class.std::_Deque_base"* %53, i32 0, i32 0
  %55 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %54, i32 0, i32 2
  %56 = getelementptr inbounds %"struct.std::_Deque_iterator"* %55, i32 0, i32 3
  %57 = load %struct.Task*** %56, align 8
  %58 = icmp ult %struct.Task** %52, %57
  br i1 %58, label %59, label %73

; <label>:59                                      ; preds = %49
  %60 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %61 = getelementptr inbounds %"class.std::_Deque_base"* %60, i32 0, i32 0
  %62 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %61, i32 0, i32 2
  %63 = getelementptr inbounds %"struct.std::_Deque_iterator"* %62, i32 0, i32 3
  %64 = load %struct.Task*** %63, align 8
  %65 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %66 = getelementptr inbounds %"class.std::_Deque_base"* %65, i32 0, i32 0
  %67 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %66, i32 0, i32 3
  %68 = getelementptr inbounds %"struct.std::_Deque_iterator"* %67, i32 0, i32 3
  %69 = load %struct.Task*** %68, align 8
  %70 = getelementptr inbounds %struct.Task** %69, i64 1
  %71 = load %struct.Task*** %__new_nstart, align 8
  %72 = call %struct.Task** @_ZSt4copyIPP4TaskS2_ET0_T_S4_S3_(%struct.Task** %64, %struct.Task** %70, %struct.Task** %71)
  br label %89

; <label>:73                                      ; preds = %49
  %74 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %75 = getelementptr inbounds %"class.std::_Deque_base"* %74, i32 0, i32 0
  %76 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %75, i32 0, i32 2
  %77 = getelementptr inbounds %"struct.std::_Deque_iterator"* %76, i32 0, i32 3
  %78 = load %struct.Task*** %77, align 8
  %79 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %80 = getelementptr inbounds %"class.std::_Deque_base"* %79, i32 0, i32 0
  %81 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %80, i32 0, i32 3
  %82 = getelementptr inbounds %"struct.std::_Deque_iterator"* %81, i32 0, i32 3
  %83 = load %struct.Task*** %82, align 8
  %84 = getelementptr inbounds %struct.Task** %83, i64 1
  %85 = load %struct.Task*** %__new_nstart, align 8
  %86 = load i64* %__old_num_nodes, align 8
  %87 = getelementptr inbounds %struct.Task** %85, i64 %86
  %88 = call %struct.Task** @_ZSt13copy_backwardIPP4TaskS2_ET0_T_S4_S3_(%struct.Task** %78, %struct.Task** %84, %struct.Task** %87)
  br label %89
...
; <label>:90                                      ; preds = %0
  ...
  %93 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %92, i32 0, i32 1
  ...
  %97 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %96, i32 0, i32 1
  ...
  %104 = call %struct.Task** @_ZNSt11_Deque_baseI4TaskSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %102, i64 %103)
  store %struct.Task** %104, %struct.Task*** %__new_map, align 8
  %105 = load %struct.Task*** %__new_map, align 8
  %106 = load i64* %__new_map_size, align 8
  %107 = load i64* %__new_num_nodes, align 8
  %108 = sub i64 %106, %107
  %109 = udiv i64 %108, 2
  %110 = getelementptr inbounds %struct.Task** %105, i64 %109
...
; <label>:116                                     ; preds = %115, %113
  ...
  %118 = getelementptr inbounds %struct.Task** %110, i64 %117
  store %struct.Task** %118, %struct.Task*** %__new_nstart, align 8
  %119 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %120 = getelementptr inbounds %"class.std::_Deque_base"* %119, i32 0, i32 0
  %121 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %120, i32 0, i32 2
  %122 = getelementptr inbounds %"struct.std::_Deque_iterator"* %121, i32 0, i32 3
  %123 = load %struct.Task*** %122, align 8
  %124 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %125 = getelementptr inbounds %"class.std::_Deque_base"* %124, i32 0, i32 0
  %126 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %125, i32 0, i32 3
  %127 = getelementptr inbounds %"struct.std::_Deque_iterator"* %126, i32 0, i32 3
  %128 = load %struct.Task*** %127, align 8
  %129 = getelementptr inbounds %struct.Task** %128, i64 1
  %130 = load %struct.Task*** %__new_nstart, align 8
  %131 = call %struct.Task** @_ZSt4copyIPP4TaskS2_ET0_T_S4_S3_(%struct.Task** %123, %struct.Task** %129, %struct.Task** %130)
  ...
  %135 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %134, i32 0, i32 0
  %136 = load %struct.Task*** %135, align 8
  %137 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %138 = getelementptr inbounds %"class.std::_Deque_base"* %137, i32 0, i32 0
  %139 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %138, i32 0, i32 1
  %140 = load i64* %139, align 8
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %132, %struct.Task** %136, i64 %140) #2
  %141 = load %struct.Task*** %__new_map, align 8
  %142 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %143 = getelementptr inbounds %"class.std::_Deque_base"* %142, i32 0, i32 0
  %144 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %143, i32 0, i32 0
  store %struct.Task** %141, %struct.Task*** %144, align 8
  ...
  %148 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %147, i32 0, i32 1
...
; <label>:149                                     ; preds = %116, %89
  ...
  %152 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %151, i32 0, i32 2
  %153 = load %struct.Task*** %__new_nstart, align 8
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %152, %struct.Task** %153) #2
  %154 = bitcast %"class.std::deque"* %5 to %"class.std::_Deque_base"*
  %155 = getelementptr inbounds %"class.std::_Deque_base"* %154, i32 0, i32 0
  %156 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %155, i32 0, i32 3
  %157 = load %struct.Task*** %__new_nstart, align 8
  %158 = load i64* %__old_num_nodes, align 8
  %159 = getelementptr inbounds %struct.Task** %157, i64 %158
  %160 = getelementptr inbounds %struct.Task** %159, i64 -1
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %156, %struct.Task** %160) #2
  ret void
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.Task** @_ZSt4copyIPP4TaskS2_ET0_T_S4_S3_(%struct.Task** %__first, %struct.Task** %__last, %struct.Task** %__result) #7 {
  %1 = alloca %struct.Task**, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  store %struct.Task** %__first, %struct.Task*** %1, align 8
  store %struct.Task** %__last, %struct.Task*** %2, align 8
  store %struct.Task** %__result, %struct.Task*** %3, align 8
  %4 = load %struct.Task*** %1, align 8
  %5 = call %struct.Task** @_ZSt12__miter_baseIPP4TaskENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.Task** %4)
  %6 = load %struct.Task*** %2, align 8
  %7 = call %struct.Task** @_ZSt12__miter_baseIPP4TaskENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.Task** %6)
  %8 = load %struct.Task*** %3, align 8
  %9 = call %struct.Task** @_ZSt14__copy_move_a2ILb0EPP4TaskS2_ET1_T0_S4_S3_(%struct.Task** %5, %struct.Task** %7, %struct.Task** %8)
  ret %struct.Task** %9
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.Task** @_ZSt13copy_backwardIPP4TaskS2_ET0_T_S4_S3_(%struct.Task** %__first, %struct.Task** %__last, %struct.Task** %__result) #7 {
  %1 = alloca %struct.Task**, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  store %struct.Task** %__first, %struct.Task*** %1, align 8
  ...
  %7 = call %struct.Task** @_ZSt12__miter_baseIPP4TaskENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.Task** %6)
  %8 = load %struct.Task*** %3, align 8
  %9 = call %struct.Task** @_ZSt23__copy_move_backward_a2ILb0EPP4TaskS2_ET1_T0_S4_S3_(%struct.Task** %5, %struct.Task** %7, %struct.Task** %8)
  ret %struct.Task** %9
}
...
define linkonce_odr %struct.Task** @_ZNSt11_Deque_baseI4TaskSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  ...
  call void @_ZNKSt11_Deque_baseI4TaskSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.7"* sret %__map_alloc, %"class.std::_Deque_base"* %6) #2
  %7 = load i64* %2, align 8
  %8 = invoke %struct.Task** @_ZNSt16allocator_traitsISaIP4TaskEE8allocateERS2_m(%"class.std::allocator.7"* %__map_alloc, i64 %7)
          to label %9 unwind label %10

; <label>:9                                       ; preds = %0
  store i32 1, i32* %5
  call void @_ZNSaIP4TaskED2Ev(%"class.std::allocator.7"* %__map_alloc) #2
  ret %struct.Task** %8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %this, %struct.Task** %__p, i64 %__n) #5 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca i64, align 8
  %__map_alloc = alloca %"class.std::allocator.7", align 1
  ...
  %6 = load %"class.std::_Deque_base"** %1
  call void @_ZNKSt11_Deque_baseI4TaskSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.7"* sret %__map_alloc, %"class.std::_Deque_base"* %6) #2
  %7 = load %struct.Task*** %2, align 8
  %8 = load i64* %3, align 8
  invoke void @_ZNSt16allocator_traitsISaIP4TaskEE10deallocateERS2_PS1_m(%"class.std::allocator.7"* %__map_alloc, %struct.Task** %7, i64 %8)
          to label %9 unwind label %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNKSt11_Deque_baseI4TaskSaIS0_EE20_M_get_map_allocatorEv(%"class.std::allocator.7"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = call %"class.std::allocator.4"* @_ZNKSt11_Deque_baseI4TaskSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %2) #2
  call void @_ZNSaIP4TaskEC2IS_EERKSaIT_E(%"class.std::allocator.7"* %agg.result, %"class.std::allocator.4"* %3) #2
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIP4TaskEE10deallocateERS2_PS1_m(%"class.std::allocator.7"* %__a, %struct.Task** %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load %struct.Task*** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIP4TaskE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.8"* %5, %struct.Task** %6, i64 %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIP4TaskED2Ev(%"class.std::allocator.7"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::allocator.7"*, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIP4TaskED2Ev(%"class.__gnu_cxx::new_allocator.8"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIP4TaskED2Ev(%"class.__gnu_cxx::new_allocator.8"* %this) unnamed_addr #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIP4TaskE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator.8"* %this, %struct.Task** %__p, i64) #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIP4TaskEC2IS_EERKSaIT_E(%"class.std::allocator.7"* %this, %"class.std::allocator.4"*) unnamed_addr #5 align 2 {
  ...
  %5 = bitcast %"class.std::allocator.7"* %4 to %"class.__gnu_cxx::new_allocator.8"*
  call void @_ZN9__gnu_cxx13new_allocatorIP4TaskEC2Ev(%"class.__gnu_cxx::new_allocator.8"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.4"* @_ZNKSt11_Deque_baseI4TaskSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %this) #5 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIP4TaskEC2Ev(%"class.__gnu_cxx::new_allocator.8"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.8"*, align 8
  store %"class.__gnu_cxx::new_allocator.8"* %this, %"class.__gnu_cxx::new_allocator.8"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.8"** %1
  ret void
...
define linkonce_odr %struct.Task** @_ZNSt16allocator_traitsISaIP4TaskEE8allocateERS2_m(%"class.std::allocator.7"* %__a, i64 %__n) #3 align 2 {
  ...
  %5 = load i64* %2, align 8
  %6 = call %struct.Task** @_ZN9__gnu_cxx13new_allocatorIP4TaskE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.8"* %4, i64 %5, i8* null)
  ret %struct.Task** %6
}
...
define linkonce_odr %struct.Task** @_ZN9__gnu_cxx13new_allocatorIP4TaskE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.8"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.8"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIP4TaskE8max_sizeEv(%"class.__gnu_cxx::new_allocator.8"* %5) #2
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorIP4TaskE8max_sizeEv(%"class.__gnu_cxx::new_allocator.8"* %this) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.8"*, align 8
  store %"class.__gnu_cxx::new_allocator.8"* %this, %"class.__gnu_cxx::new_allocator.8"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.8"** %1
...
; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.Task** @_ZSt23__copy_move_backward_a2ILb0EPP4TaskS2_ET1_T0_S4_S3_(%struct.Task** %__first, %struct.Task** %__last, %struct.Task** %__result) #7 {
  %1 = alloca %struct.Task**, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  store %struct.Task** %__first, %struct.Task*** %1, align 8
  ...
  store %struct.Task** %__result, %struct.Task*** %3, align 8
  %4 = load %struct.Task*** %1, align 8
  %5 = call %struct.Task** @_ZSt12__niter_baseIPP4TaskENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.Task** %4)
  %6 = load %struct.Task*** %2, align 8
  %7 = call %struct.Task** @_ZSt12__niter_baseIPP4TaskENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.Task** %6)
  %8 = load %struct.Task*** %3, align 8
  %9 = call %struct.Task** @_ZSt12__niter_baseIPP4TaskENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.Task** %8)
  %10 = call %struct.Task** @_ZSt22__copy_move_backward_aILb0EPP4TaskS2_ET1_T0_S4_S3_(%struct.Task** %5, %struct.Task** %7, %struct.Task** %9)
  ret %struct.Task** %10
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.Task** @_ZSt12__miter_baseIPP4TaskENSt11_Miter_baseIT_E13iterator_typeES4_(%struct.Task** %__it) #7 {
  %1 = alloca %struct.Task**, align 8
  store %struct.Task** %__it, %struct.Task*** %1, align 8
  %2 = load %struct.Task*** %1, align 8
  %3 = call %struct.Task** @_ZNSt10_Iter_baseIPP4TaskLb0EE7_S_baseES2_(%struct.Task** %2)
  ret %struct.Task** %3
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task** @_ZNSt10_Iter_baseIPP4TaskLb0EE7_S_baseES2_(%struct.Task** %__it) #5 align 2 {
  %1 = alloca %struct.Task**, align 8
  store %struct.Task** %__it, %struct.Task*** %1, align 8
  %2 = load %struct.Task*** %1, align 8
  ret %struct.Task** %2
...
; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.Task** @_ZSt22__copy_move_backward_aILb0EPP4TaskS2_ET1_T0_S4_S3_(%struct.Task** %__first, %struct.Task** %__last, %struct.Task** %__result) #7 {
  %1 = alloca %struct.Task**, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  %__simple = alloca i8, align 1
  ...
  %5 = load %struct.Task*** %2, align 8
  %6 = load %struct.Task*** %3, align 8
  %7 = call %struct.Task** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIP4TaskEEPT_PKS5_S8_S6_(%struct.Task** %4, %struct.Task** %5, %struct.Task** %6)
  ret %struct.Task** %7
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr %struct.Task** @_ZSt12__niter_baseIPP4TaskENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.Task** %__it) #9 {
  %1 = alloca %struct.Task**, align 8
  store %struct.Task** %__it, %struct.Task*** %1, align 8
  %2 = load %struct.Task*** %1, align 8
  %3 = call %struct.Task** @_ZNSt10_Iter_baseIPP4TaskLb0EE7_S_baseES2_(%struct.Task** %2)
...
; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIP4TaskEEPT_PKS5_S8_S6_(%struct.Task** %__first, %struct.Task** %__last, %struct.Task** %__result) #5 align 2 {
  %1 = alloca %struct.Task**, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  %_Num = alloca i64, align 8
  ...
  store %struct.Task** %__result, %struct.Task*** %3, align 8
  %4 = load %struct.Task*** %2, align 8
  %5 = load %struct.Task*** %1, align 8
  %6 = ptrtoint %struct.Task** %4 to i64
  %7 = ptrtoint %struct.Task** %5 to i64
  %8 = sub i64 %6, %7
...
; <label>:12                                      ; preds = %0
  %13 = load %struct.Task*** %3, align 8
  %14 = load i64* %_Num, align 8
  %15 = sub i64 0, %14
  %16 = getelementptr inbounds %struct.Task** %13, i64 %15
  %17 = bitcast %struct.Task** %16 to i8*
  %18 = load %struct.Task*** %1, align 8
  %19 = bitcast %struct.Task** %18 to i8*
...
; <label>:22                                      ; preds = %12, %0
  %23 = load %struct.Task*** %3, align 8
  %24 = load i64* %_Num, align 8
  %25 = sub i64 0, %24
  %26 = getelementptr inbounds %struct.Task** %23, i64 %25
  ret %struct.Task** %26
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.Task** @_ZSt14__copy_move_a2ILb0EPP4TaskS2_ET1_T0_S4_S3_(%struct.Task** %__first, %struct.Task** %__last, %struct.Task** %__result) #7 {
  %1 = alloca %struct.Task**, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  store %struct.Task** %__first, %struct.Task*** %1, align 8
  ...
  %8 = load %struct.Task*** %3, align 8
  %9 = call %struct.Task** @_ZSt12__niter_baseIPP4TaskENSt11_Niter_baseIT_E13iterator_typeES4_(%struct.Task** %8)
  %10 = call %struct.Task** @_ZSt13__copy_move_aILb0EPP4TaskS2_ET1_T0_S4_S3_(%struct.Task** %5, %struct.Task** %7, %struct.Task** %9)
  ret %struct.Task** %10
}

; Function Attrs: inlinehint uwtable
define linkonce_odr %struct.Task** @_ZSt13__copy_move_aILb0EPP4TaskS2_ET1_T0_S4_S3_(%struct.Task** %__first, %struct.Task** %__last, %struct.Task** %__result) #7 {
  %1 = alloca %struct.Task**, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  %__simple = alloca i8, align 1
  ...
  %5 = load %struct.Task*** %2, align 8
  %6 = load %struct.Task*** %3, align 8
  %7 = call %struct.Task** @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIP4TaskEEPT_PKS5_S8_S6_(%struct.Task** %4, %struct.Task** %5, %struct.Task** %6)
  ret %struct.Task** %7
}

; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task** @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIP4TaskEEPT_PKS5_S8_S6_(%struct.Task** %__first, %struct.Task** %__last, %struct.Task** %__result) #5 align 2 {
  %1 = alloca %struct.Task**, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  %_Num = alloca i64, align 8
...
; <label>:12                                      ; preds = %0
  %13 = load %struct.Task*** %3, align 8
  %14 = bitcast %struct.Task** %13 to i8*
  %15 = load %struct.Task*** %1, align 8
...
; <label>:19                                      ; preds = %12, %0
  %20 = load %struct.Task*** %3, align 8
  %21 = load i64* %_Num, align 8
  %22 = getelementptr inbounds %struct.Task** %20, i64 %21
  ret %struct.Task** %22
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4TaskE9constructIS1_JS1_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.5"* %this, %struct.Task* %__p, %struct.Task* %__args) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  %2 = alloca %struct.Task*, align 8
  %3 = alloca %struct.Task*, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %1, align 8
  ...
  %5 = load %struct.Task** %2, align 8
  %6 = bitcast %struct.Task* %5 to i8*
  %7 = icmp eq i8* %6, null
  br i1 %7, label %14, label %8

; <label>:8                                       ; preds = %0
  %9 = bitcast i8* %6 to %struct.Task*
  %10 = load %struct.Task** %3, align 8
  %11 = call %struct.Task* @_ZSt7forwardI4TaskEOT_RNSt16remove_referenceIS1_E4typeE(%struct.Task* %10) #2
  %12 = bitcast %struct.Task* %9 to i8*
  %13 = bitcast %struct.Task* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %12, i8* %13, i64 16, i32 8, i1 false)
  br label %14

; <label>:14                                      ; preds = %8, %0
  %15 = phi %struct.Task* [ %9, %8 ], [ null, %0 ]
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE15_M_destroy_dataESt15_Deque_iteratorIS0_RS0_PS0_ES6_RKS1_(%"class.std::deque"* %this, %"struct.std::_Deque_iterator"* %__first, %"struct.std::_Deque_iterator"* %__last, %"class.std::allocator.4"*) #5 align 2 {
  %2 = alloca %"class.std::deque"*, align 8
  %3 = alloca %"class.std::allocator.4"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EE5beginEv(%"struct.std::_Deque_iterator"* noalias sret %agg.result, %"class.std::deque"* %this) #5 align 2 {
  %1 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %this, %"class.std::deque"** %1, align 8
  %2 = load %"class.std::deque"** %1
  %3 = bitcast %"class.std::deque"* %2 to %"class.std::_Deque_base"*
  %4 = getelementptr inbounds %"class.std::_Deque_base"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %4, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %agg.result, %"struct.std::_Deque_iterator"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EED2Ev(%"class.std::_Deque_base"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  %2 = load %"class.std::_Deque_base"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 0
  %5 = load %struct.Task*** %4, align 8
...
; <label>:7                                       ; preds = %0
  ...
  %9 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %8, i32 0, i32 2
  ...
  %13 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %12, i32 0, i32 3
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator"* %13, i32 0, i32 3
  %15 = load %struct.Task*** %14, align 8
  %16 = getelementptr inbounds %struct.Task** %15, i64 1
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE16_M_destroy_nodesEPPS0_S4_(%"class.std::_Deque_base"* %2, %struct.Task** %11, %struct.Task** %16) #2
  %17 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %18 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %17, i32 0, i32 0
  %19 = load %struct.Task*** %18, align 8
  %20 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %20, i32 0, i32 1
  %22 = load i64* %21, align 8
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE17_M_deallocate_mapEPPS0_m(%"class.std::_Deque_base"* %2, %struct.Task** %19, i64 %22) #2
  br label %23

; <label>:23                                      ; preds = %7, %0
  %24 = getelementptr inbounds %"class.std::_Deque_base"* %2, i32 0, i32 0
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %24) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE16_M_destroy_nodesEPPS0_S4_(%"class.std::_Deque_base"* %this, %struct.Task** %__nstart, %struct.Task** %__nfinish) #5 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  %__n = alloca %struct.Task**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store %struct.Task** %__nstart, %struct.Task*** %2, align 8
  store %struct.Task** %__nfinish, %struct.Task*** %3, align 8
  %4 = load %"class.std::_Deque_base"** %1
  %5 = load %struct.Task*** %2, align 8
  store %struct.Task** %5, %struct.Task*** %__n, align 8
  br label %6

; <label>:6                                       ; preds = %13, %0
  %7 = load %struct.Task*** %__n, align 8
  %8 = load %struct.Task*** %3, align 8
  %9 = icmp ult %struct.Task** %7, %8
  br i1 %9, label %10, label %16

; <label>:10                                      ; preds = %6
  %11 = load %struct.Task*** %__n, align 8
  %12 = load %struct.Task** %11, align 8
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE18_M_deallocate_nodeEPS0_(%"class.std::_Deque_base"* %4, %struct.Task* %12) #2
  br label %13

; <label>:13                                      ; preds = %10
  %14 = load %struct.Task*** %__n, align 8
  %15 = getelementptr inbounds %struct.Task** %14, i32 1
  store %struct.Task** %15, %struct.Task*** %__n, align 8
  br label %6
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %this) unnamed_addr #9 align 2 {
  %1 = alloca %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %this, %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %1, align 8
  %2 = load %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %2 to %"class.std::allocator.4"*
  call void @_ZNSaI4TaskED2Ev(%"class.std::allocator.4"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaI4TaskED2Ev(%"class.std::allocator.4"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::allocator.4"*, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorI4TaskED2Ev(%"class.__gnu_cxx::new_allocator.5"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4TaskED2Ev(%"class.__gnu_cxx::new_allocator.5"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.5"** %1
  ret void
...
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EEC2Ev(%"class.std::_Deque_base"* %this) unnamed_addr #3 align 2 {
  ...
  %4 = load %"class.std::_Deque_base"** %1
  %5 = getelementptr inbounds %"class.std::_Deque_base"* %4, i32 0, i32 0
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_implC2Ev(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %5)
  invoke void @_ZNSt11_Deque_baseI4TaskSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %4, i64 0)
...
; <label>:7                                       ; preds = %0
  ...
  store i32 %10, i32* %3
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %5) #2
  br label %11
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_implC2Ev(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %this, %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %1, align 8
  %2 = load %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %2 to %"class.std::allocator.4"*
  call void @_ZNSaI4TaskEC2Ev(%"class.std::allocator.4"* %3) #2
  %4 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %2, i32 0, i32 0
  store %struct.Task** null, %struct.Task*** %4, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %2, i32 0, i32 1
  store i64 0, i64* %5, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %2, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %2, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %7) #2
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %this, i64 %__num_elements) #3 align 2 {
  ...
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %__nstart = alloca %struct.Task**, align 8
  %__nfinish = alloca %struct.Task**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  ...
  %15 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %14, i32 0, i32 1
  store i64 %13, i64* %15, align 8
  %16 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %16, i32 0, i32 1
  %18 = load i64* %17, align 8
  %19 = call %struct.Task** @_ZNSt11_Deque_baseI4TaskSaIS0_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %5, i64 %18)
  %20 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %20, i32 0, i32 0
  store %struct.Task** %19, %struct.Task*** %21, align 8
  %22 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %22, i32 0, i32 0
  %24 = load %struct.Task*** %23, align 8
  ...
  %29 = sub i64 %27, %28
  %30 = udiv i64 %29, 2
  %31 = getelementptr inbounds %struct.Task** %24, i64 %30
  store %struct.Task** %31, %struct.Task*** %__nstart, align 8
  %32 = load %struct.Task*** %__nstart, align 8
  %33 = load i64* %__num_nodes, align 8
  %34 = getelementptr inbounds %struct.Task** %32, i64 %33
  store %struct.Task** %34, %struct.Task*** %__nfinish, align 8
  %35 = load %struct.Task*** %__nstart, align 8
  %36 = load %struct.Task*** %__nfinish, align 8
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE15_M_create_nodesEPPS0_S4_(%"class.std::_Deque_base"* %5, %struct.Task** %35, %struct.Task** %36)
  %37 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %37, i32 0, i32 2
  %39 = load %struct.Task*** %__nstart, align 8
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %38, %struct.Task** %39) #2
  %40 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %41 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %40, i32 0, i32 3
  %42 = load %struct.Task*** %__nfinish, align 8
  %43 = getelementptr inbounds %struct.Task** %42, i64 -1
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_E11_M_set_nodeEPS2_(%"struct.std::_Deque_iterator"* %41, %struct.Task** %43) #2
  %44 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %45 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %44, i32 0, i32 2
  %46 = getelementptr inbounds %"struct.std::_Deque_iterator"* %45, i32 0, i32 1
  %47 = load %struct.Task** %46, align 8
  %48 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %49 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %48, i32 0, i32 2
  %50 = getelementptr inbounds %"struct.std::_Deque_iterator"* %49, i32 0, i32 0
  store %struct.Task* %47, %struct.Task** %50, align 8
  %51 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %52 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %51, i32 0, i32 3
  %53 = getelementptr inbounds %"struct.std::_Deque_iterator"* %52, i32 0, i32 1
  %54 = load %struct.Task** %53, align 8
  %55 = load i64* %2, align 8
  %56 = call i64 @_ZSt16__deque_buf_sizem(i64 16)
  %57 = urem i64 %55, %56
  %58 = getelementptr inbounds %struct.Task* %54, i64 %57
  %59 = getelementptr inbounds %"class.std::_Deque_base"* %5, i32 0, i32 0
  %60 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %59, i32 0, i32 3
  %61 = getelementptr inbounds %"struct.std::_Deque_iterator"* %60, i32 0, i32 0
  store %struct.Task* %58, %struct.Task** %61, align 8
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE15_M_create_nodesEPPS0_S4_(%"class.std::_Deque_base"* %this, %struct.Task** %__nstart, %struct.Task** %__nfinish) #3 align 2 {
  ...
  %2 = alloca %struct.Task**, align 8
  %3 = alloca %struct.Task**, align 8
  %__cur = alloca %struct.Task**, align 8
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store %struct.Task** %__nstart, %struct.Task*** %2, align 8
  store %struct.Task** %__nfinish, %struct.Task*** %3, align 8
  %4 = load %"class.std::_Deque_base"** %1
  %5 = load %struct.Task*** %2, align 8
  store %struct.Task** %5, %struct.Task*** %__cur, align 8
  br label %6

; <label>:6                                       ; preds = %13, %0
  %7 = load %struct.Task*** %__cur, align 8
  %8 = load %struct.Task*** %3, align 8
  %9 = icmp ult %struct.Task** %7, %8
  br i1 %9, label %10, label %16

; <label>:10                                      ; preds = %6
  %11 = call %struct.Task* @_ZNSt11_Deque_baseI4TaskSaIS0_EE16_M_allocate_nodeEv(%"class.std::_Deque_base"* %4)
  %12 = load %struct.Task*** %__cur, align 8
  store %struct.Task* %11, %struct.Task** %12, align 8
  br label %13

; <label>:13                                      ; preds = %10
  %14 = load %struct.Task*** %__cur, align 8
  %15 = getelementptr inbounds %struct.Task** %14, i32 1
  store %struct.Task** %15, %struct.Task*** %__cur, align 8
  br label %6
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaI4TaskEC2Ev(%"class.std::allocator.4"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::allocator.4"*, align 8
  store %"class.std::allocator.4"* %this, %"class.std::allocator.4"** %1, align 8
  %2 = load %"class.std::allocator.4"** %1
  %3 = bitcast %"class.std::allocator.4"* %2 to %"class.__gnu_cxx::new_allocator.5"*
  call void @_ZN9__gnu_cxx13new_allocatorI4TaskEC2Ev(%"class.__gnu_cxx::new_allocator.5"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %this, %"struct.std::_Deque_iterator"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator"* %2, i32 0, i32 0
  ...
  store %struct.Task** null, %struct.Task*** %6, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4TaskEC2Ev(%"class.__gnu_cxx::new_allocator.5"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
  store %"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.5"** %1
  ret void
...
define linkonce_odr void @_ZNSt5dequeI4TaskSaIS0_EEC2EOS2_(%"class.std::deque"* %this, %"class.std::deque"* %__x) unnamed_addr #3 align 2 {
  ...
  %6 = call %"class.std::deque"* @_ZSt4moveIRSt5dequeI4TaskSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::deque"* %5) #2
  %7 = bitcast %"class.std::deque"* %6 to %"class.std::_Deque_base"*
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EEC2EOS2_(%"class.std::_Deque_base"* %4, %"class.std::_Deque_base"* %7)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::deque"* @_ZSt4moveIRSt5dequeI4TaskSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::deque"* %__t) #5 {
  %1 = alloca %"class.std::deque"*, align 8
...
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EEC2EOS2_(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %7 = call %"class.std::_Deque_base"* @_ZSt4moveIRSt11_Deque_baseI4TaskSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::_Deque_base"* %6) #2
  %8 = bitcast %"struct.__gnu_cxx::__allocator_always_compares_equal"* %4 to %"struct.std::integral_constant"*
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EEC2EOS2_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %5, %"class.std::_Deque_base"* %7)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EEC2EOS2_St17integral_constantIbLb1EE(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %9 = call %"class.std::allocator.4"* @_ZNSt11_Deque_baseI4TaskSaIS0_EE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* %8) #2
  %10 = call %"class.std::allocator.4"* @_ZSt4moveIRSaI4TaskEEONSt16remove_referenceIT_E4typeEOS4_(%"class.std::allocator.4"* %9) #2
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_implC2EOS1_(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %7, %"class.std::allocator.4"* %10) #2
  invoke void @_ZNSt11_Deque_baseI4TaskSaIS0_EE17_M_initialize_mapEm(%"class.std::_Deque_base"* %6, i64 0)
          to label %11 unwind label %21

; <label>:11                                      ; preds = %0
  %12 = load %"class.std::_Deque_base"** %2, align 8
  %13 = getelementptr inbounds %"class.std::_Deque_base"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %13, i32 0, i32 0
  %15 = load %struct.Task*** %14, align 8
  %16 = icmp ne %struct.Task** %15, null
...
; <label>:17                                      ; preds = %11
  ...
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_impl12_M_swap_dataERS3_(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %18, %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %20) #2
  br label %25
...
; <label>:21                                      ; preds = %0
  ...
  store i32 %24, i32* %5
  call void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_implD2Ev(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %7) #2
  br label %26
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::_Deque_base"* @_ZSt4moveIRSt11_Deque_baseI4TaskSaIS1_EEEONSt16remove_referenceIT_E4typeEOS6_(%"class.std::_Deque_base"* %__t) #5 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_implC2EOS1_(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %this, %"class.std::allocator.4"* %__a) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"*, align 8
  %2 = alloca %"class.std::allocator.4"*, align 8
  store %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %this, %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %1, align 8
  store %"class.std::allocator.4"* %__a, %"class.std::allocator.4"** %2, align 8
  %3 = load %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %1
  %4 = bitcast %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3 to %"class.std::allocator.4"*
  %5 = load %"class.std::allocator.4"** %2, align 8
  %6 = call %"class.std::allocator.4"* @_ZSt4moveIRSaI4TaskEEONSt16remove_referenceIT_E4typeEOS4_(%"class.std::allocator.4"* %5) #2
  call void @_ZNSaI4TaskEC2ERKS0_(%"class.std::allocator.4"* %4, %"class.std::allocator.4"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 0
  store %struct.Task** null, %struct.Task*** %7, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 1
  store i64 0, i64* %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %9) #2
  %10 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2Ev(%"struct.std::_Deque_iterator"* %10) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator.4"* @_ZSt4moveIRSaI4TaskEEONSt16remove_referenceIT_E4typeEOS4_(%"class.std::allocator.4"* %__t) #5 {
  %1 = alloca %"class.std::allocator.4"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseI4TaskSaIS0_EE11_Deque_impl12_M_swap_dataERS3_(%"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %this, %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %__x) #5 align 2 {
  %1 = alloca %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"*, align 8
  %2 = alloca %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %this, %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %1, align 8
  store %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %__x, %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %2, align 8
  %3 = load %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %1
  %4 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 2
  %5 = load %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %2, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %5, i32 0, i32 2
  call void @_ZSt4swapISt15_Deque_iteratorI4TaskRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %4, %"struct.std::_Deque_iterator"* %6) #2
  %7 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 3
  %8 = load %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %2, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %8, i32 0, i32 3
  call void @_ZSt4swapISt15_Deque_iteratorI4TaskRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %7, %"struct.std::_Deque_iterator"* %9) #2
  %10 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 0
  %11 = load %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %2, align 8
  %12 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %11, i32 0, i32 0
  call void @_ZSt4swapIPP4TaskEvRT_S4_(%struct.Task*** %10, %struct.Task*** %12) #2
  %13 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %3, i32 0, i32 1
  %14 = load %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"** %2, align 8
  %15 = getelementptr inbounds %"struct.std::_Deque_base<Task, std::allocator<Task> >::_Deque_impl"* %14, i32 0, i32 1
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZSt4swapISt15_Deque_iteratorI4TaskRS1_PS1_EEvRT_S6_(%"struct.std::_Deque_iterator"* %__a, %"struct.std::_Deque_iterator"* %__b) #9 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
  %__tmp = alloca %"struct.std::_Deque_iterator", align 8
  ...
  %3 = load %"struct.std::_Deque_iterator"** %1, align 8
  %4 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI4TaskRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %3) #2
  call void @_ZNSt15_Deque_iteratorI4TaskRS0_PS0_EC2ERKS3_(%"struct.std::_Deque_iterator"* %__tmp, %"struct.std::_Deque_iterator"* %4) #2
  %5 = load %"struct.std::_Deque_iterator"** %1, align 8
  %6 = load %"struct.std::_Deque_iterator"** %2, align 8
  %7 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI4TaskRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %6) #2
  ...
  %11 = call %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI4TaskRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %__tmp) #2
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZSt4swapIPP4TaskEvRT_S4_(%struct.Task*** %__a, %struct.Task*** %__b) #9 {
  %1 = alloca %struct.Task***, align 8
  %2 = alloca %struct.Task***, align 8
  %__tmp = alloca %struct.Task**, align 8
  store %struct.Task*** %__a, %struct.Task**** %1, align 8
  store %struct.Task*** %__b, %struct.Task**** %2, align 8
  %3 = load %struct.Task**** %1, align 8
  %4 = call %struct.Task*** @_ZSt4moveIRPP4TaskEONSt16remove_referenceIT_E4typeEOS5_(%struct.Task*** %3) #2
  %5 = load %struct.Task*** %4
  store %struct.Task** %5, %struct.Task*** %__tmp, align 8
  %6 = load %struct.Task**** %2, align 8
  %7 = call %struct.Task*** @_ZSt4moveIRPP4TaskEONSt16remove_referenceIT_E4typeEOS5_(%struct.Task*** %6) #2
  %8 = load %struct.Task*** %7
  %9 = load %struct.Task**** %1, align 8
  store %struct.Task** %8, %struct.Task*** %9, align 8
  %10 = call %struct.Task*** @_ZSt4moveIRPP4TaskEONSt16remove_referenceIT_E4typeEOS5_(%struct.Task*** %__tmp) #2
  %11 = load %struct.Task*** %10
  %12 = load %struct.Task**** %2, align 8
  store %struct.Task** %11, %struct.Task*** %12, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr %struct.Task*** @_ZSt4moveIRPP4TaskEONSt16remove_referenceIT_E4typeEOS5_(%struct.Task*** %__t) #5 {
  %1 = alloca %struct.Task***, align 8
  store %struct.Task*** %__t, %struct.Task**** %1, align 8
  %2 = load %struct.Task**** %1, align 8
  ret %struct.Task*** %2
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Deque_iterator"* @_ZSt4moveIRSt15_Deque_iteratorI4TaskRS1_PS1_EEONSt16remove_referenceIT_E4typeEOS7_(%"struct.std::_Deque_iterator"* %__t) #5 {
  %1 = alloca %"struct.std::_Deque_iterator"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaI4TaskEC2ERKS0_(%"class.std::allocator.4"* %this, %"class.std::allocator.4"* %__a) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::allocator.4"*, align 8
  %2 = alloca %"class.std::allocator.4"*, align 8
  store %"class.std::allocator.4"* %this, %"class.std::allocator.4"** %1, align 8
  store %"class.std::allocator.4"* %__a, %"class.std::allocator.4"** %2, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorI4TaskEC2ERKS2_(%"class.__gnu_cxx::new_allocator.5"* %4, %"class.__gnu_cxx::new_allocator.5"* %6) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorI4TaskEC2ERKS2_(%"class.__gnu_cxx::new_allocator.5"* %this, %"class.__gnu_cxx::new_allocator.5"*) unnamed_addr #5 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator.5"*, align 8
