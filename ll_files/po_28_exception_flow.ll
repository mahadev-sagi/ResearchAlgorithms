; ModuleID = 'PostorderTraversals/po_28_exception_flow.cpp'
...
%struct.TraversalSignal = type { i32 }
...
@_ZTS15TraversalSignal = linkonce_odr constant [18 x i8] c"15TraversalSignal\00"
@_ZTI15TraversalSignal = linkonce_odr unnamed_addr constant { i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([18 x i8]* @_ZTS15TraversalSignal, i32 0, i32 0) }
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %4 = alloca i8*
  %5 = alloca i32
  %6 = alloca %struct.TraversalSignal, align 4
  %7 = alloca i32
  ...
  invoke void @_ZN8Solution8traverseEP8TreeNodeRSt6vectorIiSaIiEE(%class.Solution* %8, %struct.TreeNode* %9, %"class.std::vector"* %agg.result)
...
; <label>:11                                      ; preds = %0
  %12 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup
          catch i8* bitcast ({ i8*, i8* }* @_ZTI15TraversalSignal to i8*)
...
; <label>:15                                      ; preds = %11
  %16 = load i32* %5
  %17 = call i32 @llvm.eh.typeid.for(i8* bitcast ({ i8*, i8* }* @_ZTI15TraversalSignal to i8*)) #2
  %18 = icmp eq i32 %16, %17
  br i1 %18, label %19, label %34

; <label>:19                                      ; preds = %15
  %20 = load i8** %4
  %21 = call i8* @__cxa_begin_catch(i8* %20) #2
  %22 = bitcast i8* %21 to %struct.TraversalSignal*
  %23 = bitcast %struct.TraversalSignal* %6 to i8*
  %24 = bitcast %struct.TraversalSignal* %22 to i8*
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8Solution8traverseEP8TreeNodeRSt6vectorIiSaIiEE(%class.Solution* %this, %struct.TreeNode* %node, %"class.std::vector"* %result) #3 align 2 {
  %1 = alloca %class.Solution*, align 8
  %2 = alloca %struct.TreeNode*, align 8
  ...
  %5 = alloca i32
  %6 = alloca %struct.TraversalSignal, align 4
  %7 = alloca %struct.TraversalSignal, align 4
  %sig = alloca %struct.TraversalSignal, align 4
  store %class.Solution* %this, %class.Solution** %1, align 8
...
; <label>:12                                      ; preds = %0
  ...
  invoke void @_ZN8Solution8traverseEP8TreeNodeRSt6vectorIiSaIiEE(%class.Solution* %8, %struct.TreeNode* %15, %"class.std::vector"* %16)
...
; <label>:22                                      ; preds = %18
  %23 = load i32* %5
  %24 = call i32 @llvm.eh.typeid.for(i8* bitcast ({ i8*, i8* }* @_ZTI15TraversalSignal to i8*)) #2
...
; <label>:26                                      ; preds = %22
  ...
  %29 = bitcast i8* %28 to %struct.TraversalSignal*
  %30 = bitcast %struct.TraversalSignal* %6 to i8*
  %31 = bitcast %struct.TraversalSignal* %29 to i8*
...
; <label>:32                                      ; preds = %26, %17
  ...
  %36 = load %"class.std::vector"** %3, align 8
  invoke void @_ZN8Solution8traverseEP8TreeNodeRSt6vectorIiSaIiEE(%class.Solution* %8, %struct.TreeNode* %35, %"class.std::vector"* %36)
...
; <label>:42                                      ; preds = %38
  %43 = load i32* %5
  %44 = call i32 @llvm.eh.typeid.for(i8* bitcast ({ i8*, i8* }* @_ZTI15TraversalSignal to i8*)) #2
...
; <label>:46                                      ; preds = %42
  ...
  %49 = bitcast i8* %48 to %struct.TraversalSignal*
  %50 = bitcast %struct.TraversalSignal* %7 to i8*
  %51 = bitcast %struct.TraversalSignal* %49 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %50, i8* %51, i64 4, i32 4, i1 false)
  call void @__cxa_end_catch()
  br label %52

; <label>:52                                      ; preds = %46, %37
  %53 = load %"class.std::vector"** %3, align 8
  %54 = load %struct.TreeNode** %2, align 8
  %55 = getelementptr inbounds %struct.TreeNode* %54, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %53, i32* %55)
  %56 = call i8* @__cxa_allocate_exception(i64 4) #2
  %57 = bitcast i8* %56 to %struct.TraversalSignal*
  %58 = bitcast %struct.TraversalSignal* %57 to i8*
  %59 = bitcast %struct.TraversalSignal* %sig to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %58, i8* %59, i64 4, i32 4, i1 false)
  call void @__cxa_throw(i8* %56, i8* bitcast ({ i8*, i8* }* @_ZTI15TraversalSignal to i8*), i8* null) #15
  unreachable

; <label>:60                                      ; preds = %42, %22
  %61 = load i8** %4
  %62 = load i32* %5
