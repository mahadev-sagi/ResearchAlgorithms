; ModuleID = 'PostorderTraversals/po_02_iterative_2stack.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %temp = alloca %struct.TreeNode*, align 8
  %temp1 = alloca %struct.TreeNode*, align 8
...
; <label>:14                                      ; preds = %13
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %s1, %"class.std::deque"* %5)
          to label %15 unwind label %41

; <label>:15                                      ; preds = %14
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EED2Ev(%"class.std::deque"* %5) #2
  invoke void @_ZNSt5dequeIP8TreeNodeSaIS1_EEC2Ev(%"class.std::deque"* %8)
          to label %16 unwind label %45

; <label>:16                                      ; preds = %15
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %s2, %"class.std::deque"* %8)
          to label %17 unwind label %49

; <label>:17                                      ; preds = %16
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EED2Ev(%"class.std::deque"* %8) #2
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s1, %struct.TreeNode** %2)
...
; <label>:19                                      ; preds = %66, %18
  %20 = invoke zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s1)
...
; <label>:23                                      ; preds = %21
  %24 = invoke %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s1)
          to label %25 unwind label %53

; <label>:25                                      ; preds = %23
  %26 = load %struct.TreeNode** %24
  store %struct.TreeNode* %26, %struct.TreeNode** %temp, align 8
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s1)
          to label %27 unwind label %53

; <label>:27                                      ; preds = %25
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s2, %struct.TreeNode** %temp)
          to label %28 unwind label %53

; <label>:28                                      ; preds = %27
  %29 = load %struct.TreeNode** %temp, align 8
  %30 = getelementptr inbounds %struct.TreeNode* %29, i32 0, i32 1
...
; <label>:33                                      ; preds = %28
  %34 = load %struct.TreeNode** %temp, align 8
  %35 = getelementptr inbounds %struct.TreeNode* %34, i32 0, i32 1
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s1, %struct.TreeNode** %35)
...
; <label>:53                                      ; preds = %76, %74, %72, %68, %62, %33, %27, %25, %23, %19, %17
  ...
  store i32 %56, i32* %7
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::stack"* %s2) #2
  br label %81

; <label>:57                                      ; preds = %36, %28
  %58 = load %struct.TreeNode** %temp, align 8
...
; <label>:62                                      ; preds = %57
  %63 = load %struct.TreeNode** %temp, align 8
  %64 = getelementptr inbounds %struct.TreeNode* %63, i32 0, i32 2
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s1, %struct.TreeNode** %64)
...
; <label>:68                                      ; preds = %79, %67
  %69 = invoke zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s2)
...
; <label>:72                                      ; preds = %70
  %73 = invoke %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s2)
          to label %74 unwind label %53

; <label>:74                                      ; preds = %72
  %75 = load %struct.TreeNode** %73
  store %struct.TreeNode* %75, %struct.TreeNode** %temp1, align 8
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s2)
          to label %76 unwind label %53

; <label>:76                                      ; preds = %74
  %77 = load %struct.TreeNode** %temp1, align 8
  %78 = getelementptr inbounds %struct.TreeNode* %77, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %78)
...
; <label>:80                                      ; preds = %70
  ...
  store i32 1, i32* %4
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::stack"* %s2) #2
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::stack"* %s1) #2
  br label %82
