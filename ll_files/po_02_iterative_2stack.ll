...
; <label>:11                                      ; preds = %0
  ...
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %s1, %"class.std::deque"* %5)
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EED2Ev(%"class.std::deque"* %5) #0
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EEC2Ev(%"class.std::deque"* %6)
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %s2, %"class.std::deque"* %6)
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EED2Ev(%"class.std::deque"* %6) #0
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s1, %struct.TreeNode** %2)
  br label %12

; <label>:12                                      ; preds = %33, %11
  %13 = call zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s1)
  %14 = xor i1 %13, true
  br i1 %14, label %15, label %34

; <label>:15                                      ; preds = %12
  %16 = call %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s1)
  %17 = load %struct.TreeNode** %16
  store %struct.TreeNode* %17, %struct.TreeNode** %temp, align 8
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s1)
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s2, %struct.TreeNode** %temp)
  %18 = load %struct.TreeNode** %temp, align 8
  %19 = getelementptr inbounds %struct.TreeNode* %18, i32 0, i32 1
  %20 = load %struct.TreeNode** %19, align 8
  %21 = icmp ne %struct.TreeNode* %20, null
  br i1 %21, label %22, label %25

; <label>:22                                      ; preds = %15
  %23 = load %struct.TreeNode** %temp, align 8
  %24 = getelementptr inbounds %struct.TreeNode* %23, i32 0, i32 1
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s1, %struct.TreeNode** %24)
  br label %25

; <label>:25                                      ; preds = %22, %15
  %26 = load %struct.TreeNode** %temp, align 8
  %27 = getelementptr inbounds %struct.TreeNode* %26, i32 0, i32 2
  %28 = load %struct.TreeNode** %27, align 8
  %29 = icmp ne %struct.TreeNode* %28, null
  br i1 %29, label %30, label %33

; <label>:30                                      ; preds = %25
  %31 = load %struct.TreeNode** %temp, align 8
  %32 = getelementptr inbounds %struct.TreeNode* %31, i32 0, i32 2
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s1, %struct.TreeNode** %32)
  br label %33
...
; <label>:35                                      ; preds = %38, %34
  %36 = call zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s2)
  %37 = xor i1 %36, true
  br i1 %37, label %38, label %43

; <label>:38                                      ; preds = %35
  %39 = call %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s2)
  %40 = load %struct.TreeNode** %39
  store %struct.TreeNode* %40, %struct.TreeNode** %temp1, align 8
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s2)
  %41 = load %struct.TreeNode** %temp1, align 8
  %42 = getelementptr inbounds %struct.TreeNode* %41, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %42)
  br label %35

; <label>:43                                      ; preds = %35
  store i1 true, i1* %3
  store i32 1, i32* %4
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::stack"* %s2) #0
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::stack"* %s1) #0
  br label %44
