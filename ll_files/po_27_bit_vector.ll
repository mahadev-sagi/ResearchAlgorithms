...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %visitedState = alloca %"class.std::stack.7", align 8
...
; <label>:15                                      ; preds = %0
  ...
  call void @_ZNSt5dequeIbSaIbEEC2Ev(%"class.std::deque.8"* %6)
  call void @_ZNSt5stackIbSt5dequeIbSaIbEEEC2EOS2_(%"class.std::stack.7"* %visitedState, %"class.std::deque.8"* %6)
  call void @_ZNSt5dequeIbSaIbEED2Ev(%"class.std::deque.8"* %6) #0
  store i8 0, i8* %7
  call void @_ZNSt5stackIbSt5dequeIbSaIbEEE4pushEOb(%"class.std::stack.7"* %visitedState, i8* %7)
  br label %16

; <label>:16                                      ; preds = %48, %15
  %17 = call zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %s)
  %18 = xor i1 %17, true
  br i1 %18, label %19, label %49

; <label>:19                                      ; preds = %16
  %20 = call %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %s)
  %21 = load %struct.TreeNode** %20
  store %struct.TreeNode* %21, %struct.TreeNode** %node, align 8
  %22 = call i8* @_ZNSt5stackIbSt5dequeIbSaIbEEE3topEv(%"class.std::stack.7"* %visitedState)
  %23 = load i8* %22
  %24 = trunc i8 %23 to i1
  %25 = zext i1 %24 to i8
  store i8 %25, i8* %visited, align 1
  call void @_ZNSt5stackIbSt5dequeIbSaIbEEE3popEv(%"class.std::stack.7"* %visitedState)
  %26 = load i8* %visited, align 1
  %27 = trunc i8 %26 to i1
  br i1 %27, label %28, label %31

; <label>:28                                      ; preds = %19
  %29 = load %struct.TreeNode** %node, align 8
  %30 = getelementptr inbounds %struct.TreeNode* %29, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %30)
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %s)
  br label %48

; <label>:31                                      ; preds = %19
  store i8 1, i8* %8
  call void @_ZNSt5stackIbSt5dequeIbSaIbEEE4pushEOb(%"class.std::stack.7"* %visitedState, i8* %8)
  %32 = load %struct.TreeNode** %node, align 8
  %33 = getelementptr inbounds %struct.TreeNode* %32, i32 0, i32 2
  %34 = load %struct.TreeNode** %33, align 8
  %35 = icmp ne %struct.TreeNode* %34, null
  br i1 %35, label %36, label %39

; <label>:36                                      ; preds = %31
  %37 = load %struct.TreeNode** %node, align 8
  %38 = getelementptr inbounds %struct.TreeNode* %37, i32 0, i32 2
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %38)
  store i8 0, i8* %9
  call void @_ZNSt5stackIbSt5dequeIbSaIbEEE4pushEOb(%"class.std::stack.7"* %visitedState, i8* %9)
  br label %39

; <label>:39                                      ; preds = %36, %31
  %40 = load %struct.TreeNode** %node, align 8
  %41 = getelementptr inbounds %struct.TreeNode* %40, i32 0, i32 1
  %42 = load %struct.TreeNode** %41, align 8
  %43 = icmp ne %struct.TreeNode* %42, null
  br i1 %43, label %44, label %47

; <label>:44                                      ; preds = %39
  %45 = load %struct.TreeNode** %node, align 8
  %46 = getelementptr inbounds %struct.TreeNode* %45, i32 0, i32 1
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %s, %struct.TreeNode** %46)
  store i8 0, i8* %10
  call void @_ZNSt5stackIbSt5dequeIbSaIbEEE4pushEOb(%"class.std::stack.7"* %visitedState, i8* %10)
  br label %47
...
; <label>:49                                      ; preds = %16
  store i1 true, i1* %3
  store i32 1, i32* %4
  call void @_ZNSt5stackIbSt5dequeIbSaIbEEED2Ev(%"class.std::stack.7"* %visitedState) #0
...
define linkonce_odr void @_ZNSt5stackIbSt5dequeIbSaIbEEEC2EOS2_(%"class.std::stack.7"* %this, %"class.std::deque.8"* %__c) unnamed_addr #3 align 2 {
  %1 = alloca %"class.std::stack.7"*, align 8
  %2 = alloca %"class.std::deque.8"*, align 8
  store %"class.std::stack.7"* %this, %"class.std::stack.7"** %1, align 8
  store %"class.std::deque.8"* %__c, %"class.std::deque.8"** %2, align 8
  %3 = load %"class.std::stack.7"** %1
  %4 = getelementptr inbounds %"class.std::stack.7"* %3, i32 0, i32 0
  %5 = load %"class.std::deque.8"** %2, align 8
  %6 = call %"class.std::deque.8"* @_ZSt4moveIRSt5dequeIbSaIbEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::deque.8"* %5) #0
  call void @_ZNSt5dequeIbSaIbEEC2EOS1_(%"class.std::deque.8"* %4, %"class.std::deque.8"* %6)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt5dequeIbSaIbEEC2Ev(%"class.std::deque.8"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.std::deque.8"*, align 8
  store %"class.std::deque.8"* %this, %"class.std::deque.8"** %1, align 8
  %2 = load %"class.std::deque.8"** %1
  %3 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  call void @_ZNSt11_Deque_baseIbSaIbEEC2Ev(%"class.std::_Deque_base.9"* %3)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEED2Ev(%"class.std::deque.8"* %this) unnamed_addr #3 align 2 {
  ...
  store %"class.std::deque.8"* %this, %"class.std::deque.8"** %1, align 8
  %4 = load %"class.std::deque.8"** %1
  call void @_ZNSt5dequeIbSaIbEE5beginEv(%"struct.std::_Deque_iterator.13"* sret %2, %"class.std::deque.8"* %4) #0
  call void @_ZNSt5dequeIbSaIbEE3endEv(%"struct.std::_Deque_iterator.13"* sret %3, %"class.std::deque.8"* %4) #0
  %5 = bitcast %"class.std::deque.8"* %4 to %"class.std::_Deque_base.9"*
  %6 = call %"class.std::allocator.10"* @_ZNSt11_Deque_baseIbSaIbEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base.9"* %5) #0
  call void @_ZNSt5dequeIbSaIbEE15_M_destroy_dataESt15_Deque_iteratorIbRbPbES5_RKS0_(%"class.std::deque.8"* %4, %"struct.std::_Deque_iterator.13"* %2, %"struct.std::_Deque_iterator.13"* %3, %"class.std::allocator.10"* %6)
  %7 = bitcast %"class.std::deque.8"* %4 to %"class.std::_Deque_base.9"*
  call void @_ZNSt11_Deque_baseIbSaIbEED2Ev(%"class.std::_Deque_base.9"* %7) #0
  ret void
}
...
define linkonce_odr void @_ZNSt5stackIbSt5dequeIbSaIbEEE4pushEOb(%"class.std::stack.7"* %this, i8* %__x) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::stack.7"* %3, i32 0, i32 0
  %5 = load i8** %2, align 8
  %6 = call i8* @_ZSt4moveIRbEONSt16remove_referenceIT_E4typeEOS2_(i8* %5) #0
  call void @_ZNSt5dequeIbSaIbEE9push_backEOb(%"class.std::deque.8"* %4, i8* %6)
  ret void
}
...
define linkonce_odr i8* @_ZNSt5stackIbSt5dequeIbSaIbEEE3topEv(%"class.std::stack.7"* %this) #3 align 2 {
  %1 = alloca %"class.std::stack.7"*, align 8
  store %"class.std::stack.7"* %this, %"class.std::stack.7"** %1, align 8
  %2 = load %"class.std::stack.7"** %1
  %3 = getelementptr inbounds %"class.std::stack.7"* %2, i32 0, i32 0
  %4 = call i8* @_ZNSt5dequeIbSaIbEE4backEv(%"class.std::deque.8"* %3) #0
  ret i8* %4
}
...
define linkonce_odr void @_ZNSt5stackIbSt5dequeIbSaIbEEE3popEv(%"class.std::stack.7"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::stack.7"** %1
  %3 = getelementptr inbounds %"class.std::stack.7"* %2, i32 0, i32 0
  call void @_ZNSt5dequeIbSaIbEE8pop_backEv(%"class.std::deque.8"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt5stackIbSt5dequeIbSaIbEEED2Ev(%"class.std::stack.7"* %this) unnamed_addr #5 align 2 {
  ...
  %2 = load %"class.std::stack.7"** %1
  %3 = getelementptr inbounds %"class.std::stack.7"* %2, i32 0, i32 0
  call void @_ZNSt5dequeIbSaIbEED2Ev(%"class.std::deque.8"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE8pop_backEv(%"class.std::deque.8"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::deque.8"** %1
  %3 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %4 = getelementptr inbounds %"class.std::_Deque_base.9"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %4, i32 0, i32 3
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %5, i32 0, i32 0
  %7 = load i8** %6, align 8
  %8 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %9 = getelementptr inbounds %"class.std::_Deque_base.9"* %8, i32 0, i32 0
  %10 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %9, i32 0, i32 3
  %11 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %10, i32 0, i32 1
  %12 = load i8** %11, align 8
  %13 = icmp ne i8* %7, %12
  br i1 %13, label %14, label %29

; <label>:14                                      ; preds = %0
  %15 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %16 = getelementptr inbounds %"class.std::_Deque_base.9"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %16, i32 0, i32 3
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %17, i32 0, i32 0
  %19 = load i8** %18, align 8
  %20 = getelementptr inbounds i8* %19, i32 -1
  store i8* %20, i8** %18, align 8
  %21 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %22 = getelementptr inbounds %"class.std::_Deque_base.9"* %21, i32 0, i32 0
  %23 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %22 to %"class.std::allocator.10"*
  %24 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %25 = getelementptr inbounds %"class.std::_Deque_base.9"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %25, i32 0, i32 3
  %27 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %26, i32 0, i32 0
  %28 = load i8** %27, align 8
  call void @_ZNSt16allocator_traitsISaIbEE7destroyIbEEvRS0_PT_(%"class.std::allocator.10"* %23, i8* %28)
  br label %30

; <label>:29                                      ; preds = %0
  call void @_ZNSt5dequeIbSaIbEE15_M_pop_back_auxEv(%"class.std::deque.8"* %2)
  br label %30
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIbEE7destroyIbEEvRS0_PT_(%"class.std::allocator.10"* %__a, i8* %__p) #3 align 2 {
  ...
  %5 = load i8** %2, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIbE7destroyIbEEvPT_(%"class.__gnu_cxx::new_allocator.11"* %4, i8* %5)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE15_M_pop_back_auxEv(%"class.std::deque.8"* %this) #3 align 2 {
  ...
  %2 = load %"class.std::deque.8"** %1
  %3 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %4 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %5 = getelementptr inbounds %"class.std::_Deque_base.9"* %4, i32 0, i32 0
  %6 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %5, i32 0, i32 3
  %7 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %6, i32 0, i32 1
  %8 = load i8** %7, align 8
  call void @_ZNSt11_Deque_baseIbSaIbEE18_M_deallocate_nodeEPb(%"class.std::_Deque_base.9"* %3, i8* %8) #0
  %9 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %10 = getelementptr inbounds %"class.std::_Deque_base.9"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %10, i32 0, i32 3
  %12 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %13 = getelementptr inbounds %"class.std::_Deque_base.9"* %12, i32 0, i32 0
  %14 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %13, i32 0, i32 3
  %15 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %14, i32 0, i32 3
  %16 = load i8*** %15, align 8
  %17 = getelementptr inbounds i8** %16, i64 -1
  call void @_ZNSt15_Deque_iteratorIbRbPbE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator.13"* %11, i8** %17) #0
  %18 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %19 = getelementptr inbounds %"class.std::_Deque_base.9"* %18, i32 0, i32 0
  %20 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %19, i32 0, i32 3
  %21 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %20, i32 0, i32 2
  ...
  %28 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %29 = call %"class.std::allocator.10"* @_ZNSt11_Deque_baseIbSaIbEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base.9"* %28) #0
  %30 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %31 = getelementptr inbounds %"class.std::_Deque_base.9"* %30, i32 0, i32 0
  %32 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %31, i32 0, i32 3
  %33 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %32, i32 0, i32 0
  %34 = load i8** %33, align 8
  call void @_ZNSt16allocator_traitsISaIbEE7destroyIbEEvRS0_PT_(%"class.std::allocator.10"* %29, i8* %34)
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE18_M_deallocate_nodeEPb(%"class.std::_Deque_base.9"* %this, i8* %__p) #3 align 2 {
  %1 = alloca %"class.std::_Deque_base.9"*, align 8
  %2 = alloca i8*, align 8
  store %"class.std::_Deque_base.9"* %this, %"class.std::_Deque_base.9"** %1, align 8
  store i8* %__p, i8** %2, align 8
  %3 = load %"class.std::_Deque_base.9"** %1
  %4 = getelementptr inbounds %"class.std::_Deque_base.9"* %3, i32 0, i32 0
  %5 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %4 to %"class.std::allocator.10"*
  %6 = load i8** %2, align 8
  %7 = call i64 @_ZSt16__deque_buf_sizem(i64 1)
  call void @_ZNSt16allocator_traitsISaIbEE10deallocateERS0_Pbm(%"class.std::allocator.10"* %5, i8* %6, i64 %7)
  ret void
}
...
define linkonce_odr void @_ZNSt15_Deque_iteratorIbRbPbE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator.13"* %this, i8** %__new_node) #3 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator.13"*, align 8
  %2 = alloca i8**, align 8
  store %"struct.std::_Deque_iterator.13"* %this, %"struct.std::_Deque_iterator.13"** %1, align 8
  store i8** %__new_node, i8*** %2, align 8
  %3 = load %"struct.std::_Deque_iterator.13"** %1
  %4 = load i8*** %2, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %3, i32 0, i32 3
  store i8** %4, i8*** %5, align 8
  %6 = load i8*** %2, align 8
  %7 = load i8** %6, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %3, i32 0, i32 1
  store i8* %7, i8** %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %3, i32 0, i32 1
  %10 = load i8** %9, align 8
  %11 = call i64 @_ZNSt15_Deque_iteratorIbRbPbE14_S_buffer_sizeEv() #0
  %12 = getelementptr inbounds i8* %10, i64 %11
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %3, i32 0, i32 2
...
define linkonce_odr %"class.std::allocator.10"* @_ZNSt11_Deque_baseIbSaIbEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base.9"* %this) #3 align 2 {
  %1 = alloca %"class.std::_Deque_base.9"*, align 8
  store %"class.std::_Deque_base.9"* %this, %"class.std::_Deque_base.9"** %1, align 8
  %2 = load %"class.std::_Deque_base.9"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  %4 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3 to %"class.std::allocator.10"*
  ret %"class.std::allocator.10"* %4
}

; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNSt15_Deque_iteratorIbRbPbE14_S_buffer_sizeEv() #3 align 2 {
  %1 = call i64 @_ZSt16__deque_buf_sizem(i64 1)
  ret i64 %1
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIbEE10deallocateERS0_Pbm(%"class.std::allocator.10"* %__a, i8* %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load i8** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIbE10deallocateEPbm(%"class.__gnu_cxx::new_allocator.11"* %5, i8* %6, i64 %7)
  ret void
}
...
define linkonce_odr i8* @_ZNSt5dequeIbSaIbEE4backEv(%"class.std::deque.8"* %this) #3 align 2 {
  ...
  store %"class.std::deque.8"* %this, %"class.std::deque.8"** %1, align 8
  %2 = load %"class.std::deque.8"** %1
  call void @_ZNSt5dequeIbSaIbEE3endEv(%"struct.std::_Deque_iterator.13"* sret %__tmp, %"class.std::deque.8"* %2) #0
  %3 = call %"struct.std::_Deque_iterator.13"* @_ZNSt15_Deque_iteratorIbRbPbEmmEv(%"struct.std::_Deque_iterator.13"* %__tmp) #0
  %4 = call i8* @_ZNKSt15_Deque_iteratorIbRbPbEdeEv(%"struct.std::_Deque_iterator.13"* %__tmp) #0
  ret i8* %4
}
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE3endEv(%"struct.std::_Deque_iterator.13"* noalias sret %agg.result, %"class.std::deque.8"* %this) #3 align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::_Deque_base.9"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %4, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorIbRbPbEC2ERKS2_(%"struct.std::_Deque_iterator.13"* %agg.result, %"struct.std::_Deque_iterator.13"* %5) #0
  ret void
}
...
define linkonce_odr %"struct.std::_Deque_iterator.13"* @_ZNSt15_Deque_iteratorIbRbPbEmmEv(%"struct.std::_Deque_iterator.13"* %this) #3 align 2 {
  %1 = alloca %"struct.std::_Deque_iterator.13"*, align 8
  store %"struct.std::_Deque_iterator.13"* %this, %"struct.std::_Deque_iterator.13"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator.13"** %1
  %3 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 0
  %4 = load i8** %3, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 1
  %6 = load i8** %5, align 8
  %7 = icmp eq i8* %4, %6
  br i1 %7, label %8, label %15

; <label>:8                                       ; preds = %0
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 3
  %10 = load i8*** %9, align 8
  %11 = getelementptr inbounds i8** %10, i64 -1
  call void @_ZNSt15_Deque_iteratorIbRbPbE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator.13"* %2, i8** %11) #0
  %12 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 2
  %13 = load i8** %12, align 8
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 0
  store i8* %13, i8** %14, align 8
  br label %15

; <label>:15                                      ; preds = %8, %0
  %16 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 0
  %17 = load i8** %16, align 8
  %18 = getelementptr inbounds i8* %17, i32 -1
  store i8* %18, i8** %16, align 8
  ret %"struct.std::_Deque_iterator.13"* %2
}
...
define linkonce_odr void @_ZNSt15_Deque_iteratorIbRbPbEC2ERKS2_(%"struct.std::_Deque_iterator.13"* %this, %"struct.std::_Deque_iterator.13"* %__x) unnamed_addr #3 align 2 {
  ...
  %2 = alloca %"struct.std::_Deque_iterator.13"*, align 8
  store %"struct.std::_Deque_iterator.13"* %this, %"struct.std::_Deque_iterator.13"** %1, align 8
  store %"struct.std::_Deque_iterator.13"* %__x, %"struct.std::_Deque_iterator.13"** %2, align 8
  %3 = load %"struct.std::_Deque_iterator.13"** %1
  %4 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %3, i32 0, i32 0
  %5 = load %"struct.std::_Deque_iterator.13"** %2, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %5, i32 0, i32 0
  %7 = load i8** %6, align 8
  store i8* %7, i8** %4, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %3, i32 0, i32 1
  %9 = load %"struct.std::_Deque_iterator.13"** %2, align 8
  %10 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %9, i32 0, i32 1
  %11 = load i8** %10, align 8
  store i8* %11, i8** %8, align 8
  %12 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %3, i32 0, i32 2
  %13 = load %"struct.std::_Deque_iterator.13"** %2, align 8
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %13, i32 0, i32 2
  %15 = load i8** %14, align 8
  store i8* %15, i8** %12, align 8
  %16 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %3, i32 0, i32 3
  %17 = load %"struct.std::_Deque_iterator.13"** %2, align 8
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %17, i32 0, i32 3
  %19 = load i8*** %18, align 8
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE9push_backEOb(%"class.std::deque.8"* %this, i8* %__x) #3 align 2 {
  ...
  store %"class.std::deque.8"* %this, %"class.std::deque.8"** %1, align 8
  store i8* %__x, i8** %2, align 8
  %3 = load %"class.std::deque.8"** %1
  %4 = load i8** %2, align 8
  %5 = call i8* @_ZSt4moveIRbEONSt16remove_referenceIT_E4typeEOS2_(i8* %4) #0
  call void @_ZNSt5dequeIbSaIbEE12emplace_backIJbEEEvDpOT_(%"class.std::deque.8"* %3, i8* %5)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE12emplace_backIJbEEEvDpOT_(%"class.std::deque.8"* %this, i8* %__args) #3 align 2 {
  ...
  %5 = getelementptr inbounds %"class.std::_Deque_base.9"* %4, i32 0, i32 0
  %6 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %5, i32 0, i32 3
  %7 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %6, i32 0, i32 0
  %8 = load i8** %7, align 8
  %9 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %10 = getelementptr inbounds %"class.std::_Deque_base.9"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %10, i32 0, i32 3
  %12 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %11, i32 0, i32 2
  %13 = load i8** %12, align 8
...
; <label>:16                                      ; preds = %0
  ...
  %18 = getelementptr inbounds %"class.std::_Deque_base.9"* %17, i32 0, i32 0
  %19 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %18 to %"class.std::allocator.10"*
  %20 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %21 = getelementptr inbounds %"class.std::_Deque_base.9"* %20, i32 0, i32 0
  %22 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %21, i32 0, i32 3
  %23 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %22, i32 0, i32 0
  %24 = load i8** %23, align 8
  %25 = load i8** %2, align 8
  %26 = call i8* @_ZSt7forwardIbEOT_RNSt16remove_referenceIS0_E4typeE(i8* %25) #0
  call void @_ZNSt16allocator_traitsISaIbEE9constructIbJbEEEvRS0_PT_DpOT0_(%"class.std::allocator.10"* %19, i8* %24, i8* %26)
  %27 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %28 = getelementptr inbounds %"class.std::_Deque_base.9"* %27, i32 0, i32 0
  %29 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %28, i32 0, i32 3
  %30 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %29, i32 0, i32 0
...
; <label>:33                                      ; preds = %0
  ...
  %35 = call i8* @_ZSt7forwardIbEOT_RNSt16remove_referenceIS0_E4typeE(i8* %34) #0
  call void @_ZNSt5dequeIbSaIbEE16_M_push_back_auxIJbEEEvDpOT_(%"class.std::deque.8"* %3, i8* %35)
  br label %36
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIbEE9constructIbJbEEEvRS0_PT_DpOT0_(%"class.std::allocator.10"* %__a, i8* %__p, i8* %__args) #3 align 2 {
  ...
  %6 = load i8** %2, align 8
  %7 = load i8** %3, align 8
  %8 = call i8* @_ZSt7forwardIbEOT_RNSt16remove_referenceIS0_E4typeE(i8* %7) #0
  call void @_ZN9__gnu_cxx13new_allocatorIbE9constructIbJbEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.11"* %5, i8* %6, i8* %8)
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE16_M_push_back_auxIJbEEEvDpOT_(%"class.std::deque.8"* %this, i8* %__args) #3 align 2 {
  ...
  store i8* %__args, i8** %2, align 8
  %3 = load %"class.std::deque.8"** %1
  call void @_ZNSt5dequeIbSaIbEE22_M_reserve_map_at_backEm(%"class.std::deque.8"* %3, i64 1)
  %4 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %5 = call i8* @_ZNSt11_Deque_baseIbSaIbEE16_M_allocate_nodeEv(%"class.std::_Deque_base.9"* %4)
  %6 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %7 = getelementptr inbounds %"class.std::_Deque_base.9"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %7, i32 0, i32 3
  %9 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %8, i32 0, i32 3
  %10 = load i8*** %9, align 8
  %11 = getelementptr inbounds i8** %10, i64 1
  store i8* %5, i8** %11, align 8
  %12 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %13 = getelementptr inbounds %"class.std::_Deque_base.9"* %12, i32 0, i32 0
  %14 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %13 to %"class.std::allocator.10"*
  %15 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %16 = getelementptr inbounds %"class.std::_Deque_base.9"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %16, i32 0, i32 3
  %18 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %17, i32 0, i32 0
  %19 = load i8** %18, align 8
  %20 = load i8** %2, align 8
  %21 = call i8* @_ZSt7forwardIbEOT_RNSt16remove_referenceIS0_E4typeE(i8* %20) #0
  call void @_ZNSt16allocator_traitsISaIbEE9constructIbJbEEEvRS0_PT_DpOT0_(%"class.std::allocator.10"* %14, i8* %19, i8* %21)
  %22 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %23 = getelementptr inbounds %"class.std::_Deque_base.9"* %22, i32 0, i32 0
  %24 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %23, i32 0, i32 3
  %25 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %26 = getelementptr inbounds %"class.std::_Deque_base.9"* %25, i32 0, i32 0
  %27 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %26, i32 0, i32 3
  %28 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %27, i32 0, i32 3
  %29 = load i8*** %28, align 8
  %30 = getelementptr inbounds i8** %29, i64 1
  call void @_ZNSt15_Deque_iteratorIbRbPbE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator.13"* %24, i8** %30) #0
  %31 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %32 = getelementptr inbounds %"class.std::_Deque_base.9"* %31, i32 0, i32 0
  %33 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %32, i32 0, i32 3
  %34 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %33, i32 0, i32 1
  %35 = load i8** %34, align 8
  %36 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %37 = getelementptr inbounds %"class.std::_Deque_base.9"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %37, i32 0, i32 3
  %39 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %38, i32 0, i32 0
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE22_M_reserve_map_at_backEm(%"class.std::deque.8"* %this, i64 %__nodes_to_add) #3 align 2 {
  ...
  %6 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %7 = getelementptr inbounds %"class.std::_Deque_base.9"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %7, i32 0, i32 1
  %9 = load i64* %8, align 8
  %10 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %11 = getelementptr inbounds %"class.std::_Deque_base.9"* %10, i32 0, i32 0
  %12 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %11, i32 0, i32 3
  %13 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %12, i32 0, i32 3
  %14 = load i8*** %13, align 8
  %15 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %16 = getelementptr inbounds %"class.std::_Deque_base.9"* %15, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %16, i32 0, i32 0
...
; <label>:25                                      ; preds = %0
  ...
  call void @_ZNSt5dequeIbSaIbEE17_M_reallocate_mapEmb(%"class.std::deque.8"* %3, i64 %26, i1 zeroext false)
  br label %27
...
define linkonce_odr i8* @_ZNSt11_Deque_baseIbSaIbEE16_M_allocate_nodeEv(%"class.std::_Deque_base.9"* %this) #3 align 2 {
  ...
  %3 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  %4 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3 to %"class.std::allocator.10"*
  %5 = call i64 @_ZSt16__deque_buf_sizem(i64 1)
  %6 = call i8* @_ZNSt16allocator_traitsISaIbEE8allocateERS0_m(%"class.std::allocator.10"* %4, i64 %5)
  ret i8* %6
}
...
define linkonce_odr i8* @_ZNSt16allocator_traitsISaIbEE8allocateERS0_m(%"class.std::allocator.10"* %__a, i64 %__n) #3 align 2 {
  ...
  %4 = bitcast %"class.std::allocator.10"* %3 to %"class.__gnu_cxx::new_allocator.11"*
  %5 = load i64* %2, align 8
  %6 = call i8* @_ZN9__gnu_cxx13new_allocatorIbE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.11"* %4, i64 %5, i8* null)
  ret i8* %6
}
...
define linkonce_odr i8* @_ZN9__gnu_cxx13new_allocatorIbE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.11"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.11"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIbE8max_sizeEv(%"class.__gnu_cxx::new_allocator.11"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE17_M_reallocate_mapEmb(%"class.std::deque.8"* %this, i64 %__nodes_to_add, i1 zeroext %__add_at_front) #3 align 2 {
  ...
  %12 = getelementptr inbounds %"class.std::_Deque_base.9"* %11, i32 0, i32 0
  %13 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %12, i32 0, i32 2
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %13, i32 0, i32 3
  %15 = load i8*** %14, align 8
  ...
  %24 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %25 = getelementptr inbounds %"class.std::_Deque_base.9"* %24, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %25, i32 0, i32 1
...
; <label>:31                                      ; preds = %0
  %32 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %33 = getelementptr inbounds %"class.std::_Deque_base.9"* %32, i32 0, i32 0
  %34 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %33, i32 0, i32 0
  %35 = load i8*** %34, align 8
  %36 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %37 = getelementptr inbounds %"class.std::_Deque_base.9"* %36, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %37, i32 0, i32 1
  %39 = load i64* %38, align 8
  %40 = load i64* %__new_num_nodes, align 8
  %41 = sub i64 %39, %40
  %42 = udiv i64 %41, 2
  %43 = getelementptr inbounds i8** %35, i64 %42
...
; <label>:49                                      ; preds = %48, %46
  ...
  %51 = getelementptr inbounds i8** %43, i64 %50
  store i8** %51, i8*** %__new_nstart, align 8
  %52 = load i8*** %__new_nstart, align 8
  %53 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %54 = getelementptr inbounds %"class.std::_Deque_base.9"* %53, i32 0, i32 0
  %55 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %54, i32 0, i32 2
  %56 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %55, i32 0, i32 3
  %57 = load i8*** %56, align 8
  %58 = icmp ult i8** %52, %57
  br i1 %58, label %59, label %73

; <label>:59                                      ; preds = %49
  %60 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %61 = getelementptr inbounds %"class.std::_Deque_base.9"* %60, i32 0, i32 0
  %62 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %61, i32 0, i32 2
  %63 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %62, i32 0, i32 3
  %64 = load i8*** %63, align 8
  %65 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %66 = getelementptr inbounds %"class.std::_Deque_base.9"* %65, i32 0, i32 0
  %67 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %66, i32 0, i32 3
  %68 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %67, i32 0, i32 3
  %69 = load i8*** %68, align 8
  %70 = getelementptr inbounds i8** %69, i64 1
  %71 = load i8*** %__new_nstart, align 8
  %72 = call i8** @_ZSt4copyIPPbS1_ET0_T_S3_S2_(i8** %64, i8** %70, i8** %71)
  br label %89

; <label>:73                                      ; preds = %49
  %74 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %75 = getelementptr inbounds %"class.std::_Deque_base.9"* %74, i32 0, i32 0
  %76 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %75, i32 0, i32 2
  %77 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %76, i32 0, i32 3
  %78 = load i8*** %77, align 8
  %79 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %80 = getelementptr inbounds %"class.std::_Deque_base.9"* %79, i32 0, i32 0
  %81 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %80, i32 0, i32 3
  %82 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %81, i32 0, i32 3
  %83 = load i8*** %82, align 8
  %84 = getelementptr inbounds i8** %83, i64 1
  %85 = load i8*** %__new_nstart, align 8
  %86 = load i64* %__old_num_nodes, align 8
  %87 = getelementptr inbounds i8** %85, i64 %86
  %88 = call i8** @_ZSt13copy_backwardIPPbS1_ET0_T_S3_S2_(i8** %78, i8** %84, i8** %87)
  br label %89
...
; <label>:90                                      ; preds = %0
  %91 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %92 = getelementptr inbounds %"class.std::_Deque_base.9"* %91, i32 0, i32 0
  %93 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %92, i32 0, i32 1
  %94 = load i64* %93, align 8
  %95 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %96 = getelementptr inbounds %"class.std::_Deque_base.9"* %95, i32 0, i32 0
  %97 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %96, i32 0, i32 1
  %98 = call i64* @_ZSt3maxImERKT_S2_S2_(i64* %97, i64* %2)
  %99 = load i64* %98
  %100 = add i64 %94, %99
  %101 = add i64 %100, 2
  store i64 %101, i64* %__new_map_size, align 8
  %102 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %103 = load i64* %__new_map_size, align 8
  %104 = call i8** @_ZNSt11_Deque_baseIbSaIbEE15_M_allocate_mapEm(%"class.std::_Deque_base.9"* %102, i64 %103)
  store i8** %104, i8*** %__new_map, align 8
  %105 = load i8*** %__new_map, align 8
  %106 = load i64* %__new_map_size, align 8
  %107 = load i64* %__new_num_nodes, align 8
  %108 = sub i64 %106, %107
  %109 = udiv i64 %108, 2
  %110 = getelementptr inbounds i8** %105, i64 %109
...
; <label>:116                                     ; preds = %115, %113
  ...
  %118 = getelementptr inbounds i8** %110, i64 %117
  store i8** %118, i8*** %__new_nstart, align 8
  %119 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %120 = getelementptr inbounds %"class.std::_Deque_base.9"* %119, i32 0, i32 0
  %121 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %120, i32 0, i32 2
  %122 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %121, i32 0, i32 3
  %123 = load i8*** %122, align 8
  %124 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %125 = getelementptr inbounds %"class.std::_Deque_base.9"* %124, i32 0, i32 0
  %126 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %125, i32 0, i32 3
  %127 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %126, i32 0, i32 3
  %128 = load i8*** %127, align 8
  %129 = getelementptr inbounds i8** %128, i64 1
  %130 = load i8*** %__new_nstart, align 8
  %131 = call i8** @_ZSt4copyIPPbS1_ET0_T_S3_S2_(i8** %123, i8** %129, i8** %130)
  %132 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %133 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %134 = getelementptr inbounds %"class.std::_Deque_base.9"* %133, i32 0, i32 0
  %135 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %134, i32 0, i32 0
  %136 = load i8*** %135, align 8
  %137 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %138 = getelementptr inbounds %"class.std::_Deque_base.9"* %137, i32 0, i32 0
  %139 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %138, i32 0, i32 1
  %140 = load i64* %139, align 8
  call void @_ZNSt11_Deque_baseIbSaIbEE17_M_deallocate_mapEPPbm(%"class.std::_Deque_base.9"* %132, i8** %136, i64 %140) #0
  %141 = load i8*** %__new_map, align 8
  %142 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %143 = getelementptr inbounds %"class.std::_Deque_base.9"* %142, i32 0, i32 0
  %144 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %143, i32 0, i32 0
  store i8** %141, i8*** %144, align 8
  %145 = load i64* %__new_map_size, align 8
  %146 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %147 = getelementptr inbounds %"class.std::_Deque_base.9"* %146, i32 0, i32 0
  %148 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %147, i32 0, i32 1
  store i64 %145, i64* %148, align 8
  br label %149

; <label>:149                                     ; preds = %116, %89
  %150 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %151 = getelementptr inbounds %"class.std::_Deque_base.9"* %150, i32 0, i32 0
  %152 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %151, i32 0, i32 2
  %153 = load i8*** %__new_nstart, align 8
  call void @_ZNSt15_Deque_iteratorIbRbPbE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator.13"* %152, i8** %153) #0
  %154 = bitcast %"class.std::deque.8"* %5 to %"class.std::_Deque_base.9"*
  %155 = getelementptr inbounds %"class.std::_Deque_base.9"* %154, i32 0, i32 0
  %156 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %155, i32 0, i32 3
  %157 = load i8*** %__new_nstart, align 8
  %158 = load i64* %__old_num_nodes, align 8
  %159 = getelementptr inbounds i8** %157, i64 %158
  %160 = getelementptr inbounds i8** %159, i64 -1
  call void @_ZNSt15_Deque_iteratorIbRbPbE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator.13"* %156, i8** %160) #0
  ret void
}
...
define linkonce_odr i8** @_ZSt4copyIPPbS1_ET0_T_S3_S2_(i8** %__first, i8** %__last, i8** %__result) #5 {
  ...
  %4 = load i8*** %1, align 8
  %5 = call i8** @_ZSt12__miter_baseIPPbENSt11_Miter_baseIT_E13iterator_typeES3_(i8** %4)
  %6 = load i8*** %2, align 8
  %7 = call i8** @_ZSt12__miter_baseIPPbENSt11_Miter_baseIT_E13iterator_typeES3_(i8** %6)
  %8 = load i8*** %3, align 8
  %9 = call i8** @_ZSt14__copy_move_a2ILb0EPPbS1_ET1_T0_S3_S2_(i8** %5, i8** %7, i8** %8)
  ret i8** %9
}
...
define linkonce_odr i8** @_ZSt13copy_backwardIPPbS1_ET0_T_S3_S2_(i8** %__first, i8** %__last, i8** %__result) #5 {
  ...
  %7 = call i8** @_ZSt12__miter_baseIPPbENSt11_Miter_baseIT_E13iterator_typeES3_(i8** %6)
  %8 = load i8*** %3, align 8
  %9 = call i8** @_ZSt23__copy_move_backward_a2ILb0EPPbS1_ET1_T0_S3_S2_(i8** %5, i8** %7, i8** %8)
  ret i8** %9
}
...
define linkonce_odr i8** @_ZNSt11_Deque_baseIbSaIbEE15_M_allocate_mapEm(%"class.std::_Deque_base.9"* %this, i64 %__n) #3 align 2 {
  ...
  store %"class.std::_Deque_base.9"* %this, %"class.std::_Deque_base.9"** %1, align 8
  store i64 %__n, i64* %2, align 8
  %4 = load %"class.std::_Deque_base.9"** %1
  call void @_ZNKSt11_Deque_baseIbSaIbEE20_M_get_map_allocatorEv(%"class.std::allocator.14"* sret %__map_alloc, %"class.std::_Deque_base.9"* %4) #0
  %5 = load i64* %2, align 8
  %6 = call i8** @_ZNSt16allocator_traitsISaIPbEE8allocateERS1_m(%"class.std::allocator.14"* %__map_alloc, i64 %5)
  store i32 1, i32* %3
  call void @_ZNSaIPbED2Ev(%"class.std::allocator.14"* %__map_alloc) #0
  ret i8** %6
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE17_M_deallocate_mapEPPbm(%"class.std::_Deque_base.9"* %this, i8** %__p, i64 %__n) #3 align 2 {
  ...
  %5 = load i8*** %2, align 8
  %6 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIPbEE10deallocateERS1_PS0_m(%"class.std::allocator.14"* %__map_alloc, i8** %5, i64 %6)
  call void @_ZNSaIPbED2Ev(%"class.std::allocator.14"* %__map_alloc) #0
  ret void
}
...
define linkonce_odr void @_ZNKSt11_Deque_baseIbSaIbEE20_M_get_map_allocatorEv(%"class.std::allocator.14"* noalias sret %agg.result, %"class.std::_Deque_base.9"* %this) #3 align 2 {
  ...
  store %"class.std::_Deque_base.9"* %this, %"class.std::_Deque_base.9"** %1, align 8
  %2 = load %"class.std::_Deque_base.9"** %1
  %3 = call %"class.std::allocator.10"* @_ZNKSt11_Deque_baseIbSaIbEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base.9"* %2) #0
  call void @_ZNSaIPbEC2IbEERKSaIT_E(%"class.std::allocator.14"* %agg.result, %"class.std::allocator.10"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIPbEE10deallocateERS1_PS0_m(%"class.std::allocator.14"* %__a, i8** %__p, i64 %__n) #3 align 2 {
  ...
  %6 = load i8*** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIPbE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.15"* %5, i8** %6, i64 %7)
  ret void
}
...
define linkonce_odr void @_ZNSaIPbED2Ev(%"class.std::allocator.14"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIPbED2Ev(%"class.__gnu_cxx::new_allocator.15"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaIPbEC2IbEERKSaIT_E(%"class.std::allocator.14"* %this, %"class.std::allocator.10"*) unnamed_addr #3 align 2 {
  ...
  %5 = bitcast %"class.std::allocator.14"* %4 to %"class.__gnu_cxx::new_allocator.15"*
  call void @_ZN9__gnu_cxx13new_allocatorIPbEC2Ev(%"class.__gnu_cxx::new_allocator.15"* %5) #0
  ret void
}
...
define linkonce_odr i8** @_ZNSt16allocator_traitsISaIPbEE8allocateERS1_m(%"class.std::allocator.14"* %__a, i64 %__n) #3 align 2 {
  ...
  %5 = load i64* %2, align 8
  %6 = call i8** @_ZN9__gnu_cxx13new_allocatorIPbE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.15"* %4, i64 %5, i8* null)
  ret i8** %6
}
...
define linkonce_odr i8** @_ZN9__gnu_cxx13new_allocatorIPbE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.15"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.15"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIPbE8max_sizeEv(%"class.__gnu_cxx::new_allocator.15"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
define linkonce_odr i8** @_ZSt23__copy_move_backward_a2ILb0EPPbS1_ET1_T0_S3_S2_(i8** %__first, i8** %__last, i8** %__result) #5 {
  ...
  store i8** %__result, i8*** %3, align 8
  %4 = load i8*** %1, align 8
  %5 = call i8** @_ZSt12__niter_baseIPPbENSt11_Niter_baseIT_E13iterator_typeES3_(i8** %4)
  %6 = load i8*** %2, align 8
  %7 = call i8** @_ZSt12__niter_baseIPPbENSt11_Niter_baseIT_E13iterator_typeES3_(i8** %6)
  %8 = load i8*** %3, align 8
  %9 = call i8** @_ZSt12__niter_baseIPPbENSt11_Niter_baseIT_E13iterator_typeES3_(i8** %8)
  %10 = call i8** @_ZSt22__copy_move_backward_aILb0EPPbS1_ET1_T0_S3_S2_(i8** %5, i8** %7, i8** %9)
  ret i8** %10
}
...
define linkonce_odr i8** @_ZSt12__miter_baseIPPbENSt11_Miter_baseIT_E13iterator_typeES3_(i8** %__it) #5 {
  ...
  %2 = load i8*** %1, align 8
  %3 = call i8** @_ZNSt10_Iter_baseIPPbLb0EE7_S_baseES1_(i8** %2)
  ret i8** %3
}
...
define linkonce_odr i8** @_ZSt22__copy_move_backward_aILb0EPPbS1_ET1_T0_S3_S2_(i8** %__first, i8** %__last, i8** %__result) #5 {
  ...
  %5 = load i8*** %2, align 8
  %6 = load i8*** %3, align 8
  %7 = call i8** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIPbEEPT_PKS4_S7_S5_(i8** %4, i8** %5, i8** %6)
  ret i8** %7
}
...
define linkonce_odr i8** @_ZSt14__copy_move_a2ILb0EPPbS1_ET1_T0_S3_S2_(i8** %__first, i8** %__last, i8** %__result) #5 {
  ...
  %8 = load i8*** %3, align 8
  %9 = call i8** @_ZSt12__niter_baseIPPbENSt11_Niter_baseIT_E13iterator_typeES3_(i8** %8)
  %10 = call i8** @_ZSt13__copy_move_aILb0EPPbS1_ET1_T0_S3_S2_(i8** %5, i8** %7, i8** %9)
  ret i8** %10
}
...
define linkonce_odr i8** @_ZSt13__copy_move_aILb0EPPbS1_ET1_T0_S3_S2_(i8** %__first, i8** %__last, i8** %__result) #5 {
  ...
  %5 = load i8*** %2, align 8
  %6 = load i8*** %3, align 8
  %7 = call i8** @_ZNSt11__copy_moveILb0ELb1ESt26random_access_iterator_tagE8__copy_mIPbEEPT_PKS4_S7_S5_(i8** %4, i8** %5, i8** %6)
  ret i8** %7
}
...
; <label>:7                                       ; preds = %0
  %8 = load i8** %3, align 8
  %9 = call i8* @_ZSt7forwardIbEOT_RNSt16remove_referenceIS0_E4typeE(i8* %8) #0
  %10 = load i8* %9
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE15_M_destroy_dataESt15_Deque_iteratorIbRbPbES5_RKS0_(%"class.std::deque.8"* %this, %"struct.std::_Deque_iterator.13"* %__first, %"struct.std::_Deque_iterator.13"* %__last, %"class.std::allocator.10"*) #3 align 2 {
  %2 = alloca %"class.std::deque.8"*, align 8
  %3 = alloca %"class.std::allocator.10"*, align 8
  store %"class.std::deque.8"* %this, %"class.std::deque.8"** %2, align 8
  store %"class.std::allocator.10"* %0, %"class.std::allocator.10"** %3, align 8
  %4 = load %"class.std::deque.8"** %2
  ret void
}
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEE5beginEv(%"struct.std::_Deque_iterator.13"* noalias sret %agg.result, %"class.std::deque.8"* %this) #3 align 2 {
  ...
  %3 = bitcast %"class.std::deque.8"* %2 to %"class.std::_Deque_base.9"*
  %4 = getelementptr inbounds %"class.std::_Deque_base.9"* %3, i32 0, i32 0
  %5 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %4, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorIbRbPbEC2ERKS2_(%"struct.std::_Deque_iterator.13"* %agg.result, %"struct.std::_Deque_iterator.13"* %5) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEED2Ev(%"class.std::_Deque_base.9"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::_Deque_base.9"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  %4 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 0
  %5 = load i8*** %4, align 8
  %6 = icmp ne i8** %5, null
  br i1 %6, label %7, label %23

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  %9 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %8, i32 0, i32 2
  %10 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %9, i32 0, i32 3
  %11 = load i8*** %10, align 8
  %12 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  %13 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %12, i32 0, i32 3
  %14 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %13, i32 0, i32 3
  %15 = load i8*** %14, align 8
  %16 = getelementptr inbounds i8** %15, i64 1
  call void @_ZNSt11_Deque_baseIbSaIbEE16_M_destroy_nodesEPPbS3_(%"class.std::_Deque_base.9"* %2, i8** %11, i8** %16) #0
  %17 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  %18 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %17, i32 0, i32 0
  %19 = load i8*** %18, align 8
  %20 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %20, i32 0, i32 1
  %22 = load i64* %21, align 8
  call void @_ZNSt11_Deque_baseIbSaIbEE17_M_deallocate_mapEPPbm(%"class.std::_Deque_base.9"* %2, i8** %19, i64 %22) #0
  br label %23

; <label>:23                                      ; preds = %7, %0
  %24 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  call void @_ZNSt11_Deque_baseIbSaIbEE11_Deque_implD2Ev(%"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %24) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE16_M_destroy_nodesEPPbS3_(%"class.std::_Deque_base.9"* %this, i8** %__nstart, i8** %__nfinish) #3 align 2 {
  ...
  store %"class.std::_Deque_base.9"* %this, %"class.std::_Deque_base.9"** %1, align 8
  store i8** %__nstart, i8*** %2, align 8
  store i8** %__nfinish, i8*** %3, align 8
  %4 = load %"class.std::_Deque_base.9"** %1
  %5 = load i8*** %2, align 8
  store i8** %5, i8*** %__n, align 8
  br label %6

; <label>:6                                       ; preds = %13, %0
  %7 = load i8*** %__n, align 8
  %8 = load i8*** %3, align 8
  %9 = icmp ult i8** %7, %8
  br i1 %9, label %10, label %16

; <label>:10                                      ; preds = %6
  %11 = load i8*** %__n, align 8
  %12 = load i8** %11, align 8
  call void @_ZNSt11_Deque_baseIbSaIbEE18_M_deallocate_nodeEPb(%"class.std::_Deque_base.9"* %4, i8* %12) #0
  br label %13

; <label>:13                                      ; preds = %10
  %14 = load i8*** %__n, align 8
  %15 = getelementptr inbounds i8** %14, i32 1
  store i8** %15, i8*** %__n, align 8
  br label %6
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE11_Deque_implD2Ev(%"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %this, %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %1, align 8
  %2 = load %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %2 to %"class.std::allocator.10"*
  call void @_ZNSaIbED2Ev(%"class.std::allocator.10"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSaIbED2Ev(%"class.std::allocator.10"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIbED2Ev(%"class.__gnu_cxx::new_allocator.11"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEEC2Ev(%"class.std::_Deque_base.9"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::_Deque_base.9"** %1
  %3 = getelementptr inbounds %"class.std::_Deque_base.9"* %2, i32 0, i32 0
  call void @_ZNSt11_Deque_baseIbSaIbEE11_Deque_implC2Ev(%"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3)
  call void @_ZNSt11_Deque_baseIbSaIbEE17_M_initialize_mapEm(%"class.std::_Deque_base.9"* %2, i64 0)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE11_Deque_implC2Ev(%"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %1
  %3 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %2 to %"class.std::allocator.10"*
  call void @_ZNSaIbEC2Ev(%"class.std::allocator.10"* %3) #0
  %4 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %2, i32 0, i32 0
  store i8** null, i8*** %4, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %2, i32 0, i32 1
  store i64 0, i64* %5, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %2, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorIbRbPbEC2Ev(%"struct.std::_Deque_iterator.13"* %6) #0
  %7 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %2, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorIbRbPbEC2Ev(%"struct.std::_Deque_iterator.13"* %7) #0
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE17_M_initialize_mapEm(%"class.std::_Deque_base.9"* %this, i64 %__num_elements) #3 align 2 {
  ...
  %5 = load %"class.std::_Deque_base.9"** %1
  ...
  %13 = load i64* %12
  %14 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %15 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %14, i32 0, i32 1
  store i64 %13, i64* %15, align 8
  %16 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %17 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %16, i32 0, i32 1
  %18 = load i64* %17, align 8
  %19 = call i8** @_ZNSt11_Deque_baseIbSaIbEE15_M_allocate_mapEm(%"class.std::_Deque_base.9"* %5, i64 %18)
  %20 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %21 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %20, i32 0, i32 0
  store i8** %19, i8*** %21, align 8
  %22 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %23 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %22, i32 0, i32 0
  %24 = load i8*** %23, align 8
  %25 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %26 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %25, i32 0, i32 1
  %27 = load i64* %26, align 8
  %28 = load i64* %__num_nodes, align 8
  %29 = sub i64 %27, %28
  %30 = udiv i64 %29, 2
  %31 = getelementptr inbounds i8** %24, i64 %30
  store i8** %31, i8*** %__nstart, align 8
  %32 = load i8*** %__nstart, align 8
  %33 = load i64* %__num_nodes, align 8
  %34 = getelementptr inbounds i8** %32, i64 %33
  store i8** %34, i8*** %__nfinish, align 8
  %35 = load i8*** %__nstart, align 8
  %36 = load i8*** %__nfinish, align 8
  call void @_ZNSt11_Deque_baseIbSaIbEE15_M_create_nodesEPPbS3_(%"class.std::_Deque_base.9"* %5, i8** %35, i8** %36)
  %37 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %38 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %37, i32 0, i32 2
  %39 = load i8*** %__nstart, align 8
  call void @_ZNSt15_Deque_iteratorIbRbPbE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator.13"* %38, i8** %39) #0
  %40 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %41 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %40, i32 0, i32 3
  %42 = load i8*** %__nfinish, align 8
  %43 = getelementptr inbounds i8** %42, i64 -1
  call void @_ZNSt15_Deque_iteratorIbRbPbE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator.13"* %41, i8** %43) #0
  %44 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %45 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %44, i32 0, i32 2
  %46 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %45, i32 0, i32 1
  %47 = load i8** %46, align 8
  %48 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %49 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %48, i32 0, i32 2
  %50 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %49, i32 0, i32 0
  store i8* %47, i8** %50, align 8
  %51 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %52 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %51, i32 0, i32 3
  %53 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %52, i32 0, i32 1
  %54 = load i8** %53, align 8
  %55 = load i64* %2, align 8
  %56 = call i64 @_ZSt16__deque_buf_sizem(i64 1)
  %57 = urem i64 %55, %56
  %58 = getelementptr inbounds i8* %54, i64 %57
  %59 = getelementptr inbounds %"class.std::_Deque_base.9"* %5, i32 0, i32 0
  %60 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %59, i32 0, i32 3
  %61 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %60, i32 0, i32 0
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE15_M_create_nodesEPPbS3_(%"class.std::_Deque_base.9"* %this, i8** %__nstart, i8** %__nfinish) #3 align 2 {
  ...
  %4 = load %"class.std::_Deque_base.9"** %1
  %5 = load i8*** %2, align 8
  store i8** %5, i8*** %__cur, align 8
  br label %6

; <label>:6                                       ; preds = %13, %0
  %7 = load i8*** %__cur, align 8
  %8 = load i8*** %3, align 8
  %9 = icmp ult i8** %7, %8
  br i1 %9, label %10, label %16

; <label>:10                                      ; preds = %6
  %11 = call i8* @_ZNSt11_Deque_baseIbSaIbEE16_M_allocate_nodeEv(%"class.std::_Deque_base.9"* %4)
  %12 = load i8*** %__cur, align 8
  store i8* %11, i8** %12, align 8
  br label %13

; <label>:13                                      ; preds = %10
  %14 = load i8*** %__cur, align 8
  %15 = getelementptr inbounds i8** %14, i32 1
  store i8** %15, i8*** %__cur, align 8
  br label %6
...
define linkonce_odr void @_ZNSaIbEC2Ev(%"class.std::allocator.10"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::allocator.10"** %1
  %3 = bitcast %"class.std::allocator.10"* %2 to %"class.__gnu_cxx::new_allocator.11"*
  call void @_ZN9__gnu_cxx13new_allocatorIbEC2Ev(%"class.__gnu_cxx::new_allocator.11"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt15_Deque_iteratorIbRbPbEC2Ev(%"struct.std::_Deque_iterator.13"* %this) unnamed_addr #3 align 2 {
  ...
  %4 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 1
  store i8* null, i8** %4, align 8
  %5 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 2
  store i8* null, i8** %5, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_iterator.13"* %2, i32 0, i32 3
...
define linkonce_odr void @_ZNSt5dequeIbSaIbEEC2EOS1_(%"class.std::deque.8"* %this, %"class.std::deque.8"* %__x) unnamed_addr #3 align 2 {
  ...
  %2 = alloca %"class.std::deque.8"*, align 8
  store %"class.std::deque.8"* %this, %"class.std::deque.8"** %1, align 8
  store %"class.std::deque.8"* %__x, %"class.std::deque.8"** %2, align 8
  %3 = load %"class.std::deque.8"** %1
  %4 = bitcast %"class.std::deque.8"* %3 to %"class.std::_Deque_base.9"*
  %5 = load %"class.std::deque.8"** %2, align 8
  %6 = call %"class.std::deque.8"* @_ZSt4moveIRSt5dequeIbSaIbEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::deque.8"* %5) #0
  %7 = bitcast %"class.std::deque.8"* %6 to %"class.std::_Deque_base.9"*
  call void @_ZNSt11_Deque_baseIbSaIbEEC2EOS1_(%"class.std::_Deque_base.9"* %4, %"class.std::_Deque_base.9"* %7)
  ret void
}
...
define linkonce_odr %"class.std::deque.8"* @_ZSt4moveIRSt5dequeIbSaIbEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::deque.8"* %__t) #3 {
  %1 = alloca %"class.std::deque.8"*, align 8
  store %"class.std::deque.8"* %__t, %"class.std::deque.8"** %1, align 8
  %2 = load %"class.std::deque.8"** %1, align 8
  ret %"class.std::deque.8"* %2
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEEC2EOS1_(%"class.std::_Deque_base.9"* %this, %"class.std::_Deque_base.9"* %__x) unnamed_addr #3 align 2 {
  ...
  store %"class.std::_Deque_base.9"* %this, %"class.std::_Deque_base.9"** %1, align 8
  store %"class.std::_Deque_base.9"* %__x, %"class.std::_Deque_base.9"** %2, align 8
  %5 = load %"class.std::_Deque_base.9"** %1
  %6 = load %"class.std::_Deque_base.9"** %2, align 8
  %7 = call %"class.std::_Deque_base.9"* @_ZSt4moveIRSt11_Deque_baseIbSaIbEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::_Deque_base.9"* %6) #0
  %8 = bitcast %"struct.__gnu_cxx::__allocator_always_compares_equal"* %4 to %"struct.std::integral_constant"*
  call void @_ZNSt11_Deque_baseIbSaIbEEC2EOS1_St17integral_constantIbLb1EE(%"class.std::_Deque_base.9"* %5, %"class.std::_Deque_base.9"* %7)
  ret void
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEEC2EOS1_St17integral_constantIbLb1EE(%"class.std::_Deque_base.9"* %this, %"class.std::_Deque_base.9"* %__x) unnamed_addr #3 align 2 {
  ...
  %5 = getelementptr inbounds %"class.std::_Deque_base.9"* %4, i32 0, i32 0
  %6 = load %"class.std::_Deque_base.9"** %2, align 8
  %7 = call %"class.std::allocator.10"* @_ZNSt11_Deque_baseIbSaIbEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base.9"* %6) #0
  %8 = call %"class.std::allocator.10"* @_ZSt4moveIRSaIbEEONSt16remove_referenceIT_E4typeEOS3_(%"class.std::allocator.10"* %7) #0
  call void @_ZNSt11_Deque_baseIbSaIbEE11_Deque_implC2EOS0_(%"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %5, %"class.std::allocator.10"* %8) #0
  call void @_ZNSt11_Deque_baseIbSaIbEE17_M_initialize_mapEm(%"class.std::_Deque_base.9"* %4, i64 0)
  %9 = load %"class.std::_Deque_base.9"** %2, align 8
  %10 = getelementptr inbounds %"class.std::_Deque_base.9"* %9, i32 0, i32 0
  %11 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %10, i32 0, i32 0
  %12 = load i8*** %11, align 8
  %13 = icmp ne i8** %12, null
  br i1 %13, label %14, label %18

; <label>:14                                      ; preds = %0
  %15 = getelementptr inbounds %"class.std::_Deque_base.9"* %4, i32 0, i32 0
  %16 = load %"class.std::_Deque_base.9"** %2, align 8
  %17 = getelementptr inbounds %"class.std::_Deque_base.9"* %16, i32 0, i32 0
  call void @_ZNSt11_Deque_baseIbSaIbEE11_Deque_impl12_M_swap_dataERS2_(%"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %15, %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %17) #0
  br label %18
...
define linkonce_odr %"class.std::_Deque_base.9"* @_ZSt4moveIRSt11_Deque_baseIbSaIbEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::_Deque_base.9"* %__t) #3 {
  %1 = alloca %"class.std::_Deque_base.9"*, align 8
  store %"class.std::_Deque_base.9"* %__t, %"class.std::_Deque_base.9"** %1, align 8
  %2 = load %"class.std::_Deque_base.9"** %1, align 8
  ret %"class.std::_Deque_base.9"* %2
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE11_Deque_implC2EOS0_(%"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %this, %"class.std::allocator.10"* %__a) unnamed_addr #3 align 2 {
  ...
  %3 = load %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %1
  %4 = bitcast %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3 to %"class.std::allocator.10"*
  %5 = load %"class.std::allocator.10"** %2, align 8
  %6 = call %"class.std::allocator.10"* @_ZSt4moveIRSaIbEEONSt16remove_referenceIT_E4typeEOS3_(%"class.std::allocator.10"* %5) #0
  call void @_ZNSaIbEC2ERKS_(%"class.std::allocator.10"* %4, %"class.std::allocator.10"* %6) #0
  %7 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 0
  store i8** null, i8*** %7, align 8
  %8 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 1
  store i64 0, i64* %8, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 2
  call void @_ZNSt15_Deque_iteratorIbRbPbEC2Ev(%"struct.std::_Deque_iterator.13"* %9) #0
  %10 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 3
  call void @_ZNSt15_Deque_iteratorIbRbPbEC2Ev(%"struct.std::_Deque_iterator.13"* %10) #0
  ret void
}
...
define linkonce_odr %"class.std::allocator.10"* @_ZSt4moveIRSaIbEEONSt16remove_referenceIT_E4typeEOS3_(%"class.std::allocator.10"* %__t) #3 {
  %1 = alloca %"class.std::allocator.10"*, align 8
  store %"class.std::allocator.10"* %__t, %"class.std::allocator.10"** %1, align 8
...
define linkonce_odr void @_ZNSt11_Deque_baseIbSaIbEE11_Deque_impl12_M_swap_dataERS2_(%"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %this, %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %__x) #3 align 2 {
  %1 = alloca %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"*, align 8
  %2 = alloca %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"*, align 8
  store %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %this, %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %1, align 8
  store %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %__x, %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %2, align 8
  %3 = load %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %1
  %4 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 2
  %5 = load %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %2, align 8
  %6 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %5, i32 0, i32 2
  call void @_ZSt4swapISt15_Deque_iteratorIbRbPbEEvRT_S5_(%"struct.std::_Deque_iterator.13"* %4, %"struct.std::_Deque_iterator.13"* %6) #0
  %7 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 3
  %8 = load %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %2, align 8
  %9 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %8, i32 0, i32 3
  call void @_ZSt4swapISt15_Deque_iteratorIbRbPbEEvRT_S5_(%"struct.std::_Deque_iterator.13"* %7, %"struct.std::_Deque_iterator.13"* %9) #0
  %10 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 0
  %11 = load %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %2, align 8
  %12 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %11, i32 0, i32 0
  call void @_ZSt4swapIPPbEvRT_S3_(i8*** %10, i8*** %12) #0
  %13 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %3, i32 0, i32 1
  %14 = load %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"** %2, align 8
  %15 = getelementptr inbounds %"struct.std::_Deque_base<bool, std::allocator<bool> >::_Deque_impl"* %14, i32 0, i32 1
...
define linkonce_odr void @_ZSt4swapISt15_Deque_iteratorIbRbPbEEvRT_S5_(%"struct.std::_Deque_iterator.13"* %__a, %"struct.std::_Deque_iterator.13"* %__b) #5 {
  ...
  %2 = alloca %"struct.std::_Deque_iterator.13"*, align 8
  %__tmp = alloca %"struct.std::_Deque_iterator.13", align 8
  store %"struct.std::_Deque_iterator.13"* %__a, %"struct.std::_Deque_iterator.13"** %1, align 8
  store %"struct.std::_Deque_iterator.13"* %__b, %"struct.std::_Deque_iterator.13"** %2, align 8
  %3 = load %"struct.std::_Deque_iterator.13"** %1, align 8
  %4 = call %"struct.std::_Deque_iterator.13"* @_ZSt4moveIRSt15_Deque_iteratorIbRbPbEEONSt16remove_referenceIT_E4typeEOS6_(%"struct.std::_Deque_iterator.13"* %3) #0
  call void @_ZNSt15_Deque_iteratorIbRbPbEC2ERKS2_(%"struct.std::_Deque_iterator.13"* %__tmp, %"struct.std::_Deque_iterator.13"* %4) #0
  %5 = load %"struct.std::_Deque_iterator.13"** %1, align 8
  %6 = load %"struct.std::_Deque_iterator.13"** %2, align 8
  %7 = call %"struct.std::_Deque_iterator.13"* @_ZSt4moveIRSt15_Deque_iteratorIbRbPbEEONSt16remove_referenceIT_E4typeEOS6_(%"struct.std::_Deque_iterator.13"* %6) #0
  %8 = bitcast %"struct.std::_Deque_iterator.13"* %5 to i8*
  %9 = bitcast %"struct.std::_Deque_iterator.13"* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* %9, i64 32, i32 8, i1 false)
  %10 = load %"struct.std::_Deque_iterator.13"** %2, align 8
  %11 = call %"struct.std::_Deque_iterator.13"* @_ZSt4moveIRSt15_Deque_iteratorIbRbPbEEONSt16remove_referenceIT_E4typeEOS6_(%"struct.std::_Deque_iterator.13"* %__tmp) #0
  %12 = bitcast %"struct.std::_Deque_iterator.13"* %10 to i8*
...
define linkonce_odr void @_ZSt4swapIPPbEvRT_S3_(i8*** %__a, i8*** %__b) #5 {
  ...
  %3 = load i8**** %1, align 8
  %4 = call i8*** @_ZSt4moveIRPPbEONSt16remove_referenceIT_E4typeEOS4_(i8*** %3) #0
  %5 = load i8*** %4
  store i8** %5, i8*** %__tmp, align 8
  %6 = load i8**** %2, align 8
  %7 = call i8*** @_ZSt4moveIRPPbEONSt16remove_referenceIT_E4typeEOS4_(i8*** %6) #0
  %8 = load i8*** %7
  %9 = load i8**** %1, align 8
  store i8** %8, i8*** %9, align 8
  %10 = call i8*** @_ZSt4moveIRPPbEONSt16remove_referenceIT_E4typeEOS4_(i8*** %__tmp) #0
  %11 = load i8*** %10
...
define linkonce_odr %"struct.std::_Deque_iterator.13"* @_ZSt4moveIRSt15_Deque_iteratorIbRbPbEEONSt16remove_referenceIT_E4typeEOS6_(%"struct.std::_Deque_iterator.13"* %__t) #3 {
  %1 = alloca %"struct.std::_Deque_iterator.13"*, align 8
  store %"struct.std::_Deque_iterator.13"* %__t, %"struct.std::_Deque_iterator.13"** %1, align 8
  %2 = load %"struct.std::_Deque_iterator.13"** %1, align 8
  ret %"struct.std::_Deque_iterator.13"* %2
}
...
define linkonce_odr void @_ZNSaIbEC2ERKS_(%"class.std::allocator.10"* %this, %"class.std::allocator.10"* %__a) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIbEC2ERKS1_(%"class.__gnu_cxx::new_allocator.11"* %4, %"class.__gnu_cxx::new_allocator.11"* %6) #0
  ret void
}
...
define linkonce_odr %struct.TreeNode*** @_ZNSt11_Deque_baseIP8TreeNodeSaIS1_EE15_M_allocate_mapEm(%"class.std::_Deque_base"* %this, i64 %__n) #3 align 2 {
  %1 = alloca %"class.std::_Deque_base"*, align 8
  %2 = alloca i64, align 8
  %__map_alloc = alloca %"class.std::allocator.17", align 1
  %3 = alloca i32
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  store i64 %__n, i64* %2, align 8
  %4 = load %"class.std::_Deque_base"** %1
  call void @_ZNKSt11_Deque_baseIP8TreeNodeSaIS1_EE20_M_get_map_allocatorEv(%"class.std::allocator.17"* sret %__map_alloc, %"class.std::_Deque_base"* %4) #0
  %5 = load i64* %2, align 8
  %6 = call %struct.TreeNode*** @_ZNSt16allocator_traitsISaIPP8TreeNodeEE8allocateERS3_m(%"class.std::allocator.17"* %__map_alloc, i64 %5)
  store i32 1, i32* %3
  call void @_ZNSaIPP8TreeNodeED2Ev(%"class.std::allocator.17"* %__map_alloc) #0
  ret %struct.TreeNode*** %6
}
...
define linkonce_odr void @_ZNSt11_Deque_baseIP8TreeNodeSaIS1_EE17_M_deallocate_mapEPPS1_m(%"class.std::_Deque_base"* %this, %struct.TreeNode*** %__p, i64 %__n) #3 align 2 {
  ...
  %5 = load %struct.TreeNode**** %2, align 8
  %6 = load i64* %3, align 8
  call void @_ZNSt16allocator_traitsISaIPP8TreeNodeEE10deallocateERS3_PS2_m(%"class.std::allocator.17"* %__map_alloc, %struct.TreeNode*** %5, i64 %6)
  call void @_ZNSaIPP8TreeNodeED2Ev(%"class.std::allocator.17"* %__map_alloc) #0
  ret void
}
...
define linkonce_odr void @_ZNKSt11_Deque_baseIP8TreeNodeSaIS1_EE20_M_get_map_allocatorEv(%"class.std::allocator.17"* noalias sret %agg.result, %"class.std::_Deque_base"* %this) #3 align 2 {
  ...
  call void @_ZNSaIPP8TreeNodeEC2IS0_EERKSaIT_E(%"class.std::allocator.17"* %agg.result, %"class.std::allocator.4"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIPP8TreeNodeEE10deallocateERS3_PS2_m(%"class.std::allocator.17"* %__a, %struct.TreeNode*** %__p, i64 %__n) #3 align 2 {
  %1 = alloca %"class.std::allocator.17"*, align 8
  %2 = alloca %struct.TreeNode***, align 8
  %3 = alloca i64, align 8
  store %"class.std::allocator.17"* %__a, %"class.std::allocator.17"** %1, align 8
  store %struct.TreeNode*** %__p, %struct.TreeNode**** %2, align 8
  store i64 %__n, i64* %3, align 8
  %4 = load %"class.std::allocator.17"** %1, align 8
  %5 = bitcast %"class.std::allocator.17"* %4 to %"class.__gnu_cxx::new_allocator.18"*
  %6 = load %struct.TreeNode**** %2, align 8
  %7 = load i64* %3, align 8
  call void @_ZN9__gnu_cxx13new_allocatorIPP8TreeNodeE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.18"* %5, %struct.TreeNode*** %6, i64 %7)
  ret void
}
...
define linkonce_odr void @_ZNSaIPP8TreeNodeED2Ev(%"class.std::allocator.17"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.std::allocator.17"*, align 8
  store %"class.std::allocator.17"* %this, %"class.std::allocator.17"** %1, align 8
  %2 = load %"class.std::allocator.17"** %1
  %3 = bitcast %"class.std::allocator.17"* %2 to %"class.__gnu_cxx::new_allocator.18"*
  call void @_ZN9__gnu_cxx13new_allocatorIPP8TreeNodeED2Ev(%"class.__gnu_cxx::new_allocator.18"* %3) #0
  ret void
}
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPP8TreeNodeED2Ev(%"class.__gnu_cxx::new_allocator.18"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.18"*, align 8
  store %"class.__gnu_cxx::new_allocator.18"* %this, %"class.__gnu_cxx::new_allocator.18"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator.18"** %1
  ret void
}
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIPP8TreeNodeE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator.18"* %this, %struct.TreeNode*** %__p, i64) #3 align 2 {
  ...
  %3 = alloca %struct.TreeNode***, align 8
  %4 = alloca i64, align 8
  store %"class.__gnu_cxx::new_allocator.18"* %this, %"class.__gnu_cxx::new_allocator.18"** %2, align 8
  store %struct.TreeNode*** %__p, %struct.TreeNode**** %3, align 8
  store i64 %0, i64* %4, align 8
  %5 = load %"class.__gnu_cxx::new_allocator.18"** %2
  %6 = load %struct.TreeNode**** %3, align 8
  %7 = bitcast %struct.TreeNode*** %6 to i8*
  call void @_ZdlPv(i8* %7) #0
  ret void
...
define linkonce_odr void @_ZNSaIPP8TreeNodeEC2IS0_EERKSaIT_E(%"class.std::allocator.17"* %this, %"class.std::allocator.4"*) unnamed_addr #3 align 2 {
  ...
  store %"class.std::allocator.17"* %this, %"class.std::allocator.17"** %2, align 8
  store %"class.std::allocator.4"* %0, %"class.std::allocator.4"** %3, align 8
  %4 = load %"class.std::allocator.17"** %2
  %5 = bitcast %"class.std::allocator.17"* %4 to %"class.__gnu_cxx::new_allocator.18"*
  call void @_ZN9__gnu_cxx13new_allocatorIPP8TreeNodeEC2Ev(%"class.__gnu_cxx::new_allocator.18"* %5) #0
  ret void
}
...
define linkonce_odr %struct.TreeNode*** @_ZNSt16allocator_traitsISaIPP8TreeNodeEE8allocateERS3_m(%"class.std::allocator.17"* %__a, i64 %__n) #3 align 2 {
  ...
  store %"class.std::allocator.17"* %__a, %"class.std::allocator.17"** %1, align 8
  store i64 %__n, i64* %2, align 8
  %3 = load %"class.std::allocator.17"** %1, align 8
  %4 = bitcast %"class.std::allocator.17"* %3 to %"class.__gnu_cxx::new_allocator.18"*
  %5 = load i64* %2, align 8
  %6 = call %struct.TreeNode*** @_ZN9__gnu_cxx13new_allocatorIPP8TreeNodeE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.18"* %4, i64 %5, i8* null)
  ret %struct.TreeNode*** %6
}
...
define linkonce_odr %struct.TreeNode*** @_ZN9__gnu_cxx13new_allocatorIPP8TreeNodeE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.18"* %this, i64 %__n, i8*) #3 align 2 {
  ...
  %5 = load %"class.__gnu_cxx::new_allocator.18"** %2
  %6 = load i64* %3, align 8
  %7 = call i64 @_ZNK9__gnu_cxx13new_allocatorIPP8TreeNodeE8max_sizeEv(%"class.__gnu_cxx::new_allocator.18"* %5) #0
  %8 = icmp ugt i64 %6, %7
  br i1 %8, label %9, label %10
...
define linkonce_odr void @_ZNSt11_Deque_baseIP8TreeNodeSaIS1_EEC2EOS3_(%"class.std::_Deque_base"* %this, %"class.std::_Deque_base"* %__x) unnamed_addr #3 align 2 {
  ...
  %3 = alloca %"struct.std::integral_constant", align 1
  %4 = alloca %"struct.__gnu_cxx::__allocator_always_compares_equal.20", align 1
  store %"class.std::_Deque_base"* %this, %"class.std::_Deque_base"** %1, align 8
  ...
  %8 = bitcast %"struct.__gnu_cxx::__allocator_always_compares_equal.20"* %4 to %"struct.std::integral_constant"*
