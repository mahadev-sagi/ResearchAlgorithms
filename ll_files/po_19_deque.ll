...
; <label>:11                                      ; preds = %0
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EEC2Ev(%"class.std::deque"* %dq)
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EE9push_backERKS1_(%"class.std::deque"* %dq, %struct.TreeNode** %2)
  br label %12

; <label>:12                                      ; preds = %35, %11
  %13 = call zeroext i1 @_ZNKSt5dequeIP8TreeNodeSaIS1_EE5emptyEv(%"class.std::deque"* %dq) #0
  %14 = xor i1 %13, true
  br i1 %14, label %15, label %36

; <label>:15                                      ; preds = %12
  %16 = call %struct.TreeNode** @_ZNSt5dequeIP8TreeNodeSaIS1_EE4backEv(%"class.std::deque"* %dq) #0
  %17 = load %struct.TreeNode** %16
  store %struct.TreeNode* %17, %struct.TreeNode** %node, align 8
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EE8pop_backEv(%"class.std::deque"* %dq) #0
...
; <label>:24                                      ; preds = %15
  ...
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EE9push_backERKS1_(%"class.std::deque"* %dq, %struct.TreeNode** %26)
  br label %27
...
; <label>:32                                      ; preds = %27
  ...
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EE9push_backERKS1_(%"class.std::deque"* %dq, %struct.TreeNode** %34)
  br label %35
...
; <label>:36                                      ; preds = %12
  ...
  store i1 true, i1* %3
  store i32 1, i32* %4
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EED2Ev(%"class.std::deque"* %dq) #0
  br label %45
