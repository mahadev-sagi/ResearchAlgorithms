; ModuleID = 'PostorderTraversals/po_19_deque.cpp'
...
; <label>:13                                      ; preds = %0
  invoke void @_ZNSt5dequeIP8TreeNodeSaIS1_EEC2Ev(%"class.std::deque"* %dq)
          to label %14 unwind label %33

; <label>:14                                      ; preds = %13
  invoke void @_ZNSt5dequeIP8TreeNodeSaIS1_EE9push_backERKS1_(%"class.std::deque"* %dq, %struct.TreeNode** %2)
...
; <label>:16                                      ; preds = %50, %15
  %17 = call zeroext i1 @_ZNKSt5dequeIP8TreeNodeSaIS1_EE5emptyEv(%"class.std::deque"* %dq) #2
  %18 = xor i1 %17, true
  br i1 %18, label %19, label %51

; <label>:19                                      ; preds = %16
  %20 = call %struct.TreeNode** @_ZNSt5dequeIP8TreeNodeSaIS1_EE4backEv(%"class.std::deque"* %dq) #2
  %21 = load %struct.TreeNode** %20
  store %struct.TreeNode* %21, %struct.TreeNode** %node, align 8
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EE8pop_backEv(%"class.std::deque"* %dq) #2
  %22 = load %struct.TreeNode** %node, align 8
  %23 = getelementptr inbounds %struct.TreeNode* %22, i32 0, i32 0
  invoke void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %23)
          to label %24 unwind label %37

; <label>:24                                      ; preds = %19
  %25 = load %struct.TreeNode** %node, align 8
  %26 = getelementptr inbounds %struct.TreeNode* %25, i32 0, i32 1
  %27 = load %struct.TreeNode** %26, align 8
  %28 = icmp ne %struct.TreeNode* %27, null
  br i1 %28, label %29, label %41

; <label>:29                                      ; preds = %24
  %30 = load %struct.TreeNode** %node, align 8
  %31 = getelementptr inbounds %struct.TreeNode* %30, i32 0, i32 1
  invoke void @_ZNSt5dequeIP8TreeNodeSaIS1_EE9push_backERKS1_(%"class.std::deque"* %dq, %struct.TreeNode** %31)
...
; <label>:37                                      ; preds = %51, %46, %29, %19, %14
  ...
  store i32 %40, i32* %6
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EED2Ev(%"class.std::deque"* %dq) #2
  br label %65
...
; <label>:46                                      ; preds = %41
  ...
  invoke void @_ZNSt5dequeIP8TreeNodeSaIS1_EE9push_backERKS1_(%"class.std::deque"* %dq, %struct.TreeNode** %48)
...
; <label>:51                                      ; preds = %16
  %52 = call i32* @_ZNSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %agg.result) #2
  %53 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %7, i32 0, i32 0
  store i32* %52, i32** %53
  %54 = call i32* @_ZNSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %agg.result) #2
  %55 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %8, i32 0, i32 0
  store i32* %54, i32** %55
  %56 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %7, i32 0, i32 0
  %57 = load i32** %56
  %58 = getelementptr %"class.__gnu_cxx::__normal_iterator"* %8, i32 0, i32 0
  %59 = load i32** %58
