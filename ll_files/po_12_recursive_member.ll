; ModuleID = 'PostorderTraversals/po_12_recursive_member.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %2 = alloca %struct.TreeNode*, align 8
  %3 = alloca i1
  %it = alloca %class.PostOrderIterator, align 8
  %4 = alloca i8*
  %5 = alloca i32
  ...
  invoke void @_ZN17PostOrderIteratorC2EP8TreeNode(%class.PostOrderIterator* %it, %struct.TreeNode* %9)
...
; <label>:11                                      ; preds = %17, %10
  %12 = invoke zeroext i1 @_ZN17PostOrderIterator7hasNextEv(%class.PostOrderIterator* %it)
          to label %13 unwind label %22
...
; <label>:14                                      ; preds = %13
  %15 = invoke i32 @_ZN17PostOrderIterator4nextEv(%class.PostOrderIterator* %it)
          to label %16 unwind label %22

; <label>:16                                      ; preds = %14
  store i32 %15, i32* %6
  invoke void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %agg.result, i32* %6)
...
; <label>:22                                      ; preds = %16, %14, %11
  ...
  %25 = extractvalue { i8*, i32 } %23, 1
  store i32 %25, i32* %5
  call void @_ZN17PostOrderIteratorD2Ev(%class.PostOrderIterator* %it) #2
  br label %30
...
define linkonce_odr void @_ZN17PostOrderIteratorC2EP8TreeNode(%class.PostOrderIterator* %this, %struct.TreeNode* %root) unnamed_addr #3 align 2 {
  %1 = alloca %class.PostOrderIterator*, align 8
  %2 = alloca %struct.TreeNode*, align 8
  %3 = alloca %"class.std::deque", align 8
  %4 = alloca i8*
  %5 = alloca i32
  store %class.PostOrderIterator* %this, %class.PostOrderIterator** %1, align 8
  store %struct.TreeNode* %root, %struct.TreeNode** %2, align 8
  %6 = load %class.PostOrderIterator** %1
  %7 = getelementptr inbounds %class.PostOrderIterator* %6, i32 0, i32 0
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EEC2Ev(%"class.std::deque"* %3)
  invoke void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %7, %"class.std::deque"* %3)
          to label %8 unwind label %12

; <label>:8                                       ; preds = %0
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EED2Ev(%"class.std::deque"* %3) #2
  %9 = getelementptr inbounds %class.PostOrderIterator* %6, i32 0, i32 1
  store %struct.TreeNode* null, %struct.TreeNode** %9, align 8
  %10 = load %struct.TreeNode** %2, align 8
  %11 = getelementptr inbounds %class.PostOrderIterator* %6, i32 0, i32 2
  store %struct.TreeNode* %10, %struct.TreeNode** %11, align 8
  ret void
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZN17PostOrderIterator7hasNextEv(%class.PostOrderIterator* %this) #5 align 2 {
  %1 = alloca %class.PostOrderIterator*, align 8
  store %class.PostOrderIterator* %this, %class.PostOrderIterator** %1, align 8
  %2 = load %class.PostOrderIterator** %1
  %3 = getelementptr inbounds %class.PostOrderIterator* %2, i32 0, i32 0
  %4 = call zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %3)
  br i1 %4, label %5, label %9

; <label>:5                                       ; preds = %0
  %6 = getelementptr inbounds %class.PostOrderIterator* %2, i32 0, i32 2
...
define linkonce_odr i32 @_ZN17PostOrderIterator4nextEv(%class.PostOrderIterator* %this) #3 align 2 {
  %1 = alloca i32, align 4
  %2 = alloca %class.PostOrderIterator*, align 8
  %peekNode = alloca %struct.TreeNode*, align 8
  %val = alloca i32, align 4
  store %class.PostOrderIterator* %this, %class.PostOrderIterator** %2, align 8
  %3 = load %class.PostOrderIterator** %2
  br label %4

; <label>:4                                       ; preds = %55, %0
  %5 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 2
  %6 = load %struct.TreeNode** %5, align 8
  %7 = icmp ne %struct.TreeNode* %6, null
  br i1 %7, label %12, label %8

; <label>:8                                       ; preds = %4
  %9 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 0
  %10 = call zeroext i1 @_ZNKSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE5emptyEv(%"class.std::stack"* %9)
  %11 = xor i1 %10, true
  br label %12
...
; <label>:14                                      ; preds = %12
  %15 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 2
  %16 = load %struct.TreeNode** %15, align 8
  %17 = icmp ne %struct.TreeNode* %16, null
  br i1 %17, label %18, label %26

; <label>:18                                      ; preds = %14
  %19 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 0
  %20 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 2
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE4pushERKS1_(%"class.std::stack"* %19, %struct.TreeNode** %20)
  %21 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 2
  ...
  %25 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 2
  store %struct.TreeNode* %24, %struct.TreeNode** %25, align 8
  br label %55

; <label>:26                                      ; preds = %14
  %27 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 0
  %28 = call %struct.TreeNode** @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3topEv(%"class.std::stack"* %27)
  %29 = load %struct.TreeNode** %28
  store %struct.TreeNode* %29, %struct.TreeNode** %peekNode, align 8
  %30 = load %struct.TreeNode** %peekNode, align 8
...
; <label>:34                                      ; preds = %26
  %35 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 1
  %36 = load %struct.TreeNode** %35, align 8
  %37 = load %struct.TreeNode** %peekNode, align 8
  %38 = getelementptr inbounds %struct.TreeNode* %37, i32 0, i32 2
  %39 = load %struct.TreeNode** %38, align 8
  %40 = icmp ne %struct.TreeNode* %36, %39
  br i1 %40, label %41, label %46

; <label>:41                                      ; preds = %34
  %42 = load %struct.TreeNode** %peekNode, align 8
  %43 = getelementptr inbounds %struct.TreeNode* %42, i32 0, i32 2
  %44 = load %struct.TreeNode** %43, align 8
  %45 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 2
  store %struct.TreeNode* %44, %struct.TreeNode** %45, align 8
  br label %54

; <label>:46                                      ; preds = %34, %26
  %47 = load %struct.TreeNode** %peekNode, align 8
  %48 = getelementptr inbounds %struct.TreeNode* %47, i32 0, i32 0
  %49 = load i32* %48, align 4
  store i32 %49, i32* %val, align 4
  %50 = load %struct.TreeNode** %peekNode, align 8
  %51 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 1
  store %struct.TreeNode* %50, %struct.TreeNode** %51, align 8
  %52 = getelementptr inbounds %class.PostOrderIterator* %3, i32 0, i32 0
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEE3popEv(%"class.std::stack"* %52)
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZN17PostOrderIteratorD2Ev(%class.PostOrderIterator* %this) unnamed_addr #9 align 2 {
  %1 = alloca %class.PostOrderIterator*, align 8
  store %class.PostOrderIterator* %this, %class.PostOrderIterator** %1, align 8
  %2 = load %class.PostOrderIterator** %1
  %3 = getelementptr inbounds %class.PostOrderIterator* %2, i32 0, i32 0
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::stack"* %3) #2
  ret void
}
