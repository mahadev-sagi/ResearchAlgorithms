...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  call void @_ZN17PostOrderIteratorC2EP8TreeNode(%class.PostOrderIterator* %it, %struct.TreeNode* %7)
  br label %8

; <label>:8                                       ; preds = %10, %0
  %9 = call zeroext i1 @_ZN17PostOrderIterator7hasNextEv(%class.PostOrderIterator* %it)
  br i1 %9, label %10, label %12

; <label>:10                                      ; preds = %8
  %11 = call i32 @_ZN17PostOrderIterator4nextEv(%class.PostOrderIterator* %it)
  store i32 %11, i32* %4
  call void @_ZNSt6vectorIiSaIiEE9push_backEOi(%"class.std::vector"* %agg.result, i32* %4)
  br label %8

; <label>:12                                      ; preds = %8
  store i1 true, i1* %3
  store i32 1, i32* %5
  call void @_ZN17PostOrderIteratorD2Ev(%class.PostOrderIterator* %it) #0
  %13 = load i1* %3
...
define linkonce_odr void @_ZN17PostOrderIteratorC2EP8TreeNode(%class.PostOrderIterator* %this, %struct.TreeNode* %root) unnamed_addr #3 align 2 {
  ...
  store %struct.TreeNode* %root, %struct.TreeNode** %2, align 8
  %4 = load %class.PostOrderIterator** %1
  %5 = getelementptr inbounds %class.PostOrderIterator* %4, i32 0, i32 0
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EEC2Ev(%"class.std::deque"* %3)
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEEC2EOS4_(%"class.std::stack"* %5, %"class.std::deque"* %3)
  call void @_ZNSt5dequeIP8TreeNodeSaIS1_EED2Ev(%"class.std::deque"* %3) #0
  %6 = getelementptr inbounds %class.PostOrderIterator* %4, i32 0, i32 1
  store %struct.TreeNode* null, %struct.TreeNode** %6, align 8
  %7 = load %struct.TreeNode** %2, align 8
  %8 = getelementptr inbounds %class.PostOrderIterator* %4, i32 0, i32 2
...
define linkonce_odr void @_ZN17PostOrderIteratorD2Ev(%class.PostOrderIterator* %this) unnamed_addr #5 align 2 {
  ...
  %2 = load %class.PostOrderIterator** %1
  %3 = getelementptr inbounds %class.PostOrderIterator* %2, i32 0, i32 0
  call void @_ZNSt5stackIP8TreeNodeSt5dequeIS1_SaIS1_EEED2Ev(%"class.std::stack"* %3) #0
  ret void
}
