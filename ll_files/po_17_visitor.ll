...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  call void @_ZN13VectorVisitorC2ERSt6vectorIiSaIiEE(%class.VectorVisitor* %adapter, %"class.std::vector"* %agg.result)
  %6 = load %struct.TreeNode** %2, align 8
  %7 = bitcast %class.VectorVisitor* %adapter to %class.NodeVisitor*
  call void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %5, %struct.TreeNode* %6, %class.NodeVisitor* %7)
  store i1 true, i1* %3
  store i32 1, i32* %4
  call void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %adapter) #0
  %8 = load i1* %3
...
define linkonce_odr void @_ZN13VectorVisitorC2ERSt6vectorIiSaIiEE(%class.VectorVisitor* %this, %"class.std::vector"* %r) unnamed_addr #3 align 2 {
  ...
  call void @_ZN11NodeVisitorC2Ev(%class.NodeVisitor* %4) #0
...
define linkonce_odr void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %this) unnamed_addr #5 align 2 {
  ...
  call void @_ZN11NodeVisitorD2Ev(%class.NodeVisitor* %3) #0
  ret void
}
...
define linkonce_odr void @_ZN13VectorVisitorD0Ev(%class.VectorVisitor* %this) unnamed_addr #5 align 2 {
  ...
  store %class.VectorVisitor* %this, %class.VectorVisitor** %1, align 8
  %2 = load %class.VectorVisitor** %1
  call void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %2) #0
...
define linkonce_odr void @_ZN11NodeVisitorD0Ev(%class.NodeVisitor* %this) unnamed_addr #3 align 2 {
  ...
  store %class.NodeVisitor* %this, %class.NodeVisitor** %1, align 8
  %2 = load %class.NodeVisitor** %1
  call void @_ZN11NodeVisitorD2Ev(%class.NodeVisitor* %2) #0
  %3 = bitcast %class.NodeVisitor* %2 to i8*
  call void @_ZdlPv(i8* %3) #10
  ret void
}
