; ModuleID = 'PostorderTraversals/po_17_visitor.cpp'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %2 = alloca %struct.TreeNode*, align 8
  %3 = alloca i1
  %adapter = alloca %class.VectorVisitor, align 8
  %4 = alloca i8*
  %5 = alloca i32
  %6 = alloca i32
  ...
  invoke void @_ZN13VectorVisitorC2ERSt6vectorIiSaIiEE(%class.VectorVisitor* %adapter, %"class.std::vector"* %agg.result)
          to label %8 unwind label %13

; <label>:8                                       ; preds = %0
  %9 = load %struct.TreeNode** %2, align 8
  %10 = bitcast %class.VectorVisitor* %adapter to %class.NodeVisitor*
  invoke void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %7, %struct.TreeNode* %9, %class.NodeVisitor* %10)
          to label %11 unwind label %17

; <label>:11                                      ; preds = %8
  store i1 true, i1* %3
  store i32 1, i32* %6
  call void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %adapter) #2
  %12 = load i1* %3
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN13VectorVisitorC2ERSt6vectorIiSaIiEE(%class.VectorVisitor* %this, %"class.std::vector"* %r) unnamed_addr #5 align 2 {
  %1 = alloca %class.VectorVisitor*, align 8
  %2 = alloca %"class.std::vector"*, align 8
  store %class.VectorVisitor* %this, %class.VectorVisitor** %1, align 8
  store %"class.std::vector"* %r, %"class.std::vector"** %2, align 8
  %3 = load %class.VectorVisitor** %1
  %4 = bitcast %class.VectorVisitor* %3 to %class.NodeVisitor*
  call void @_ZN11NodeVisitorC2Ev(%class.NodeVisitor* %4) #2
  %5 = bitcast %class.VectorVisitor* %3 to i8***
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV13VectorVisitor, i64 0, i64 2), i8*** %5
  %6 = getelementptr inbounds %class.VectorVisitor* %3, i32 0, i32 1
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %this, %struct.TreeNode* %root, %class.NodeVisitor* %visitor) #3 align 2 {
  %1 = alloca %class.Solution*, align 8
  %2 = alloca %struct.TreeNode*, align 8
  %3 = alloca %class.NodeVisitor*, align 8
  store %class.Solution* %this, %class.Solution** %1, align 8
  store %struct.TreeNode* %root, %struct.TreeNode** %2, align 8
  store %class.NodeVisitor* %visitor, %class.NodeVisitor** %3, align 8
...
; <label>:8                                       ; preds = %0
  ...
  %12 = load %class.NodeVisitor** %3, align 8
  call void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %4, %struct.TreeNode* %11, %class.NodeVisitor* %12)
  ...
  %16 = load %class.NodeVisitor** %3, align 8
  call void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %4, %struct.TreeNode* %15, %class.NodeVisitor* %16)
  %17 = load %class.NodeVisitor** %3, align 8
  %18 = bitcast %class.NodeVisitor* %17 to void (%class.NodeVisitor*, i32)***
  %19 = load void (%class.NodeVisitor*, i32)*** %18
  %20 = getelementptr inbounds void (%class.NodeVisitor*, i32)** %19, i64 2
  %21 = load void (%class.NodeVisitor*, i32)** %20
  %22 = load %struct.TreeNode** %2, align 8
  %23 = getelementptr inbounds %struct.TreeNode* %22, i32 0, i32 0
  %24 = load i32* %23, align 4
  call void %21(%class.NodeVisitor* %17, i32 %24)
  br label %25
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %this) unnamed_addr #10 align 2 {
  %1 = alloca %class.VectorVisitor*, align 8
  store %class.VectorVisitor* %this, %class.VectorVisitor** %1, align 8
  %2 = load %class.VectorVisitor** %1
  %3 = bitcast %class.VectorVisitor* %2 to %class.NodeVisitor*
  call void @_ZN11NodeVisitorD2Ev(%class.NodeVisitor* %3) #2
  ret void
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZN11NodeVisitorC2Ev(%class.NodeVisitor* %this) unnamed_addr #10 align 2 {
  %1 = alloca %class.NodeVisitor*, align 8
  store %class.NodeVisitor* %this, %class.NodeVisitor** %1, align 8
  %2 = load %class.NodeVisitor** %1
  %3 = bitcast %class.NodeVisitor* %2 to i8***
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV11NodeVisitor, i64 0, i64 2), i8*** %3
  ret void
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZN13VectorVisitorD0Ev(%class.VectorVisitor* %this) unnamed_addr #10 align 2 {
  %1 = alloca %class.VectorVisitor*, align 8
  store %class.VectorVisitor* %this, %class.VectorVisitor** %1, align 8
  %2 = load %class.VectorVisitor** %1
  call void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %2) #2
  %3 = bitcast %class.VectorVisitor* %2 to i8*
...
define linkonce_odr void @_ZN13VectorVisitor5visitEi(%class.VectorVisitor* %this, i32 %val) unnamed_addr #3 align 2 {
  ...
  %3 = load %class.VectorVisitor** %1
  %4 = getelementptr inbounds %class.VectorVisitor* %3, i32 0, i32 1
  %5 = load %"class.std::vector"** %4, align 8
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %5, i32* %2)
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN11NodeVisitorD2Ev(%class.NodeVisitor* %this) unnamed_addr #5 align 2 {
  %1 = alloca %class.NodeVisitor*, align 8
  store %class.NodeVisitor* %this, %class.NodeVisitor** %1, align 8
  %2 = load %class.NodeVisitor** %1
  ret void
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN11NodeVisitorD0Ev(%class.NodeVisitor* %this) unnamed_addr #5 align 2 {
  %1 = alloca %class.NodeVisitor*, align 8
  store %class.NodeVisitor* %this, %class.NodeVisitor** %1, align 8
  %2 = load %class.NodeVisitor** %1
  call void @_ZN11NodeVisitorD2Ev(%class.NodeVisitor* %2) #2
  %3 = bitcast %class.NodeVisitor* %2 to i8*
  call void @_ZdlPv(i8* %3) #12
  ret void
}
