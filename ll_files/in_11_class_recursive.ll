; ModuleID = 'InorderTraversals/in_11_class_recursive.cpp'
...
define void @_Z18in_order_traversalP4NodeRSt6vectorIiSaIiEE(%struct.Node* %root, %"class.std::vector"* %result) #3 {
  ...
  %sol = alloca %class.Solution, align 8
  %3 = alloca %"class.std::vector", align 8
  %4 = alloca i8*
  %5 = alloca i32
  store %struct.Node* %root, %struct.Node** %1, align 8
  store %"class.std::vector"* %result, %"class.std::vector"** %2, align 8
  call void @_ZN8SolutionC2Ev(%class.Solution* %sol) #2
  %6 = load %"class.std::vector"** %2, align 8
  %7 = load %struct.Node** %1, align 8
  invoke void @_ZN8Solution16inorderTraversalEP4Node(%"class.std::vector"* sret %3, %class.Solution* %sol, %struct.Node* %7)
          to label %8 unwind label %10

; <label>:8                                       ; preds = %0
  %9 = call %"class.std::vector"* @_ZNSt6vectorIiSaIiEEaSEOS1_(%"class.std::vector"* %6, %"class.std::vector"* %3) #2
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %3) #2
  call void @_ZN8SolutionD2Ev(%class.Solution* %sol) #2
  ret void
...
define linkonce_odr void @_ZN8SolutionC2Ev(%class.Solution* %this) unnamed_addr #4 align 2 {
  ...
  %2 = load %class.Solution** %1
  %3 = getelementptr inbounds %class.Solution* %2, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::vector"* @_ZNSt6vectorIiSaIiEEaSEOS1_(%"class.std::vector"* %this, %"class.std::vector"* %__x) #5 align 2 {
  ...
  %5 = load %"class.std::vector"** %2, align 8
  %6 = call %"class.std::vector"* @_ZSt4moveIRSt6vectorIiSaIiEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::vector"* %5) #2
  call void @_ZNSt6vectorIiSaIiEE14_M_move_assignEOS1_St17integral_constantIbLb1EE(%"class.std::vector"* %4, %"class.std::vector"* %6) #2
...
define linkonce_odr void @_ZN8Solution16inorderTraversalEP4Node(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.Node* %root) #3 align 2 {
  ...
  %3 = load %class.Solution** %1
  %4 = getelementptr inbounds %class.Solution* %3, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE5clearEv(%"class.std::vector"* %4) #2
  %5 = load %struct.Node** %2, align 8
  call void @_ZN8Solution6helperEP4Node(%class.Solution* %3, %struct.Node* %5)
  %6 = getelementptr inbounds %class.Solution* %3, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEEC2ERKS1_(%"class.std::vector"* %agg.result, %"class.std::vector"* %6)
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN4NodeC2Ei(%struct.Node* %this, i32 %v) unnamed_addr #5 align 2 {
  %1 = alloca %struct.Node*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIiEC2Ev(%"class.std::allocator"* %this) unnamed_addr #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIiED2Ev(%"class.std::allocator"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %this, %"class.std::allocator"** %1, align 8
  %2 = load %"class.std::allocator"** %1
  %3 = bitcast %"class.std::allocator"* %2 to %"class.__gnu_cxx::new_allocator"*
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt6vectorIiSaIiEE5emptyEv(%"class.std::vector"* %this) #5 align 2 {
  %1 = alloca %"class.std::vector"*, align 8
  ...
  store i32* %7, i32** %8
  %9 = call zeroext i1 @_ZN9__gnu_cxxeqIPKiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESB_(%"class.__gnu_cxx::__normal_iterator.4"* %2, %"class.__gnu_cxx::__normal_iterator.4"* %3) #2
  ret i1 %9
}
...
define linkonce_odr zeroext i1 @_ZN9__gnu_cxxeqIPKiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESB_(%"class.__gnu_cxx::__normal_iterator.4"* %__lhs, %"class.__gnu_cxx::__normal_iterator.4"* %__rhs) #4 {
  ...
  %4 = call i32** @_ZNK9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEE4baseEv(%"class.__gnu_cxx::__normal_iterator.4"* %3) #2
  %5 = load i32** %4
  %6 = load %"class.__gnu_cxx::__normal_iterator.4"** %2, align 8
  %7 = call i32** @_ZNK9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEE4baseEv(%"class.__gnu_cxx::__normal_iterator.4"* %6) #2
  %8 = load i32** %7
  %9 = icmp eq i32* %5, %8
  ret i1 %9
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32* @_ZNKSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %this) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %2 = alloca %"class.std::vector"*, align 8
  ...
  %8 = load i32** %7, align 8
  store i32* %8, i32** %3
  call void @_ZN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEC2ERKS2_(%"class.__gnu_cxx::__normal_iterator.4"* %1, i32** %3) #2
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32* @_ZNKSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %this) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %2 = alloca %"class.std::vector"*, align 8
  %3 = alloca i32*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %2, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEC2ERKS2_(%"class.__gnu_cxx::__normal_iterator.4"* %this, i32** %__i) unnamed_addr #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::__normal_iterator.4"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32** @_ZNK9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEE4baseEv(%"class.__gnu_cxx::__normal_iterator.4"* %this) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::__normal_iterator.4"*, align 8
  store %"class.__gnu_cxx::__normal_iterator.4"* %this, %"class.__gnu_cxx::__normal_iterator.4"** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEEC2ERKS0_(%"struct.std::_Vector_base"* %this, %"class.std::allocator"* %__a) unnamed_addr #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiED2Ev(%"class.__gnu_cxx::new_allocator"* %this) unnamed_addr #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE10deallocateEPim(%"class.__gnu_cxx::new_allocator"* %this, i32* %__p, i64) #5 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32* @_ZNSt10_Iter_baseIPKiLb0EE7_S_baseES1_(i32* %__it) #5 align 2 {
  %1 = alloca i32*, align 8
  store i32* %__it, i32** %1, align 8
  %2 = load i32** %1, align 8
  ret i32* %2
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNK9__gnu_cxx13new_allocatorIiE8max_sizeEv(%"class.__gnu_cxx::new_allocator"* %this) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator"** %1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2ERKS0_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"class.std::allocator"* %__a) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"*, align 8
  %2 = alloca %"class.std::allocator"*, align 8
  store %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1, align 8
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %2, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiEC2ERKS1_(%"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"*) unnamed_addr #5 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiEC2Ev(%"class.__gnu_cxx::new_allocator"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %1, align 8
  %2 = load %"class.__gnu_cxx::new_allocator"** %1
  ret void
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE14_M_move_assignEOS1_St17integral_constantIbLb1EE(%"class.std::vector"* %this, %"class.std::vector"* %__x) #5 align 2 {
  %1 = alloca %"class.std::vector"*, align 8
  %2 = alloca %"class.std::vector"*, align 8
  %3 = alloca %"struct.std::integral_constant", align 1
  ...
  call void @_ZNKSt12_Vector_baseIiSaIiEE13get_allocatorEv(%"class.std::allocator"* sret %4, %"struct.std::_Vector_base"* %8) #2
  call void @_ZNSt6vectorIiSaIiEEC2ERKS0_(%"class.std::vector"* %__tmp, %"class.std::allocator"* %4) #2
  call void @_ZNSaIiED2Ev(%"class.std::allocator"* %4) #2
  %9 = bitcast %"class.std::vector"* %7 to %"struct.std::_Vector_base"*
  %10 = getelementptr inbounds %"struct.std::_Vector_base"* %9, i32 0, i32 0
  %11 = bitcast %"class.std::vector"* %__tmp to %"struct.std::_Vector_base"*
  %12 = getelementptr inbounds %"struct.std::_Vector_base"* %11, i32 0, i32 0
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_impl12_M_swap_dataERS2_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %10, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %12) #2
  %13 = bitcast %"class.std::vector"* %7 to %"struct.std::_Vector_base"*
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_impl12_M_swap_dataERS2_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %14, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %17) #2
  %18 = bitcast %"class.std::vector"* %7 to %"struct.std::_Vector_base"*
  %19 = call %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %18) #2
  %20 = load %"class.std::vector"** %2, align 8
  %21 = bitcast %"class.std::vector"* %20 to %"struct.std::_Vector_base"*
  %22 = call %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %21) #2
  invoke void @_ZSt15__alloc_on_moveISaIiEEvRT_S2_(%"class.std::allocator"* %19, %"class.std::allocator"* %22)
          to label %23 unwind label %24

; <label>:23                                      ; preds = %0
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %__tmp) #2
  ret void
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::vector"* @_ZSt4moveIRSt6vectorIiSaIiEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::vector"* %__t) #5 {
  %1 = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %__t, %"class.std::vector"** %1, align 8
  %2 = load %"class.std::vector"** %1, align 8
  ret %"class.std::vector"* %2
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2ERKS0_(%"class.std::vector"* %this, %"class.std::allocator"* %__a) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::vector"*, align 8
  %2 = alloca %"class.std::allocator"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %1, align 8
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %2, align 8
  ...
  %4 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*
  %5 = load %"class.std::allocator"** %2, align 8
  call void @_ZNSt12_Vector_baseIiSaIiEEC2ERKS0_(%"struct.std::_Vector_base"* %4, %"class.std::allocator"* %5) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNKSt12_Vector_baseIiSaIiEE13get_allocatorEv(%"class.std::allocator"* noalias sret %agg.result, %"struct.std::_Vector_base"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8
  %2 = load %"struct.std::_Vector_base"** %1
  %3 = call %"class.std::allocator"* @_ZNKSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %2) #2
  call void @_ZNSaIiEC2ERKS_(%"class.std::allocator"* %agg.result, %"class.std::allocator"* %3) #2
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_impl12_M_swap_dataERS2_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %__x) #5 align 2 {
  %1 = alloca %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"*, align 8
  %2 = alloca %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"*, align 8
  store %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1, align 8
  store %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %__x, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %2, align 8
  %3 = load %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1
  %4 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3, i32 0, i32 0
  %5 = load %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %2, align 8
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %5, i32 0, i32 0
  call void @_ZSt4swapIPiEvRT_S2_(i32** %4, i32** %6) #2
  %7 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3, i32 0, i32 1
  %8 = load %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %2, align 8
  %9 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %8, i32 0, i32 1
  call void @_ZSt4swapIPiEvRT_S2_(i32** %7, i32** %9) #2
  %10 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3, i32 0, i32 2
  %11 = load %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %2, align 8
  %12 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %11, i32 0, i32 2
  call void @_ZSt4swapIPiEvRT_S2_(i32** %10, i32** %12) #2
  ret void
}

; Function Attrs: inlinehint uwtable
define linkonce_odr void @_ZSt15__alloc_on_moveISaIiEEvRT_S2_(%"class.std::allocator"* %__one, %"class.std::allocator"* %__two) #9 {
  %1 = alloca %"class.std::allocator"*, align 8
  %2 = alloca %"class.std::allocator"*, align 8
  %3 = alloca %"struct.std::integral_constant", align 1
  store %"class.std::allocator"* %__one, %"class.std::allocator"** %1, align 8
  store %"class.std::allocator"* %__two, %"class.std::allocator"** %2, align 8
  %4 = load %"class.std::allocator"** %1, align 8
  %5 = load %"class.std::allocator"** %2, align 8
  call void @_ZSt18__do_alloc_on_moveISaIiEEvRT_S2_St17integral_constantIbLb1EE(%"class.std::allocator"* %4, %"class.std::allocator"* %5)
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator"* @_ZSt4moveIRSaIiEEONSt16remove_referenceIT_E4typeEOS3_(%"class.std::allocator"* %__t) #5 {
  %1 = alloca %"class.std::allocator"*, align 8
...
define linkonce_odr void @_ZSt4swapIPiEvRT_S2_(i32** %__a, i32** %__b) #4 {
  ...
  %4 = call i32** @_ZSt4moveIRPiEONSt16remove_referenceIT_E4typeEOS3_(i32** %3) #2
  %5 = load i32** %4
  store i32* %5, i32** %__tmp, align 8
  %6 = load i32*** %2, align 8
  %7 = call i32** @_ZSt4moveIRPiEONSt16remove_referenceIT_E4typeEOS3_(i32** %6) #2
  %8 = load i32** %7
  %9 = load i32*** %1, align 8
  store i32* %8, i32** %9, align 8
  %10 = call i32** @_ZSt4moveIRPiEONSt16remove_referenceIT_E4typeEOS3_(i32** %__tmp) #2
  %11 = load i32** %10
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32** @_ZSt4moveIRPiEONSt16remove_referenceIT_E4typeEOS3_(i32** %__t) #5 {
  %1 = alloca i32**, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIiEC2ERKS_(%"class.std::allocator"* %this, %"class.std::allocator"* %__a) unnamed_addr #5 align 2 {
  %1 = alloca %"class.std::allocator"*, align 8
  %2 = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %this, %"class.std::allocator"** %1, align 8
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %2, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"class.std::allocator"* @_ZNKSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %this) #5 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8
  %2 = load %"struct.std::_Vector_base"** %1
  %3 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE5clearEv(%"class.std::vector"* %this) #5 align 2 {
  %1 = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %1, align 8
  %2 = load %"class.std::vector"** %1
  %3 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*
...
; <label>:6                                       ; preds = %0
  ...
  call void @_ZN8Solution6helperEP4Node(%class.Solution* %3, %struct.Node* %9)
  %10 = getelementptr inbounds %class.Solution* %3, i32 0, i32 0
  %11 = load %struct.Node** %2, align 8
  %12 = getelementptr inbounds %struct.Node* %11, i32 0, i32 0
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %10, i32* %12)
  %13 = load %struct.Node** %2, align 8
  %14 = getelementptr inbounds %struct.Node* %13, i32 0, i32 2
  %15 = load %struct.Node** %14, align 8
  call void @_ZN8Solution6helperEP4Node(%class.Solution* %3, %struct.Node* %15)
  br label %16
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2ERKS1_(%"class.std::vector"* %this, %"class.std::vector"* %__x) unnamed_addr #3 align 2 {
  ...
  %14 = call %"class.std::allocator"* @_ZNKSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %13) #2
  call void @_ZN9__gnu_cxx14__alloc_traitsISaIiEE17_S_select_on_copyERKS1_(%"class.std::allocator"* sret %3, %"class.std::allocator"* %14)
  invoke void @_ZNSt12_Vector_baseIiSaIiEEC2EmRKS0_(%"struct.std::_Vector_base"* %9, i64 %11, %"class.std::allocator"* %3)
          to label %15 unwind label %37

; <label>:15                                      ; preds = %0
  call void @_ZNSaIiED2Ev(%"class.std::allocator"* %3) #2
  %16 = load %"class.std::vector"** %2, align 8
  %17 = call i32* @_ZNKSt6vectorIiSaIiEE5beginEv(%"class.std::vector"* %16) #2
  %18 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %6, i32 0, i32 0
  store i32* %17, i32** %18
  %19 = load %"class.std::vector"** %2, align 8
  %20 = call i32* @_ZNKSt6vectorIiSaIiEE3endEv(%"class.std::vector"* %19) #2
  %21 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %7, i32 0, i32 0
  store i32* %20, i32** %21
  %22 = bitcast %"class.std::vector"* %8 to %"struct.std::_Vector_base"*
  %23 = getelementptr inbounds %"struct.std::_Vector_base"* %22, i32 0, i32 0
  %24 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %23, i32 0, i32 0
  ...
  %28 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %6, i32 0, i32 0
  %29 = load i32** %28
  %30 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %7, i32 0, i32 0
  %31 = load i32** %30
  %32 = invoke i32* @_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEPiiET0_T_SA_S9_RSaIT1_E(i32* %29, i32* %31, i32* %25, %"class.std::allocator"* %27)
...
; <label>:33                                      ; preds = %15
  ...
  %36 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %35, i32 0, i32 1
...
; <label>:41                                      ; preds = %15
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEED2Ev(%"struct.std::_Vector_base"* %45) #2
  br label %46
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEEC2EmRKS0_(%"struct.std::_Vector_base"* %this, i64 %__n, %"class.std::allocator"* %__a) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2ERKS0_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %7, %"class.std::allocator"* %8) #2
  %9 = load i64* %2, align 8
...
define linkonce_odr void @_ZN9__gnu_cxx14__alloc_traitsISaIiEE17_S_select_on_copyERKS1_(%"class.std::allocator"* noalias sret %agg.result, %"class.std::allocator"* %__a) #3 align 2 {
  ...
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %1, align 8
  %2 = load %"class.std::allocator"** %1, align 8
  call void @_ZNSt16allocator_traitsISaIiEE37select_on_container_copy_constructionERKS0_(%"class.std::allocator"* sret %agg.result, %"class.std::allocator"* %2)
  ret void
}

; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEPiiET0_T_SA_S9_RSaIT1_E(i32* %__first.coerce, i32* %__last.coerce, i32* %__result, %"class.std::allocator"*) #9 {
  ...
  %6 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %__first, i32 0, i32 0
  store i32* %__first.coerce, i32** %6
  %7 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %__last, i32 0, i32 0
  store i32* %__last.coerce, i32** %7
  store i32* %__result, i32** %2, align 8
  store %"class.std::allocator"* %0, %"class.std::allocator"** %3, align 8
  %8 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %4 to i8*
  %9 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__first to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* %9, i64 8, i32 8, i1 false)
  %10 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %5 to i8*
  %11 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__last to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %10, i8* %11, i64 8, i32 8, i1 false)
  %12 = load i32** %2, align 8
  %13 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %4, i32 0, i32 0
  %14 = load i32** %13
  %15 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %5, i32 0, i32 0
  %16 = load i32** %15
...
; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt18uninitialized_copyIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEPiET0_T_SA_S9_(i32* %__first.coerce, i32* %__last.coerce, i32* %__result) #9 {
  %__first = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %__last = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %1 = alloca i32*, align 8
  %__assignable = alloca i8, align 1
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %3 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %4 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %__first, i32 0, i32 0
  store i32* %__first.coerce, i32** %4
  %5 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %__last, i32 0, i32 0
  store i32* %__last.coerce, i32** %5
  store i32* %__result, i32** %1, align 8
  store i8 1, i8* %__assignable, align 1
  %6 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %2 to i8*
  %7 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__first to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* %7, i64 8, i32 8, i1 false)
  %8 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %3 to i8*
  %9 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__last to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* %9, i64 8, i32 8, i1 false)
  %10 = load i32** %1, align 8
  %11 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %2, i32 0, i32 0
  %12 = load i32** %11
  %13 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %3, i32 0, i32 0
  %14 = load i32** %13
...
; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt4copyIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEPiET0_T_SA_S9_(i32* %__first.coerce, i32* %__last.coerce, i32* %__result) #9 {
  %__first = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %__last = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %1 = alloca i32*, align 8
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  ...
  %9 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__first to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* %9, i64 8, i32 8, i1 false)
  %10 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %3, i32 0, i32 0
  %11 = load i32** %10
  ...
  %13 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %2, i32 0, i32 0
  store i32* %12, i32** %13
  %14 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %5 to i8*
  %15 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__last to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* %15, i64 8, i32 8, i1 false)
  %16 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %5, i32 0, i32 0
  %17 = load i32** %16
  ...
  %19 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %4, i32 0, i32 0
  store i32* %18, i32** %19
  %20 = load i32** %1, align 8
  %21 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %2, i32 0, i32 0
  %22 = load i32** %21
  %23 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %4, i32 0, i32 0
  %24 = load i32** %23
...
; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt14__copy_move_a2ILb0EN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEPiET1_T0_SA_S9_(i32* %__first.coerce, i32* %__last.coerce, i32* %__result) #9 {
  %__first = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %__last = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %1 = alloca i32*, align 8
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  ...
  %7 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__first to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* %7, i64 8, i32 8, i1 false)
  %8 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %2, i32 0, i32 0
  %9 = load i32** %8
  ...
  %11 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %3 to i8*
  %12 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__last to i8*
...
; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt12__miter_baseIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEENSt11_Miter_baseIT_E13iterator_typeES9_(i32* %__it.coerce) #9 {
  %1 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %__it = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %2 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %3 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %__it, i32 0, i32 0
  store i32* %__it.coerce, i32** %3
  %4 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %2 to i8*
  %5 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__it to i8*
  ...
  %9 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %1, i32 0, i32 0
  store i32* %8, i32** %9
  %10 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %1, i32 0, i32 0
  %11 = load i32** %10
  ret i32* %11
}
...
define linkonce_odr i32* @_ZNSt10_Iter_baseIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEELb0EE7_S_baseES7_(i32* %__it.coerce) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %__it = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %2 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %__it, i32 0, i32 0
  store i32* %__it.coerce, i32** %2
  %3 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %1 to i8*
  %4 = bitcast %"class.__gnu_cxx::__normal_iterator.4"* %__it to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* %4, i64 8, i32 8, i1 false)
  %5 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %1, i32 0, i32 0
  %6 = load i32** %5
  ret i32* %6
}

; Function Attrs: inlinehint uwtable
define linkonce_odr i32* @_ZSt12__niter_baseIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEENSt11_Niter_baseIT_E13iterator_typeES9_(i32* %__it.coerce) #9 {
  %__it = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %1 = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %2 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %__it, i32 0, i32 0
  store i32* %__it.coerce, i32** %2
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32* @_ZNSt10_Iter_baseIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEELb1EE7_S_baseES7_(i32* %__it.coerce) #5 align 2 {
  %__it = alloca %"class.__gnu_cxx::__normal_iterator.4", align 8
  %1 = getelementptr %"class.__gnu_cxx::__normal_iterator.4"* %__it, i32 0, i32 0
  store i32* %__it.coerce, i32** %1
  %2 = call i32** @_ZNK9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEE4baseEv(%"class.__gnu_cxx::__normal_iterator.4"* %__it) #2
  %3 = load i32** %2
  ret i32* %3
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE37select_on_container_copy_constructionERKS0_(%"class.std::allocator"* noalias sret %agg.result, %"class.std::allocator"* %__rhs) #5 align 2 {
  %1 = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %__rhs, %"class.std::allocator"** %1, align 8
  %2 = load %"class.std::allocator"** %1, align 8
  call void @_ZNSaIiEC2ERKS_(%"class.std::allocator"* %agg.result, %"class.std::allocator"* %2) #2
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr i64 @_ZNSt16allocator_traitsISaIiEE8max_sizeERKS0_(%"class.std::allocator"* %__a) #5 align 2 {
  %1 = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %1, align 8
  %2 = load %"class.std::allocator"** %1, align 8
  %3 = bitcast %"class.std::allocator"* %2 to %"class.__gnu_cxx::new_allocator"*
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRKiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %this, i32* %__p, i32* %__args) #5 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %2 = alloca i32*, align 8
  %3 = alloca i32*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %1, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt6vectorIiSaIiEE15_M_erase_at_endEPi(%"class.std::vector"* %this, i32* %__pos) #5 align 2 {
  %1 = alloca %"class.std::vector"*, align 8
  %2 = alloca i32*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %1, align 8
