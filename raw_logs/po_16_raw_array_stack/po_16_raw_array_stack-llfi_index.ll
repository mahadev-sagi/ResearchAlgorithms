; ModuleID = '/home/foo/ResearchAlgorithms/po_16_raw_array_stack.ll'
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %MAX_SIZE = alloca i32, align 4, !llfi_index !138
  %stack = alloca [100000 x %struct.TreeNode*], align 16, !llfi_index !139
  %top = alloca i32, align 4, !llfi_index !140
  %output = alloca [100000 x i32], align 16, !llfi_index !141
  %outIndex = alloca i32, align 4, !llfi_index !142
  %node = alloca %struct.TreeNode*, align 8, !llfi_index !143
  %i = alloca i32, align 4, !llfi_index !144
  ...
  %5 = load %class.Solution** %1, !llfi_index !147
  store i1 false, i1* %3, !llfi_index !148
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %agg.result) #0, !llfi_index !149
  %6 = load %struct.TreeNode** %2, align 8, !llfi_index !150
  %7 = icmp eq %struct.TreeNode* %6, null, !llfi_index !151
  br i1 %7, label %8, label %9, !llfi_index !152

; <label>:8                                       ; preds = %0
  store i1 true, i1* %3, !llfi_index !153
  store i32 1, i32* %4, !llfi_index !154
  br label %71, !llfi_index !155

; <label>:9                                       ; preds = %0
  store i32 100000, i32* %MAX_SIZE, align 4, !llfi_index !156
  store i32 -1, i32* %top, align 4, !llfi_index !157
  store i32 0, i32* %outIndex, align 4, !llfi_index !158
  %10 = load %struct.TreeNode** %2, align 8, !llfi_index !159
  %11 = load i32* %top, align 4, !llfi_index !160
  %12 = add nsw i32 %11, 1, !llfi_index !161
  store i32 %12, i32* %top, align 4, !llfi_index !162
  %13 = sext i32 %12 to i64, !llfi_index !163
  %14 = getelementptr inbounds [100000 x %struct.TreeNode*]* %stack, i32 0, i64 %13, !llfi_index !164
  store %struct.TreeNode* %10, %struct.TreeNode** %14, align 8, !llfi_index !165
  br label %15, !llfi_index !166

; <label>:15                                      ; preds = %56, %9
  %16 = load i32* %top, align 4, !llfi_index !167
  %17 = icmp sge i32 %16, 0, !llfi_index !168
  br i1 %17, label %18, label %57, !llfi_index !169

; <label>:18                                      ; preds = %15
  %19 = load i32* %top, align 4, !llfi_index !170
  %20 = add nsw i32 %19, -1, !llfi_index !171
  store i32 %20, i32* %top, align 4, !llfi_index !172
  %21 = sext i32 %19 to i64, !llfi_index !173
  %22 = getelementptr inbounds [100000 x %struct.TreeNode*]* %stack, i32 0, i64 %21, !llfi_index !174
  %23 = load %struct.TreeNode** %22, align 8, !llfi_index !175
  store %struct.TreeNode* %23, %struct.TreeNode** %node, align 8, !llfi_index !176
  %24 = load %struct.TreeNode** %node, align 8, !llfi_index !177
  %25 = getelementptr inbounds %struct.TreeNode* %24, i32 0, i32 0, !llfi_index !178
  %26 = load i32* %25, align 4, !llfi_index !179
  %27 = load i32* %outIndex, align 4, !llfi_index !180
  %28 = add nsw i32 %27, 1, !llfi_index !181
  store i32 %28, i32* %outIndex, align 4, !llfi_index !182
  %29 = sext i32 %27 to i64, !llfi_index !183
  %30 = getelementptr inbounds [100000 x i32]* %output, i32 0, i64 %29, !llfi_index !184
  store i32 %26, i32* %30, align 4, !llfi_index !185
  %31 = load %struct.TreeNode** %node, align 8, !llfi_index !186
  %32 = getelementptr inbounds %struct.TreeNode* %31, i32 0, i32 1, !llfi_index !187
  %33 = load %struct.TreeNode** %32, align 8, !llfi_index !188
  %34 = icmp ne %struct.TreeNode* %33, null, !llfi_index !189
  br i1 %34, label %35, label %43, !llfi_index !190

; <label>:35                                      ; preds = %18
  %36 = load %struct.TreeNode** %node, align 8, !llfi_index !191
  %37 = getelementptr inbounds %struct.TreeNode* %36, i32 0, i32 1, !llfi_index !192
  %38 = load %struct.TreeNode** %37, align 8, !llfi_index !193
  %39 = load i32* %top, align 4, !llfi_index !194
  %40 = add nsw i32 %39, 1, !llfi_index !195
  store i32 %40, i32* %top, align 4, !llfi_index !196
  %41 = sext i32 %40 to i64, !llfi_index !197
  %42 = getelementptr inbounds [100000 x %struct.TreeNode*]* %stack, i32 0, i64 %41, !llfi_index !198
  store %struct.TreeNode* %38, %struct.TreeNode** %42, align 8, !llfi_index !199
  br label %43, !llfi_index !200

; <label>:43                                      ; preds = %35, %18
  %44 = load %struct.TreeNode** %node, align 8, !llfi_index !201
  %45 = getelementptr inbounds %struct.TreeNode* %44, i32 0, i32 2, !llfi_index !202
  %46 = load %struct.TreeNode** %45, align 8, !llfi_index !203
  %47 = icmp ne %struct.TreeNode* %46, null, !llfi_index !204
  br i1 %47, label %48, label %56, !llfi_index !205

; <label>:48                                      ; preds = %43
  %49 = load %struct.TreeNode** %node, align 8, !llfi_index !206
  %50 = getelementptr inbounds %struct.TreeNode* %49, i32 0, i32 2, !llfi_index !207
  %51 = load %struct.TreeNode** %50, align 8, !llfi_index !208
  %52 = load i32* %top, align 4, !llfi_index !209
  %53 = add nsw i32 %52, 1, !llfi_index !210
  store i32 %53, i32* %top, align 4, !llfi_index !211
  %54 = sext i32 %53 to i64, !llfi_index !212
  %55 = getelementptr inbounds [100000 x %struct.TreeNode*]* %stack, i32 0, i64 %54, !llfi_index !213
  store %struct.TreeNode* %51, %struct.TreeNode** %55, align 8, !llfi_index !214
...
; <label>:57                                      ; preds = %15
  %58 = load i32* %outIndex, align 4, !llfi_index !217
  %59 = sub nsw i32 %58, 1, !llfi_index !218
  store i32 %59, i32* %i, align 4, !llfi_index !219
  br label %60, !llfi_index !220

; <label>:60                                      ; preds = %67, %57
  %61 = load i32* %i, align 4, !llfi_index !221
  %62 = icmp sge i32 %61, 0, !llfi_index !222
  br i1 %62, label %63, label %70, !llfi_index !223

; <label>:63                                      ; preds = %60
  %64 = load i32* %i, align 4, !llfi_index !224
  %65 = sext i32 %64 to i64, !llfi_index !225
  %66 = getelementptr inbounds [100000 x i32]* %output, i32 0, i64 %65, !llfi_index !226
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %agg.result, i32* %66), !llfi_index !227
  br label %67, !llfi_index !228

; <label>:67                                      ; preds = %63
  %68 = load i32* %i, align 4, !llfi_index !229
  %69 = add nsw i32 %68, -1, !llfi_index !230
  store i32 %69, i32* %i, align 4, !llfi_index !231
  br label %60, !llfi_index !232

; <label>:70                                      ; preds = %60
  store i1 true, i1* %3, !llfi_index !233
  store i32 1, i32* %4, !llfi_index !234
  br label %71, !llfi_index !235

; <label>:71                                      ; preds = %70, %8
  %72 = load i1* %3, !llfi_index !236
  br i1 %72, label %74, label %73, !llfi_index !237

; <label>:73                                      ; preds = %71
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %agg.result) #0, !llfi_index !238
  br label %74, !llfi_index !239
...
define linkonce_odr i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %this) #3 align 2 {
  ...
  %3 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !244
  %4 = getelementptr inbounds %"struct.std::_Vector_base"* %3, i32 0, i32 0, !llfi_index !245
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, i32 0, i32 1, !llfi_index !246
  %6 = load i32** %5, align 8, !llfi_index !247
  %7 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !248
  %8 = getelementptr inbounds %"struct.std::_Vector_base"* %7, i32 0, i32 0, !llfi_index !249
  %9 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %8, i32 0, i32 0, !llfi_index !250
  %10 = load i32** %9, align 8, !llfi_index !251
  %11 = ptrtoint i32* %6 to i64, !llfi_index !252
  %12 = ptrtoint i32* %10 to i64, !llfi_index !253
  %13 = sub i64 %11, %12, !llfi_index !254
  %14 = sdiv exact i64 %13, 4, !llfi_index !255
  ret i64 %14, !llfi_index !256
}
...
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %this, i64 %__n) #3 align 2 {
  ...
  store i64 %__n, i64* %2, align 8, !llfi_index !260
  %3 = load %"class.std::vector"** %1, !llfi_index !261
  %4 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !262
  %5 = getelementptr inbounds %"struct.std::_Vector_base"* %4, i32 0, i32 0, !llfi_index !263
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %5, i32 0, i32 0, !llfi_index !264
  %7 = load i32** %6, align 8, !llfi_index !265
  %8 = load i64* %2, align 8, !llfi_index !266
  %9 = getelementptr inbounds i32* %7, i64 %8, !llfi_index !267
  ret i32* %9, !llfi_index !268
}
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.std::vector"*, align 8, !llfi_index !269
  store %"class.std::vector"* %this, %"class.std::vector"** %1, align 8, !llfi_index !270
  %2 = load %"class.std::vector"** %1, !llfi_index !271
  %3 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !272
  %4 = getelementptr inbounds %"struct.std::_Vector_base"* %3, i32 0, i32 0, !llfi_index !273
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, i32 0, i32 0, !llfi_index !274
  %6 = load i32** %5, align 8, !llfi_index !275
  %7 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !276
  %8 = getelementptr inbounds %"struct.std::_Vector_base"* %7, i32 0, i32 0, !llfi_index !277
  %9 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %8, i32 0, i32 1, !llfi_index !278
  %10 = load i32** %9, align 8, !llfi_index !279
  %11 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !280
  %12 = call %"class.std::allocator.1"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %11) #0, !llfi_index !281
  call void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %6, i32* %10, %"class.std::allocator.1"* %12), !llfi_index !282
  %13 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !283
  call void @_ZNSt12_Vector_baseIiSaIiEED2Ev(%"struct.std::_Vector_base"* %13) #0, !llfi_index !284
...
define linkonce_odr void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %__first, i32* %__last, %"class.std::allocator.1"*) #5 {
  ...
  %3 = alloca i32*, align 8, !llfi_index !287
  %4 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !288
  store i32* %__first, i32** %2, align 8, !llfi_index !289
  store i32* %__last, i32** %3, align 8, !llfi_index !290
  store %"class.std::allocator.1"* %0, %"class.std::allocator.1"** %4, align 8, !llfi_index !291
  %5 = load i32** %2, align 8, !llfi_index !292
  %6 = load i32** %3, align 8, !llfi_index !293
  call void @_ZSt8_DestroyIPiEvT_S1_(i32* %5, i32* %6), !llfi_index !294
...
define linkonce_odr %"class.std::allocator.1"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %this) #3 align 2 {
  ...
  %2 = load %"struct.std::_Vector_base"** %1, !llfi_index !298
  %3 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !299
  %4 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3 to %"class.std::allocator.1"*, !llfi_index !300
  ret %"class.std::allocator.1"* %4, !llfi_index !301
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEED2Ev(%"struct.std::_Vector_base"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8, !llfi_index !302
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8, !llfi_index !303
  %2 = load %"struct.std::_Vector_base"** %1, !llfi_index !304
  %3 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !305
  %4 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3, i32 0, i32 0, !llfi_index !306
  %5 = load i32** %4, align 8, !llfi_index !307
  %6 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !308
  %7 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %6, i32 0, i32 2, !llfi_index !309
  %8 = load i32** %7, align 8, !llfi_index !310
  %9 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !311
  %10 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %9, i32 0, i32 0, !llfi_index !312
  %11 = load i32** %10, align 8, !llfi_index !313
  %12 = ptrtoint i32* %8 to i64, !llfi_index !314
  %13 = ptrtoint i32* %11 to i64, !llfi_index !315
  %14 = sub i64 %12, %13, !llfi_index !316
  %15 = sdiv exact i64 %14, 4, !llfi_index !317
  call void @_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim(%"struct.std::_Vector_base"* %2, i32* %5, i64 %15), !llfi_index !318
  %16 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !319
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implD2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %16) #0, !llfi_index !320
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim(%"struct.std::_Vector_base"* %this, i32* %__p, i64 %__n) #3 align 2 {
  ...
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8, !llfi_index !325
  store i32* %__p, i32** %2, align 8, !llfi_index !326
  store i64 %__n, i64* %3, align 8, !llfi_index !327
  %4 = load %"struct.std::_Vector_base"** %1, !llfi_index !328
  %5 = load i32** %2, align 8, !llfi_index !329
  %6 = icmp ne i32* %5, null, !llfi_index !330
  br i1 %6, label %7, label %12, !llfi_index !331

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %"struct.std::_Vector_base"* %4, i32 0, i32 0, !llfi_index !332
  %9 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %8 to %"class.std::allocator.1"*, !llfi_index !333
  %10 = load i32** %2, align 8, !llfi_index !334
  %11 = load i64* %3, align 8, !llfi_index !335
  call void @_ZNSt16allocator_traitsISaIiEE10deallocateERS0_Pim(%"class.std::allocator.1"* %9, i32* %10, i64 %11), !llfi_index !336
  br label %12, !llfi_index !337
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implD2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"*, align 8, !llfi_index !339
  store %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1, align 8, !llfi_index !340
  %2 = load %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1, !llfi_index !341
  %3 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2 to %"class.std::allocator.1"*, !llfi_index !342
  call void @_ZNSaIiED2Ev(%"class.std::allocator.1"* %3) #0, !llfi_index !343
  ret void, !llfi_index !344
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIiED2Ev(%"class.std::allocator.1"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !345
  store %"class.std::allocator.1"* %this, %"class.std::allocator.1"** %1, align 8, !llfi_index !346
  %2 = load %"class.std::allocator.1"** %1, !llfi_index !347
  %3 = bitcast %"class.std::allocator.1"* %2 to %"class.__gnu_cxx::new_allocator.2"*, !llfi_index !348
  call void @_ZN9__gnu_cxx13new_allocatorIiED2Ev(%"class.__gnu_cxx::new_allocator.2"* %3) #0, !llfi_index !349
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiED2Ev(%"class.__gnu_cxx::new_allocator.2"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.2"*, align 8, !llfi_index !351
  store %"class.__gnu_cxx::new_allocator.2"* %this, %"class.__gnu_cxx::new_allocator.2"** %1, align 8, !llfi_index !352
  %2 = load %"class.__gnu_cxx::new_allocator.2"** %1, !llfi_index !353
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE10deallocateERS0_Pim(%"class.std::allocator.1"* %__a, i32* %__p, i64 %__n) #3 align 2 {
  ...
  %3 = alloca i64, align 8, !llfi_index !357
  store %"class.std::allocator.1"* %__a, %"class.std::allocator.1"** %1, align 8, !llfi_index !358
  store i32* %__p, i32** %2, align 8, !llfi_index !359
  store i64 %__n, i64* %3, align 8, !llfi_index !360
  %4 = load %"class.std::allocator.1"** %1, align 8, !llfi_index !361
  %5 = bitcast %"class.std::allocator.1"* %4 to %"class.__gnu_cxx::new_allocator.2"*, !llfi_index !362
  %6 = load i32** %2, align 8, !llfi_index !363
  %7 = load i64* %3, align 8, !llfi_index !364
  call void @_ZN9__gnu_cxx13new_allocatorIiE10deallocateEPim(%"class.__gnu_cxx::new_allocator.2"* %5, i32* %6, i64 %7), !llfi_index !365
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE10deallocateEPim(%"class.__gnu_cxx::new_allocator.2"* %this, i32* %__p, i64) #3 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator.2"*, align 8, !llfi_index !367
  %3 = alloca i32*, align 8, !llfi_index !368
  %4 = alloca i64, align 8, !llfi_index !369
  store %"class.__gnu_cxx::new_allocator.2"* %this, %"class.__gnu_cxx::new_allocator.2"** %2, align 8, !llfi_index !370
  store i32* %__p, i32** %3, align 8, !llfi_index !371
  store i64 %0, i64* %4, align 8, !llfi_index !372
  %5 = load %"class.__gnu_cxx::new_allocator.2"** %2, !llfi_index !373
  %6 = load i32** %3, align 8, !llfi_index !374
  %7 = bitcast i32* %6 to i8*, !llfi_index !375
  call void @_ZdlPv(i8* %7) #0, !llfi_index !376
...
define linkonce_odr void @_ZSt8_DestroyIPiEvT_S1_(i32* %__first, i32* %__last) #5 {
  %1 = alloca i32*, align 8, !llfi_index !378
  %2 = alloca i32*, align 8, !llfi_index !379
  store i32* %__first, i32** %1, align 8, !llfi_index !380
  store i32* %__last, i32** %2, align 8, !llfi_index !381
  %3 = load i32** %1, align 8, !llfi_index !382
  %4 = load i32** %2, align 8, !llfi_index !383
  call void @_ZNSt12_Destroy_auxILb1EE9__destroyIPiEEvT_S3_(i32* %3, i32* %4), !llfi_index !384
...
define linkonce_odr void @_ZNSt12_Destroy_auxILb1EE9__destroyIPiEEvT_S3_(i32*, i32*) #3 align 2 {
  ...
  %4 = alloca i32*, align 8, !llfi_index !387
  store i32* %0, i32** %3, align 8, !llfi_index !388
  store i32* %1, i32** %4, align 8, !llfi_index !389
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %this) unnamed_addr #3 align 2 {
  ...
  %3 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !394
  call void @_ZNSt12_Vector_baseIiSaIiEEC2Ev(%"struct.std::_Vector_base"* %3), !llfi_index !395
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %this, i32* %__x) #3 align 2 {
  ...
  store i32* %__x, i32** %2, align 8, !llfi_index !400
  %3 = load %"class.std::vector"** %1, !llfi_index !401
  %4 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !402
  %5 = getelementptr inbounds %"struct.std::_Vector_base"* %4, i32 0, i32 0, !llfi_index !403
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %5, i32 0, i32 1, !llfi_index !404
  %7 = load i32** %6, align 8, !llfi_index !405
  %8 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !406
  %9 = getelementptr inbounds %"struct.std::_Vector_base"* %8, i32 0, i32 0, !llfi_index !407
  %10 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %9, i32 0, i32 2, !llfi_index !408
  %11 = load i32** %10, align 8, !llfi_index !409
  %12 = icmp ne i32* %7, %11, !llfi_index !410
  br i1 %12, label %13, label %27, !llfi_index !411

; <label>:13                                      ; preds = %0
  %14 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !412
  %15 = getelementptr inbounds %"struct.std::_Vector_base"* %14, i32 0, i32 0, !llfi_index !413
  %16 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %15 to %"class.std::allocator.1"*, !llfi_index !414
  %17 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !415
  %18 = getelementptr inbounds %"struct.std::_Vector_base"* %17, i32 0, i32 0, !llfi_index !416
  %19 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %18, i32 0, i32 1, !llfi_index !417
  %20 = load i32** %19, align 8, !llfi_index !418
  %21 = load i32** %2, align 8, !llfi_index !419
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.1"* %16, i32* %20, i32* %21), !llfi_index !420
  %22 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !421
  %23 = getelementptr inbounds %"struct.std::_Vector_base"* %22, i32 0, i32 0, !llfi_index !422
  %24 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %23, i32 0, i32 1, !llfi_index !423
  %25 = load i32** %24, align 8, !llfi_index !424
  %26 = getelementptr inbounds i32* %25, i32 1, !llfi_index !425
  store i32* %26, i32** %24, align 8, !llfi_index !426
  br label %29, !llfi_index !427

; <label>:27                                      ; preds = %0
  %28 = load i32** %2, align 8, !llfi_index !428
  call void @_ZNSt6vectorIiSaIiEE19_M_emplace_back_auxIJRKiEEEvDpOT_(%"class.std::vector"* %3, i32* %28), !llfi_index !429
  br label %29, !llfi_index !430
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.1"* %__a, i32* %__p, i32* %__args) #3 align 2 {
  %1 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !432
  %2 = alloca i32*, align 8, !llfi_index !433
  %3 = alloca i32*, align 8, !llfi_index !434
  store %"class.std::allocator.1"* %__a, %"class.std::allocator.1"** %1, align 8, !llfi_index !435
  store i32* %__p, i32** %2, align 8, !llfi_index !436
  store i32* %__args, i32** %3, align 8, !llfi_index !437
  %4 = load %"class.std::allocator.1"** %1, align 8, !llfi_index !438
  %5 = bitcast %"class.std::allocator.1"* %4 to %"class.__gnu_cxx::new_allocator.2"*, !llfi_index !439
  %6 = load i32** %2, align 8, !llfi_index !440
  %7 = load i32** %3, align 8, !llfi_index !441
  %8 = call i32* @_ZSt7forwardIRKiEOT_RNSt16remove_referenceIS2_E4typeE(i32* %7) #0, !llfi_index !442
  call void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRKiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.2"* %5, i32* %6, i32* %8), !llfi_index !443
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE19_M_emplace_back_auxIJRKiEEEvDpOT_(%"class.std::vector"* %this, i32* %__args) #3 align 2 {
  ...
  %__new_start = alloca i32*, align 8, !llfi_index !448
  %__new_finish = alloca i32*, align 8, !llfi_index !449
  store %"class.std::vector"* %this, %"class.std::vector"** %1, align 8, !llfi_index !450
  store i32* %__args, i32** %2, align 8, !llfi_index !451
  %3 = load %"class.std::vector"** %1, !llfi_index !452
  %4 = call i64 @_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc(%"class.std::vector"* %3, i64 1, i8* getelementptr inbounds ([28 x i8]* @.str2, i32 0, i32 0)), !llfi_index !453
  store i64 %4, i64* %__len, align 8, !llfi_index !454
  %5 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !455
  %6 = load i64* %__len, align 8, !llfi_index !456
  %7 = call i32* @_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm(%"struct.std::_Vector_base"* %5, i64 %6), !llfi_index !457
  store i32* %7, i32** %__new_start, align 8, !llfi_index !458
  %8 = load i32** %__new_start, align 8, !llfi_index !459
  store i32* %8, i32** %__new_finish, align 8, !llfi_index !460
  %9 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !461
  %10 = getelementptr inbounds %"struct.std::_Vector_base"* %9, i32 0, i32 0, !llfi_index !462
  %11 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %10 to %"class.std::allocator.1"*, !llfi_index !463
  %12 = load i32** %__new_start, align 8, !llfi_index !464
  %13 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %3) #0, !llfi_index !465
  %14 = getelementptr inbounds i32* %12, i64 %13, !llfi_index !466
  %15 = load i32** %2, align 8, !llfi_index !467
  %16 = call i32* @_ZSt7forwardIRKiEOT_RNSt16remove_referenceIS2_E4typeE(i32* %15) #0, !llfi_index !468
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.1"* %11, i32* %14, i32* %16), !llfi_index !469
  store i32* null, i32** %__new_finish, align 8, !llfi_index !470
  %17 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !471
  %18 = getelementptr inbounds %"struct.std::_Vector_base"* %17, i32 0, i32 0, !llfi_index !472
  %19 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %18, i32 0, i32 0, !llfi_index !473
  %20 = load i32** %19, align 8, !llfi_index !474
  %21 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !475
  %22 = getelementptr inbounds %"struct.std::_Vector_base"* %21, i32 0, i32 0, !llfi_index !476
  %23 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %22, i32 0, i32 1, !llfi_index !477
  %24 = load i32** %23, align 8, !llfi_index !478
  %25 = load i32** %__new_start, align 8, !llfi_index !479
  %26 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !480
  %27 = call %"class.std::allocator.1"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %26) #0, !llfi_index !481
  %28 = call i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %20, i32* %24, i32* %25, %"class.std::allocator.1"* %27), !llfi_index !482
  store i32* %28, i32** %__new_finish, align 8, !llfi_index !483
  %29 = load i32** %__new_finish, align 8, !llfi_index !484
  %30 = getelementptr inbounds i32* %29, i32 1, !llfi_index !485
  store i32* %30, i32** %__new_finish, align 8, !llfi_index !486
  %31 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !487
  %32 = getelementptr inbounds %"struct.std::_Vector_base"* %31, i32 0, i32 0, !llfi_index !488
  %33 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %32, i32 0, i32 0, !llfi_index !489
  %34 = load i32** %33, align 8, !llfi_index !490
  %35 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !491
  %36 = getelementptr inbounds %"struct.std::_Vector_base"* %35, i32 0, i32 0, !llfi_index !492
  %37 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %36, i32 0, i32 1, !llfi_index !493
  %38 = load i32** %37, align 8, !llfi_index !494
  %39 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !495
  %40 = call %"class.std::allocator.1"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %39) #0, !llfi_index !496
  call void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %34, i32* %38, %"class.std::allocator.1"* %40), !llfi_index !497
  %41 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !498
  %42 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !499
  %43 = getelementptr inbounds %"struct.std::_Vector_base"* %42, i32 0, i32 0, !llfi_index !500
  %44 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %43, i32 0, i32 0, !llfi_index !501
  %45 = load i32** %44, align 8, !llfi_index !502
  %46 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !503
  %47 = getelementptr inbounds %"struct.std::_Vector_base"* %46, i32 0, i32 0, !llfi_index !504
  %48 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %47, i32 0, i32 2, !llfi_index !505
  %49 = load i32** %48, align 8, !llfi_index !506
  %50 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !507
  %51 = getelementptr inbounds %"struct.std::_Vector_base"* %50, i32 0, i32 0, !llfi_index !508
  %52 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %51, i32 0, i32 0, !llfi_index !509
  %53 = load i32** %52, align 8, !llfi_index !510
  %54 = ptrtoint i32* %49 to i64, !llfi_index !511
  %55 = ptrtoint i32* %53 to i64, !llfi_index !512
  %56 = sub i64 %54, %55, !llfi_index !513
  %57 = sdiv exact i64 %56, 4, !llfi_index !514
  call void @_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim(%"struct.std::_Vector_base"* %41, i32* %45, i64 %57), !llfi_index !515
  %58 = load i32** %__new_start, align 8, !llfi_index !516
  %59 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !517
  %60 = getelementptr inbounds %"struct.std::_Vector_base"* %59, i32 0, i32 0, !llfi_index !518
  %61 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %60, i32 0, i32 0, !llfi_index !519
  store i32* %58, i32** %61, align 8, !llfi_index !520
  %62 = load i32** %__new_finish, align 8, !llfi_index !521
  %63 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !522
  %64 = getelementptr inbounds %"struct.std::_Vector_base"* %63, i32 0, i32 0, !llfi_index !523
  %65 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %64, i32 0, i32 1, !llfi_index !524
  store i32* %62, i32** %65, align 8, !llfi_index !525
  %66 = load i32** %__new_start, align 8, !llfi_index !526
  %67 = load i64* %__len, align 8, !llfi_index !527
  %68 = getelementptr inbounds i32* %66, i64 %67, !llfi_index !528
  %69 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !529
  %70 = getelementptr inbounds %"struct.std::_Vector_base"* %69, i32 0, i32 0, !llfi_index !530
  %71 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %70, i32 0, i32 2, !llfi_index !531
  store i32* %68, i32** %71, align 8, !llfi_index !532
...
define linkonce_odr i64 @_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc(%"class.std::vector"* %this, i64 %__n, i8* %__s) #3 align 2 {
  ...
  %2 = alloca i64, align 8, !llfi_index !535
  %3 = alloca i8*, align 8, !llfi_index !536
  %__len = alloca i64, align 8, !llfi_index !537
  %4 = alloca i64, align 8, !llfi_index !538
  store %"class.std::vector"* %this, %"class.std::vector"** %1, align 8, !llfi_index !539
  store i64 %__n, i64* %2, align 8, !llfi_index !540
  store i8* %__s, i8** %3, align 8, !llfi_index !541
  %5 = load %"class.std::vector"** %1, !llfi_index !542
  %6 = call i64 @_ZNKSt6vectorIiSaIiEE8max_sizeEv(%"class.std::vector"* %5) #0, !llfi_index !543
  %7 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %5) #0, !llfi_index !544
  %8 = sub i64 %6, %7, !llfi_index !545
  %9 = load i64* %2, align 8, !llfi_index !546
  %10 = icmp ult i64 %8, %9, !llfi_index !547
  br i1 %10, label %11, label %13, !llfi_index !548

; <label>:11                                      ; preds = %0
  %12 = load i8** %3, align 8, !llfi_index !549
  call void @_ZSt20__throw_length_errorPKc(i8* %12) #9, !llfi_index !550
  unreachable, !llfi_index !551

; <label>:13                                      ; preds = %0
  %14 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %5) #0, !llfi_index !552
  %15 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %5) #0, !llfi_index !553
  store i64 %15, i64* %4, !llfi_index !554
  %16 = call i64* @_ZSt3maxImERKT_S2_S2_(i64* %4, i64* %2), !llfi_index !555
  %17 = load i64* %16, !llfi_index !556
  %18 = add i64 %14, %17, !llfi_index !557
  store i64 %18, i64* %__len, align 8, !llfi_index !558
  %19 = load i64* %__len, align 8, !llfi_index !559
  %20 = call i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %5) #0, !llfi_index !560
  %21 = icmp ult i64 %19, %20, !llfi_index !561
  br i1 %21, label %26, label %22, !llfi_index !562

; <label>:22                                      ; preds = %13
  %23 = load i64* %__len, align 8, !llfi_index !563
  %24 = call i64 @_ZNKSt6vectorIiSaIiEE8max_sizeEv(%"class.std::vector"* %5) #0, !llfi_index !564
  %25 = icmp ugt i64 %23, %24, !llfi_index !565
  br i1 %25, label %26, label %28, !llfi_index !566

; <label>:26                                      ; preds = %22, %13
  %27 = call i64 @_ZNKSt6vectorIiSaIiEE8max_sizeEv(%"class.std::vector"* %5) #0, !llfi_index !567
  br label %30, !llfi_index !568

; <label>:28                                      ; preds = %22
  %29 = load i64* %__len, align 8, !llfi_index !569
  br label %30, !llfi_index !570

; <label>:30                                      ; preds = %28, %26
  %31 = phi i64 [ %27, %26 ], [ %29, %28 ], !llfi_index !571
  ret i64 %31, !llfi_index !572
}

; Function Attrs: nounwind uwtable
define linkonce_odr i32* @_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm(%"struct.std::_Vector_base"* %this, i64 %__n) #3 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8, !llfi_index !573
  %2 = alloca i64, align 8, !llfi_index !574
  ...
  %3 = load %"struct.std::_Vector_base"** %1, !llfi_index !577
  %4 = load i64* %2, align 8, !llfi_index !578
  %5 = icmp ne i64 %4, 0, !llfi_index !579
  br i1 %5, label %6, label %11, !llfi_index !580

; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds %"struct.std::_Vector_base"* %3, i32 0, i32 0, !llfi_index !581
  %8 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %7 to %"class.std::allocator.1"*, !llfi_index !582
  %9 = load i64* %2, align 8, !llfi_index !583
  %10 = call i32* @_ZNSt16allocator_traitsISaIiEE8allocateERS0_m(%"class.std::allocator.1"* %8, i64 %9), !llfi_index !584
  br label %12, !llfi_index !585

; <label>:11                                      ; preds = %0
  br label %12, !llfi_index !586

; <label>:12                                      ; preds = %11, %6
  %13 = phi i32* [ %10, %6 ], [ null, %11 ], !llfi_index !587
  ret i32* %13, !llfi_index !588
}

; Function Attrs: nounwind uwtable
define linkonce_odr i32* @_ZSt7forwardIRKiEOT_RNSt16remove_referenceIS2_E4typeE(i32* %__t) #3 {
  %1 = alloca i32*, align 8, !llfi_index !589
  store i32* %__t, i32** %1, align 8, !llfi_index !590
  %2 = load i32** %1, align 8, !llfi_index !591
  ret i32* %2, !llfi_index !592
}
...
define linkonce_odr i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %__first, i32* %__last, i32* %__result, %"class.std::allocator.1"* %__alloc) #5 {
  ...
  %3 = alloca i32*, align 8, !llfi_index !595
  %4 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !596
  %5 = alloca %"class.std::move_iterator", align 8, !llfi_index !597
  %6 = alloca %"class.std::move_iterator", align 8, !llfi_index !598
  store i32* %__first, i32** %1, align 8, !llfi_index !599
  store i32* %__last, i32** %2, align 8, !llfi_index !600
  store i32* %__result, i32** %3, align 8, !llfi_index !601
  store %"class.std::allocator.1"* %__alloc, %"class.std::allocator.1"** %4, align 8, !llfi_index !602
  %7 = load i32** %1, align 8, !llfi_index !603
  %8 = call i32* @_ZSt32__make_move_if_noexcept_iteratorIPiSt13move_iteratorIS0_EET0_T_(i32* %7), !llfi_index !604
  %9 = getelementptr %"class.std::move_iterator"* %5, i32 0, i32 0, !llfi_index !605
  store i32* %8, i32** %9, !llfi_index !606
  %10 = load i32** %2, align 8, !llfi_index !607
  %11 = call i32* @_ZSt32__make_move_if_noexcept_iteratorIPiSt13move_iteratorIS0_EET0_T_(i32* %10), !llfi_index !608
  %12 = getelementptr %"class.std::move_iterator"* %6, i32 0, i32 0, !llfi_index !609
  store i32* %11, i32** %12, !llfi_index !610
  %13 = load i32** %3, align 8, !llfi_index !611
  %14 = load %"class.std::allocator.1"** %4, align 8, !llfi_index !612
  %15 = getelementptr %"class.std::move_iterator"* %5, i32 0, i32 0, !llfi_index !613
  %16 = load i32** %15, !llfi_index !614
  %17 = getelementptr %"class.std::move_iterator"* %6, i32 0, i32 0, !llfi_index !615
  %18 = load i32** %17, !llfi_index !616
  %19 = call i32* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPiES1_iET0_T_S4_S3_RSaIT1_E(i32* %16, i32* %18, i32* %13, %"class.std::allocator.1"* %14), !llfi_index !617
  ret i32* %19, !llfi_index !618
}
...
; <label>:8                                       ; preds = %0
  ...
  %11 = call i32* @_ZSt7forwardIRKiEOT_RNSt16remove_referenceIS2_E4typeE(i32* %10) #0, !llfi_index !903
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEEC2Ev(%"struct.std::_Vector_base"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3), !llfi_index !913
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this) unnamed_addr #3 align 2 {
  ...
  %3 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2 to %"class.std::allocator.1"*, !llfi_index !918
  call void @_ZNSaIiEC2Ev(%"class.std::allocator.1"* %3) #0, !llfi_index !919
  %4 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2, i32 0, i32 0, !llfi_index !920
  store i32* null, i32** %4, align 8, !llfi_index !921
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2, i32 0, i32 1, !llfi_index !922
  store i32* null, i32** %5, align 8, !llfi_index !923
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2, i32 0, i32 2, !llfi_index !924
  store i32* null, i32** %6, align 8, !llfi_index !925
...
define linkonce_odr void @_ZNSaIiEC2Ev(%"class.std::allocator.1"* %this) unnamed_addr #3 align 2 {
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIiEC2Ev(%"class.__gnu_cxx::new_allocator.2"* %3) #0, !llfi_index !931
