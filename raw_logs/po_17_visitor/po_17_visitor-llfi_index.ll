...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNode(%"class.std::vector"* noalias sret %agg.result, %class.Solution* %this, %struct.TreeNode* %root) #3 align 2 {
  ...
  %adapter = alloca %class.VectorVisitor, align 8, !llfi_index !137
  %4 = alloca i32, !llfi_index !138
  store %class.Solution* %this, %class.Solution** %1, align 8, !llfi_index !139
  store %struct.TreeNode* %root, %struct.TreeNode** %2, align 8, !llfi_index !140
  %5 = load %class.Solution** %1, !llfi_index !141
  store i1 false, i1* %3, !llfi_index !142
  call void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %agg.result) #0, !llfi_index !143
  call void @_ZN13VectorVisitorC2ERSt6vectorIiSaIiEE(%class.VectorVisitor* %adapter, %"class.std::vector"* %agg.result), !llfi_index !144
  %6 = load %struct.TreeNode** %2, align 8, !llfi_index !145
  %7 = bitcast %class.VectorVisitor* %adapter to %class.NodeVisitor*, !llfi_index !146
  call void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %5, %struct.TreeNode* %6, %class.NodeVisitor* %7), !llfi_index !147
  store i1 true, i1* %3, !llfi_index !148
  store i32 1, i32* %4, !llfi_index !149
  call void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %adapter) #0, !llfi_index !150
  %8 = load i1* %3, !llfi_index !151
  br i1 %8, label %10, label %9, !llfi_index !152

; <label>:9                                       ; preds = %0
  call void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %agg.result) #0, !llfi_index !153
  br label %10, !llfi_index !154
...
define linkonce_odr i64 @_ZNKSt6vectorIiSaIiEE4sizeEv(%"class.std::vector"* %this) #3 align 2 {
  ...
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, i32 0, i32 1, !llfi_index !161
  ...
  %9 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %8, i32 0, i32 0, !llfi_index !165
  %10 = load i32** %9, align 8, !llfi_index !166
  %11 = ptrtoint i32* %6 to i64, !llfi_index !167
  %12 = ptrtoint i32* %10 to i64, !llfi_index !168
  %13 = sub i64 %11, %12, !llfi_index !169
  %14 = sdiv exact i64 %13, 4, !llfi_index !170
  ret i64 %14, !llfi_index !171
}
...
define linkonce_odr i32* @_ZNSt6vectorIiSaIiEEixEm(%"class.std::vector"* %this, i64 %__n) #3 align 2 {
  %1 = alloca %"class.std::vector"*, align 8, !llfi_index !172
  %2 = alloca i64, align 8, !llfi_index !173
  store %"class.std::vector"* %this, %"class.std::vector"** %1, align 8, !llfi_index !174
  store i64 %__n, i64* %2, align 8, !llfi_index !175
  %3 = load %"class.std::vector"** %1, !llfi_index !176
  %4 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !177
  %5 = getelementptr inbounds %"struct.std::_Vector_base"* %4, i32 0, i32 0, !llfi_index !178
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %5, i32 0, i32 0, !llfi_index !179
  %7 = load i32** %6, align 8, !llfi_index !180
  %8 = load i64* %2, align 8, !llfi_index !181
  %9 = getelementptr inbounds i32* %7, i64 %8, !llfi_index !182
  ret i32* %9, !llfi_index !183
}
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEED2Ev(%"class.std::vector"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.std::vector"*, align 8, !llfi_index !184
  store %"class.std::vector"* %this, %"class.std::vector"** %1, align 8, !llfi_index !185
  %2 = load %"class.std::vector"** %1, !llfi_index !186
  %3 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !187
  %4 = getelementptr inbounds %"struct.std::_Vector_base"* %3, i32 0, i32 0, !llfi_index !188
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %4, i32 0, i32 0, !llfi_index !189
  %6 = load i32** %5, align 8, !llfi_index !190
  %7 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !191
  %8 = getelementptr inbounds %"struct.std::_Vector_base"* %7, i32 0, i32 0, !llfi_index !192
  %9 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %8, i32 0, i32 1, !llfi_index !193
  %10 = load i32** %9, align 8, !llfi_index !194
  %11 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !195
  %12 = call %"class.std::allocator.1"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %11) #0, !llfi_index !196
  call void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %6, i32* %10, %"class.std::allocator.1"* %12), !llfi_index !197
  %13 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !198
  call void @_ZNSt12_Vector_baseIiSaIiEED2Ev(%"struct.std::_Vector_base"* %13) #0, !llfi_index !199
...
define linkonce_odr void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %__first, i32* %__last, %"class.std::allocator.1"*) #5 {
  ...
  %3 = alloca i32*, align 8, !llfi_index !202
  %4 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !203
  store i32* %__first, i32** %2, align 8, !llfi_index !204
  store i32* %__last, i32** %3, align 8, !llfi_index !205
  store %"class.std::allocator.1"* %0, %"class.std::allocator.1"** %4, align 8, !llfi_index !206
  %5 = load i32** %2, align 8, !llfi_index !207
  %6 = load i32** %3, align 8, !llfi_index !208
  call void @_ZSt8_DestroyIPiEvT_S1_(i32* %5, i32* %6), !llfi_index !209
...
define linkonce_odr %"class.std::allocator.1"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %this) #3 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8, !llfi_index !211
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8, !llfi_index !212
  %2 = load %"struct.std::_Vector_base"** %1, !llfi_index !213
  %3 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !214
  %4 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3 to %"class.std::allocator.1"*, !llfi_index !215
  ret %"class.std::allocator.1"* %4, !llfi_index !216
}
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEED2Ev(%"struct.std::_Vector_base"* %this) unnamed_addr #3 align 2 {
  ...
  %4 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3, i32 0, i32 0, !llfi_index !221
  %5 = load i32** %4, align 8, !llfi_index !222
  %6 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !223
  %7 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %6, i32 0, i32 2, !llfi_index !224
  %8 = load i32** %7, align 8, !llfi_index !225
  %9 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !226
  %10 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %9, i32 0, i32 0, !llfi_index !227
  %11 = load i32** %10, align 8, !llfi_index !228
  %12 = ptrtoint i32* %8 to i64, !llfi_index !229
  %13 = ptrtoint i32* %11 to i64, !llfi_index !230
  %14 = sub i64 %12, %13, !llfi_index !231
  %15 = sdiv exact i64 %14, 4, !llfi_index !232
  call void @_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim(%"struct.std::_Vector_base"* %2, i32* %5, i64 %15), !llfi_index !233
  %16 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !234
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implD2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %16) #0, !llfi_index !235
  ret void, !llfi_index !236
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim(%"struct.std::_Vector_base"* %this, i32* %__p, i64 %__n) #3 align 2 {
  %1 = alloca %"struct.std::_Vector_base"*, align 8, !llfi_index !237
  %2 = alloca i32*, align 8, !llfi_index !238
  %3 = alloca i64, align 8, !llfi_index !239
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %1, align 8, !llfi_index !240
  store i32* %__p, i32** %2, align 8, !llfi_index !241
  store i64 %__n, i64* %3, align 8, !llfi_index !242
  %4 = load %"struct.std::_Vector_base"** %1, !llfi_index !243
  %5 = load i32** %2, align 8, !llfi_index !244
  %6 = icmp ne i32* %5, null, !llfi_index !245
  br i1 %6, label %7, label %12, !llfi_index !246

; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %"struct.std::_Vector_base"* %4, i32 0, i32 0, !llfi_index !247
  %9 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %8 to %"class.std::allocator.1"*, !llfi_index !248
  %10 = load i32** %2, align 8, !llfi_index !249
  %11 = load i64* %3, align 8, !llfi_index !250
  call void @_ZNSt16allocator_traitsISaIiEE10deallocateERS0_Pim(%"class.std::allocator.1"* %9, i32* %10, i64 %11), !llfi_index !251
  br label %12, !llfi_index !252
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implD2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this) unnamed_addr #5 align 2 {
  %1 = alloca %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"*, align 8, !llfi_index !254
  store %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1, align 8, !llfi_index !255
  %2 = load %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %1, !llfi_index !256
  %3 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2 to %"class.std::allocator.1"*, !llfi_index !257
  call void @_ZNSaIiED2Ev(%"class.std::allocator.1"* %3) #0, !llfi_index !258
  ret void, !llfi_index !259
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSaIiED2Ev(%"class.std::allocator.1"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !260
  store %"class.std::allocator.1"* %this, %"class.std::allocator.1"** %1, align 8, !llfi_index !261
  %2 = load %"class.std::allocator.1"** %1, !llfi_index !262
  %3 = bitcast %"class.std::allocator.1"* %2 to %"class.__gnu_cxx::new_allocator.2"*, !llfi_index !263
  call void @_ZN9__gnu_cxx13new_allocatorIiED2Ev(%"class.__gnu_cxx::new_allocator.2"* %3) #0, !llfi_index !264
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiED2Ev(%"class.__gnu_cxx::new_allocator.2"* %this) unnamed_addr #3 align 2 {
  %1 = alloca %"class.__gnu_cxx::new_allocator.2"*, align 8, !llfi_index !266
  store %"class.__gnu_cxx::new_allocator.2"* %this, %"class.__gnu_cxx::new_allocator.2"** %1, align 8, !llfi_index !267
  %2 = load %"class.__gnu_cxx::new_allocator.2"** %1, !llfi_index !268
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE10deallocateERS0_Pim(%"class.std::allocator.1"* %__a, i32* %__p, i64 %__n) #3 align 2 {
  %1 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !270
  %2 = alloca i32*, align 8, !llfi_index !271
  %3 = alloca i64, align 8, !llfi_index !272
  store %"class.std::allocator.1"* %__a, %"class.std::allocator.1"** %1, align 8, !llfi_index !273
  store i32* %__p, i32** %2, align 8, !llfi_index !274
  store i64 %__n, i64* %3, align 8, !llfi_index !275
  %4 = load %"class.std::allocator.1"** %1, align 8, !llfi_index !276
  %5 = bitcast %"class.std::allocator.1"* %4 to %"class.__gnu_cxx::new_allocator.2"*, !llfi_index !277
  %6 = load i32** %2, align 8, !llfi_index !278
  %7 = load i64* %3, align 8, !llfi_index !279
  call void @_ZN9__gnu_cxx13new_allocatorIiE10deallocateEPim(%"class.__gnu_cxx::new_allocator.2"* %5, i32* %6, i64 %7), !llfi_index !280
...
define linkonce_odr void @_ZN9__gnu_cxx13new_allocatorIiE10deallocateEPim(%"class.__gnu_cxx::new_allocator.2"* %this, i32* %__p, i64) #3 align 2 {
  %2 = alloca %"class.__gnu_cxx::new_allocator.2"*, align 8, !llfi_index !282
  %3 = alloca i32*, align 8, !llfi_index !283
  %4 = alloca i64, align 8, !llfi_index !284
  store %"class.__gnu_cxx::new_allocator.2"* %this, %"class.__gnu_cxx::new_allocator.2"** %2, align 8, !llfi_index !285
  store i32* %__p, i32** %3, align 8, !llfi_index !286
  store i64 %0, i64* %4, align 8, !llfi_index !287
  %5 = load %"class.__gnu_cxx::new_allocator.2"** %2, !llfi_index !288
  %6 = load i32** %3, align 8, !llfi_index !289
  %7 = bitcast i32* %6 to i8*, !llfi_index !290
  call void @_ZdlPv(i8* %7) #0, !llfi_index !291
...
define linkonce_odr void @_ZSt8_DestroyIPiEvT_S1_(i32* %__first, i32* %__last) #5 {
  ...
  store i32* %__first, i32** %1, align 8, !llfi_index !295
  store i32* %__last, i32** %2, align 8, !llfi_index !296
  %3 = load i32** %1, align 8, !llfi_index !297
  %4 = load i32** %2, align 8, !llfi_index !298
  call void @_ZNSt12_Destroy_auxILb1EE9__destroyIPiEEvT_S3_(i32* %3, i32* %4), !llfi_index !299
...
define linkonce_odr void @_ZNSt12_Destroy_auxILb1EE9__destroyIPiEEvT_S3_(i32*, i32*) #3 align 2 {
  ...
  %4 = alloca i32*, align 8, !llfi_index !302
  store i32* %0, i32** %3, align 8, !llfi_index !303
  store i32* %1, i32** %4, align 8, !llfi_index !304
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEEC2Ev(%"class.std::vector"* %this) unnamed_addr #3 align 2 {
  ...
  %2 = load %"class.std::vector"** %1, !llfi_index !308
  %3 = bitcast %"class.std::vector"* %2 to %"struct.std::_Vector_base"*, !llfi_index !309
  call void @_ZNSt12_Vector_baseIiSaIiEEC2Ev(%"struct.std::_Vector_base"* %3), !llfi_index !310
...
define linkonce_odr void @_ZN13VectorVisitorC2ERSt6vectorIiSaIiEE(%class.VectorVisitor* %this, %"class.std::vector"* %r) unnamed_addr #3 align 2 {
  %1 = alloca %class.VectorVisitor*, align 8, !llfi_index !312
  %2 = alloca %"class.std::vector"*, align 8, !llfi_index !313
  store %class.VectorVisitor* %this, %class.VectorVisitor** %1, align 8, !llfi_index !314
  store %"class.std::vector"* %r, %"class.std::vector"** %2, align 8, !llfi_index !315
  %3 = load %class.VectorVisitor** %1, !llfi_index !316
  %4 = bitcast %class.VectorVisitor* %3 to %class.NodeVisitor*, !llfi_index !317
  call void @_ZN11NodeVisitorC2Ev(%class.NodeVisitor* %4) #0, !llfi_index !318
  %5 = bitcast %class.VectorVisitor* %3 to i8***, !llfi_index !319
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV13VectorVisitor, i64 0, i64 2), i8*** %5, !llfi_index !320
  %6 = getelementptr inbounds %class.VectorVisitor* %3, i32 0, i32 1, !llfi_index !321
  %7 = load %"class.std::vector"** %2, align 8, !llfi_index !322
  store %"class.std::vector"* %7, %"class.std::vector"** %6, align 8, !llfi_index !323
...
define linkonce_odr void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %this, %struct.TreeNode* %root, %class.NodeVisitor* %visitor) #3 align 2 {
  %1 = alloca %class.Solution*, align 8, !llfi_index !325
  %2 = alloca %struct.TreeNode*, align 8, !llfi_index !326
  %3 = alloca %class.NodeVisitor*, align 8, !llfi_index !327
  store %class.Solution* %this, %class.Solution** %1, align 8, !llfi_index !328
  store %struct.TreeNode* %root, %struct.TreeNode** %2, align 8, !llfi_index !329
  store %class.NodeVisitor* %visitor, %class.NodeVisitor** %3, align 8, !llfi_index !330
  %4 = load %class.Solution** %1, !llfi_index !331
  %5 = load %struct.TreeNode** %2, align 8, !llfi_index !332
  %6 = icmp eq %struct.TreeNode* %5, null, !llfi_index !333
  br i1 %6, label %7, label %8, !llfi_index !334

; <label>:7                                       ; preds = %0
  br label %25, !llfi_index !335

; <label>:8                                       ; preds = %0
  %9 = load %struct.TreeNode** %2, align 8, !llfi_index !336
  %10 = getelementptr inbounds %struct.TreeNode* %9, i32 0, i32 1, !llfi_index !337
  %11 = load %struct.TreeNode** %10, align 8, !llfi_index !338
  %12 = load %class.NodeVisitor** %3, align 8, !llfi_index !339
  call void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %4, %struct.TreeNode* %11, %class.NodeVisitor* %12), !llfi_index !340
  %13 = load %struct.TreeNode** %2, align 8, !llfi_index !341
  %14 = getelementptr inbounds %struct.TreeNode* %13, i32 0, i32 2, !llfi_index !342
  %15 = load %struct.TreeNode** %14, align 8, !llfi_index !343
  %16 = load %class.NodeVisitor** %3, align 8, !llfi_index !344
  call void @_ZN8Solution18postorderTraversalEP8TreeNodeR11NodeVisitor(%class.Solution* %4, %struct.TreeNode* %15, %class.NodeVisitor* %16), !llfi_index !345
  %17 = load %class.NodeVisitor** %3, align 8, !llfi_index !346
  %18 = bitcast %class.NodeVisitor* %17 to void (%class.NodeVisitor*, i32)***, !llfi_index !347
  %19 = load void (%class.NodeVisitor*, i32)*** %18, !llfi_index !348
  %20 = getelementptr inbounds void (%class.NodeVisitor*, i32)** %19, i64 2, !llfi_index !349
  %21 = load void (%class.NodeVisitor*, i32)** %20, !llfi_index !350
  %22 = load %struct.TreeNode** %2, align 8, !llfi_index !351
  %23 = getelementptr inbounds %struct.TreeNode* %22, i32 0, i32 0, !llfi_index !352
  %24 = load i32* %23, align 4, !llfi_index !353
  call void %21(%class.NodeVisitor* %17, i32 %24), !llfi_index !354
  br label %25, !llfi_index !355
...
define linkonce_odr void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %this) unnamed_addr #5 align 2 {
  %1 = alloca %class.VectorVisitor*, align 8, !llfi_index !357
  store %class.VectorVisitor* %this, %class.VectorVisitor** %1, align 8, !llfi_index !358
  %2 = load %class.VectorVisitor** %1, !llfi_index !359
  %3 = bitcast %class.VectorVisitor* %2 to %class.NodeVisitor*, !llfi_index !360
  call void @_ZN11NodeVisitorD2Ev(%class.NodeVisitor* %3) #0, !llfi_index !361
  ret void, !llfi_index !362
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZN11NodeVisitorC2Ev(%class.NodeVisitor* %this) unnamed_addr #5 align 2 {
  %1 = alloca %class.NodeVisitor*, align 8, !llfi_index !363
  store %class.NodeVisitor* %this, %class.NodeVisitor** %1, align 8, !llfi_index !364
  %2 = load %class.NodeVisitor** %1, !llfi_index !365
  %3 = bitcast %class.NodeVisitor* %2 to i8***, !llfi_index !366
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV11NodeVisitor, i64 0, i64 2), i8*** %3, !llfi_index !367
  ret void, !llfi_index !368
}

; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr void @_ZN13VectorVisitorD0Ev(%class.VectorVisitor* %this) unnamed_addr #5 align 2 {
  %1 = alloca %class.VectorVisitor*, align 8, !llfi_index !369
  store %class.VectorVisitor* %this, %class.VectorVisitor** %1, align 8, !llfi_index !370
  %2 = load %class.VectorVisitor** %1, !llfi_index !371
  call void @_ZN13VectorVisitorD2Ev(%class.VectorVisitor* %2) #0, !llfi_index !372
  %3 = bitcast %class.VectorVisitor* %2 to i8*, !llfi_index !373
  call void @_ZdlPv(i8* %3) #9, !llfi_index !374
...
define linkonce_odr void @_ZN13VectorVisitor5visitEi(%class.VectorVisitor* %this, i32 %val) unnamed_addr #3 align 2 {
  %1 = alloca %class.VectorVisitor*, align 8, !llfi_index !376
  %2 = alloca i32, align 4, !llfi_index !377
  store %class.VectorVisitor* %this, %class.VectorVisitor** %1, align 8, !llfi_index !378
  store i32 %val, i32* %2, align 4, !llfi_index !379
  %3 = load %class.VectorVisitor** %1, !llfi_index !380
  %4 = getelementptr inbounds %class.VectorVisitor* %3, i32 0, i32 1, !llfi_index !381
  %5 = load %"class.std::vector"** %4, align 8, !llfi_index !382
  call void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %5, i32* %2), !llfi_index !383
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE9push_backERKi(%"class.std::vector"* %this, i32* %__x) #3 align 2 {
  ...
  store i32* %__x, i32** %2, align 8, !llfi_index !388
  %3 = load %"class.std::vector"** %1, !llfi_index !389
  %4 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !390
  %5 = getelementptr inbounds %"struct.std::_Vector_base"* %4, i32 0, i32 0, !llfi_index !391
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %5, i32 0, i32 1, !llfi_index !392
  %7 = load i32** %6, align 8, !llfi_index !393
  %8 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !394
  %9 = getelementptr inbounds %"struct.std::_Vector_base"* %8, i32 0, i32 0, !llfi_index !395
  %10 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %9, i32 0, i32 2, !llfi_index !396
  %11 = load i32** %10, align 8, !llfi_index !397
  %12 = icmp ne i32* %7, %11, !llfi_index !398
  br i1 %12, label %13, label %27, !llfi_index !399

; <label>:13                                      ; preds = %0
  %14 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !400
  %15 = getelementptr inbounds %"struct.std::_Vector_base"* %14, i32 0, i32 0, !llfi_index !401
  %16 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %15 to %"class.std::allocator.1"*, !llfi_index !402
  %17 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !403
  %18 = getelementptr inbounds %"struct.std::_Vector_base"* %17, i32 0, i32 0, !llfi_index !404
  %19 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %18, i32 0, i32 1, !llfi_index !405
  %20 = load i32** %19, align 8, !llfi_index !406
  %21 = load i32** %2, align 8, !llfi_index !407
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.1"* %16, i32* %20, i32* %21), !llfi_index !408
  %22 = bitcast %"class.std::vector"* %3 to %"struct.std::_Vector_base"*, !llfi_index !409
  %23 = getelementptr inbounds %"struct.std::_Vector_base"* %22, i32 0, i32 0, !llfi_index !410
  %24 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %23, i32 0, i32 1, !llfi_index !411
  %25 = load i32** %24, align 8, !llfi_index !412
  %26 = getelementptr inbounds i32* %25, i32 1, !llfi_index !413
  store i32* %26, i32** %24, align 8, !llfi_index !414
  br label %29, !llfi_index !415

; <label>:27                                      ; preds = %0
  %28 = load i32** %2, align 8, !llfi_index !416
  call void @_ZNSt6vectorIiSaIiEE19_M_emplace_back_auxIJRKiEEEvDpOT_(%"class.std::vector"* %3, i32* %28), !llfi_index !417
  br label %29, !llfi_index !418
...
define linkonce_odr void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.1"* %__a, i32* %__p, i32* %__args) #3 align 2 {
  %1 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !420
  %2 = alloca i32*, align 8, !llfi_index !421
  %3 = alloca i32*, align 8, !llfi_index !422
  store %"class.std::allocator.1"* %__a, %"class.std::allocator.1"** %1, align 8, !llfi_index !423
  store i32* %__p, i32** %2, align 8, !llfi_index !424
  store i32* %__args, i32** %3, align 8, !llfi_index !425
  %4 = load %"class.std::allocator.1"** %1, align 8, !llfi_index !426
  %5 = bitcast %"class.std::allocator.1"* %4 to %"class.__gnu_cxx::new_allocator.2"*, !llfi_index !427
  ...
  call void @_ZN9__gnu_cxx13new_allocatorIiE9constructIiJRKiEEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator.2"* %5, i32* %6, i32* %8), !llfi_index !431
...
define linkonce_odr void @_ZNSt6vectorIiSaIiEE19_M_emplace_back_auxIJRKiEEEvDpOT_(%"class.std::vector"* %this, i32* %__args) #3 align 2 {
  ...
  %11 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %10 to %"class.std::allocator.1"*, !llfi_index !451
  ...
  call void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator.1"* %11, i32* %14, i32* %16), !llfi_index !457
  ...
  %27 = call %"class.std::allocator.1"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %26) #0, !llfi_index !469
  %28 = call i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %20, i32* %24, i32* %25, %"class.std::allocator.1"* %27), !llfi_index !470
  ...
  %40 = call %"class.std::allocator.1"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %39) #0, !llfi_index !484
  call void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %34, i32* %38, %"class.std::allocator.1"* %40), !llfi_index !485
...
; <label>:11                                      ; preds = %0
  ...
  call void @_ZSt20__throw_length_errorPKc(i8* %12) #10, !llfi_index !538
...
; <label>:6                                       ; preds = %0
  ...
  %8 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %7 to %"class.std::allocator.1"*, !llfi_index !570
  %9 = load i64* %2, align 8, !llfi_index !571
  %10 = call i32* @_ZNSt16allocator_traitsISaIiEE8allocateERS0_m(%"class.std::allocator.1"* %8, i64 %9), !llfi_index !572
...
define linkonce_odr i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %__first, i32* %__last, i32* %__result, %"class.std::allocator.1"* %__alloc) #5 {
  ...
  %4 = alloca %"class.std::allocator.1"*, align 8, !llfi_index !584
  ...
  store %"class.std::allocator.1"* %__alloc, %"class.std::allocator.1"** %4, align 8, !llfi_index !590
  ...
  %14 = load %"class.std::allocator.1"** %4, align 8, !llfi_index !600
  ...
  %19 = call i32* @_ZSt22__uninitialized_copy_aISt13move_iteratorIPiES1_iET0_T_S4_S3_RSaIT1_E(i32* %16, i32* %18, i32* %13, %"class.std::allocator.1"* %14), !llfi_index !605
...
; <label>:9                                       ; preds = %1
  call void @_ZSt17__throw_bad_allocv() #10, !llfi_index !829
...
define linkonce_odr void @_ZN11NodeVisitorD2Ev(%class.NodeVisitor* %this) unnamed_addr #3 align 2 {
  %1 = alloca %class.NodeVisitor*, align 8, !llfi_index !897
  store %class.NodeVisitor* %this, %class.NodeVisitor** %1, align 8, !llfi_index !898
  %2 = load %class.NodeVisitor** %1, !llfi_index !899
  ret void, !llfi_index !900
}

; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN11NodeVisitorD0Ev(%class.NodeVisitor* %this) unnamed_addr #3 align 2 {
  %1 = alloca %class.NodeVisitor*, align 8, !llfi_index !901
  store %class.NodeVisitor* %this, %class.NodeVisitor** %1, align 8, !llfi_index !902
  %2 = load %class.NodeVisitor** %1, !llfi_index !903
  call void @_ZN11NodeVisitorD2Ev(%class.NodeVisitor* %2) #0, !llfi_index !904
  %3 = bitcast %class.NodeVisitor* %2 to i8*, !llfi_index !905
  call void @_ZdlPv(i8* %3) #9, !llfi_index !906
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEEC2Ev(%"struct.std::_Vector_base"* %this) unnamed_addr #3 align 2 {
  ...
  %3 = getelementptr inbounds %"struct.std::_Vector_base"* %2, i32 0, i32 0, !llfi_index !911
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %3), !llfi_index !912
...
define linkonce_odr void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2Ev(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this) unnamed_addr #3 align 2 {
  ...
  %3 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2 to %"class.std::allocator.1"*, !llfi_index !917
  call void @_ZNSaIiEC2Ev(%"class.std::allocator.1"* %3) #0, !llfi_index !918
  %4 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2, i32 0, i32 0, !llfi_index !919
  store i32* null, i32** %4, align 8, !llfi_index !920
  %5 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2, i32 0, i32 1, !llfi_index !921
  store i32* null, i32** %5, align 8, !llfi_index !922
  %6 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %2, i32 0, i32 2, !llfi_index !923
  store i32* null, i32** %6, align 8, !llfi_index !924
...
define linkonce_odr void @_ZNSaIiEC2Ev(%"class.std::allocator.1"* %this) unnamed_addr #3 align 2 {
  ...
  %3 = bitcast %"class.std::allocator.1"* %2 to %"class.__gnu_cxx::new_allocator.2"*, !llfi_index !929
  call void @_ZN9__gnu_cxx13new_allocatorIiEC2Ev(%"class.__gnu_cxx::new_allocator.2"* %3) #0, !llfi_index !930
...
define internal void @_GLOBAL__I_a() #0 section ".text.startup" {
  call void @__cxx_global_var_init(), !llfi_index !936
